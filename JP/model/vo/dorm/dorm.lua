...
function var_0_0.StaticGetMapSize(arg_6_0)
	...
	local var_6_3 = BackYardConst.MAX_MAP_SIZE
	local var_6_4 = var_6_3.x
	local var_6_5 = var_6_3.y

	return Vector4(var_6_1, var_6_2, var_6_4, var_6_5)
end
...
function var_0_0.getComfortable(arg_13_0, arg_13_1)
	...
	for iter_13_0, iter_13_1 in pairs(arg_13_0.furnitures) do
		local var_13_3 = iter_13_1.count or 1
	...
	for iter_13_5, iter_13_6 in pairs(var_13_4) do
		local var_13_5 = var_13_1[iter_13_6[1]] or {}
		...
		for iter_13_7 = 1, iter_13_6[2] do
			var_13_0 = var_13_0 + (var_13_5[iter_13_7] or 0)
		end
	end

	local var_13_6 = var_13_0 + arg_13_0:getConfig("comfortable")

	if arg_13_0:isUnlockFloor(2) then
		var_13_6 = var_13_6 + var_0_0.DORM_2_FLOOR_COMFORTABLE_ADDITION
	end
...
function var_0_0.getFoodLeftTime(arg_26_0)
	...
	return arg_26_0.nextAddShipExpTime + (var_26_3 / var_26_2 - 1) * var_26_0.time
end
...
function var_0_0.IsLackOfFood(arg_28_0)
	...
	return arg_28_0:getFoodLeftTime() - pg.TimeMgr.GetInstance():GetServerTime() <= 0
end
...
function var_0_0.AddFurniture(arg_56_0, arg_56_1)
	if not arg_56_0.furnitures[arg_56_1.id] then
		...
		var_56_0:setCount(var_56_0.count + arg_56_1.count)
	end
end

function var_0_0.AddFurnitrues(arg_57_0, arg_57_1)
	for iter_57_0, iter_57_1 in ipairs(arg_57_1) do
		local var_57_0 = Furniture.New({
			count = 1,
			id = iter_57_1
		})

		arg_57_0:AddFurniture(var_57_0)
	end
end
...
function var_0_0.GetPutFurnitureList(arg_61_0, arg_61_1)
	local var_61_0 = {}
	local var_61_1 = arg_61_0:GetTheme(arg_61_1)
	local var_61_2 = var_61_1 and var_61_1:GetAllFurniture() or {}
