	...
	var_0_0.readyToAchieveDic = var_0_0.readyToAchieveDic or {
		...
		[ActivityConst.ACTIVITY_TYPE_STORY_AWARD] = function(arg_28_0)
			...
			for iter_28_0 = 1, #var_28_1.chapter do
				local var_28_2 = var_28_1.chapter[iter_28_0]

				if getProxy(ChapterProxy):isClear(var_28_2) and not _.include(arg_28_0.data1_list, var_28_2) then
					return true
				end
			end
		...
		[ActivityConst.ACTIVITY_TYPE_TASKS] = function(arg_29_0)
			...
			local var_29_3 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_WORLDINPICTURE)

			if var_29_3 and not var_29_3:isEnd() and var_29_3:getConfig("config_client").linkActID == arg_29_0.id and var_29_3:readyToAchieve() then
				return true
			end

			if arg_29_0:getConfig("config_client") and arg_29_0:getConfig("config_client").decodeGameId then
				local var_29_4 = arg_29_0:getConfig("config_client").decodeGameId
				local var_29_5 = getProxy(MiniGameProxy):GetHubByGameId(var_29_4)

				if var_29_5 then
					local var_29_6 = arg_29_0:getConfig("config_data")
					local var_29_7 = var_29_6[#var_29_6]
					local var_29_8 = _.all(var_29_7, function(arg_31_0)
						return getProxy(TaskProxy):getFinishTaskById(arg_31_0) ~= nil
					end)

					if var_29_5.ultimate <= 0 and var_29_8 then
						return true
					end
				end
			end
			...
			if arg_29_0:getConfig("config_client") and arg_29_0:getConfig("config_client").linkTaskPoolAct then
				local var_29_9 = arg_29_0:getConfig("config_client").linkTaskPoolAct
				local var_29_10 = getProxy(ActivityProxy):getActivityById(var_29_9)

				if var_29_10 and var_29_10:readyToAchieve() then
					return true
				end
			end

			if arg_29_0:getConfig("config_client") and arg_29_0:getConfig("config_client").link_act then
				local var_29_11 = arg_29_0:getConfig("config_client").link_act
				local var_29_12 = getProxy(ActivityProxy):getActivityById(var_29_11)

				if var_29_12 and var_29_12:readyToAchieve() then
					return true
				end
			end
		...
		[ActivityConst.ACTIVITY_TYPE_RETURN_AWARD] = function(arg_38_0)
			local var_38_0 = arg_38_0.data1

			if var_38_0 == 1 then
				local var_38_1 = pg.activity_template_headhunting[arg_38_0.id]
				local var_38_2 = var_38_1.target
				local var_38_3 = 0

				for iter_38_0, iter_38_1 in ipairs(arg_38_0:getClientList()) do
					var_38_3 = var_38_3 + iter_38_1:getPt()
				end

				local var_38_4 = 0

				for iter_38_2 = #var_38_2, 1, -1 do
					if table.contains(arg_38_0.data1_list, var_38_2[iter_38_2]) then
						var_38_4 = iter_38_2
				...
				local var_38_5 = var_38_1.drop_client
				local var_38_6 = math.min(var_38_4 + 1, #var_38_5)
				local var_38_7 = _.any(var_38_1.tasklist, function(arg_39_0)
					local var_39_0 = getProxy(TaskProxy):getTaskById(arg_39_0)

					return var_39_0 and var_39_0:isFinish() and not var_39_0:isReceive()
				end)

				return var_38_3 >= var_38_2[var_38_6] and var_38_4 ~= #var_38_5 or var_38_7
			elseif var_38_0 == 2 then
				local var_38_8 = getProxy(TaskProxy)
				local var_38_9 = pg.activity_template_returnner[arg_38_0.id]

				return _.any(_.flatten(var_38_9.task_list), function(arg_40_0)
					local var_40_0 = var_38_8:getTaskById(arg_40_0)
		...
		[ActivityConst.ACTIVITY_TYPE_TURNTABLE] = function(arg_42_0)
			...
			local var_42_1 = arg_42_0.data4

			if var_42_1 ~= 0 then
				local var_42_2 = var_42_0.task_table[var_42_1]
				local var_42_3 = getProxy(TaskProxy)

				for iter_42_0, iter_42_1 in ipairs(var_42_2) do
					if (var_42_3:getTaskById(iter_42_1) or var_42_3:getFinishTaskById(iter_42_1)):getTaskStatus() == 1 then
						return true
					end
				end

				local var_42_4 = pg.TimeMgr.GetInstance():DiffDay(arg_42_0.data1, pg.TimeMgr.GetInstance():GetServerTime()) + 1

				if math.clamp(var_42_4, 1, pg.activity_event_turning[arg_42_0:getConfig("config_id")].total_num) > arg_42_0.data3 then
					for iter_42_2, iter_42_3 in ipairs(var_42_2) do
						if (var_42_3:getTaskById(iter_42_3) or var_42_3:getFinishTaskById(iter_42_3)):getTaskStatus() ~= 2 then
							return false
						end
					end
			...
			elseif var_42_1 == 0 then
				local var_42_5 = pg.TimeMgr.GetInstance():DiffDay(arg_42_0.data1, pg.TimeMgr.GetInstance():GetServerTime()) + 1

				if math.clamp(var_42_5, 1, pg.activity_event_turning[arg_42_0:getConfig("config_id")].total_num) > arg_42_0.data3 then
					return true
				end
			end
		...
		[ActivityConst.ACTIVITY_TYPE_SHRINE] = function(arg_44_0)
			...
			local var_44_1 = var_44_0 and #var_44_0 or 7
			local var_44_2 = pg.TimeMgr.GetInstance():DiffDay(arg_44_0.data3, pg.TimeMgr.GetInstance():GetServerTime()) + 1
			local var_44_3 = math.clamp(var_44_2, 1, var_44_1)
			...
			if var_44_0 then
				...
				for iter_44_0 = 1, var_44_3 do
					local var_44_6 = var_44_0[iter_44_0][1]

					if var_44_6 and iter_44_0 <= var_44_5 and not var_44_4:IsPlayed(var_44_6) then
						return true
					end
				end
			end

			if var_44_1 <= var_44_3 and var_44_1 <= arg_44_0.data2 and not (arg_44_0.data1 > 0) then
				return true
			end
		...
		[ActivityConst.ACTIVITY_TYPE_LINK_LINK] = function(arg_45_0)
			local var_45_0 = arg_45_0:getConfig("config_client")[3]
			local var_45_1 = pg.TimeMgr.GetInstance()
			local var_45_2 = var_45_1:DiffDay(arg_45_0.data3, var_45_1:GetServerTime()) + 1 - arg_45_0.data2

			return math.clamp(var_45_2, 0, #var_45_0 - arg_45_0.data2) > 0
		end,
		[ActivityConst.ACTIVITY_TYPE_BUILDING_BUFF] = function(arg_46_0)
			local var_46_0 = arg_46_0:GetBuildingIds()

			for iter_46_0, iter_46_1 in ipairs(var_46_0) do
				local var_46_1 = arg_46_0:GetBuildingLevel(iter_46_1)
				local var_46_2 = pg.activity_event_building[iter_46_1]

				if var_46_2 and var_46_1 < #var_46_2.buff then
					local var_46_3 = var_46_2.material[var_46_1]

					if underscore.all(var_46_3, function(arg_47_0)
						local var_47_0 = arg_47_0[1]
						local var_47_1 = arg_47_0[2]
						local var_47_2 = arg_47_0[3]
						local var_47_3 = 0

						if var_47_0 == DROP_TYPE_VITEM then
							local var_47_4 = AcessWithinNull(Item.getConfigData(var_47_1), "link_id")

							assert(var_47_4 == arg_46_0.id)

							var_47_3 = arg_46_0:GetMaterialCount(var_47_1)
						elseif var_47_0 > DROP_TYPE_USE_ACTIVITY_DROP then
							local var_47_5 = AcessWithinNull(pg.activity_drop_type[var_47_0], "activity_id")

							assert(var_47_5)

							bagAct = getProxy(ActivityProxy):getActivityById(var_47_5)
							var_47_3 = bagAct:getVitemNumber(var_47_1)
						end
		...
		[ActivityConst.ACTIVITY_TYPE_PUZZLA] = function(arg_52_0)
			...
			local var_52_3 = arg_52_0:getConfig("config_client").linkActID

			if var_52_3 then
				local var_52_4 = getProxy(ActivityProxy):getActivityById(var_52_3)

				if var_52_4 and var_52_4:readyToAchieve() then
					return true
				end
			end

			if _.any(var_52_2, function(arg_53_0)
				local var_53_0 = table.contains(var_52_1, arg_53_0)
				local var_53_1 = table.contains(var_52_0, arg_53_0)
			...
			local var_52_5 = pg.activity_event_picturepuzzle[arg_52_0.id]

			if var_52_5 and var_52_5.chapter > 0 and arg_52_0.data1 < 1 then
				return true
			end

			if var_52_5 and #var_52_5.auto_finish_args > 0 and arg_52_0.data1 == 1 then
				return true
			end
		...
		[ActivityConst.ACTIVITY_TYPE_APRIL_REWARD] = function(arg_56_0)
			if arg_56_0.data1 == 0 then
				local var_56_0 = arg_56_0:getStartTime()
				local var_56_1 = pg.TimeMgr.GetInstance():GetServerTime()

				if arg_56_0:getConfig("config_client").autounlock <= var_56_1 - var_56_0 then
					return true
				end
		...
		[ActivityConst.ACTIVITY_TYPE_EVENT] = function(arg_59_0)
			...
			return PlayerPrefs.GetInt("ACTIVITY_TYPE_EVENT_" .. arg_59_0.id .. "_" .. var_59_0) == 0
		end,
		...
		[ActivityConst.ACTIVITY_TYPE_FIREWORK] = function(arg_62_0)
			...
			local var_62_1 = arg_62_0:getConfig("config_data")[2][2]
			local var_62_2 = getProxy(PlayerProxy):getRawData():getResource(var_62_0)

			if arg_62_0.data1 > 0 and var_62_1 <= var_62_2 then
				return true
			end
		...
		[ActivityConst.ACTIVITY_TYPE_CARD_PUZZLE] = function(arg_66_0)
			...
			local function var_66_4()
				local var_68_0 = getProxy(PlayerProxy):getData().id

				return PlayerPrefs.GetInt("DAY_TIP_" .. arg_66_0.id .. "_" .. var_68_0 .. "_" .. arg_66_0:getDayIndex()) == 0
			end

			return var_66_3() or var_66_4()
		end,
		[ActivityConst.ACTIVITY_TYPE_SURVEY] = function(arg_69_0)
			local var_69_0, var_69_1 = getProxy(ActivityProxy):isSurveyOpen()
			local var_69_2 = getProxy(ActivityProxy):isSurveyDone()

			return var_69_0 and not var_69_2 and not SurveyPage.IsEverEnter(var_69_1)
		end,
		...
		[ActivityConst.ACTIVITY_TYPE_GIFT_UP] = function(arg_71_0)
			...
			local var_71_1 = math.min(#var_71_0, arg_71_0:getNDay())

			return underscore(var_71_0):chain():first(var_71_1):any(function(arg_72_0)
		...
		[ActivityConst.ACTIVITY_TYPE_UR_EXCHANGE] = function(arg_73_0)
			...
			local var_73_1 = getProxy(PlayerProxy):getData():getResource(var_73_0.uPtId)
			local var_73_2 = #var_73_0.goodsId + 1
			local var_73_3 = var_73_2 - _.reduce(var_73_0.goodsId, 0, function(arg_74_0, arg_74_1)
				return arg_74_0 + getProxy(ShopsProxy):getActivityShopById(var_73_0.shopId):GetCommodityById(arg_74_1):GetPurchasableCnt()
			end)
			local var_73_4 = var_73_3 < var_73_2 and pg.activity_shop_template[var_73_0.goodsId[var_73_3]] or nil

			return var_73_3 < var_73_2 and var_73_1 >= var_73_4.resource_num
		end,
		...
		[ActivityConst.ACTIVITY_TYPE_TASK_RYZA] = function(arg_77_0)
			local var_77_0 = getProxy(ActivityTaskProxy):getTaskById(arg_77_0.id)
		...
		[ActivityConst.ACTIVITY_TYPE_MINIGAME] = function(arg_78_0)
			...
			if getProxy(MiniGameProxy):GetHubByHubId(var_78_0).count > 0 then
				return true
			end
		end,
		[ActivityConst.ACTIVITY_TYPE_7DAYSLOGIN] = function(arg_79_0)
			local var_79_0 = arg_79_0:getConfig("config_id")
			local var_79_1 = pg.activity_7_day_sign[var_79_0].front_drops
			local var_79_2 = pg.TimeMgr.GetInstance()
			local var_79_3 = var_79_2:GetServerTime()

			return arg_79_0.data1 < #var_79_1 and not var_79_2:IsSameDay(var_79_3, arg_79_0.data2) and var_79_3 > arg_79_0.data2
		end,
		...
		[ActivityConst.ACTIVITY_TYPE_ISLAND_GAME_PT] = function(arg_85_0)
			local var_85_0 = pg.island_activity_pt_page[arg_85_0:getIslandConfig("config_id")].task_id
			local var_85_1 = getProxy(IslandProxy):GetIsland():GetTaskAgency()

			return IslandGamePtTemplatePage.ShouldFirstTip(arg_85_0.id) or _.any(var_85_0, function(arg_86_0)
				local var_86_0 = var_85_1:GetTask(arg_86_0)

				return var_86_0 and var_86_0:IsFinish() and not var_85_1:IsFinishTask(arg_86_0)
			end)
		end,
		[ActivityConst.ACTIVITY_TYPE_ISLAND_CHEATE_TAVERN] = function(arg_87_0)
			local var_87_0 = getProxy(ActivityTaskProxy):getTaskById(ActivityConst.ISLAND_BAR_ACT_ID)
...
function var_0_0.IsShowTipById(arg_88_0)
	var_0_0.ShowTipTableById = var_0_0.ShowTipTableById or {
		[ActivityConst.ACTIVITY_ID_US_SKIRMISH_RE] = function(arg_89_0)
			...
			local var_89_1 = var_89_0:getRawData()
			local var_89_2 = 0
			local var_89_3 = 0

			for iter_89_0, iter_89_1 in ipairs(var_89_1) do
				local var_89_4 = iter_89_1:GetState()

				var_89_2 = var_89_4 > SkirmishVO.StateInactive and var_89_2 + 1 or var_89_2
				var_89_3 = var_89_4 == SkirmishVO.StateClear and var_89_3 + 1 or var_89_3
			end
		...
		[ActivityConst.POCKY_SKIN_LOGIN] = function(arg_90_0)
			...
			local function var_90_8()
				...
				for iter_93_0 = 1, math.min(#var_93_0, var_90_4.data3) do
					...
					local var_93_2 = var_90_1:getTaskById(var_93_1)

					if var_93_2 and var_93_2:isFinish() and not var_93_2:isReceive() then
						return true
					end
				end
			end
			...
			local function var_90_9()
				...
				local var_94_0 = ActivityPtData.New(var_90_3)

				return var_94_0.level >= #var_94_0.targets
			end

			return var_90_8() or var_90_6() or var_90_7() or var_90_9()
		end,
		[ActivityConst.TOWERCLIMBING_SIGN] = function(arg_95_0)
			local var_95_0 = getProxy(MiniGameProxy):GetHubByHubId(9)
			local var_95_1 = var_95_0.ultimate
			local var_95_2 = var_95_0:getConfig("reward_need")
			local var_95_3 = var_95_0.usedtime
		...
		[ActivityConst.LOVE_LETTER_LOGIN_ID] = function(arg_99_0)
			...
			for iter_99_0 = 1, var_99_0 do
				local var_99_1 = arg_99_0:getConfig("config_data")[iter_99_0]
				local var_99_2 = var_99_1 and getProxy(TaskProxy):getTaskVO(var_99_1) or nil

				if var_99_2 and var_99_2:getTaskStatus() == 1 then
					return true
				end
			end
	...
	local var_88_0 = var_0_0.ShowTipTableById[arg_88_0.id]

	return tobool(var_88_0), var_88_0 and var_88_0(arg_88_0)
end
...
function var_0_0.activityTasksSubTypeFunc(arg_100_0, arg_100_1)
	if arg_100_1 == 1 then
		...
		local var_100_5 = math.min(var_100_3, var_100_4)
		...
		for iter_100_0 = 1, var_100_5 do
			...
			if iter_100_0 < var_100_5 then
				for iter_100_1, iter_100_2 in ipairs(var_100_2[iter_100_0]) do
					local var_100_7 = var_100_1:getTaskById(iter_100_2) or var_100_1:getFinishTaskById(iter_100_2)
		...
		local var_100_8 = math.min(var_100_0, var_100_4)

		for iter_100_3, iter_100_4 in ipairs(var_100_2[var_100_8]) do
			local var_100_9 = var_100_1:getTaskById(iter_100_4) or var_100_1:getFinishTaskById(iter_100_4)
...
function var_0_0.isShow(arg_101_0)
	if LOCK_SKIN_US then
		local var_101_0 = pg.gameset.levellimit_skinstory.key_value
		local var_101_1 = pg.gameset.levellimit_skinstory.description

		if var_101_0 >= getProxy(PlayerProxy):getRawData().level and table.contains(var_101_1, arg_101_0.id) then
			return false
		end
	end

	local var_101_2 = arg_101_0:getConfig("page_info")
	...
	elseif arg_101_0:getConfig("type") == ActivityConst.ACTIVITY_TYPE_CLIENT_DISPLAY then
		local var_101_3 = arg_101_0:getConfig("config_client").display_link

		if var_101_3 then
			return underscore.any(var_101_3, function(arg_103_0)
	...
	elseif arg_101_0:getConfig("type") == ActivityConst.ACTIVITY_TYPE_SURVEY then
		local var_101_4 = getProxy(ActivityProxy)
		local var_101_5 = var_101_4:isSurveyOpen()
		local var_101_6 = var_101_4:isSurveyDone()

		return var_101_5 and not var_101_6
	elseif arg_101_0:getConfig("type") == ActivityConst.ACTIVITY_TYPE_UR_EXCHANGE then
		if getProxy(ShopsProxy):getActivityShops() == nil then
			return false
		end

		local var_101_7 = arg_101_0:getConfig("config_client")
		local var_101_8 = getProxy(PlayerProxy):getData():getResource(var_101_7.uPtId)
		local var_101_9 = #var_101_7.goodsId + 1

		return var_101_9 > var_101_9 - _.reduce(var_101_7.goodsId, 0, function(arg_104_0, arg_104_1)
			return arg_104_0 + getProxy(ShopsProxy):getActivityShopById(var_101_7.shopId):GetCommodityById(arg_104_1):GetPurchasableCnt()
		end)
	elseif arg_101_0:getConfig("type") == ActivityConst.ACTIVITY_TYPE_TASK_RYZA and table.contains({
		...
		return #getProxy(ActivityProxy):getActivityById(arg_101_0:getConfig("id")):getConfig("config_data") ~= #getProxy(ActivityTaskProxy):getFinishTaskById(arg_101_0:getConfig("id"))
	end
...
function var_0_0.isAfterShow(arg_105_0)
	if arg_105_0.configId == ActivityConst.ISLAND_SIGN_ID then
		local var_105_0 = _.flatten(arg_105_0:getConfig("config_data"))
		local var_105_1 = getProxy(ActivityTaskProxy):GetActivityTasks(arg_105_0.id)

		return _.all(var_105_0, function(arg_106_0)
			local var_106_0 = var_105_1[arg_106_0]

			return var_106_0 and var_106_0:isOver()
		end)
	end

	if arg_105_0.configId == ActivityConst.UR_TASK_ACT_ID or arg_105_0.configId == ActivityConst.SPECIAL_WEAPON_ACT_ID then
		local var_105_2 = getProxy(TaskProxy)

		return underscore.all(arg_105_0:getConfig("config_data")[1], function(arg_107_0)
			local var_107_0 = var_105_2:getTaskVO(arg_107_0)
...
function var_0_0.getStartTime(arg_116_0)
	...
	if var_116_1 and var_116_1[1] == "newuser" then
		return arg_116_0.stopTime - var_116_1[3] * 86400
	else
...
function var_0_0.GetCrusingUnreceiveAward(arg_124_0)
	...
	local var_124_0 = pg.battlepass_event_pt[arg_124_0.id]
	local var_124_1 = {}
	local var_124_2 = {}

	for iter_124_0, iter_124_1 in ipairs(arg_124_0.data1_list) do
		var_124_2[iter_124_1] = true
	end

	for iter_124_2, iter_124_3 in ipairs(var_124_0.target) do
		if iter_124_3 > arg_124_0.data1 then
			break
		elseif not var_124_2[iter_124_3] then
			table.insert(var_124_1, Drop.Create(pg.battlepass_event_award[var_124_0.award[iter_124_2]].drop_client))
		end
	end

	if arg_124_0.data2 ~= 1 then
		return PlayerConst.MergePassItemDrop(var_124_1)
	end

	local var_124_3 = {}

	for iter_124_4, iter_124_5 in ipairs(arg_124_0.data2_list) do
		var_124_3[iter_124_5] = true
	end

	for iter_124_6, iter_124_7 in ipairs(var_124_0.target) do
		if iter_124_7 > arg_124_0.data1 then
			break
		elseif not var_124_3[iter_124_7] then
			table.insert(var_124_1, Drop.Create(pg.battlepass_event_award[var_124_0.award_pay[iter_124_6]].drop_client))
		end
	end
...
function var_0_0.GetCrusingInfo(arg_125_0)
	...
	local var_125_0 = pg.battlepass_event_pt[arg_125_0.id]
	local var_125_1 = var_125_0.pt
	local var_125_2 = {}
	local var_125_3 = {}

	for iter_125_0, iter_125_1 in ipairs(var_125_0.key_point_display) do
		var_125_3[iter_125_1] = true
	end
	...
	for iter_125_2, iter_125_3 in ipairs(var_125_0.target) do
		table.insert(var_125_2, {
			id = iter_125_2,
			pt = iter_125_3,
			award = pg.battlepass_event_award[var_125_0.award[iter_125_2]].drop_client,
			award_pay = pg.battlepass_event_award[var_125_0.award_pay[iter_125_2]].drop_client,
			isImportent = var_125_3[iter_125_2]
		})
	end

	local var_125_4 = arg_125_0.data1
	local var_125_5 = arg_125_0.data2 == 1
	local var_125_6 = {}

	for iter_125_4, iter_125_5 in ipairs(arg_125_0.data1_list) do
		var_125_6[iter_125_5] = true
	end

	local var_125_7 = {}

	for iter_125_6, iter_125_7 in ipairs(arg_125_0.data2_list) do
		var_125_7[iter_125_7] = true
	end

	local var_125_8 = 0

	for iter_125_8, iter_125_9 in ipairs(var_125_2) do
		if var_125_4 < iter_125_9.pt then
			break
		else
			var_125_8 = iter_125_8
		end
	end
	...
	return {
		...
		isPay = var_125_5,
		awardDic = var_125_6,
		awardPayDic = var_125_7,
		phase = var_125_8
	}
end

function var_0_0.GetHei5Info(arg_126_0)
	local var_126_0 = pg.black_friday_battlepass_event_pt[arg_126_0.id]
	local var_126_1 = var_126_0.pt
	local var_126_2 = {}
	local var_126_3 = {}

	for iter_126_0, iter_126_1 in ipairs(var_126_0.key_point_display) do
		var_126_3[iter_126_1] = true
	end

	for iter_126_2, iter_126_3 in ipairs(var_126_0.target) do
		table.insert(var_126_2, {
			id = iter_126_2,
			pt = iter_126_3,
			award = pg.black_friday_battlepass_event_award[var_126_0.award[iter_126_2]].drop_client,
			award_pay = pg.black_friday_battlepass_event_award[var_126_0.award_pay[iter_126_2]].drop_client,
			isImportent = var_126_3[iter_126_2]
		})
	end

	local var_126_4 = arg_126_0.data1
	local var_126_5 = arg_126_0.data2 == 1
	local var_126_6 = {}

	for iter_126_4, iter_126_5 in ipairs(arg_126_0.data1_list) do
		var_126_6[iter_126_5] = true
	end

	local var_126_7 = {}

	for iter_126_6, iter_126_7 in ipairs(arg_126_0.data2_list) do
		var_126_7[iter_126_7] = true
	end

	local var_126_8 = 0

	for iter_126_8, iter_126_9 in ipairs(var_126_2) do
		if var_126_4 < iter_126_9.pt then
			break
		else
			var_126_8 = iter_126_8
		end
	end
	...
	return {
		...
		isPay = var_126_5,
		awardDic = var_126_6,
		awardPayDic = var_126_7,
		phase = var_126_8
	}
end

function var_0_0.GetHei5UnreceiveAward(arg_127_0)
	local var_127_0 = pg.black_friday_battlepass_event_pt[arg_127_0.id]
	local var_127_1 = {}
	local var_127_2 = {}
	...
	for iter_127_2, iter_127_3 in ipairs(var_127_0.target) do
		...
		elseif not var_127_2[iter_127_3] then
			table.insert(var_127_1, Drop.Create(pg.black_friday_battlepass_event_award[var_127_0.award[iter_127_2]].drop_client))
		end
	end

	if arg_127_0.data2 ~= 1 then
		return PlayerConst.MergePassItemDrop(var_127_1)
	end

	local var_127_3 = {}

	for iter_127_4, iter_127_5 in ipairs(arg_127_0.data2_list) do
		var_127_3[iter_127_5] = true
	end

	for iter_127_6, iter_127_7 in ipairs(var_127_0.target) do
		if iter_127_7 > arg_127_0.data1 then
			break
		elseif not var_127_3[iter_127_7] then
			table.insert(var_127_1, Drop.Create(pg.black_friday_battlepass_event_award[var_127_0.award_pay[iter_127_6]].drop_client))
		end
	end
...
function var_0_0.GetLoginRedPointKey(arg_132_0)
	local var_132_0 = arg_132_0:GetPlayerID()

	return string.format("%s_%s", var_132_0, arg_132_0.id)
end
...
function var_0_0.GetPlayerActivyIDKey(arg_136_0)
	local var_136_0 = getProxy(PlayerProxy):getPlayerId()

	return "Activity_PlayerPrefs_PlayerId_" .. var_136_0 .. "ActivityID_" .. arg_136_0
end
