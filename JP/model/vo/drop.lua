...
function var_0_0.InitSwitch()
	...
	var_0_0.CountCase = {
		...
		[DROP_TYPE_EQUIPMENT_SKIN] = function(arg_118_0)
			...
			return (var_118_0 and var_118_0.count or 0) + getProxy(BayProxy):GetEquipSkinCountInShips(arg_118_0.id)
		end,
		[DROP_TYPE_RYZA_DROP] = function(arg_119_0)
			...
			return var_119_1 and var_119_1.count or 0
		end,
		...
		[DROP_TYPE_ISLAND_FURNITURE] = function(arg_130_0)
			...
			if var_130_0 then
				local var_130_1 = var_130_0:GetAgoraAgency():GetFurnitures()
	...
	function var_0_0.CountDefault(arg_136_0)
		...
		if var_136_0 > DROP_TYPE_USE_ACTIVITY_DROP then
			return getProxy(ActivityProxy):getActivityById(pg.activity_drop_type[var_136_0].activity_id):getVitemNumber(arg_136_0.id)
		else
			return 0, false
		end
	end
	...
	var_0_0.TransCase = {
		...
		[DROP_TYPE_VITEM] = function(arg_178_0, arg_178_1, arg_178_2)
			...
			return switch(arg_178_0:getConfig("virtual_type"), {
				...
				[6] = function()
					...
					local var_180_1 = getProxy(ActivityProxy)
					local var_180_2 = var_180_1:getActivityByType(ActivityConst.ACTIVITY_TYPE_REFLUX)

					if var_180_2 then
						local var_180_3 = var_180_2.data1KeyValueList[1]

						var_180_3[var_180_0] = defaultValue(var_180_3[var_180_0], 0) + arg_178_0.count

						var_180_1:updateActivity(var_180_2)
					end
				...
				[28] = function()
					local var_184_0 = Drop.New({
						type = arg_178_0.type,
						id = arg_178_0.id,
						count = math.floor(arg_178_0.count / 1000)
					})
					local var_184_1 = Drop.New({
						type = arg_178_0.type,
						id = arg_178_0.id,
		...
		[DROP_TYPE_SHIP] = function(arg_186_0, arg_186_1)
			if Ship.isMetaShipByConfigID(arg_186_0.id) and Player.isMetaShipNeedToTrans(arg_186_0.id) then
				...
				if var_186_0 then
					...
					local var_186_1 = Player.metaShip2Res(arg_186_0.id)
					local var_186_2 = Drop.New(var_186_1[1])

					getProxy(BayProxy):addMetaTransItemMap(arg_186_0.id, var_186_2)

					return arg_186_0, var_186_2
				end
			end
		...
		[DROP_TYPE_ACTIVITY_MEDAL] = function(arg_188_0)
			local var_188_0 = getProxy(PlayerProxy):getRawData()
			local var_188_1 = pg.TimeMgr.GetInstance():GetServerTime()

			var_188_0:updateMedalList({
				{
					key = arg_188_0.id,
					value = var_188_1
				}
	...
	var_0_0.AddItemCase = {
		...
		[DROP_TYPE_ITEM] = function(arg_192_0)
			if arg_192_0:getConfig("type") == Item.EXP_BOOK_TYPE then
				local var_192_0 = getProxy(BagProxy):getItemCountById(arg_192_0.id)
				local var_192_1 = math.min(arg_192_0:getConfig("max_num") - var_192_0, arg_192_0.count)

				if var_192_1 > 0 then
					getProxy(BagProxy):addItemById(arg_192_0.id, var_192_1)
				end
			else
		...
		[DROP_TYPE_VITEM] = function(arg_198_0)
			...
			switch(arg_198_0:getConfig("virtual_type"), {
				...
				function()
					...
					if var_200_1 > 0 then
						var_200_2 = var_200_0:getActivityById(var_200_1)
					else
						var_200_2 = var_200_0:getActivityByType(ActivityConst.ACTIVITY_TYPE_PUZZLA)
					end
				...
				function()
					...
					local var_201_1 = var_201_0:getActivitiesByType(ActivityConst.ACTIVITY_TYPE_VOTE)

					for iter_201_0, iter_201_1 in ipairs(var_201_1) do
						iter_201_1.data1 = iter_201_1.data1 + arg_198_0.count

						local var_201_2 = iter_201_1:getConfig("config_id")
						local var_201_3 = pg.activity_vote[var_201_2]

						if var_201_3 and var_201_3.ticket_id_period == arg_198_0.id then
				...
				[9] = function()
					...
					local var_205_1 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_MONOPOLY)

					if var_205_1 then
						var_205_1.data1_list[1] = var_205_1.data1_list[1] + arg_198_0.count
				...
				[15] = function()
					...
					if var_210_1:getConfig("type") == ActivityConst.ACTIVITY_TYPE_WORLDINPICTURE then
						local var_210_2 = pg.activity_event_grid[var_210_1.data1]

						if arg_198_0.id == var_210_2.ticket_item then
							var_210_1.data2 = var_210_1.data2 + arg_198_0.count
						elseif arg_198_0.id == var_210_2.explore_item then
				...
				[16] = function()
					...
					local var_211_1 = var_211_0:getActivitiesByType(ActivityConst.ACTIVITY_TYPE_SHAKE_BEADS)

					for iter_211_0, iter_211_1 in pairs(var_211_1) do
				...
				[20] = function()
					...
					local var_213_1 = pg.gameset.urpt_chapter_max.description
					local var_213_2 = var_213_1[1]
					local var_213_3 = var_213_1[2]
					local var_213_4 = var_213_0:GetLimitCntById(var_213_2)
					local var_213_5 = math.min(var_213_3 - var_213_4, arg_198_0.count)

					if var_213_5 > 0 then
						var_213_0:addItemById(var_213_2, var_213_5)
						var_213_0:AddLimitCnt(var_213_2, var_213_5)
					end
				end,
				[21] = function()
				...
				[24] = function()
					local var_218_0 = arg_198_0:getConfig("link_id")
					local var_218_1 = getProxy(ActivityProxy):getActivityById(var_218_0)

					if var_218_1 and not var_218_1:isEnd() and var_218_1:getConfig("type") == ActivityConst.ACTIVITY_TYPE_HOTSPRING then
						var_218_1.data2 = var_218_1.data2 + arg_198_0.count
				...
				[30] = function()
					local var_224_0 = arg_198_0:getConfig("link_id")
					...
					local var_224_2 = arg_198_0.count

					if var_224_1:IsLimitExpItem(arg_198_0.id) then
						var_224_2 = var_224_1:FilterExp(var_224_2)
						var_224_2 = getProxy(LoveLetterProxy):AddLoveLetterExp(var_224_1:GetTargetGroupId(), var_224_2)

						var_224_1:AddDailyProgress(var_224_2)
					else
						local var_224_3 = getProxy(LoveLetterProxy):AddLoveLetterExp(var_224_1:GetTargetGroupId(), var_224_2)
					end
				...
				[101] = function()
					local var_231_0 = arg_198_0:getConfig("link_id")
					local var_231_1 = getProxy(ActivityProxy):getActivityById(var_231_0)

					if var_231_1 and not var_231_1:isEnd() then
						var_231_1.data1 = var_231_1.data1 + arg_198_0.count

						getProxy(ActivityProxy):updateActivity(var_231_1)
					end
				end,
				[102] = function()
					local var_232_0 = arg_198_0:getConfig("link_id")
					local var_232_1 = pg.activity_template[var_232_0].type
				...
				[103] = function()
					local var_234_0 = arg_198_0:getConfig("link_id")
					local var_234_1 = getProxy(ActivityProxy):getActivityById(var_234_0)

					if not var_234_1 or var_234_1:isEnd() then
						return
					end

					local var_234_2 = var_234_1:getConfig("type")
					...
					switch(var_234_2, {
						...
						[ActivityConst.ACTIVITY_TYPE_MALL] = function()
							local var_236_0 = var_234_1:getConfig("config_data")[1]
							local var_236_1 = arg_198_0.id ~= var_236_0

							if var_236_1 then
								var_234_1:AddStaff(arg_198_0.id, arg_198_0.count)
							else
								var_234_1:AddGold(arg_198_0.count)
							end
						...
						[ActivityConst.ACTIVITY_TYPE_REVERSE_PACMAN] = function()
							var_234_1:AddVitemNumber(arg_198_0.id, arg_198_0.count)
							getProxy(ActivityProxy):updateActivity(var_234_1)
						end
					}, function()
						assert(var_234_1 .. "对应" .. var_234_2 .. "错误")
					end)
				end
			})
		end,
		...
		[DROP_TYPE_ICON_FRAME] = function(arg_242_0)
			...
			local var_242_2 = IconFrame.New({
				id = arg_242_0.id
			})
			local var_242_3 = var_242_1 + var_242_2:getConfig("time_second")

			var_242_2:updateData({
				isNew = true,
				end_time = var_242_3
			})
			var_242_0:addAttireFrame(var_242_2)
			pg.ToastMgr.GetInstance():ShowToast(pg.ToastMgr.TYPE_ATTIRE, var_242_2)
		end,
		[DROP_TYPE_CHAT_FRAME] = function(arg_243_0)
			local var_243_0 = getProxy(AttireProxy)
			local var_243_1 = pg.TimeMgr.GetInstance():GetServerTime()
			local var_243_2 = ChatFrame.New({
				id = arg_243_0.id
			})
			local var_243_3 = var_243_1 + var_243_2:getConfig("time_second")

			var_243_2:updateData({
				isNew = true,
				end_time = var_243_3
			})
			var_243_0:addAttireFrame(var_243_2)
			pg.ToastMgr.GetInstance():ShowToast(pg.ToastMgr.TYPE_ATTIRE, var_243_2)
		end,
		...
		[DROP_TYPE_SKIN_TIMELIMIT] = function(arg_247_0)
			local var_247_0 = arg_247_0.id
			local var_247_1 = arg_247_0.count
			local var_247_2 = getProxy(ShipSkinProxy)
			local var_247_3 = var_247_2:getSkinById(var_247_0)

			if var_247_3 and var_247_3:isExpireType() then
				local var_247_4 = var_247_1 + var_247_3.endTime
				local var_247_5 = ShipSkin.New({
					id = var_247_0,
					end_time = var_247_4
				})

				var_247_2:addSkin(var_247_5)
			elseif not var_247_3 then
				local var_247_6 = var_247_1 + pg.TimeMgr.GetInstance():GetServerTime()
				local var_247_7 = ShipSkin.New({
					id = var_247_0,
					end_time = var_247_6
				})

				var_247_2:addSkin(var_247_7)
			end
		end,
		[DROP_TYPE_BUFF] = function(arg_248_0)
			local var_248_0 = arg_248_0.id
			local var_248_1 = pg.benefit_buff_template[var_248_0]

			assert(var_248_1 and var_248_1.act_id > 0, "should exist act id")

			local var_248_2 = getProxy(ActivityProxy):getActivityById(var_248_1.act_id)

			if var_248_2 and not var_248_2:isEnd() then
				local var_248_3 = var_248_1.max_time
				local var_248_4 = pg.TimeMgr.GetInstance():GetServerTime() + var_248_3

				var_248_2:AddBuff(ActivityBuff.New(var_248_2.id, var_248_0, var_248_4))
				getProxy(ActivityProxy):updateActivity(var_248_2)
			end
		end,
		...
		[DROP_TYPE_LIVINGAREA_COVER] = function(arg_255_0)
			local var_255_0 = getProxy(LivingAreaCoverProxy)
			local var_255_1 = LivingAreaCover.New({
				unlock = true,
				isNew = true,
				id = arg_255_0.id
			})

			var_255_0:UpdateCover(var_255_1)
			pg.ToastMgr.GetInstance():ShowToast(pg.ToastMgr.TYPE_COVER, var_255_1)
		...
		[DROP_TYPE_COMBAT_UI_STYLE] = function(arg_256_0)
			local var_256_0 = getProxy(AttireProxy)
			local var_256_1 = pg.TimeMgr.GetInstance():GetServerTime()
			local var_256_2 = CombatUIStyle.New({
				id = arg_256_0.id
			})

			var_256_2:setUnlock()
			var_256_2:setNew()
			var_256_0:addAttireFrame(var_256_2)
			pg.ToastMgr.GetInstance():ShowToast(pg.ToastMgr.TYPE_COMBAT_UI, var_256_2)
		end,
	...
	function var_0_0.AddItemDefault(arg_258_0)
		if arg_258_0.type > DROP_TYPE_USE_ACTIVITY_DROP then
			local var_258_0 = getProxy(ActivityProxy):getActivityById(pg.activity_drop_type[arg_258_0.type].activity_id)

			if arg_258_0.type == DROP_TYPE_RYZA_DROP then
				if var_258_0 and not var_258_0:isEnd() then
					var_258_0:AddItem(AtelierMaterial.New({
						configId = arg_258_0.id,
						count = arg_258_0.count
					}))
					getProxy(ActivityProxy):updateActivity(var_258_0)
				end
			elseif var_258_0 and not var_258_0:isEnd() then
				var_258_0:addVitemNumber(arg_258_0.id, arg_258_0.count)
				getProxy(ActivityProxy):updateActivity(var_258_0)
			end
		elseif arg_258_0.type >= DROP_TYPE_ISLAND_ITEM and arg_258_0.type <= DROP_TYPE_ISLAND_CARD_DIY then
			...
			table.insert(var_258_1, {
				type = arg_258_0.type,
				id = arg_258_0.id,
				number = arg_258_0.count
			})
			IslandDropHelper.AddItems({
				drop_list = var_258_1
			})
		else
			print("can not handle this type>>" .. arg_258_0.type)
		end
	end
	...
	var_0_0.MsgboxIntroCase = {
		...
		[DROP_TYPE_SHIP] = function(arg_262_0, arg_262_1, arg_262_2)
			local var_262_0 = arg_262_0:getConfig("skin_id")
			local var_262_1, var_262_2, var_262_3 = ShipWordHelper.GetWordAndCV(var_262_0, ShipWordHelper.WORD_TYPE_DROP, nil, PLATFORM_CODE ~= PLATFORM_US)

			setText(arg_262_2, var_262_3 or i18n("ship_drop_desc_default"))
		end,
		[DROP_TYPE_OPERATION] = function(arg_263_0, arg_263_1, arg_263_2)
			local var_263_0 = arg_263_0:getConfig("skin_id")
			local var_263_1, var_263_2, var_263_3 = ShipWordHelper.GetWordAndCV(var_263_0, ShipWordHelper.WORD_TYPE_DROP, nil, PLATFORM_CODE ~= PLATFORM_US)

			setText(arg_263_2, var_263_3 or i18n("ship_drop_desc_default"))
		end,
		[DROP_TYPE_EQUIP] = function(arg_264_0, arg_264_1, arg_264_2)
			setText(arg_264_2, arg_264_1.name or arg_264_0:getConfig("name") or "")
		end,
		...
		[DROP_TYPE_EQUIPMENT_SKIN] = function(arg_268_0, arg_268_1, arg_268_2)
			local var_268_0 = arg_268_0:getConfig("desc")
			local var_268_1 = _.map(arg_268_0:getConfig("equip_type"), function(arg_269_0)
				return EquipType.Type2Name2(arg_269_0)
			end)

			setText(arg_268_2, var_268_0 .. "\n\n" .. i18n("word_fit") .. ": " .. table.concat(var_268_1, ","))
		end,
		...
		[DROP_TYPE_ICON_FRAME] = function(arg_273_0, arg_273_1, arg_273_2)
			setText(arg_273_2, arg_273_0.desc and arg_273_0.desc or arg_273_0:getConfig("desc"))
		end,
		...
		[DROP_TYPE_LOVE_LETTER] = function(arg_276_0, arg_276_1, arg_276_2)
			local var_276_0 = string.gsub(arg_276_0:getConfig("display"), "$1", ShipGroup.getDefaultShipNameByGroupID(arg_276_0.count))

			setText(arg_276_2, SwitchSpecialChar(var_276_0, true))
		end,
	...
	function var_0_0.MsgboxIntroDefault(arg_288_0, arg_288_1, arg_288_2)
		if arg_288_0.type > DROP_TYPE_USE_ACTIVITY_DROP then
			setText(arg_288_2, arg_288_0:getConfig("display"))
		else
			setText(arg_288_2, arg_288_0.desc or "")
		end
	end
	...
	var_0_0.UpdateDropCase = {
		...
		[DROP_TYPE_EQUIPMENT_SKIN] = function(arg_297_0, arg_297_1, arg_297_2)
			...
			updateEquipmentSkin(arg_297_1, var_297_0, arg_297_2)
		end,
	...
	function var_0_0.UpdateDropDefault(arg_316_0, arg_316_1, arg_316_2)
	...
	function var_0_0.UpdateCustomDropDefault(arg_331_0, arg_331_1, arg_331_2)
		if arg_331_2.style == "dorm" then
			updateDorm3dIcon(arg_331_1, arg_331_0, arg_331_2)
		elseif arg_331_2.style == "island" then
			updateIslandDefaultIconTpl(arg_331_1, arg_331_0, arg_331_2)
		else
			warning(string.format("without dropType %d in updateCustomDrop", arg_331_0.type))
		end
	end
end
