...
function var_0_0.InitSwitch()
	...
	var_0_0.AddItemCase = {
		...
		[DROP_TYPE_ICON_FRAME] = function(arg_241_0)
			...
			local var_241_2 = IconFrame.New({
				id = arg_241_0.id
			})
			local var_241_3 = var_241_1 + var_241_2:getConfig("time_second")

			var_241_2:updateData({
				isNew = true,
				end_time = var_241_3
			})
			var_241_0:addAttireFrame(var_241_2)
			pg.ToastMgr.GetInstance():ShowToast(pg.ToastMgr.TYPE_ATTIRE, var_241_2)
		end,
		...
		[DROP_TYPE_SKIN_TIMELIMIT] = function(arg_246_0)
			local var_246_0 = arg_246_0.id
			local var_246_1 = arg_246_0.count
			local var_246_2 = getProxy(ShipSkinProxy)
			local var_246_3 = var_246_2:getSkinById(var_246_0)

			if var_246_3 and var_246_3:isExpireType() then
				local var_246_4 = var_246_1 + var_246_3.endTime
				local var_246_5 = ShipSkin.New({
					id = var_246_0,
					end_time = var_246_4
				})

				var_246_2:addSkin(var_246_5)
			elseif not var_246_3 then
				local var_246_6 = var_246_1 + pg.TimeMgr.GetInstance():GetServerTime()
				local var_246_7 = ShipSkin.New({
					id = var_246_0,
					end_time = var_246_6
				})

				var_246_2:addSkin(var_246_7)
			end
		end,
		[DROP_TYPE_BUFF] = function(arg_247_0)
			local var_247_0 = arg_247_0.id
			local var_247_1 = pg.benefit_buff_template[var_247_0]

			assert(var_247_1 and var_247_1.act_id > 0, "should exist act id")

			local var_247_2 = getProxy(ActivityProxy):getActivityById(var_247_1.act_id)

			if var_247_2 and not var_247_2:isEnd() then
				local var_247_3 = var_247_1.max_time
				local var_247_4 = pg.TimeMgr.GetInstance():GetServerTime() + var_247_3

				var_247_2:AddBuff(ActivityBuff.New(var_247_2.id, var_247_0, var_247_4))
				getProxy(ActivityProxy):updateActivity(var_247_2)
			end
		end,
		...
		[DROP_TYPE_LIVINGAREA_COVER] = function(arg_254_0)
			local var_254_0 = getProxy(LivingAreaCoverProxy)
			local var_254_1 = LivingAreaCover.New({
				unlock = true,
				isNew = true,
				id = arg_254_0.id
			})

			var_254_0:UpdateCover(var_254_1)
			pg.ToastMgr.GetInstance():ShowToast(pg.ToastMgr.TYPE_COVER, var_254_1)
		...
		[DROP_TYPE_COMBAT_UI_STYLE] = function(arg_255_0)
			local var_255_0 = getProxy(AttireProxy)
			local var_255_1 = pg.TimeMgr.GetInstance():GetServerTime()
			local var_255_2 = CombatUIStyle.New({
				id = arg_255_0.id
			})

			var_255_2:setUnlock()
			var_255_2:setNew()
			var_255_0:addAttireFrame(var_255_2)
			pg.ToastMgr.GetInstance():ShowToast(pg.ToastMgr.TYPE_COMBAT_UI, var_255_2)
		end,
	...
	function var_0_0.AddItemDefault(arg_257_0)
		if arg_257_0.type > DROP_TYPE_USE_ACTIVITY_DROP then
			local var_257_0 = getProxy(ActivityProxy):getActivityById(pg.activity_drop_type[arg_257_0.type].activity_id)

			if arg_257_0.type == DROP_TYPE_RYZA_DROP then
			...
			elseif var_257_0 and not var_257_0:isEnd() then
				var_257_0:addVitemNumber(arg_257_0.id, arg_257_0.count)
				getProxy(ActivityProxy):updateActivity(var_257_0)
			end
		elseif arg_257_0.type >= DROP_TYPE_ISLAND_ITEM and arg_257_0.type <= DROP_TYPE_ISLAND_CARD_DIY then
			...
			table.insert(var_257_1, {
				type = arg_257_0.type,
				id = arg_257_0.id,
				number = arg_257_0.count
			})
			IslandDropHelper.AddItems({
				drop_list = var_257_1
			})
		else
			print("can not handle this type>>" .. arg_257_0.type)
		end
	end
	...
	var_0_0.MsgboxIntroCase = {
		...
		[DROP_TYPE_SHIP] = function(arg_261_0, arg_261_1, arg_261_2)
			local var_261_0 = arg_261_0:getConfig("skin_id")
			local var_261_1, var_261_2, var_261_3 = ShipWordHelper.GetWordAndCV(var_261_0, ShipWordHelper.WORD_TYPE_DROP, nil, PLATFORM_CODE ~= PLATFORM_US)

			setText(arg_261_2, var_261_3 or i18n("ship_drop_desc_default"))
		end,
		...
		[DROP_TYPE_EQUIP] = function(arg_263_0, arg_263_1, arg_263_2)
			setText(arg_263_2, arg_263_1.name or arg_263_0:getConfig("name") or "")
		end,
		...
		[DROP_TYPE_EQUIPMENT_SKIN] = function(arg_267_0, arg_267_1, arg_267_2)
			local var_267_0 = arg_267_0:getConfig("desc")
			local var_267_1 = _.map(arg_267_0:getConfig("equip_type"), function(arg_268_0)
				return EquipType.Type2Name2(arg_268_0)
			end)

			setText(arg_267_2, var_267_0 .. "\n\n" .. i18n("word_fit") .. ": " .. table.concat(var_267_1, ","))
		end,
		...
		[DROP_TYPE_ICON_FRAME] = function(arg_272_0, arg_272_1, arg_272_2)
			setText(arg_272_2, arg_272_0.desc and arg_272_0.desc or arg_272_0:getConfig("desc"))
		end,
		...
		[DROP_TYPE_LOVE_LETTER] = function(arg_275_0, arg_275_1, arg_275_2)
			local var_275_0 = string.gsub(arg_275_0:getConfig("display"), "$1", ShipGroup.getDefaultShipNameByGroupID(arg_275_0.count))

			setText(arg_275_2, SwitchSpecialChar(var_275_0, true))
		end,
	...
	function var_0_0.MsgboxIntroDefault(arg_287_0, arg_287_1, arg_287_2)
		if arg_287_0.type > DROP_TYPE_USE_ACTIVITY_DROP then
			setText(arg_287_2, arg_287_0:getConfig("display"))
		else
			setText(arg_287_2, arg_287_0.desc or "")
		end
	end
	...
	var_0_0.UpdateDropCase = {
		...
		[DROP_TYPE_EQUIPMENT_SKIN] = function(arg_296_0, arg_296_1, arg_296_2)
			local var_296_0 = setmetatable({
				count = arg_296_0.count
			}, {
				__index = arg_296_0:getConfigTable()
			})

			updateEquipmentSkin(arg_296_1, var_296_0, arg_296_2)
		end,
	...
	function var_0_0.UpdateDropDefault(arg_315_0, arg_315_1, arg_315_2)
	...
	function var_0_0.UpdateCustomDropDefault(arg_330_0, arg_330_1, arg_330_2)
		if arg_330_2.style == "dorm" then
			updateDorm3dIcon(arg_330_1, arg_330_0, arg_330_2)
		elseif arg_330_2.style == "island" then
			updateIslandDefaultIconTpl(arg_330_1, arg_330_0, arg_330_2)
		else
			warning(string.format("without dropType %d in updateCustomDrop", arg_330_0.type))
		end
	end
end
