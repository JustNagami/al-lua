...
function var_0_0.UpdateData(arg_2_0, arg_2_1)
	...
	arg_2_0.unlockCollectionCnt = arg_2_1.item_list and #arg_2_1.item_list or 0
...
function var_0_0.AddGold(arg_3_0, arg_3_1)
	...
	local var_3_0 = pg.gameset.auction_currency_ceiling.key_value

	if var_3_0 < arg_3_0.gold then
		arg_3_0.gold = var_3_0
	end
end
...
function var_0_0.GetMaxLineCnt(arg_14_0)
	return arg_14_0.storeLine > 10 and arg_14_0.storeLine or 10
end
