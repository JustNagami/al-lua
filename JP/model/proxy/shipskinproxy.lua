...
function var_0_0.register(arg_3_0)
	...
	arg_3_0:on(12201, function(arg_4_0)
		...
		for iter_4_4, iter_4_5 in ipairs(arg_4_0.forbidden_list) do
			...
			elseif var_4_1.genre ~= ShopArgs.SkinShop then
...
function var_0_0.GetAllSkins(arg_34_0)
	...
	local function var_34_2(arg_36_0)
		...
		local var_36_2 = var_36_1.collaboration_skin_time
		local var_36_3 = var_36_2 == "" or var_36_2 == var_36_1.time
		local var_36_4, var_36_5 = pg.TimeMgr.GetInstance():inTime(var_36_1.time)
