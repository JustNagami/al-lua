...
_G.pg.base.gametip.help_shipinfo_attr = {
	tip = {
		...
		{
			info = "    対潜：対潜兵装のダメージを上げる。対潜探知範囲に影響します。",
			icon = {
				atlas = "attricon",
				path = "antisub",
				posX = 0,
		...
		{
			info = "    潜航力：最大潜航時間。潜航状態で消費し続け、0になると浮上状態になる",
			icon = {
				atlas = "attricon",
				path = "oxy_max",
				posX = 0,
...
_G.pg.base.gametip.ship_remould_warning_506114 = {
	tip = "改造（近代化改修）を行うと、<color=#92fc63>【1番兵装枠に戦闘機を装備可能】【1番兵装枠機数+2】</color>、<color=#92fc63>【2番兵装枠に任意の艦載機を装備可能】【2番兵装枠機数/砲座+1】</color>\n続けますか？",
}
...
_G.pg.base.gametip.course_class_help = {
	tip = {
		{
			info = "大講堂について\n\n大講堂では、艦隊が保有している「熟練度」を「経験値パック」に変換（経験値生成）することができます。\n\n・熟練度について\n限界突破を3回行ったレベル100以上の艦は出撃時、得られる経験値の一定割合分の熟練度を獲得できます。\n熟練度は艦隊全体で共有し、上限分しかストックできません。\n大講堂を強化すると、熟練度保有上限・熟練度の獲得効率を上昇させることができます。\nなお、日曜日は出撃時に得られる「熟練度」が2倍になります。\n\n・経験値生成について\n大講堂は、熟練度が0でない限り、また経験値生成上限に達していない限り時間に応じて熟練度を艦船に経験値を付与できる「経験値パック」を生成していきます。\n「学園」画面やメイン画面の左のタブで、大講堂で生成された「経験値パック」を受け取ることが出来ます。経験値パックを受け取ると、大講堂の生成経験値の備蓄量も経験値パックの経験値提供分減らされます。\n生成された「経験値パック」は「ドック」の詳細画面の「EXP育成」で使用でき、その艦船に経験値を付与することが出来ます。\n大講堂を強化すると、経験値の生成上限を上昇させることができます。",
		},
	},
}
...
_G.pg.base.gametip.help_shipblueprintui_luck = {
	tip = {
		{
			info = "「竜骨編纂」とは\n\n1. 特別計画艦の強化レベルが<color=#92fc63>Lv.30</color>になった場合、当該艦の「竜骨編纂」が解禁されます\n2. 「竜骨編纂」では、<color=#92fc63>最大レベル5</color>まで強化することができ、艦に対応する<color=#92fc63>強化ユニット</color>を消費し、進捗を100％まで進行させると、そのレベルの竜骨編纂が完了します\n3. レベル<color=#92fc63>I～IV</color>では艦の<color=#92fc63>「運」</color>ステータスが強化されます\n4. レベル<color=#92fc63>V</color>では<color=#92fc63>スキル</color>を一部<color=#92fc63>強化</color>することができます",
		},
	},
}
...
_G.pg.base.gametip.help_monopoly = {
	tip = {
		...
		{
			info = "1.右下のサイコロをタップすると、アイテム「サイコロ」を1個消\n費し、すごろく盤で一回移動することができます；",
		},
		{
			info = "2.サイコロを8個消費する度に、年玉（特別ボーナス）を入手する\nことができます；",
		},
		{
			info = "3.7個目までの年玉は「年玉・大」となっており、8個目以降の年\n玉は普通のボーナスになります；",
		},
		{
			info = "4.サイコロはイベント期間中、毎日4つ自動で加算されます。また\n、イベント「四天王の大冒険・鞍山編」「四天王の大冒険・撫順\n編」「戦士の特別訓練」でも追加のサイコロを入手することがで\nきます；",
		},
		{
			info = "5.すごろくを10週し、11回出発地点に到達すると、駆逐艦「キン\nバリー」の着せ替え「安陽の異文化勉強」を入手できます；",
		},
		{
			info = "6.すごろくの各マスで様々な効果があります。また、出発時点を\n通過すると資金を少しを入手することができます；",
		},
		{
			info = "    ：資金を少し入手できます；",
			icon = {
...
_G.pg.base.gametip.help_summer_shrine = {
	tip = {
		{
			info = "■概要\n「幸運祈願」では、お賽銭（5資金）を消費すること\nで、一定時間、様々な効果を得られます。\n幸運祈願の可能回数はスタンプを1回手に入れるたび\nに1回増えます。\n■遊び方\n・賽銭箱の上の縄をスワイプして引っ張ると、幸運\n祈願の効果を選択することが出来ます。\n・幸運祈願効果\n　学業祈願：戦術教室でスキルを新たに強化する場合\n、所要時間が少し短縮\n　開運招福：メイン海域及び作戦履歴海域戦闘時、味方\nが与えるダメージが微増\n　良縁祈願：秘書艦の親密度上昇スピードがアップ\n・幸運祈願は同時に一種類しか適用できず、同じ祈願\nを複数回行っても効果は上乗せされません。\n・幸運祈願の効果は24時間持続します。また、幸運祈\n願の効果適用中にもう一回祈願すると、前の祈願の効\n果・持続時間が上書きされます。\n■注意\n「幸運祈願可能回数」が0の場合でもお賽銭を入れるこ\nとが出来ますが、幸運祈願を行うことが出来ません。",
		},
	},
}
...
_G.pg.base.gametip.help_music_game = {
	tip = {
		{
			info = "■ミニゲーム（饅頭ステージ）とは",
		},
		{
			info = "「ミニゲーム（饅頭ステージ）」とは、リズムゲームを遊び「共鳴ノード」を貯めるミニゲームになります。\n「共鳴ノード」は回数を所持している状態で、リズムゲームをB評価以上をクリアすると、「共鳴ノード」を1 個入手できます。\n「共鳴ノード」は7つ貯めるとイベントページから限定兵装「パッションμチケット」を入手できます。\n「共鳴ノード」を貯められる回数はイベント開始後1日ごとに1回増加します。",
		},
		{
			info = "■遊び方",
		},
		{
			info = "・画面スライドで曲を選び、さらに難易度を選んで画面右下の「スタート」をタップすると、リズムゲームを開始することができます。\n・リズムゲームでは、アイコンが画面の真ん中に到着するタイミングに合わせてタップするとスコアを獲得できます。\n（HARD難易度の場合、青いアイコンは画面左側をタップ、赤いアイコンは画面右側をタップ、黄色いアイコンは画面左右両方をタップ、アイコンに白いラインがついた場合は長押しする必要があります）\n・曲選択画面右上の「X1」はアイコンの流れる速さを表しており、タップすると速さの調整が可能です\n・アイコンタップのタイミングに応じて、得られる評価およびスコアが異なります\n・PERFECT/GOODの評価を得た時のみCOMBOが継続します",
		},
	},
}
...
_G.pg.base.gametip.MeixiV4_help = {
	tip = {
		...
		{
			info = "出現する任務をクリアし、報酬を入手しましょう！",
		},
		{
			info = "2.表示された2つの任務をクリアすると、次の任務に進むことができます。",
		},
		{
			info = "3.報酬一覧：\n解放任務1：T2強化パーツ*5，資金*100\n解放任務2：ストーリー解放①\n解放任務3：T2改造設計図*2\n解放任務4：資金*100\n解放任務5：T2装備箱*3，資金*100\n解放任務6：ストーリー解放②\n解放任務7：海軍カレー*3\n解放任務8：資金*100\n解放任務9：T3装備箱*1，資金*100\n解放任務10：ストーリー解放③\n解放任務11：T3教科書*2\n解放任務12：資金*100\n解放任務13：限定兵装，資金*100\n解放任務14：ストーリー解放④",
		},
	},
}
...
_G.pg.base.gametip.idolmaster_collection = {
	tip = {
		...
		{
			info = "2.アイドルプロフィールは下記の方法で開放できます：\n①イベントステージをクリア\n②イベント任務をクリア\n③「コラボpt」を集める\n④ミニゲーム「饅頭渡し会」をプレイする",
		},
		{
...
_G.pg.base.gametip.player_expResource_mail_overflow = {
	tip = "$1所持数が上限になっています。続けると一部のアイテムが入手できなくなります。続けますか？",
}
...
_G.pg.base.gametip.eatgame_tips = {
	tip = {
		{
			info = "■概要\n「母港大食い競争」とは、9/21（水）まで7日分毎日開放されるゲームをクリアし「お肉」を集め、夕立の改造素材アイテムを入手出来るイベントになります。\n「ミート・パフューム」か「夕立改」を所持している場合、入手するアイテムは「大食い競争チャンピオンの証」になります\n\n■遊び方\n・ゲームが開始すると、画面上でゲージと動くカーソルが出現します。\n・画面をタップすると、カーソルが止まります。\n・カーソルが止まった部分の色によって、スコアが増減します（ゲージの緑色の部分で止まればスコアが一番高く、赤色の部分で止まるとスコアが減少します）\n・ゲーム時間が0になるか、ボタンをタップしゲームを中断すると、クリア扱いとなります。",
		},
	},
}
...
_G.pg.base.gametip.help_monopoly_world = {
	tip = {
		...
		{
			info = "1.スペシャルログインとは、毎日5回加算される移動回数を消費し、踏んだマスによって報酬を獲得できるキャンペーンになります；",
		},
		{
			info = "2.踏んだマスによって得られる報酬のほかに、1周する毎に200資金を入手できます。さらに、限定家具やイベントPt「弧光結晶」を入手できます；",
		},
		{
			info = "    ：物資入手；",
			icon = {
		...
		{
			info = "SP報酬：\n1周目:家具「レプリカ：ダイナウイング」、「弧光結晶」×150；\n2周目:家具「レプリカ：ダイナダイバー」、「弧光結晶」×150；\n3周目:家具「レプリカ：ダイナストライカー」、「弧光結晶」×200；\n4周目:「レプリカ：ダイナソルジャー」、「弧光結晶」×250；\n5週目:「レプリカ：ダイナレックス」、「弧光結晶」×300；",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_help_2112 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n2021.12.1（水）0:00～2022.1.31（月）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「飛鷹(META)」、SP報酬からは空母「コロラド」の限定着せ替え「旅の旋律」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n　①週次開放任務\n　キャンペーン開始時とキャンペーン期間中7日間経過する毎に開放される任務。全8グループ\n　②全期間任務\n　最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n　さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n　①通常報酬\n　「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n　②SP報酬\n　「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n　シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくりしながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n　ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n　「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n　ダイヤを消費しますので、オススメしません……\n　「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.Pray_activity_tips1 = {
	tip = {
		{
			info = "■概要\n冬の祝いと願いは、「願い事」をすることで艦隊に一定時間、強化効果を与えられるキャンペーンになります。\n\n「カード」を贈ると、「冬の願い」を1個入手できます。「冬の願い」を7つ集めると、イベントページにて艦船と交換できる「願いのカード(2026)」を入手できます。\n\n「願い事」を行うと、艦隊強化効果を一定時間得られます。\n\n■「カード」について\n・キャンペーン期間中、毎日「残りカード」回数が1回増加します（最大7回）。\n・「残りカード」を所持している状態では、艦船にカードを贈ることができます。\n・カードを贈ると下記の効果が発揮されます：\n　①「冬の願い」を1個入手\n　②願い事可能回数が2回増加\n　③カードを貰った艦船による艦隊強化効果を1個入手します\n　※③の艦隊強化効果は艦船によって異なります\n　※③による艦隊強化効果は同時に1種類しか適用できず、新たに艦船にカードを贈った場合、前の効果が上書きされます。\n・「冬の願い」を7つ集めると、イベントバナーで「願いのカード(2026)」を入手できます\n・「願いのカード(2026)」を倉庫で使用すると、SSR艦船1隻と記念アイテムを入手できます\n\n■「願い事」について\n・カードを贈ると、願い事可能回数が2回増加\n・願い事可能回数を所持している状態で、画面右の願いをするボタンをタップすることで、「願い事」を行うことができます\n・「願い事」を行うと、3種類の強化効果から1個を選び、一定時間に艦隊に付与できます\n　※「願い事」による艦隊強化効果は同時に1種類しか適用できず、新たに「願い事」を行った場合、前の効果が上書きされます。",
		},
	},
}
...
_G.pg.base.gametip.help_xinnian2022_z28 = {
	tip = {
		{
			info = "■概要\n花火工房（復刻イベント）とは、花火工房で花火を作ることで「花火工房チケット」を集め、駆逐艦「Z28」を入手できるキャンペーンです。\n\n■遊び方\n・裏山やイベントバナーの花火工房で、花火を作ることができます\n・ゲーム回数を所持している状態で花火を作ると、ゲーム回数が１回消費され、花火報酬と「花火工房チケット」を入手できます\n・「花火工房チケット」を7つ集めると、イベントバナーで駆逐艦「Z28」と交換できます\n・ゲーム回数はキャンペーン期間中毎日1回加算されます（最大7回）",
		},
	},
}
...
_G.pg.base.gametip.springfes_tips1 = {
	tip = {
		{
			info = "「母港春節」キャンペーン画面では下記の内容に遷移できます。\n\n撫順の大冒険Ⅲ：ミニゲームをプレイし、駆逐艦「撫順」を手に入れよう！\n画中世界：任務をクリアで探索回数を稼ぎ、画中世界を探索して新キャラ「海天」「海圻」を手に入れよう！\nおえかき：任務クリアで絵の具を手に入れ、おえかきを完成させて駆逐艦「鞍山」を手に入れよう！\n改造任務：任務クリアで改造素材を手に入れ、「鞍山」「長春」のミサイル駆逐艦化改造を行おう！\n饅頭の年玉：手に入れた「お年玉」はこちらで開封可能\n着せ替え：着せ替えショップへ移動可能\n限定建造：小型艦建造画面へ移動可能",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_help_2202 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2022.2.1（火）0:00～2022.3.31（木）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「隼鷹(META)」、SP報酬からは空母「コロンビア」の限定着せ替え「草原を駆ける」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n　①週次開放任務\n　キャンペーン開始時とキャンペーン期間中7日間経過する毎に開放される任務。全8グループ\n　②全期間任務\n　最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n　さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n　①通常報酬\n　「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n　②SP報酬\n　「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n　シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくりしながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n　ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n　「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n　ダイヤを消費しますので、オススメしません……\n　「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_help_2208 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2022.8.1（月）0:00～2022.9.30（金）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「トレント(META)」、SP報酬からは駆逐艦「北風」の限定着せ替え「鳩と奇術の夜」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n　①週次開放任務\n　キャンペーン開始時とキャンペーン期間中7日間経過する毎に開放される任務。全8グループ\n　②全期間任務\n　最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n　さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n　①通常報酬\n　「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n　②SP報酬\n　「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n　シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくりしながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n　ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n　「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n　ダイヤを消費しますので、オススメしません……\n　「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_help_2210 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2022.10.1（土）0:00～2022.11.30（水）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「ハンター(META)」、SP報酬からは軽巡洋艦「パーミャチ·メルクーリヤ」の限定着せ替え「待ち受けスタイル」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n　①週次開放任務\n　キャンペーン開始時とキャンペーン期間中7日間経過する毎に開放される任務。全8グループ\n　②全期間任務\n　最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n　さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n　①通常報酬\n　「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n　②SP報酬\n　「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n　シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくりしながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n　ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n　「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n　ダイヤを消費しますので、オススメしません厖\n　「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_tip_2308 = {
	tip = "<size=23> 2023.8.1-2023.9.30キャンペーン期間中、シーズン任務報酬で<color=#854747>「旗風(META)」</color>などを入手可能！</size>",
}
...
_G.pg.base.gametip.battlepass_main_help_2310 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2023.10.1（日）0:00～2023.11.30（木）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「プリンストン(META)」、SP報酬からは潜水艦「U-410」の限定着せ替え「リージャリイ・プラクティス」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n　①週次開放任務\n　キャンペーン開始時とキャンペーン期間中7日間経過する毎に開放される任務。全8グループ\n　②全期間任務\n　最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n　さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n　①通常報酬\n　「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n　②SP報酬\n　「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n　シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくりしながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n　ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n　「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n　ダイヤを消費しますので、オススメしません厖\n　「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_help_2312 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2023.12.1（金）0:00～2024.1.31（水）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「エレバス(META)」、SP報酬からは駆逐艦「初春」の限定着せ替え「鈴の初春」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n　①週次開放任務\n　キャンペーン開始時とキャンペーン期間中7日間経過する毎に開放される任務。全8グループ\n　②全期間任務\n　最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n　さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n　①通常報酬\n　「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n　②SP報酬\n　「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n　シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくりしながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n　ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n　「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n　ダイヤを消費しますので、オススメしません厖\n　「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_tip_2404 = {
	tip = "<size=23> 2024.4.1-2024.5.31キャンペーン期間中、シーズン任務報酬で<color=#854747>「ヴァンパイア(META)」</color>などを入手可能！</size>",
}
...
_G.pg.base.gametip.battlepass_main_tip_2408 = {
	tip = "<size=23> 2024.8.1-2024.9.30キャンペーン期間中、シーズン任務報酬で<color=#854747>「霞(META)」</color>などを入手可能！</size>",
}
...
_G.pg.base.gametip.battlepass_main_tip_2510 = {
	tip = "2025/10/1-2025/11/30キャンペーン期間中、シーズン任務累計<icon name=pt w=0.5 h=0.5/>入手報酬で<color=#854747>「デューイ(META)」</color>などを入手可能",
}
_G.pg.base.gametip.battlepass_main_help_2510 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2025.10.1（水）0:00～2025.11.30（木）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「デューイ(META)」、SP報酬からは駆逐艦「江風」の限定着せ替え「ほろ酔いに熱冷まし」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n ①週次開放任務\n キャンペーン開始時とキャンペーン期間中毎週月曜日0時に開放される任務。全8グループ\n ②全期間任務\n 最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n ①通常報酬\n 「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n ②SP報酬\n 「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくり返しながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n 「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n ダイヤを消費しますので、オススメしません。\n 「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.newserver_activity_tip = {
	tip = {
		...
		{
			info = "<color=#92fc63>·開催期間</color>\nキャンペーン期間中に新規着任した指揮官が最初にゲームにログインした日から21日目の23:59まで（残り時間はイベント一覧のキャンペーンページでも確認できます）\n",
		},
		{
			info = "<color=#92fc63>·新人任務</color>\n新規着任した指揮官は「新指揮官任務」をこなすことで、「新人特典Pt」を入手できます。新人任務は毎日0時に更新される「デイリー」任務と、キャンペーン中に1回しか完了できない「一回限り」の任務が存在します；\n一部の新指揮官任務をクリアすると艦船「アーク・ロイヤル」、「U-47」、「シリアス」を入手出来ます\n",
		},
		{
			info = "<color=#92fc63>·新指揮官ショップ</color>\n「新人特典Pt」はショップの「新指揮官ショップ」で艦船「長門」、「着任支援建造チケット」、「キューブ」などの報酬を入手できます；\n新指揮官ショップのラインナップは3段階で順次開放されます。段階1：初回ログインで開放されます；段階2：初回ログインから7日後に開放されます；段階3：初回ログインから14日後に開放されます；\n新指揮官ショップの交換はキャンペーン終了7日後まで行えます\n",
		},
		{
			info = "<color=#92fc63>·着任支援建造</color>\nキャンペーン期間中、「着任支援建造チケット」を消費し、「着任支援建造」を行うことができます。「着任支援建造」を40回行うと、建造ページにて艦船「エンタープライズ」を入手できます（入手すると、着任支援建造は終了します）",
		},
	},
}
...
_G.pg.base.gametip.world_boss_item_info = {
	tip = "META座標情報解析装置|セイレーン作戦で集めた「META座標」情報を記録する装置。解析を行うと「META戦」を開放できます。\n「META戦」が溜まった状態では新たに解析を行うことはできません。\n「META戦」本日開放数：$1/$2\n座標情報所持上限：$3/$4",
}
...
_G.pg.base.gametip.littleEugen_npc = {
	tip = {
		...
		{
			info = "■遊び方\n1.イベント期間中、イベントページで表示される限定任務をクリアすると、「ケーキPt」を入手できます。「ケーキPt」は自動で友好度に変換されます",
		},
		{
			info = "2.【プリンツ・オイゲンちゃん】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。",
		},
		{
		...
		{
			info = "6.仮加入状態の【プリンツ・オイゲンちゃん】は大艦隊作戦には参加できません。",
		},
	},
}
...
_G.pg.base.gametip.littleChaijun_npc = {
	tip = {
		{
			info = "■概要\n「ころんとあげる　プチクッキー」とは、イベント開始時に仮加入した【リトル・チェシャー】の「友好度」を限定任務で入手できる「クッキーPt」から変換し貯めることで、【リトル・チェシャー】を正式加入させられるイベントになります。",
		},
		{
			info = "■遊び方\n1.イベント期間中、イベントページで表示される限定任務をクリアすると、「クッキーPt」を入手できます。「クッキーPt」は自動で友好度に変換されます",
		},
		{
			info = "2.【リトル・チェシャー】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることはできず、また退役や強化・限界突破素材への選択をすることもできません。",
		},
		{
			info = "3.イベント終了までにイベントページの「友好度報酬」を最後まで受け取ると、【リトル・チェシャー】を「正式加入」させることができます（友好度が10000必要）。イベント終了時、「正式加入」していない【リトル・チェシャー】は母港からいなくなります。",
		},
		{
			info = "4.友好度報酬は4/17（水）まで毎日1段階ずつ解放されます。",
		},
		{
			info = "5.仮加入状態の【リトル・チェシャー】はセイレーン作戦（META戦含む）に参加できず、またセイレーン作戦では友好度を獲得できません。",
		},
		{
			info = "6.仮加入状態の【リトル・チェシャー】は大艦隊作戦には参加できません。",
		},
	},
}
_G.pg.base.gametip.five_qingdian = {
	tip = {
		{
			info = "遊び方：\nキャンペーン期間中、毎日ゲーム回数が<color=#92fc63>1</color>回加算されます（最大<color=#92fc63>7</color>回まで）\n1.ゲーム回数を所持している状態でミニゲームをプレイすると、ゲーム回数が消費され、招待状入手進捗が進捗し、招待状入手進捗が最大になると<color=#92fc63>「特別招待状」</color>を入手できます\n2.ゲーム回数は「裏山会場」画面の右側で確認できます。招待状の入手進捗は<color=#92fc63>「招待状」</color>ボタンをタップすると確認できます\n3.ゲーム回数を所持していなくても、ミニゲームをプレイできます",
		},
	},
}
...
_G.pg.base.gametip.summerland_tip = {
	tip = {
		{
			info = "■概要裏山会場とは、期間限定で開催するキャンペーンページになります。開催期間は<color=#92fc63>2022.8.18-2022.9.1</color>になります\n\n■各種遷移先\nミニゲーム：ミニゲーム「饅頭アイス」をプレイできます\n限定任務：限定任務を確認できます\n着せ替え：着せ替えショップに遷移できます\n限定建造：限定建造画面に遷移できます\n",
		},
	},
}
...
_G.pg.base.gametip.backhill_campusfestival_tip = {
	tip = {
		{
			info = "開催期間：2022.9.15-10.13\n遊び方：\n1.<color=#92fc63>9月21日</color>まで毎日開放される期間限定任務をクリアすると、裏山会場施設を増築できる「学園祭増築資材」を入手できます\n2.裏山会場の一部施設は「学園祭増築資材」を消費することで、キャンペーン期間中、艦隊に強化効果を付与できます。付与する効果は施設によって異なります\n3.すべての施設はレベル3まで増築でき、また施設レベルが高ければ高いほど、艦隊への強化効果が上昇します\n4.強化効果を付与する施設は下記になります：\n饅頭教育棟\n饅頭購買部\n饅頭大舞台\n饅頭占い館\n5.キャンペーン期間中、毎日「ゲーム回数」が１回自動で加算されます（最大7回）\n6.「ゲーム回数」を所持している状態でミニゲーム「饅頭スイーツ」をクリアすると、「ゲーム回数」が1回消費され、「五周年の招待状」の入手進捗が1つ進みます。7回分消費されると「五周年の招待状」を入手できます\n7.ゲーム回数は裏山会場画面の右側に表示されます。また招待状の入手進捗はイベント一覧画面で表示されます\n8.「ゲーム回数」を所持していなくてもミニゲームで遊べますが、「五周年の招待状」の入手進捗は進みません",
		},
	},
}
...
_G.pg.base.gametip.battle_text_common_4 = {
	tip = "<color=#f1f102>敵が与えるダメージが大幅に上昇。敵弾がシールドを無視し、射線上の全ての味方艦船にダメージを与える</color>",
}
...
_G.pg.base.gametip.gametip_xiaoqiye = {
	tip = {
		{
			info = "■概要\n「駆けろ 幼き翼！」とは、イベント開始時に仮加入した【リトル·エンタープライズ】の「友好度」を海域に出撃することで貯め、【リトル·エンタープライズ】を正式加入させるイベントになります。",
		},
		{
			info = "■遊び方\n1.イベント期間中、メイン海域（ノーマル）3章以降のステージまたはイベント海域（常設イベントを除く）の中枢艦隊を撃破すると、「友好度」を獲得する事ができます。獲得した「友好度」が一定の数値に到達すると、「友好度報酬」を入手することができます",
		},
		{
			info = "2.【リトル·エンタープライズ】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。",
		},
		{
			info = "3.【リトル·エンタープライズ】を編成に入れている艦隊で上記ステージの敵中枢艦隊を撃破し、かつ勝利時【リトル·エンタープライズ】が戦闘可能な状態の場合、獲得できる「友好度」が2倍になります。",
		},
		{
			info = "4.イベント終了までにイベントページの「友好度報酬」を最後まで受け取ると、【リトル·エンタープライズ】を「正式加入」させることができます（友好度が1000必要）。イベント終了時、「正式加入」していない【リトル·エンタープライズ】は母港からいなくなります。",
		},
		{
			info = "5.友好度報酬は4/12（水）まで毎日1段階ずつ解放されます。",
		},
		{
			info = "6.仮加入状態の【リトル·エンタープライズ】はセイレーン作戦（META戦含む）に参加できず、またセイレーン作戦では友好度を獲得できません。",
		},
		{
			info = "7.仮加入状態の【リトル·エンタープライズ】は大艦隊作戦には参加できません。",
		},
	},
}
...
_G.pg.base.gametip.gametip_xiaokewei = {
	tip = {
		{
			info = "■概要\n「小さなレディのマナー講義」とは、イベント開始時に仮加入した【リトル・フォーミダブル】の「友好度」を海域に出撃することで貯め、【リトル・フォーミダブル】を正式加入させるイベントになります。",
		},
		{
			info = "■遊び方\n1.イベント期間中、メイン海域（ノーマル）3章以降のステージまたはイベント海域（常設イベントを除く）の中枢艦隊を撃破すると、「友好度」を獲得する事ができます。獲得した「友好度」が一定の数値に到達すると、「友好度報酬」を入手することができます",
		},
		{
			info = "2.【リトル・フォーミダブル】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。",
		},
		{
			info = "3.【リトル・フォーミダブル】を編成に入れている艦隊で上記ステージの敵中枢艦隊を撃破し、かつ勝利時【リトル・フォーミダブル】が戦闘可能な状態の場合、獲得できる「友好度」が2倍になります。",
		},
		{
		...
		{
			info = "7.仮加入状態の【リトル・フォーミダブル】は大艦隊作戦には参加できません。",
		},
	},
}
...
_G.pg.base.gametip.shan_luan_task_help = {
	tip = {
		{
			info = "開催期間：<color=#92fc63>11.23-12.7 メンテまで </color>\n\n  概要：\n 出現する任務をクリアすると、Ptアイテム「忍指南」と「秘伝玉」を入手できます。\n キャラそれぞれの任務を最後までクリアすると、限定家具を入手できます。\n\n  遊び方：\n 1.画面のキャライラストをタップすると、キャラそれぞれの限定任務を確認することができます。\n 2.キャラそれぞれの限定任務画面では任務内容の確認と「忍指南」などの報酬の受け取りが可能です。\n 3.限定任務報酬の「秘伝玉」を7個集めると、「詳細確認」にてコラボ記念家具「暴風城絵巻」を入手できます。\n 4.任務を一定数達成するごとに、「詳細確認」で報酬を開放することができ、更にコラボ開催期間中に味方艦隊に適用する強化効果を入手できます。",
		},
	},
}
...
_G.pg.base.gametip.senran_pt_consume_tip = {
	tip = "<icon name=renzhinan_pt w=0.6 h=0.6/>を<color=#3fbe0d>$1</color>消費し、レベルを<color=#3fbe0d>Lv.$2</color>に上昇させますか?",
}
...
_G.pg.base.gametip.senran_pt_words_banjiu = {
	tip = {
		...
		{
			"1100002/pt3",
			"指揮官の教え方がいいのですね…調子も上がってきました",
		},
		{
			"1100002/pt4",
			"成果が出ている…ですか？それは嬉しいですね",
		},
		{
			"1100002/pt5",
			"今日もお疲れ様でした。これからもよろしくお願いいたします",
		},
	},
}
...
_G.pg.base.gametip.vote_lable_title = {
	tip = "<size=32>人気投票開催期間</size> <size=24>2025/12/4 - 2026/2/7 23:59</size>",
}
...
_G.pg.base.gametip.vote_2023_reward_word_1 = {
	tip = "ふふふ、シミュレーションさせちゃうなんてつまらないわね。声をかけてくれてたら最初から出てやったのに…まあいいわ。なんだかんだ楽しく遊ばせてもらったし、ちょっとしたお返しをしてあげる♪",
}
...
_G.pg.base.gametip.idol3rd_collection = {
	tip = {
		...
		{
			info = "・5月9日（木）メンテナンスまでに「共鳴のパッション」イベントに参加し、「μ兵装」艦船たちの「グッズアイテム」を12種類全部集めると、限定家具「共鳴のミニステージ」を入手可能。",
		},
		{
			info = "・「グッズアイテム」は下記の方法で入手可能\n  ①イベント海域を☆3でクリア\n  ②イベント限定任務（イベント一覧＆「限定任務」ページ）を完遂\n  ③イベントアイテム「共鳴のエンブレム」累計入手数報酬",
		},
		{
			info = "・すべての「グッズアイテム」を入手すると、グッズを画面上に配置可能になります。また、画面右の「シェア」ボタンで配置済の画面をシェア可能\n\n・報酬の受け取り期限は5月15日（水）23:59まで",
		},
	},
}
...
_G.pg.base.gametip.unique_ship_tip2 = {
	tip = "<color=#92fc63>$1</color>を入力して操作を続けてください。",
}
...
_G.pg.base.gametip.help_monopoly_car2024 = {
	tip = {
		...
		{
			info = "4. 開始地点を3回通過すると、限定家具を入手できます。違うスタッフと一緒に開始地点を通過すると資金2000を入手できます ",
		},
		{
...
_G.pg.base.gametip.MonopolyCar2024Game_lock_auto_tip = {
	tip = "10回前進すると自動前進モードが開放されます（進捗$1）",
}
...
_G.pg.base.gametip.sitelasibao_expup_desc = {
	tip = "イベント期間中、<color=#92fc63>ストラスブール、ローダシュー、デュプレクス、Z23、ハーマイオニー、ポンペオ・マーニョ</color>が出撃で得られる経験値が<color=#92fc63>20%</color>アップ",
}
...
_G.pg.base.gametip.SkinDiscount_Owned_Tips = {
	tip = "すでに着せ替えを所持しています（$1/$2）。購入すると、未所持の着せ替えを購入する際に適用できるクーポンを入手できます。\nすでに対象着せ替えを全部所持している場合、入手が着せ替えが自動でダイヤ680に変換され、またクーポン券が入手されません。\nお得パックを購入しますか？",
}
_G.pg.base.gametip.SkinDiscount_Last_Coupon = {
	tip = "購入すると、クーポン数が適用できる着せ替えの数を上回るため、一部クーポンを適用できなくなります。\n購入を続けますか？",
}
...
_G.pg.base.gametip.SuperBulin2_help = {
	tip = {
		{
			info = "遊び方：\n1.イベント期間中、母港と海域の特定の場所に「パスワード」が現れるプリン！\n2.見つけられない場合は、「パスワード」のアイコンをタップするといいプリン！\n ヘルプは10分に1個開放できるプリン！\n3.「パスワード」をすべて集めると、特殊ステージに挑戦できるプリン！\n 特殊ステージをクリアすると、報酬を入手できるプリン！",
		},
	},
}
...
_G.pg.base.gametip.xiaoankeleiqi_npc = {
	tip = {
		{
			info = "■概要\n「星々を描いて」は、イベント開始時に仮加入した【リトル・アンカレッジ】の「友好度」を海域に出撃することで貯め、【リトル・アンカレッジ】を正式加入させるイベントになります。",
		},
		{
			info = "■遊び方\n1.イベント期間中、特定のステージの敵中枢艦隊を撃破すると、「友好度」を獲得する事ができます。獲得した「友好度」が一定の数値に到達すると、「友好度報酬」を入手することができます",
		},
		{
			info = "2.【リトル・アンカレッジ】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。",
		},
		{
			info = "3.【リトル・アンカレッジ】を編成に入れている艦隊で上記ステージの敵中枢艦隊を撃破し、かつ勝利時【リトル・アンカレッジ】が戦闘可能な状態の場合、獲得できる「友好度」が2倍になります。",
		},
		{
			info = "4.イベント終了までにイベントページの「友好度報酬」を最後まで受け取ると、【リトル・アンカレッジ】を「正式加入」させることができます（友好度が1000必要）。イベント終了時、「正式加入」していない【リトル・アンカレッジ】は母港からいなくなります。",
		},
		{
			info = "5.友好度報酬は5/1（木）まで毎日1段階ずつ解放されます。",
		},
		{
			info = "6.仮加入状態の【リトル・アンカレッジ】はセイレーン作戦（META戦含む）に参加できず、またセイレーン作戦では友好度を獲得できません。",
		},
		{
...
_G.pg.base.gametip.littleaijier_npc = {
	tip = {
		{
			info = "■概要\n「「深淵の国」の支配者」とは、イベント開始時に仮加入した【エーギルちゃん】の「友好度」を海域に出撃することで貯め、【エーギルちゃん】を正式加入させるイベントになります。",
		},
		{
			info = "■遊び方\n1.イベント期間中、限定イベントをこなすと「友好度」を獲得する事ができます。獲得した「友好度」が一定の数値に到達すると、「友好度報酬」を入手することができます",
		},
		{
			info = "2.【エーギルちゃん】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。",
		},
		{
			info = "3.イベント終了までにイベントページの「友好度報酬」を最後まで受け取ると、【エーギルちゃん】を「正式加入」させることができます。イベント終了時、「正式加入」していない【エーギルちゃん】は母港からいなくなります。",
		},
		{
			info = "4.友好度報酬は6/4（水）まで毎日1段階ずつ解放されます。",
		},
		{
			info = "5.仮加入状態の【エーギルちゃん】はセイレーン作戦（META戦含む）に参加できません。",
		},
		{
...
_G.pg.base.gametip.island_manage_buff_tip = {
	tip = "*営業が開始すると、仲間の能力変化と強化効果の変化が経営結果に影響しません",
}
...
_G.pg.base.gametip.island_draw_help = {
	tip = "星彩賞は「星彩チケット」を消費し、ランダムでS・A・B・Cランクの賞品アイテムを入手できます。\n 1.星彩賞の「星彩チケット」は離島経営の各種コンテンツを遊ぶか、ダイヤを消費して購入することができます。\n 2.星彩賞の各ランクの賞品はそれぞれ総数が固定であり、出現確率が同じになります。一度賞品を入手すると、その賞品が開催期間中再度出現することはありません。\n   また、S賞の賞品については、入手の<color=#39bfff>順番（出現順番）を変更</color>することができます。\n 3.星彩賞は期毎に期間限定で開催されます。星彩賞の開催期間が終了すると、賞品のラインナップが<color=#39bfff>更新</color>されます。\n 4.星彩賞の開催期間中に賞品を一定個数入手（引く）すると、星彩賞の画面で「累計入手回数報酬」を選んで入手できます。「累計入手回数報酬」の累計入手回数カウントは開催期間終了後にリセットされます。\n 5.星彩賞の開催期間終了時、賞品が全部入手されていなく、かつ「星彩チケット」を所持している場合、<color=#39bfff>賞品を全部入手できるよう自動で「星彩チケット」が消費</color>されます。\n 　賞品が全部入手された場合、余った「星彩チケット」は自動で<color=#39bfff>ダイヤに変換</color>されます。\n 　この方法で自動入手した賞品・変換されたダイヤはメールボックスに送られます。",
}
...
_G.pg.base.gametip.island_chara_attr_help = {
	tip = "1.仲間の<color=#39bfff>能力（ステータス）</color>が高いと、対応の<color=#39bfff>グレード</color>も上昇します\n2.<color=#39bfff>グレード</color>が高いと、<color=#39bfff>当該能力に対応する作業</color>を行う際、<color=#39bfff>効率</color>が上昇します\n3.<color=#39bfff>グレード</color>別の<color=#39bfff>能力</color>範囲について：\n\t<color=#E79CC6>S</color> 能力>=200\n\t<color=#FFDC1C>A</color> 120<=能力<200\n\t<color=#B7A4FF>B</color> 80<=能力<120\n\t<color=#97CFF6>C</color> 50<=能力<80\n\t<color=#757577>D</color> 25<=能力<50\n\t<color=#757577>E</color> 0<=能力<25",
}
...
_G.pg.base.gametip.island_urgent_notice = {
	tip = {
		...
		{
			info = "在<color=#39bfff>11/6（木）メンテナンス後</color>、バランス調整や各種システムの改善・改修のため、現在開催中の離島経営の開発シーズンについては、開発シーズンのリセットを行わせていただきます。\n リセット後の開発シーズンは<color=#39bfff>2025年11月6日(木)メンテナンス後～2026年2月5日(木)メンテナンス</color>まで開催されます。\n 離島経営をすでにプレイした指揮官に対して<color=#39bfff>「メイン画面」-「補填」</color>にて関連の補填アイテムの配布を行わせていただきます。\n この度は「離島経営」コンテンツ実装に関して、多くのご不便とご迷惑をおかけしましたことを心よりお詫び申し上げます。\n\n  ①開発Ptについて\n 開発シーズン終了時、資源倉庫の一部の資源（倉庫の「資源」カテゴリーにて確認できます）がそれぞれの変換レートに応じてシーズン開発Ptに自動変換され、入手した開発Ptの累計数量に応じて累計Pt報酬が解放されます。\n 11/6（木）メンテナンス後に行われるシーズンリセットでは、シーズン期間は通常と異なるため、変換レートは<color=#39bfff>通常の4倍</color>で適用されます。累計Pt報酬は「メイン画面」→「補填」にて入手できます。\n  「秋の特産経営」の特産品資源が開発Ptに変換されません。\n\n  ②リセット内容について\n 1.生産・経営作業：<color=#39bfff>離島依頼、輸送委託、配置作業、手動での栽培、店舗経営</color>など、各種進行中のタスクがリセットされます。（例：メンテナンス前に店舗経営に出された料理は収益を受け取れず削除されます）\n 2.開発順位：シーズンの開発順位（ランキング）がリセットされます。また、離島経営に参加した指揮官全員に順位1位の報酬を配布する予定です。\n 3.開発計画：シーズン関連の開発計画の進捗がリセットされます。未完了の開発計画については、入手可能な星彩賞チケットを補填する予定です；リセット時点ですでに完了したものの、まだ報酬を入手していない開発計画については、その報酬の星彩賞チケットを別途配布する予定です。\n 4.開発ショップ：開発ショップの商品購入可能数がリセットされます。また、11/6（木）メンテナンス後、新しい指揮官着せ替えとモーションが販売開始されます。11/6（木）メンテナンスまで販売予定だった指揮官着せ替えとモーションのみ、2/5（木）メンテナンスまでに期間を延長します（すでに購入済みの場合、再度購入できません）。\n 5.離島依頼：11/6（木）メンテナンス時点で完了済みのイベント依頼の数に応じて<color=#39bfff>「離島シーズンPt交換チケット」</color>付与されます。「離島シーズンPt交換チケット」は離島開発Ptに変換できます。（例：11/6メンテナンス後に入手した「離島シーズンPt交換チケット」は、2/5シーズン終了時に離島開発Ptに変換されます）\n 6.その他リセットされる内容：離島依頼（デイリー・ウィークリー緊急依頼の回数と評価）、輸送委託（更新回数）、出現中の開発計画（デイリー、ウィークリー）、定期補給・定期補給受領可能回数、キャラインタラクト回数、資源採取ポイント（マップ上の採集可能な資源ポイント）、店舗の経営回数もリセットされます。\n 7.下記コンテンツはリセットされません：星彩賞（入手済みの賞品、所持中のチケット、星彩賞を引いた回数、累計回数報酬）、秋の特産経営コンテンツ（特産資源、特産制作アイテム、限定依頼、イベント計画の進捗）、加速券ははリセットされません。\n 　また、一度入手・完了するとシーズンリセット関係なく永続的に解放・所持するるコンテンツ：開発資金、離島開発レベル、離島キャラの加入と育成状況、購入・入手済みの家具/着せ替え/配置オブジェクト、離島技術の研究（完了済みの研究、研究進捗）、店舗レベル、メイン開発計画、実績などはリセットされません。",
		},
	},
}
...
_G.pg.base.gametip.vote_help_2025 = {
	tip = {
		{
			info = "<color=#FFDD00>アズールレーン2025開催について</color>\n\n\n\n概要：\n· アズールレーン人気投票2025では、限定任務クリアで自動で入手できる投票券を使って推しの艦船に投票し、投票数に応じて報酬を入手できるイベントになります。\n\n・メイン画面右上の「人気投票」で限定任務並びに順位の確認、各項目での投票を行えます。　\n\n・人気投票の開催期間：<color=#92fc63>2025年12月4日 – 2026年2月2日23:59まで</color>となります\n\n·人気投票における「日程結果」では、各投票項目での全サーバーでの合計投票数が表示されます。\n\n·過去の人気投票イベントでのTOP3艦船は<color=#92fc63>殿堂入り</color>として扱われ、今回の投票イベントに参加しません。また、裏山画面の「殿堂入り」でTOP3艦船たちのミニストーリーを読むことができます\n\n·殿堂入り艦船以外の、下記<color=#92fc63>2025年10月23日以前に実装された艦船・特別計画艦</color>に投票できます。（特別計画艦以外のコラボキャラ・μ型・Zwei型・Ⅱ型艤装やIF艦船は人気投票の対象外となっており、またMETA・リトル艦船は「特別投票」枠にて投票できます）。\n\n\n\n投票券の入手方法：\n\n指揮官レベルが25以上を達成すると、下記の方法で<color=#92fc63>投票券</color>を入手できます。\n\n人気投票本戦（特別投票を除く）：\n\n· 人気投票開催期間中に出現する<color=#92fc63>限定デイリー任務</color>をクリアすると、投票券が自動で<color=#92fc63>加算されます</color>。デイリー任務による投票券の入手上限は<color=#92fc63>一日20枚まで</color>になります。\n\n· 人気投票開催期間中に出現する<color=#92fc63>限定1回の任務</color>をクリアすると、投票券が自動で<color=#92fc63>加算されます</color>。それぞれの投票項目での投票券入手上限が存在します。\n\t投票券入手任務と投票券の入手上限については「限定任務」にて確認できます。　\n\t\n各項目における投票券入手数上限：\n\t\t\n予選：480\n\t\t\nグループ戦A：200\n\t\t\nグループ戦B：200\n\t\t\nグループ戦C：200\n\t\t\nグループ戦D：200\n\t\t\n復活戦：160\n\t\t\n決勝戦：280\n\n· 各項目の投票期間終了後、残りの投票券が<color=#92fc63>自動で削除され</color>、限定任務の進捗は<color=#92fc63>リセット</color>されます。\n\n特別投票：\n\n特別投票開催期間中、ゲームにログインすると1日1枚<color=#92fc63>投票券</color>を入手できます。\n\n\n\n開催日程：\n\n本戦・特別投票は下記のスケジュールで行われます：\n\n<color=#92fc63>予選</color>：\t\n2025年12月4日（木）メンテナンス後-2025年12月15日（月）23:59まで\n\n<color=#92fc63>グループ戦A</color>：\t\n2025年12月18日（木）0時-2025年12月22日（月）23:59まで\n\n<color=#92fc63>特別投票Ⅰ</color>：2025年12月23日（火）0時-2025年12月25日（木）23:59まで\n\n<color=#92fc63>グループ戦B</color>：\t\n2023年12月27日（土）0時-2025年12月31日（水）23:59まで\n\n<color=#92fc63>特別投票Ⅱ</color>：2026年1月1日（木）0時-2026年1月3日（土）23:59\n\n<color=#92fc63>グループ戦C</color>：\t\n2026年1月5日（月）0時-2026年1月9日（金）23:59まで\n\n<color=#92fc63>特別投票Ⅲ</color>：2026年1月10日（土）0時-2026年1月12日（月）23:59まで\n\n<color=#92fc63>グループ戦D</color>：\t\n2026年1月14日（水）0時-2026年1月18日（日）23:59まで\n\n<color=#92fc63>復活戦</color>：2026年1月20日（火）0時-2026年1月23日（金）23:59まで\n\n<color=#92fc63>決勝戦</color>：\t2026年1月27日（火）0時-2026年2月2日（月）23:59まで\n\n\n\n各項目の投票期間、最終結果は裏山の<color=#92fc63>「日程結果」</color>にて確認できます。\n\n\n\n各項目のルールについて：\n\n<color=#92fc63>予選</color>\n<color=#92fc63>予選</color>は投票期間中キャラの投票数が表示されず、現在順位のみ表示されます。\n\n<color=#92fc63>予選</color>は殿堂入り艦船、コラボキャラ（特別計画艦を除く）、META艦船、リトル艦船以外の全キャラが参加します。また、μ型・Zwei型・Ⅱ型艤装やIF艦船は本体と同じキャラとして扱われます。\n\n<color=#92fc63>予選</color>では票数TOP240までの艦船がグループ戦に進出します。グループ戦ではそれぞれのグループ毎に60名の艦船が参加します。\n\n\n\n<color=#92fc63>グループ戦</color>\n<color=#92fc63>グループ戦</color>は<color=#92fc63>予選</color>得票数TOP240の艦船が4つのグループに分けられます。\n\nそれぞれのグループ戦で得票数TOP5までの艦船は<color=#92fc63>決勝戦</color>に進出します。得票数が6位から15位までの艦船は<color=#92fc63>復活戦</color>に進出します。\n\n\n\n<color=#92fc63>特別投票</color>\n<color=#92fc63>特別投票</color>は全部で3項目に分けられ、それぞれセイレーン、META艦船、リトル艦船が参加します。特別投票に参加する艦船は本戦には参加できません。\n\n\n\n<color=#92fc63>復活戦</color>\n<color=#92fc63>復活戦</color>は<color=#92fc63>グループ戦で</color>でそれぞれ得票数6位～15位の艦船が参加します。\n\n<color=#92fc63>復活戦</color>の得票数TOP15の艦船が<color=#92fc63>復活戦</color>に進出します。\n\n\n\n<color=#92fc63>決勝戦</color>\n<color=#92fc63>決勝戦</color>はグループ戦から合計20名、復活戦から15名の艦船が参加します。\n\n\n\n得票数が同数の場合：\n\n<color=#92fc63>予選</color>で得票数が同票の艦船は、最終結果の票数に先に到達した順で順位が決まります。\n\n<color=#92fc63>グループ戦</color>、<color=#92fc63>復活戦</color>、<color=#92fc63>決勝戦</color>で得票数が同票の艦船は、<color=#92fc63>予選</color>での最終順位で順位が決まります。\n",
		},
	},
}
...
_G.pg.base.gametip.winter_luckybag_9005 = {
	tip = "迎春特売2026対象の着せ替え（$1/$2）着を所持しています。対象の着せ替えをすでに全部入手済みの場合、着せ替えクーポン(迎春2026)は使用できません。また、お得パックで入手した着せ替えが入手済みの着せ替えである場合、自動でダイヤに変換されます。\nお得パックを購入しますか？",
}
_G.pg.base.gametip.winter_luckybag_9006 = {
	tip = "迎春特売2026対象の着せ替え（$1/$2）着を所持しています。対象の着せ替えをすでに全部入手済みの場合、着せ替えクーポン(迎春2026)は使用できません。また、お得パックで入手した着せ替えが入手済みの着せ替えである場合、自動でダイヤ×1080に変換されます。\nお得パックを購入しますか？",
}
...
_G.pg.base.gametip.change_skin_asmr_desc_1 = {
	tip = "前の画面に戻ります（音量にご注意ください）",
}
_G.pg.base.gametip.change_skin_asmr_desc_2 = {
	tip = "イヤホンをつけてお楽しみください",
}
...
_G.pg.base.gametip.battlepass_main_tip_2602 = {
	tip = "2026/2/1-2026/3/31キャンペーン期間中、シーズン任務累計<icon name=pt w=0.5 h=0.5/>入手報酬で<color=#854747>「カラビニエーレ(META)」</color>などを入手可能",
}
_G.pg.base.gametip.battlepass_main_help_2602 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2026.2.1（日）0:00～2026.3.31（火）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「カラビニエーレ(META)」、SP報酬からは駆逐艦「Z47」の限定着せ替え「バッター★ホームラン」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n ①週次開放任務\n キャンペーン開始時とキャンペーン期間中毎週月曜日0時に開放される任務。全8グループ\n ②全期間任務\n 最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n ①通常報酬\n 「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n ②SP報酬\n 「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくり返しながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n 「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n ダイヤを消費しますので、オススメしません。\n 「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.battlepass_main_tip_2606 = {
	tip = "2026/6/1-2026/7/31キャンペーン期間中、シーズン任務累計<icon name=pt w=0.5 h=0.5/>入手報酬で<color=#854747>「ケーニヒスベルク(META)」</color>などを入手可能",
}
_G.pg.base.gametip.battlepass_main_help_2606 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2026.6.1（月）0:00～2026.7.31（金）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「ケーニヒスベルク(META)」、SP報酬からは駆逐艦「深雪」の限定着せ替え「お餅とハプニング」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n ①週次開放任務\n キャンペーン開始時とキャンペーン期間中毎週月曜日0時に開放される任務。全8グループ\n ②全期間任務\n 最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n ①通常報酬\n 「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n ②SP報酬\n 「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくり返しながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n 「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n ダイヤを消費しますので、オススメしません。\n 「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
...
_G.pg.base.gametip.littleyunxian_npc = {
	tip = {
		{
			info = "■概要\n「小さき仙人の背伸び」とは、イベント開始時に仮加入した【雲仙ちゃん】の「友好度」を期間限定任務をクリアすることで貯め、【雲仙ちゃん】を正式加入させるイベントになります。",
		},
		{
			info = "■遊び方\n1.イベント期間中、限定イベントをこなすと「友好度」を獲得する事ができます。獲得した「友好度」が一定の数値に到達すると、「友好度報酬」を入手することができます",
		},
		{
			info = "2.【雲仙ちゃん】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。",
		},
		{
			info = "3.イベント終了までにイベントページの「友好度報酬」を最後まで受け取ると、【雲仙ちゃん】を「正式加入」させることができます。イベント終了時、「正式加入」していない【雲仙ちゃん】は母港からいなくなります。",
		},
		{
			info = "4.友好度報酬は6/3（水）まで毎日1段階ずつ解放されます。",
		},
		{
			info = "5.仮加入状態の【雲仙ちゃん】はセイレーン作戦（META戦含む）に参加できません。",
		},
		{
			info = "7.仮加入状態の【雲仙ちゃん】は大艦隊作戦には参加できません。",
		},
	},
}
_G.pg.base.gametip.littleMusashi_npc = {
	tip = {
		{
			info = "■概要\n「未だ未熟の守護者」とは、イベント開始時に仮加入した【武蔵ちゃん】の「友好度」を海域に出撃することで貯め、【武蔵ちゃん】を正式加入させるイベントになります。",
		},
		{
			info = "■遊び方\n1.イベント期間中、限定イベントをこなすと「友好度」を獲得する事ができます。獲得した「友好度」が一定の数値に到達すると、「友好度報酬」を入手することができます",
		},
		{
			info = "2.【武蔵ちゃん】は、友好度報酬（7段階目）の「正式加入」を達成しない限り、ケッコンすることができず、また退役や強化・限界突破素材への選択をすることができません。",
		},
		{
			info = "3.イベント終了までにイベントページの「友好度報酬」を最後まで受け取ると、【武蔵ちゃん】を「正式加入」させることができます。イベント終了時、「正式加入」していない【武蔵ちゃん】は母港からいなくなります。",
		},
		{
			info = "4.友好度報酬は5/6（水）まで毎日1段階ずつ解放されます。",
		},
		{
			info = "5.仮加入状態の【武蔵ちゃん】はセイレーン作戦（META戦含む）に参加できません。",
		},
		{
...
_G.pg.base.gametip.battlepass_main_help_2608 = {
	tip = {
		{
			info = "■キャンペーン開催期間\n 2026.8.1（土）0:00～2026.9.30（水）23:59\n\n■概要\n「シーズン任務」とは、キャンペーン開催中の任務をクリアし「進捗Pt」を集め、入手した進捗Ptに応じた累計獲得数報酬が手に入るキャンペーンになります。\nまた、通常の累計獲得数報酬に追加する形で「SP報酬」が存在し、ショップアイテム「クルーズパス」を購入すると、SP報酬も入手可能となります。\n通常報酬からは艦船「ニュルンベルク(META)」、SP報酬からは重巡洋艦「クインシー」の限定着せ替え「断れない自習タイム」を入手できます。\n\n■遊び方\n・「シーズン任務」キャンペーンの開始と同時に、2種類の任務が開放されます。\n ①週次開放任務\n キャンペーン開始時とキャンペーン期間中毎週月曜日0時に開放される任務。全8グループ\n ②全期間任務\n 最初から全開放される任務。全1グループ\n・上記「シーズン任務」はすべて自動受領済となり、また「シーズン任務」画面を開いた際、既に完成条件を満たしている任務はクリア状態となり、「進捗Pt」を自動で入手できます。\n さらに「クルーズパス」を購入すると、15段階分の報酬（進捗Pt1500）が入手可能となります。\n・「進捗Pt」の累計入手数に応じて、進捗Pt累計獲得数報酬を入手できます。累計獲得数報酬は2種類存在します。\n ①通常報酬\n 「進捗Pt」の入手数に応じて獲得できる報酬。全100段階となります\n ②SP報酬\n 「クルーズパス」を購入すると開放される追加報酬。通常報酬と同じく全100段階存在し、通常報酬と同じ段階のSP報酬が入手できます。\n・キャンペーンが終了すると、入手済みの進捗Ptはリセットされます。\n\n■Tips\n・プレイスタイル\n シーズン任務は全100段階あり、いきなり最後まではクリアできない仕様になっております。いつものクエストをくり返しながら任務をこなしていくか、狙いの報酬を決めて最短ペースでクリアしていくかなど、自分のプレイスタイルに合わせてプレイすることをオススメします。\n\n・クルーズパス\n ショップで「クルーズパス」を購入すると、お得なアイテムとともに「進捗Pt」を1500Pt入手できます。また、追加の限定着せ替えは「クルーズパス」を購入して開放される「SP報酬」でのみ入手できます。要注意。\n\n・任務のスキップ（オススメしません）\n 「シーズン任務」の「任務一覧」画面で、各任務の右側の矢印ボタンをタップすると、任務を自動でスキップ（クリア状態にする）し、進捗Ptを入手出来る「シーズン任務チケット」の購入・使用が可能です。\n ダイヤを消費しますので、オススメしません。\n 「シーズン任務チケット」はキャンペーン終了後も所持し続けることができます。",
		},
	},
}
