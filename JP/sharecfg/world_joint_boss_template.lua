		...
		description = {
			{
				"二刀流・夕照",
				2,
				"        江風(META)は一定時間毎に<color=#92fc63>「二刀流・夕照」</color>を発動し、目標の移動速度を0.5秒間ダウンさせ、さらに目標に向けて交叉する直線軌道の特殊斬撃と三日月型の弾幕を放つ。<color=#92fc63>特殊斬撃は命中した対象に耐久上限の5％分の固定ダメージを与える</color>。\n江風(META)の<color=#92fc63>三日月型の弾幕は命中した対象に魚雷属性のダメージを与える</color>。"
			},
			{
				"過去の影",
				3,
				"\n「二刀流・夕照」の特殊斬撃が命中しダメージを10回与える毎に、もしくは戦闘中自身が耐久を20％分失う毎に、「血の影」を召喚し、<color=#92fc63>自身の火力・雷装ステータスがアップするほか、「二刀流・夕照」の発動頻度が上昇する</color>。"
			}
		},
		p_offset = {
			-376,
		...
		description = {
			{
				"引っ掻いてやるぜ",
				2,
				"夕立(META)は<color=#92fc63>現在耐久が上限に対して占める割合が一番高い</color>艦船に狙いを定め続け、5秒後その艦船に爪で大きなダメージを与え，さらに100%で<color=#92fc63>20秒持続する特殊炎上効果</color>を付与する（この攻撃のダメージを回避しても特殊炎上効果は付与される。特殊炎上効果は2秒毎に炎上ダメージを与える。この効果を連続で受けても継続時間がリセットされるだけで効果は2倍にならない。この攻撃は5秒に1度しか発動できない）\n 狙いを定め続けている間に、耐久が上限に対して占める割合が一番高い艦船が変わった場合，対象がリセットされる。"
			},
			{
				"ぶん殴ってやるぜ",
				3,
		...
		description = {
			{
				"強者殺猟",
				2,
				"戦闘開始時、レーゲンスブルク(META)は敵の<color=#92fc63>火力・雷装・航空・回避・命中</color>それぞれの<color=#92fc63>ステータスが最も高いユニット</color>に対して【強者殺猟】を1つ付与する；当該ステータスが全部0の場合、【強者殺猟】は付与されない；艦船1隻で複数のステータスが最も高い場合、【強者殺猟】が複数付与される\n【強者殺猟】を所持中の艦船は、<color=#92fc63>所持中の【強者殺猟】の枚数に応じてレーゲンスブルク(META)から受けるダメージ倍率が以下になる。</color>（1個目で110％・2個目以降は1個につき更に220％加算される）；【強者殺猟】を所持中の艦船が主力艦隊にいる場合、炎上状態になりダメージを受ける（炎上ダメージは【強者殺猟】に影響されない）。\n【強者殺猟】が艦船に付与されなかった場合は1つ、【強者殺猟】を持っていた艦船が戦闘不能になった場合は、その分の【強者殺猟】がレーゲンスブルク(META)に付与される；レーゲンスブルク(META)が持っている【強者殺猟】の個数だけ、<color=#92fc63>受けるダメージが20％軽減される</color>。"
			},
			{
				"段階的な勝利",
				1,
