		...
		link_params = {
			{
				...
				"「怪談実録 白夜ヴィラより脱出せよ！」- 「ストーリー」モードをクリア"
			}
		}
	}
		...
		link_params = {
			{
				3,
				51071,
				"「怪談実録 白夜ヴィラより脱出せよ！」-  イベント画面右上の「実績」で各種任務をクリア"
			}
		}
	}
