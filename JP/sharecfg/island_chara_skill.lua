...
;(function()
	...
	pg.base.island_chara_skill[1015] = {
		...
		desc = "基地工場の工業生産設備に配置されている場合、一度の作業毎に$1%の確率で追加産出を獲得",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1016] = {
		...
		name = "収穫スキル",
		icon = "chara_all_skill_5",
		desc = "豊穣の畑で作業時、配置する毎に$1%の確率で追加産出を獲得",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1018] = {
		...
		desc = "饅頭軽食のスタッフとして配置時、メニューの一枠の容量+1、料理営業売上が$1%増加する",
		desc_add = {
			{
				{
					"4"
	...
	pg.base.island_chara_skill[1019] = {
		...
		name = "調製スキル",
		icon = "chara_all_skill_4",
		desc = "饅頭カフェで作業時、配置する毎に$1%の確率で追加産出を獲得",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1020] = {
		...
		name = "収集スキル",
		icon = "chara_all_skill_2",
		desc = "翠緑の森・積岩鉱山で作業時、作業スピードが$1%アップ",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1022] = {
		...
		name = "農作スキル",
		icon = "chara_all_skill_5",
		desc = "豊穣の畑・薫る果樹園・青々苗場で作業時、作業スピードが$1%アップ",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1023] = {
		...
		name = "全力集中",
		icon = "chara_all_skill_8",
		desc = "体力回復が$1%遅くなるが、作業速度が$2%アップ",
		desc_add = {
			{
				{
					"10"
	...
	pg.base.island_chara_skill[1024] = {
		...
		name = "採集スキル",
		icon = "chara_all_skill_9",
		desc = "青々苗場で作業時、配置する毎に$1%の確率で追加産出を獲得",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1025] = {
		...
		name = "爆破スキル",
		icon = "chara_all_skill_1",
		desc = "積岩鉱山で作業時、配置する毎に$1%の確率で追加産出を獲得",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1026] = {
		...
		name = "焼き物上手",
		icon = "chara_all_skill_13",
		desc = "烏魚焼肉のスタッフとして配置時、メニューの一枠の容量+1、料理営業売上が$1%増加する",
		desc_add = {
			{
				{
					"4"
	...
	pg.base.island_chara_skill[1027] = {
		...
		desc = "基地工場の木材加工設備に配置されている場合、作業速度が$1%アップ",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1028] = {
		...
		name = "手工スキル",
		icon = "chara_all_skill_14",
		desc = "基地工場の手工作業台に配置されている場合、配置する毎に$1%の確率で追加産出を獲得",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1029] = {
		...
		name = "元気モリモリ",
		icon = "chara_all_skill_8",
		desc = "翠緑の森で作業時、木材産出時間が$1%短縮。体力が70以下の時に挨拶すると、体力が$2回復する（一日1回まで）",
		desc_add = {
			{
				{
					"1"
	...
	pg.base.island_chara_skill[1030] = {
		...
		name = "店舗管理上手",
		icon = "chara_all_skill_12",
		desc = "任意の店舗のスタッフとして配置されている場合、体力消費を$1%軽減。配置店舗のメニュー枠の出品可能数+1",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1031] = {
		...
		desc = "ロイヤル・フォーチュンに挨拶をすると、ランダムな報酬を入手できる（$1）。（一日1回まで）",
		desc_add = {
			{
				{
					"Lv1"
	...
	pg.base.island_chara_skill[1032] = {
		...
		name = "ドリンク調製",
		icon = "chara_all_skill_4",
		desc = "饅頭カフェで作業時、配置する毎に$1%の確率で追加産出を獲得。メニューの営業利益が$2%アップ",
		desc_add = {
			{
				{
					"1"
