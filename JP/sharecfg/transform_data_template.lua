...
;(function()
	...
	pg.base.transform_data_template[2811] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "改造を行うと、対空+60\n対空砲砲座+1\n特殊対潜装備追加\nスキル<color=#92fc63>【レインボー・プラン】</color>が<color=#92fc63>【レインボー・プラン改】</color>に強化\nスキル<color=#92fc63>【特殊弾幕-エルドリッジⅡ】</color>が<color=#92fc63>【特殊弾幕・エルドリッジⅢ】</color>に強化されます",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			2809,
...
;(function()
	...
	pg.base.transform_data_template[6211] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "改造(近代化改修)完了、対空+20、装填+25\nスキル【BIG SEVEN】が【BIG SEVEN·ウェストバージニア】に強化",
		icon = "mt_yellow",
		skill_id = 0,
		condition_id = {
			6206,
...
;(function()
	...
	pg.base.transform_data_template[16311] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "近代化改修完了。雷装+30、対空+15\n\n改造後<color=#92fc63>【対空砲砲座+1】</color> ，<color=#92fc63>対空砲補正+40%</color>",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			16308,
...
;(function()
	...
	pg.base.transform_data_template[24211] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "改造（近代化改修）完了。火力+30、命中+15\n改造後【主砲砲座+1】\n主砲枠威力補正が120%に変更",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			24209,
...
;(function()
	...
	pg.base.transform_data_template[53411] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "改造（近代化改修）完了、対空+35，航空+25\n改造後<color=#92fc63>【1番兵装枠は戦闘機を装備可能】【1番兵装枠機数+2】</color><color=#92fc63>【2番兵装枠は任意の艦載機を装備可能】【2番兵装枠機数/砲座+1】</color>",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			53409,
	...
	pg.base.transform_data_template[57911] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "改造（近代化改修）完了、対空+35，航空+25\n改造後<color=#92fc63>【1番兵装枠に戦闘機を装備可能】【2番兵装枠に任意の艦載機を装備可能】</color>、<color=#92fc63>【1つ目と2つ目の装備枠の威力補正+10%】</color>",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			57909,
