...
function var_0_0.CanFollowPlayer(arg_4_0, arg_4_1)
	local var_4_0 = arg_4_0.ships[arg_4_1]
...
function var_0_0.AddSkin(arg_23_0, arg_23_1)
	local var_23_0 = pg.island_skin_template[arg_23_1].ship_group
	local var_23_1 = arg_23_0.shipSkinDic[var_23_0] or {}

	table.insert(var_23_1, IslandShipSkin.New({
		color_id = 0,
		id = arg_23_1,
		color_list = {}
	}))
...
function var_0_0.GetCurrentSkinColorByShipId(arg_25_0, arg_25_1, arg_25_2)
	for iter_25_0, iter_25_1 in ipairs(arg_25_0.shipSkinDic[arg_25_1] or {}) do
...
function var_0_0.GetOwnDressCountByDressId(arg_31_0, arg_31_1)
	return arg_31_0.hasDressData[arg_31_1] and arg_31_0.hasDressData[arg_31_1].num or 0
end
...
function var_0_0.CheckSkinIsOwned(arg_34_0, arg_34_1)
	...
	local var_34_0 = pg.island_skin_template[arg_34_1].ship_group

	for iter_34_0, iter_34_1 in pairs(arg_34_0:GetOwnSkinListByShipId(var_34_0)) do
...
function var_0_0.GetSkinData(arg_35_0, arg_35_1)
	...
	local var_35_0 = pg.island_skin_template[arg_35_1].ship_group

	for iter_35_0, iter_35_1 in pairs(arg_35_0:GetOwnSkinListByShipId(var_35_0)) do
