...
function var_0_0.GetObject(arg_3_0)
	...
	arg_3_0.active[var_3_0] = var_3_1
...
function var_0_0.GetLocalPosition(arg_5_0, arg_5_1)
	...
	return IslandCalcUtil.WorldPosition2LocalPosition(arg_5_0.root, var_5_0), var_5_0
end
...
function var_0_0.Play(arg_6_0, arg_6_1, arg_6_2)
	...
	local var_6_3 = var_6_0.transform:Find("Text")

	if var_6_3 then
		setText(var_6_3, arg_6_2 and arg_6_2.value or 0)
	end
end

function var_0_0.Update(arg_7_0)
	for iter_7_0, iter_7_1 in pairs(arg_7_0.active or {}) do
		local var_7_0 = iter_7_1.unit

		if IsNil(iter_7_0) then
			arg_7_0.active[iter_7_0] = nil
		elseif Time.time >= iter_7_1.expireTime or not var_7_0 or IsNil(var_7_0._go) then
			arg_7_0:Recycle(iter_7_0)
		else
			local var_7_1, var_7_2 = arg_7_0:GetLocalPosition(var_7_0)
