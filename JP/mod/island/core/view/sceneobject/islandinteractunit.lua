...
function var_0_0.StartInteract(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4, arg_7_5, arg_7_6, arg_7_7)
	...
	arg_7_0.director.extrapolationMode = arg_7_4.is_loop == 1 and UnityEngine.Playables.DirectorWrapMode.Loop or UnityEngine.Playables.DirectorWrapMode.None
...
function var_0_0.EndInteract(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4)
	if arg_8_3 then
		arg_8_0.director.time = arg_8_0.director.extrapolationMode == UnityEngine.Playables.DirectorWrapMode.None and arg_8_0.director.duration or 0
	...
	if #var_11_0 > 0 then
		...
		for iter_11_0, iter_11_1 in ipairs(var_11_1) do
			...
			if var_11_3 ~= nil then
				local var_11_4 = arg_11_1.binding_path[var_11_3]
				local var_11_5 = var_11_4 == "" and arg_11_0:GetTargetRoot() or arg_11_0:GetTargetRoot():Find(var_11_4)

				if var_11_5 then
					TimelineHelper.SetAutoBinding(arg_11_0.director, iter_11_1, go(var_11_5))
				end
			end
		end
		...
		for iter_11_2, iter_11_3 in ipairs(arg_11_1.control_binding or {}) do
			...
			local var_11_7 = iter_11_3[2]
			local var_11_8 = iter_11_3[3] or ""
			local var_11_9 = var_11_1[var_11_6]

			if var_11_9 and var_11_7 and var_11_7 > 0 then
				local var_11_10 = var_11_8 == "" and arg_11_0:GetTargetRoot() or arg_11_0:GetTargetRoot():Find(var_11_8)

				if var_11_10 then
					TimelineHelper.SetControlBinding(arg_11_0.director, var_11_9, var_11_7 - 1, go(var_11_10))
				end
			end
		end
	end
...
function var_0_0.BindPlayer(arg_13_0, arg_13_1, arg_13_2)
	...
	if arg_13_1 < #var_13_0 then
		local var_13_3 = TimelineHelper.GetChildTracks(var_13_0[arg_13_1 + 1]):ToTable()
