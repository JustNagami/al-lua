...
function var_0_0.OnFishPointSelected(arg_26_0, arg_26_1)
	local var_26_0 = arg_26_1.node

	if not var_26_0 then
		return
	end

	local var_26_1 = var_26_0:GetBlackboardVariable("FishPoint")

	if not var_26_1 or var_26_1 == "" then
		arg_26_0:UnSelectedFishPoint()
	else
		local var_26_2, var_26_3 = IslandCalcUtil.GetTypeAndIdByUniqueId(var_26_1)
		local var_26_4 = arg_26_0:GetUnitModuleWithType(var_26_2, var_26_3)

		if var_26_4 then
			arg_26_0:SelectedFishPoint(var_26_4)
		end
	end
end

function var_0_0.OnAllDailyOrWeeklyFinish(arg_27_0, arg_27_1)
	local var_27_0 = arg_27_0:GetUnitListByKey(IslandConst.UNIT_LIST_FOLLOW)
	local var_27_1 = {}
...
function var_0_0.UnSelectedFishPoint(arg_30_0)
	if arg_30_0.selectedFishPointId then
		...
		arg_30_0:GetSubView(IslandOpView):UpdateOperationButton(IslandOpView.OperationType.None, var_30_0)
	end
end

function var_0_0.OnStartFishing(arg_31_0, arg_31_1)
	local var_31_0 = arg_31_1.unitId
	local var_31_1 = arg_31_0:GetPlayerUnitModule(var_31_0)

	if not var_31_1 then
		return
	end

	if not isa(var_31_1, IslandVisitorUnit) then
		return
	end
	...
	local var_31_5 = pg.island_fish_rod[var_31_3].attachment_id
	local var_31_6 = IslandVistorFishingPlayer.New(arg_31_0, var_31_1, var_31_2, var_31_5, var_31_4)

	var_31_6:Play()

	arg_31_0.fishingSynPlayers[var_31_0] = var_31_6
end

function var_0_0.OnFishingStateChange(arg_32_0, arg_32_1)
	local var_32_0 = arg_32_1.op
	local var_32_1 = arg_32_1.unitId
	local var_32_2 = arg_32_0:GetPlayerUnitModule(var_32_1)
	local var_32_3 = arg_32_0.fishingSynPlayers[var_32_1]

	if not isa(var_32_2, IslandVisitorUnit) then
		return
	end

	if not var_32_3 or not var_32_3:IsSameFishPoint(arg_32_1.fishPointId) then
		return
	end

	local function var_32_4()
		var_32_2:WakeUp()
		arg_32_0.fishingSynPlayers[var_32_1]:Dispose()

		arg_32_0.fishingSynPlayers[var_32_1] = nil
	end

	if var_32_0 == IslandConst.FISHING_OP_CANCEL then
		var_32_3:OnCancel(var_32_4)
	elseif var_32_0 == IslandConst.FISHING_OP_FAILD then
		var_32_3:OnFailed(var_32_4)
	elseif var_32_0 == IslandConst.FISHING_OP_SUCCESS then
		var_32_3:OnSuccess(var_32_4)
	end
end
...
function var_0_0.OnCoupleActionWithFollower(arg_37_0, arg_37_1)
	local var_37_0 = arg_37_0:GetUnitListByKey(IslandConst.UNIT_LIST_FOLLOW)
	local var_37_1 = arg_37_0:GetPlayerPosition()
	local var_37_2 = pg.island_set.action_bubble_range.key_value_int
	local var_37_3 = _.select(var_37_0, function(arg_38_0)
		return not arg_38_0:IsExitState() and Vector3.Distance(arg_38_0:GetPosition(), var_37_1) <= var_37_2
	end)
	...
	local var_37_4 = var_37_3[math.random(1, #var_37_3)]
	local var_37_5 = pg.island_action[arg_37_1]

	arg_37_0.coupleAction4FollowerPlayer:Play(var_37_4, arg_37_0.player, var_37_5)
...
function var_0_0.OnFollowerWillDelStep1(arg_40_0, arg_40_1)
	local var_40_0 = arg_40_0:GetUnitListByKey(IslandConst.UNIT_LIST_FOLLOW)
	local var_40_1
	...
	if not var_40_1 or var_40_1:IsExitState() then
		pg.TipsMgr.GetInstance():ShowTips(i18n("island_follower_exiting_tip"))

		return
	end

	var_40_1:DoExitHandle()
end

function var_0_0.OnFollowerWillDelStep2(arg_41_0, arg_41_1)
	local var_41_0 = arg_41_1.node

	if not var_41_0 then
		return
	end

	local var_41_1 = var_41_0:GetComponent(typeof(WorldObjectItem)).uniqueId
	local var_41_2, var_41_3 = IslandCalcUtil.GetTypeAndIdByUniqueId(var_41_1)
	local var_41_4 = arg_41_0:GetUnitModuleWithType(var_41_2, var_41_3)

	if not var_41_4 then
		return
	end

	arg_41_0:NotifiyMeditor(IslandMediator.DEL_FOLLOWER, var_41_4:GetDataVO():GetShipId())
end
...
function var_0_0.OnShowChatMsg(arg_44_0, arg_44_1)
	...
	local var_44_1 = arg_44_0:GetPlayerUnitModule(var_44_0)

	if not var_44_1 then
		return
	end

	arg_44_0:GetSubView(IslandTopHeadHudView):PlayChat(var_44_1, arg_44_1.emojiId, arg_44_1.content, nil)
end
...
function var_0_0.OnPlaySingleAnimationEnd(arg_47_0, arg_47_1)
	...
	local var_47_0 = arg_47_0:GetSelectedNpcId()
	local var_47_1, var_47_2 = IslandCalcUtil.GetTypeAndIdByUniqueId(var_47_0)
	local var_47_3 = arg_47_0:GetUnitModuleWithType(var_47_1, var_47_2)

	if isa(var_47_3, IslandStrollNpcUnit) and var_47_3:GetDataVO():ExistGreetingActionFeedback() then
		arg_47_0.npcActionPlayer:Resopon(var_47_3, arg_47_0.player, arg_47_1)
	else
		arg_47_0.npcActionPlayer:ResoponByRandom(arg_47_0.player, arg_47_1)
	end
end
...
function var_0_0.OnShowNpcAniamtionBubble(arg_48_0, arg_48_1)
	...
	local var_48_1 = arg_48_1:GetGreetingFeedback()

	arg_48_0:GetSubView(IslandBottomHeadHudView):ShowAnimationOp(var_48_0, var_48_1)
end

function var_0_0.OnHideNpcAniamtionBubble(arg_49_0, arg_49_1)
	local var_49_0 = arg_49_0:GetStrollUnitModule(arg_49_1.id)

	arg_49_0:GetSubView(IslandBottomHeadHudView):HideAnimationOp(var_49_0)
end
...
function var_0_0.OnResponAniamtionOp(arg_52_0, arg_52_1)
	...
	local var_52_3 = arg_52_0:GetPlayerUnitModule(var_52_0)
	...
	if var_52_2 == 0 then
		if not arg_52_0:IsPlayer(var_52_0) then
			arg_52_0:GetSubView(IslandTopHeadHudView):HideAnimationOp(var_52_3)
		else
			pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildActionOp(2, var_52_2, 1, 0, 0, 0))
		end

		return
	end

	local var_52_4 = pg.island_action[var_52_2]

	if var_52_1 == 0 and var_52_4.type == IslandConst.ANIMATION_OP_DOUBLE and not arg_52_0:IsPlayer(var_52_0) then
		arg_52_0:GetSubView(IslandTopHeadHudView):ShowAnimationOp(var_52_3, var_52_2)
	elseif var_52_1 > 0 and var_52_4.type == IslandConst.ANIMATION_OP_DOUBLE and not arg_52_0:IsPlayer(var_52_1) then
		local var_52_5 = arg_52_0:GetPlayerUnitModule(var_52_1)

		arg_52_0.coupleActionPlayer:Play(var_52_3, var_52_5, var_52_4)
		arg_52_0:GetSubView(IslandTopHeadHudView):HideAnimationOp(var_52_5)
	elseif var_52_1 > 0 and var_52_4.type == IslandConst.ANIMATION_OP_DOUBLE and arg_52_0:IsPlayer(var_52_1) then
		local var_52_6 = arg_52_0:GetPlayerUnitModule(var_52_1)

		arg_52_0.coupleActionPlayer:Play(var_52_3, var_52_6, var_52_4)
		arg_52_0:GetSubView(IslandAniamtionOpView):RemoveWaitTimer(false)
		pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildActionOp(2, var_52_2, 1, var_52_1, 0, 1))
	end
end

function var_0_0.OnShowChatMsg(arg_53_0, arg_53_1)
	local var_53_0 = arg_53_1.player.id
	local var_53_1 = arg_53_0:GetPlayerUnitModule(var_53_0)

	if not var_53_1 then
		return
	end

	arg_53_0:GetSubView(IslandTopHeadHudView):PlayChat(var_53_1, arg_53_1.emojiId, arg_53_1.content, nil)
end
...
function var_0_0.OnTracking(arg_63_0, arg_63_1)
	...
	if var_63_0 == IslandTaskTrackCard.TYPES.MAIN then
		arg_63_0.mainTrackId = tonumber(arg_63_1.id)
		arg_63_0.needTryMainTrack = true
	elseif var_63_0 == IslandTaskTrackCard.TYPES.OTHER then
...
local function var_0_2(arg_70_0, arg_70_1, arg_70_2)
	for iter_70_0, iter_70_1 in ipairs(arg_70_0) do
		for iter_70_2, iter_70_3 in ipairs(iter_70_1[2]) do
			local var_70_0 = pg.island_interaction[iter_70_3]

			if var_70_0.type == arg_70_2 and var_0_1(tonumber(var_70_0.param), arg_70_1) then
				return iter_70_1[1]
			end
		end
	end
...
local function var_0_3(arg_71_0)
	...
	for iter_71_0, iter_71_1 in ipairs(arg_71_0) do
		for iter_71_2, iter_71_3 in ipairs(iter_71_1[2]) do
			local var_71_2 = pg.island_interaction[iter_71_3]

			if var_71_2.type == IslandInteractionUntil.TYPE_TRANSFER then
				table.insert(var_71_0, iter_71_1[1])
			elseif var_71_2.type == IslandInteractionUntil.TYPE_SP_TRANSFER then
...
function var_0_0.GetOptTrackingTarget(arg_72_0, arg_72_1)
	...
	local var_72_5
	local var_72_6 = var_0_2(var_72_2, var_72_1.mapId, IslandInteractionUntil.TYPE_TRANSFER) or var_0_2(var_72_2, var_72_1.mapId, IslandInteractionUntil.TYPE_SP_TRANSFER)

	var_72_6 = var_72_6 or var_0_3(var_72_2)
...
function var_0_0.OnChangeTakePhotoModel(arg_97_0, arg_97_1, arg_97_2)
	...
	elseif arg_97_0.takePhotoModel == IslandConst.TakePhotoModel.Third then
		...
		local var_97_0 = IslandCameraMgr.instance:GetVirtualCamera(IslandConst.Third_PERSON_TAKE_PHOTO_CAMERA_NAME).gameObject:GetComponent(typeof(CameraPovLook))
		local var_97_1 = arg_97_0.player._tf.position + Vector3(0, 0.5, 0)
		local var_97_2 = arg_97_0.thirdTakePhotoItem._tf.position + Vector3(0, 1, 0)

		var_97_0:SetPosAndRotationByTargetDir((var_97_1 - var_97_2).normalized)
...
function var_0_0.OnNpcDetectorUnSelected(arg_100_0, arg_100_1)
	...
	local var_100_1 = var_100_0:GetComponent(typeof(WorldObjectItem)).uniqueId

	arg_100_0:GetSubView(IslandOpView):UpdateAnimationOpEffect(var_100_1)
	arg_100_0:GetSubView(IslandBottomHeadHudView):UpdateAnimationOpEffect(var_100_1)
	arg_100_0:GetSubView(IslandAniamtionOpView):SortForNpcAction(nil)

	if arg_100_0.selectedNpcId ~= var_100_1 then
		return
	end
...
function var_0_0.OnDetectorChanged(arg_101_0, arg_101_1)
	...
	local var_101_1 = var_101_0:GetBlackboardVariable("DetectorList")

	for iter_101_0 = 1, var_101_1.Count do
		local var_101_2 = var_101_1[iter_101_0 - 1]
		local var_101_3, var_101_4 = IslandCalcUtil.GetTypeAndIdByUniqueId(var_101_2)

		if var_101_3 == IslandConst.UNIT_LIST_OBJ then
			local var_101_5 = arg_101_0:GetUnitModuleWithType(var_101_3, var_101_4)

			if var_101_5 then
				arg_101_0:Op("NotifiyIsland", ISLAND_EX_EVT.APPROACH_OBJECT, var_101_5.id)
			end
		end
	end
end
...
function var_0_0.OnDetectorSelected(arg_102_0, arg_102_1)
	local var_102_0 = arg_102_1.node

	if not var_102_0 then
		return
	end

	local var_102_1 = var_102_0:GetBlackboardVariable("AnyOne")

	if not var_102_1 or var_102_1 == "" then
		arg_102_0:OnClearSelectedUnit()
	else
		local var_102_2, var_102_3 = IslandCalcUtil.GetTypeAndIdByUniqueId(var_102_1)
		local var_102_4 = arg_102_0:GetUnitModuleWithType(var_102_2, var_102_3)

		if var_102_4 then
			arg_102_0:OnSelectedUnit(var_102_4)
		end
	end
end
...
function var_0_0.OnPlayChatBubble(arg_105_0, arg_105_1)
	...
	arg_105_0:GetSubView(IslandTopHeadHudView):PlayBubble(arg_105_1.name, var_105_0, arg_105_1.callback)
end

function var_0_0.OnRawPlayChatBubble(arg_106_0, arg_106_1)
	local var_106_0 = arg_106_0:GetAllUnits()

	arg_106_0:GetSubView(IslandTopHeadHudView):RawPlayBubble(arg_106_1.info, var_106_0, arg_106_1.callback)
end
...
function var_0_0.OnChangeVisterDress(arg_108_0, arg_108_1)
	...
	local var_108_1 = arg_108_0:GetPlayerUnitModule(var_108_0)

	if var_108_1 then
		var_108_1:OnChangeDress(arg_108_1.changeDressData)
	end
end
...
function var_0_0.OnGenSystem(arg_112_0, arg_112_1)
	local var_112_0 = arg_112_0.systemBuilders[arg_112_1:GetType()]:Build(arg_112_1)

	arg_112_0:AddUnit(var_112_0)
end
...
function var_0_0.OnRemoveUnit(arg_119_0, arg_119_1, arg_119_2)
	...
	if var_119_1 > 0 then
		local var_119_2 = var_119_0[var_119_1]

		for iter_119_2 = #arg_119_0.pathfinders, 1, -1 do
			local var_119_3 = arg_119_0.pathfinders[iter_119_2]

			if var_119_3:IsSameUnit(var_119_2) then
				var_119_3:Dispose()
				table.remove(arg_119_0.pathfinders, iter_119_2)
			end
		end

		arg_119_0:RemoveUnit(var_119_2)
		var_119_2:Dispose()
		...
		arg_119_0:GetSubView(IslandBottomHeadHudView):HideAnimationOp(var_119_2)
...
function var_0_0.OnWorldObjectStartInteraction(arg_142_0, arg_142_1, arg_142_2, arg_142_3)
	...
	local var_142_5 = arg_142_1:GetTimeline()[arg_142_3]
	local var_142_6 = arg_142_1:GetBlackboardParam()[arg_142_3]

	var_142_2:StartInteract(var_142_3, arg_142_2.id, arg_142_3, var_142_5, var_142_6, arg_142_1:AnySlotUsing(), var_142_4)
end
...
function var_0_0.OnWorldObjectEndInteraction(arg_143_0, arg_143_1, arg_143_2)
	...
	local var_143_4 = arg_143_0.player == var_143_3

	if var_143_4 then
		arg_143_0:GetSubView(IslandOpView):EndInteraction()
	end

	var_143_2:EndInteract(var_143_3, arg_143_2.id, not arg_143_1:AnySlotUsing(), var_143_4)
end
...
function var_0_0.OnCharacterChangeDress(arg_148_0, arg_148_1, arg_148_2, arg_148_3, arg_148_4)
	...
	local var_148_1 = arg_148_0:GetUnitListByKey(IslandConst.UNIT_LIST_FOLLOW)

	for iter_148_0, iter_148_1 in ipairs(var_148_1) do
		if iter_148_1:GetDataVO():IsSameShip(arg_148_1) then
			iter_148_1:OnCharacterChangeDress(arg_148_2, arg_148_3, arg_148_4)
		end
	end

	local var_148_2 = arg_148_0:GetUnitListByKey(IslandConst.UNIT_LIST_STROLL)

	for iter_148_2, iter_148_3 in ipairs(var_148_2) do
...
function var_0_0.OnPlayEffect(arg_164_0, arg_164_1, arg_164_2, arg_164_3)
	local var_164_0
	local var_164_1 = arg_164_0:GetUnitListByKey(IslandConst.UNIT_LIST_STROLL)
