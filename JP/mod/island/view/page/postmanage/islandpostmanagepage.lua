...
function var_0_0.OnGetCollctionData(arg_19_0, arg_19_1)
	...
	local var_19_1 = getProxy(PlayerProxy):getPlayerId()
	local var_19_2 = "IslandSignAutoCollectTime" .. tostring(var_19_1)

	PlayerPrefs.SetInt(var_19_2, var_19_0)
...
function var_0_0.OnShow(arg_21_0)
	arg_21_0:BlurPanel()
	triggerToggle(arg_21_0.togglesTF:Find(arg_21_0.contextData.curPage or var_0_0.PAGE_PROD), true)
	arg_21_0:FlushTips()
...
function var_0_0.OnFlushProdPageAndShipExpDone(arg_26_0, arg_26_1)
	if arg_26_1.addShipExpData then
		...
		local var_26_3 = IslandShip.StaticGetPrefab(var_26_1)
