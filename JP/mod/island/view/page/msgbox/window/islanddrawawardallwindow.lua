...
function var_0_0.UpdateActivity(arg_5_0, arg_5_1)
	...
	eachChild(arg_5_0.rtRarities, function(arg_6_0, arg_6_1)
		...
		local var_6_1 = arg_5_0.activity:GetRankList(var_6_0)

		setText(arg_6_0:Find("title/Text"), i18n("island_draw_" .. var_6_0))
		UIItemList.StaticAlign(arg_6_0:Find("container"), arg_6_0:Find("container/tpl"), #var_6_1, function(arg_7_0, arg_7_1, arg_7_2)
			arg_7_1 = arg_7_1 + 1

			if arg_7_0 == UIItemList.EventUpdate then
				local var_7_0, var_7_1 = unpack(var_6_1[arg_7_1])
				local var_7_2 = pg.island_draw_reward[var_7_0]
				local var_7_3 = Drop.New({
					type = var_7_2.drop_type,
					id = var_7_2.drop_id
				})

				IslandShopDrawAwardPage.ShowDropInfo(var_7_3, arg_7_2:Find("mask/Image"))
				setScrollText(arg_7_2:Find("name/Text"), var_7_3:getName())
