return {
	...
	},
	{
		...
		isShow = function()
			...
			return var_22_1 and not var_22_1:isEnd()
		end,
		isTip = function()
			...
			if var_24_1 and not var_24_1:isEnd() then
				local var_24_2 = getProxy(MiniGameProxy):GetHubByHubId(var_24_1:getConfig("config_id"))

				return var_24_2 and var_24_2.id == 7 and var_24_2.count > 0
			end
		end
	},
	{
	...
	},
	{
		...
		isTip = function()
			...
			return Activity.IsActivityReady(var_29_0)
		end
	},
	{
		...
		isShow = function()
			local var_30_0 = 970710
			local var_30_1 = getProxy(MetaCharacterProxy):getMetaProgressVOByID(var_30_0)

			return var_30_1 and var_30_1:isInAct()
		end,
		isTip = function()
			local var_31_0 = 970710
			local var_31_1 = getProxy(MetaCharacterProxy):getMetaProgressVOByID(var_31_0)

			if var_31_1:isPassType() then
				return false
			end

			if not var_31_1:isShow() then
				return false
			end

			local var_31_2 = false

			if var_31_1.metaPtData then
				var_31_2 = var_31_1.metaPtData:CanGetAward()
			end

			if var_31_2 == false then
				var_31_2 = getProxy(MetaCharacterProxy):getRedTag(var_31_0)
			end
	...
	},
	{
		...
		isTip = function()
			local var_33_0 = ActivityConst.GetLatestPermanentActivityIds()

			return PlayerPrefs.GetInt("permanent_times", 0) ~= #var_33_0
		end
	},
	{
	...
	},
	{
		...
		isTip = function()
			local var_37_0 = getProxy(ActivityProxy):getActivityById(ActivityConst.OTHER_WORLD_TERMINAL_BATTLE_ID)
	...
	},
	{
		...
		isShow = function()
			local var_40_0 = getProxy(ActivityProxy):getActivityById(51073)

			return var_40_0 and not var_40_0:isEnd()
		end,
		isTip = function()
			local var_41_0 = getProxy(ActivityProxy):getActivityById(51073)
	...
	},
	{
		...
		isShow = function()
			local var_42_0 = getProxy(ActivityProxy):getActivityById(970002)

			return var_42_0 and not var_42_0:isEnd()
		end,
		isTip = function()
			local var_43_0 = getProxy(ActivityProxy):getActivityById(970002)
			local var_43_1 = getProxy(ActivityProxy):getActivityById(970003)

			return Activity.IsActivityReady(var_43_0) or Activity.IsActivityReady(var_43_1)
		end
	}
}
