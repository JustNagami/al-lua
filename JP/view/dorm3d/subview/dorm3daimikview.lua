...
function var_0_0.FlushHint(arg_10_0)
	...
	arg_10_0:emit(AimIKSystem.GET_TIP_SHOW_INFO, var_10_0)

	local var_10_1 = var_10_0[1]

	UIItemList.StaticAlign(arg_10_0.tipTF, arg_10_0.tipTF:GetChild(0), #var_10_1, function(arg_11_0, arg_11_1, arg_11_2)
		...
		setLocalPosition(arg_11_2, LuaHelper.ScreenToLocal(arg_10_0.tipTF, var_10_1[arg_11_1].pos, pg.UIMgr.GetInstance().uiCameraComp))
	end)
end
