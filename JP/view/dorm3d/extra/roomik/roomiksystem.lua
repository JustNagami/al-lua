...
function var_0_0.RegisterEvents(arg_2_0)
	...
	arg_2_0:Bind(var_0_0.CONSUME_IK_SPECIAL_CALL, function(arg_12_0, arg_12_1)
		local var_12_0 = arg_2_0:ConsumeIKSpecialCall()

		if arg_12_1 then
			arg_12_1.consumed = var_12_0
		end
	end)
...
function var_0_0.SwitchIKConfig(arg_20_0, arg_20_1, arg_20_2)
	...
	local function var_20_1()
		if var_20_0.skin_id ~= arg_20_1.skinId then
			local var_21_0 = pg.dorm3d_ik_status.get_id_list_by_base[var_20_0.base]
			local var_21_1 = _.detect(var_21_0, function(arg_22_0)
				return pg.dorm3d_ik_status[arg_22_0].skin_id == arg_20_1.skinId
			end)

			assert(var_21_1, string.format("Missing Status Config By Skin: %s original Status: %s", arg_20_1.skinId, arg_20_2))

			var_20_0 = pg.dorm3d_ik_status[var_21_1]
		end
	end

	if type(var_20_0.skin_id) == "table" then
...
function var_0_0.SetIKState(arg_23_0, arg_23_1, arg_23_2, arg_23_3)
	...
	if arg_23_1 then
		table.insert(var_23_1, function(arg_24_0)
			...
			local var_24_0 = var_23_0.ikConfig.camera_group

			arg_23_0:Emit(Dorm3dIKView.SET_CAMERA_BUTTON_ACTIVE, #pg.dorm3d_ik_status.get_id_list_by_camera_group[var_24_0] > 1)
...
function var_0_0.RegisterIKFunc(arg_35_0)
	...
	pg.IKMgr.GetInstance():RegisterOnIKLayerAction(function(arg_41_0)
		local var_41_0 = arg_35_0:GetCurrentLadyEnv()

		arg_35_0.blockIK = nil

		local var_41_1 = _.detect(var_41_0.readyIKLayers, function(arg_42_0)
			return arg_42_0:GetControllerPath() == arg_41_0.ikData:GetControllerPath()
		end)

		arg_35_0:OnTriggerIK(var_41_1)
		arg_35_0:Emit(var_0_0.ON_IK_STATUS_CHANGED, var_41_1:GetConfigID(), var_0_0.IK_STATUS.TRIGGER)
	end)
end
...
function var_0_0.SetIKStatus(arg_43_0, arg_43_1, arg_43_2, arg_43_3, arg_43_4)
	...
	local var_43_0 = table.shallowCopy(arg_43_2.ik_id)
	local var_43_1 = {}

	_.each(arg_43_1.iKTouchDatas, function(arg_45_0)
		local var_45_0 = arg_45_0[3]

		if var_45_0[1] == 7 then
			local var_45_1 = pg.dorm3d_ik_touch_move[var_45_0[2]]
			local var_45_2 = var_45_1.target_ik

			if not _.detect(var_43_0, function(arg_46_0)
				return arg_46_0[1] == var_45_2
			end) then
				var_43_1[var_45_2] = {
					back_time = var_45_1.back_time
				}
				...
				if var_45_1.trigger_dialogue > 0 then
					var_45_3[3] = {
						4,
						0,
						var_45_1.trigger_dialogue
					}
				end

				table.insert(var_43_0, var_45_3)
			end
		end
	end)

	local var_43_2 = _.map(var_43_0, function(arg_47_0)
		local var_47_0 = Dorm3dIK.New({
			configId = arg_47_0[1]
		})
		local var_47_1 = arg_47_0[3]
		local var_47_2 = var_47_1[1]
		local var_47_3 = switch(var_47_2, {
		...
		end, unpack(var_47_1, 2))

		table.insert(arg_43_1.readyIKLayers, var_47_0)

		arg_43_1.ikActionDict[var_47_0:GetControllerPath()] = var_47_1

		local var_47_4 = var_47_0:GetRevertTime()
		local var_47_5 = var_43_1[var_47_0:GetConfigID()]
		local var_47_6 = tobool(var_47_5)

		if var_47_6 then
			var_47_3 = var_47_5.back_time
			var_47_4 = var_47_5.back_time
			var_47_0.ignoreDrag = true
		end

		local var_47_7 = var_47_0:GetSubTargets()
		local var_47_8 = var_47_0:GetPlaneRotations()
		local var_47_9 = var_47_0:GetPlaneScales()
		local var_47_10 = _.map(_.range(#var_47_7), function(arg_55_0)
			return {
				name = var_47_7[arg_55_0][1],
				planeRot = var_47_8[arg_55_0],
				planeScale = var_47_9[arg_55_0]
			}
		end)
	...
	pg.IKMgr.GetInstance():SetIKStatus(var_43_2)

	local var_43_3 = {}

	_.each(arg_43_1.iKTouchDatas, function(arg_56_0)
		local var_56_0 = arg_56_0[1]
		local var_56_1 = pg.dorm3d_ik_touch[var_56_0]

		if #var_56_1.scene_item == 0 then
			return
		end

		if var_43_3[var_56_1.scene_item] then
			return
		end

		var_43_3[var_56_1.scene_item] = true

		local var_56_2 = arg_43_0:GetSceneItem(var_56_1.scene_item)

		if not var_56_2 then
			warning(string.format("dorm3d_ik_touch:%d without scene_item:%s", var_56_0, var_56_1.scene_item))

			return
		end

		if IsNil(GetComponent(var_56_2, typeof(UnityEngine.Collider))) then
			go(var_56_2):AddComponent(typeof(UnityEngine.BoxCollider))
		end
	end)
...
function var_0_0.ExitIKStatus(arg_58_0, arg_58_1, arg_58_2, arg_58_3, arg_58_4)
	...
	if arg_58_0.ikSwitchSkinId then
		local var_58_0 = arg_58_0:Get("apartment"):GetConfigID()

		arg_58_1:SwitchCharacterSkin(var_58_0, arg_58_0.ikSwitchSkinId)
...
function var_0_0.SetIKTimelineStatus(arg_61_0, arg_61_1, arg_61_2, arg_61_3, arg_61_4, arg_61_5)
	...
	local var_61_0 = pg.dorm3d_ik_timeline_status[arg_61_3]
	...
	table.IpairsCArray(arg_61_2:GetComponentsInChildren(typeof(UnityEngine.Collider), true), function(arg_62_0, arg_62_1)
		...
		local var_62_2 = var_62_1 and string.find(var_62_1, "Collider") or -1
		...
		var_61_1[var_62_3] = var_62_0

		setActive(var_62_0, true)
	end)

	arg_61_1.IKSettings.Colliders = var_61_1
	arg_61_1.ikTimelineMode = true

	local var_61_2 = _.map(var_61_0.ik_id, function(arg_63_0)
		...
		local var_63_4 = _.map(_.range(#var_63_1), function(arg_64_0)
			return {
	...
	local var_61_3 = arg_61_2.transform:Find("IKLayers")
	local var_61_4 = {}
	local var_61_5 = {}

	table.Foreach(DormConst.boneMap, function(arg_65_0, arg_65_1)
		var_61_5[arg_65_1] = arg_65_0
	end)

	local var_61_6 = arg_61_2.transform:GetComponentsInChildren(typeof(Transform), true)

	table.IpairsCArray(var_61_6, function(arg_66_0, arg_66_1)
		if var_61_5[arg_66_1.name] then
			var_61_4[var_61_5[arg_66_1.name]] = arg_66_1
		end
	end)
	pg.IKMgr.GetInstance():RegisterEnv(var_61_3, var_61_4)
	arg_61_0:RegisterIKFunc()
	pg.IKMgr.GetInstance():SetIKStatus(var_61_2)
...
function var_0_0.OnTriggerIK(arg_76_0, arg_76_1)
	...
	local var_76_2 = arg_76_1:GetControllerPath()
	local var_76_3 = var_76_0.ikActionDict[var_76_2]
	...
	arg_76_0:Emit(var_0_0.ON_IK_LAYER_ACTION, var_76_0, arg_76_1:GetConfigID(), var_76_3, function()
...
function var_0_0.UpdateIKTarget(arg_78_0)
	...
	if var_78_0.ikHandler then
		...
		local var_78_1 = var_78_0.ikHandler.screenPosition
		local var_78_2 = pg.UIMgr.GetInstance().uiCamera:Find("Canvas").rect
		local var_78_3 = var_78_1 - Vector2.New(var_78_2.width, var_78_2.height) * 0.5

		arg_78_0:Emit(Dorm3dIKView.SET_HAND_POSITION, var_78_3)

		if Time.time > arg_78_0.ikNextCheckStamp then
			arg_78_0.ikNextCheckStamp = arg_78_0.ikNextCheckStamp + var_0_0.IK_STATUS_DELTA

			local var_78_4 = _.detect(var_78_0.readyIKLayers, function(arg_79_0)
				return arg_79_0:GetControllerPath() == var_78_0.ikHandler.ikData:GetControllerPath()
			end)

			arg_78_0:Emit(var_0_0.ON_IK_STATUS_CHANGED, var_78_4:GetConfigID(), var_0_0.IK_STATUS.DRAG)
		end
	end
...
function var_0_0.UpdateIKTips(arg_80_0, arg_80_1)
	...
	local var_80_0 = not arg_80_0.blockIK and Time.time > arg_80_0.nextTipIKTime

	arg_80_0:Emit(Dorm3dIKView.UPDATE_TIPS, var_80_0, arg_80_1)
end

function var_0_0.CycleIKCameraGroup(arg_81_0)
	local var_81_0 = arg_81_0:GetCurrentLadyEnv()

	assert(arg_81_0:Func("GetBlackboardValue", var_81_0, "inIK"))
	seriesAsync({
		function(arg_82_0)
			pg.IKMgr.GetInstance():ResetActiveIKs()

			local var_82_0 = var_81_0.ikConfig
			local var_82_1 = var_82_0.camera_group
			local var_82_2 = pg.dorm3d_ik_status.get_id_list_by_camera_group[var_82_1]
			local var_82_3 = var_82_2[table.indexof(var_82_2, var_82_0.id) % #var_82_2 + 1]

			arg_81_0:SwitchIKConfig(var_81_0, var_82_3)
