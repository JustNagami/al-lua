local var_0_0 = class("AimIKSystem", import("view.dorm3d.Core.BaseSystem"))
	...
	if arg_15_1 then
		...
		seriesAsync({
			...
			function(arg_18_0)
				...
				local var_18_0 = arg_15_0.headAimIKComp and arg_15_0.headAimIKComp.weight or 1
...
function var_0_0.InvalidateExitProcess(arg_24_0)
	arg_24_0.exitProcessToken = (arg_24_0.exitProcessToken or 0) + 1
...
function var_0_0.GetTipShowInfo(arg_29_0, arg_29_1)
	...
	arg_29_0:Emit(Dorm3dRoomTemplateScene.EXTRA_GET_SCREEN_POSITION, var_29_1, arg_29_0.stickSceneGo.transform.position, arg_29_0.mainCamera)
