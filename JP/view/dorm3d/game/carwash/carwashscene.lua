...
function var_0_0.preload(arg_7_0, arg_7_1)
	...
	seriesAsync({
		...
		function(arg_12_0)
			local var_12_0 = pg.dorm3d_carwash[arg_7_0.contextData.groupId].character_prefab

			arg_7_0.loader:GetPrefab(var_12_0, "", function(arg_13_0)
...
function var_0_0.willExit(arg_14_0)
	...
	local var_14_0 = underscore.map(arg_14_0.sceneInfo, function(arg_15_0)
