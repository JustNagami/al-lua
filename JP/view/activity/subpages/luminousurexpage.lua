		...
		if arg_4_0.canExchange then
			pg.MsgboxMgr.GetInstance():ShowMsgBox({
				...
				onYes = function()
					...
					pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildUrRedeem(var_10_0.commodity_id, 2))
				end
			})
		else
...
function var_0_0.UpdateTask(arg_27_0, arg_27_1, arg_27_2)
	...
	local var_27_4, var_27_5 = var_0_0.taskTypeDic[var_27_1](arg_27_0, var_27_3)

	setText(arg_27_2:Find("name"), var_27_2)
	setText(arg_27_2:Find("count"), var_27_4)
	setActive(arg_27_2:Find("complete"), var_27_5 == nil)
	setActive(arg_27_2:Find("btn_go"), var_27_5 ~= nil)

	if var_27_5 then
		onButton(arg_27_0, arg_27_2:Find("btn_go"), function()
			var_27_5()
			pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildUrJump(var_27_1))
		end)
	end
end
...
function var_0_0.UpdateExchangeStatus(arg_32_0)
	...
	arg_32_0.curGoods = arg_32_0.exchangeState < arg_32_0.length and pg.activity_shop_template[arg_32_0.goodsId[arg_32_0.exchangeState]] or nil
...
function var_0_0.UpdatePtCount(arg_34_0)
	local var_34_0 = ((arg_34_0.exchangeState < arg_34_0.length and arg_34_0.ptCount < arg_34_0.curGoods.resource_num and "<color=red>" or "<color=#3689DE>") .. arg_34_0.ptCount .. "</color>/" .. (arg_34_0.exchangeState == 3 and "--" or arg_34_0.curGoods.resource_num)) .. i18n("UrExchange_Pt_charges", arg_34_0.restExchange)

	setText(arg_34_0._ptText, var_34_0)
end
