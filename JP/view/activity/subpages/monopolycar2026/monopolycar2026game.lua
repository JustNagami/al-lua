...
local function var_0_3(arg_1_0)
	...
	return var_1_0 ~= nil and var_1_0 ~= "" and var_1_0 ~= "0"
end

local function var_0_4(arg_2_0)
	local var_2_0 = pg.activity_monopolycar2026_story_event
	local var_2_1 = var_2_0.all[arg_2_0]

	return var_2_1 and var_2_0[var_2_1]
end
...
local function var_0_7(arg_5_0)
	...
	return var_5_0 ~= nil and var_5_0 ~= "" and var_5_0 ~= "0"
end
...
function var_0_0.UpdateAutoBtn(arg_9_0)
	...
	local var_9_0 = arg_9_0.useCount >= 10

	setActive(arg_9_0.btnAutolock, not var_9_0)
end
...
function var_0_0.CheckMainStorys(arg_12_0, arg_12_1)
	...
	local var_12_2 = {}
	local var_12_3 = arg_12_0.turnCnt or 1

	for iter_12_0, iter_12_1 in ipairs(var_12_0.all) do
		local var_12_4 = var_12_0[iter_12_1]

		if var_12_4 and iter_12_1 <= var_12_3 - 1 and var_0_7(var_12_4) and not var_12_1:IsPlayed(var_12_4.main_story) then
			table.insert(var_12_2, var_12_4.main_story)
		end
	end
	...
	for iter_12_2, iter_12_3 in ipairs(var_12_2) do
		table.insert(var_12_5, function(arg_14_0)
...
function var_0_0.InitMap(arg_26_0)
	...
	for iter_26_0, iter_26_1 in ipairs(pg.activity_monopolycar2026_map_event.all) do
		local var_26_0 = pg.activity_monopolycar2026_map_event[iter_26_1]
		local var_26_1 = var_26_0.event_id
		local var_26_2 = cloneTplTo(arg_26_0.tplMapCell, arg_26_0.mapContainer, tostring(var_26_1))
		local var_26_3 = Vector3(var_26_0.pos.x, var_26_0.pos.y, 0)

		var_26_2.localPosition = var_26_3

		setActive(var_26_2, false)

		local var_26_4 = pg.activity_event_monopoly_map[var_26_1].icon
		local var_26_5 = {
			col = col,
			row = row,
			mapId = var_26_1,
			...
			icon = var_26_4,
			position = var_26_3,
			flip = var_26_0.flip or 0
		}

		table.insert(arg_26_0.mapCells, var_26_5)
	end
...
function var_0_0.InitStoryMap(arg_29_0)
	...
	for iter_29_0, iter_29_1 in ipairs(pg.activity_monopolycar2026_story_event.all) do
		...
		var_29_1.localPosition = Vector3(var_29_0.pos.x, var_29_0.pos.y, 0)

		local var_29_2 = var_0_3(var_29_0)
		...
		local var_29_3 = findTF(var_29_1, "Image")
		local var_29_4 = pg.ship_skin_template[var_29_0.icon]

		GetImageSpriteFromAtlasAsync("SquareIcon/" .. var_29_4.prefab, "", var_29_3)
...
function var_0_0.UpdateStoryAward(arg_31_0)
	...
	local var_31_3 = var_31_2 and var_31_2.drop_client and var_31_2.drop_client[1]
	...
	if var_31_3 then
		...
		updateDrop(arg_31_0.storyAward, var_31_4)
	end
end
...
function var_0_0.UpdateStoriesUnlock(arg_32_0)
	...
	for iter_32_0, iter_32_1 in ipairs(arg_32_0.storyCells) do
		local var_32_2 = var_0_4(iter_32_0)
		local var_32_3 = false

		if var_0_3(var_32_2) then
			var_32_1 = var_32_1 + 1
			var_32_3 = var_32_1 <= arg_32_0.turnCnt
		end

		if var_32_3 and var_32_1 > 1 then
			local var_32_4 = var_0_5(iter_32_0)

			var_32_3 = not var_32_4 or var_32_0:IsPlayed(var_32_4.story)
		end

		setActive(iter_32_1, var_32_3)
	end
end
...
function var_0_0.UpdateStoryUI(arg_36_0)
	...
	for iter_36_0, iter_36_1 in ipairs(pg.activity_monopolycar2026_story_event.all) do
		local var_36_5 = pg.activity_monopolycar2026_story_event[iter_36_1]
		local var_36_6 = var_0_3(var_36_5)
		...
		if var_36_6 then
			local var_36_8 = var_36_3:IsPlayed(var_36_5.story)

			if var_36_8 then
				var_36_1 = var_36_1 + 1
			end

			local var_36_9 = var_36_4 <= arg_36_0.turnCnt

			if var_36_9 and var_36_4 > 1 then
				local var_36_10 = var_0_5(iter_36_0)

				var_36_9 = not var_36_10 or var_36_3:IsPlayed(var_36_10.story)
			end

			var_36_7 = var_36_9 and not var_36_8
			var_36_2 = var_36_2 or var_36_7
		else
			setActive(arg_36_0.storyCells[iter_36_0], false)
		end

		setActive(arg_36_0.storyCells[iter_36_0]:Find("tip"), var_36_7)
	end

	setText(arg_36_0.storyCnt, i18n("monopoly2026_story_award", var_36_1, var_36_0))

	local var_36_11 = var_36_0 > 0 and var_36_1 == var_36_0

	setActive(arg_36_0.storyAwardGot, var_36_11)
...
function var_0_0.UpdateCarPos(arg_37_0, arg_37_1, arg_37_2)
	if arg_37_0.model then
		...
		arg_37_0:ApplyModelFlip(arg_37_0.mapCells[arg_37_1].flip or 0)

		local var_37_0 = arg_37_0.mapCells[arg_37_1].position
		local var_37_1 = arg_37_1 + 1 > #arg_37_0.mapCells and 1 or arg_37_1 + 1
		local var_37_2 = arg_37_0.mapCells[var_37_1]

		arg_37_0.car.localPosition = var_37_0
...
function var_0_0.ApplyModelFlip(arg_40_0, arg_40_1)
	...
	if arg_40_0.modelIconTf and arg_40_0.modelIconBasePos then
		...
		if arg_40_1 == 1 then
			...
			var_40_0 = (var_40_1 and var_40_1.rect.height or 0) + (var_40_2 and var_40_2.rect.height or 0)
		end

		local var_40_3 = arg_40_0.modelIconBasePos

		arg_40_0.modelIconTf.localPosition = Vector3(var_40_3.x, var_40_3.y - var_40_0, var_40_3.z)
	end

	if arg_40_0.modelArrTf and arg_40_0.modelArrBaseScale then
		local var_40_4 = arg_40_0.modelArrBaseScale
		local var_40_5 = arg_40_1 == 1 and -1 or var_40_4.y

		arg_40_0.modelArrTf.localScale = Vector3(var_40_4.x, var_40_5, var_40_4.z)
	end
end
...
function var_0_0.GetCarMoveType(arg_41_0, arg_41_1, arg_41_2, arg_41_3)
	local var_41_0
	local var_41_1
	local var_41_2 = arg_41_3 and stateWalkB or stateStandB
	local var_41_3 = Vector3(1, 1, 1)
