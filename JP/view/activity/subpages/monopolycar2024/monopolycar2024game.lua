...
function var_0_0.UpdateActData(arg_6_0, arg_6_1)
	...
	local var_6_1 = arg_6_1.data1

	arg_6_0.totalCnt = math.ceil((var_6_0 - var_6_1) / 86400) * arg_6_1:getDataConfig("daily_time") + (arg_6_1.data1_list[1] or 0)
	...
	for iter_21_0, iter_21_1 in ipairs(var_0_6) do
		table.insert(var_21_0, function(arg_22_0)
			PoolMgr.GetInstance():GetSpineChar(iter_21_1, true, function(arg_23_0)
				...
				var_23_0.transform.localScale = Vector3(0.6, 0.6, 1)
				var_23_0.transform.localPosition = var_0_7[iter_21_0]

				var_23_0.transform:SetParent(arg_21_0._tf, false)
				var_23_0:GetComponent(typeof(SpineAnimUI)):SetAction("stand", 0)
...
function var_0_0.SetUpMainLoop(arg_24_0)
	if not arg_24_0.handle then
		arg_24_0.handle = UpdateBeat:CreateListener(arg_24_0.Update, arg_24_0)
	end
...
function var_0_0.RegisterUI(arg_27_0)
	...
	onButton(arg_27_0, arg_27_0.register, function()
		...
		arg_27_0.awardWindow:ExecuteAction("Flush", arg_27_0.lapReward, var_32_0, arg_27_0.titles)
	end, SFX_PANEL)
...
function var_0_0.UpdateAutoBtn(arg_35_0)
	...
	setActive(arg_35_0.btnAutoSel, var_35_0)
...
function var_0_0.CheckSpStory(arg_50_0, arg_50_1, arg_50_2)
	local var_50_0 = arg_50_0.mapCells[arg_50_0.pos]
	...
	local var_50_1 = var_50_0.mapId
	local var_50_2 = pg.activity_event_monopoly_map[var_50_1].ship_event
	local var_50_3 = _.detect(var_50_2, function(arg_51_0)
	...
	local var_50_5 = var_50_4[math.random(1, #var_50_4)]
	...
	if arg_50_0.autoFlag then
		pg.NewStoryMgr.GetInstance():ForceAutoPlay(var_50_5, var_50_6, true, true)
	else
		pg.NewStoryMgr.GetInstance():Play(var_50_5, var_50_6, true)
	end
end
...
function var_0_0.CheckEvent(arg_66_0, arg_66_1)
	...
	seriesAsync({
		function(arg_67_0)
			local var_67_0 = pg.activity_event_monopoly_event[arg_66_0.effectId].story

			if not var_67_0 or tonumber(var_67_0) == 0 then
				arg_67_0()
			...
			if arg_66_0.autoFlag then
				pg.NewStoryMgr.GetInstance():ForceAutoPlay(var_67_0, arg_67_0, true, true)
			else
				pg.NewStoryMgr.GetInstance():Play(var_67_0, arg_67_0, true, true)
			end
		end,
		function(arg_68_0)
...
function var_0_0.CheckCountStory(arg_75_0, arg_75_1)
	...
	local var_75_2 = _.detect(var_75_1, function(arg_76_0)
		return arg_76_0[1] == var_75_0
	end)

	if var_75_2 then
		pg.NewStoryMgr.GetInstance():Play(var_75_2[2], arg_75_1)
	else
		arg_75_1()
	end
end
...
function var_0_0.CheckFinishedForSpEvent(arg_78_0, arg_78_1)
	...
	local var_78_2 = arg_78_0:GetUnReadDialogue(var_78_1)

	arg_78_0.bubblePage:Show(arg_78_0.actId, arg_78_1, var_78_2)
end
...
function var_0_0.CheckRepeatCharForSpEvent(arg_80_0, arg_80_1)
	...
	local var_80_0 = _.select(arg_80_0.spEvents[arg_80_1] or {}, function(arg_81_0)
		return arg_81_0[1] == 5
	end)
	...
	local var_80_1 = var_80_0[1][2] or {}
	local var_80_2 = arg_80_0:GetUnReadDialogue(var_80_1)

	arg_80_0.bubblePage:Show(arg_80_0.actId, arg_80_1, var_80_2)
end
...
function var_0_0.CheckRollResultForSpEvent(arg_83_0, arg_83_1, arg_83_2)
	...
	local var_83_1 = _.select(arg_83_0.spEvents[arg_83_2] or {}, function(arg_84_0)
	...
	local var_83_2 = var_83_1[1][2] or {}
	local var_83_3 = arg_83_0:GetUnReadDialogue(var_83_2)

	arg_83_0.bubblePage:Show(arg_83_0.actId, arg_83_2, var_83_3)
end
...
function var_0_0.ReadyMoveCar(arg_89_0, arg_89_1, arg_89_2)
	...
	for iter_89_0 = 1, #arg_89_1 do
		if arg_89_0:CheckPathTurn(arg_89_1[iter_89_0]) then
			table.insert(var_89_2, arg_89_0.mapCells[arg_89_1[iter_89_0]].position)
...
function var_0_0.MoveCar(arg_93_0)
	...
	local var_93_0 = math.abs(arg_93_0.targetPosition.x - arg_93_0.car.localPosition.x)
	local var_93_1 = math.abs(arg_93_0.targetPosition.y - arg_93_0.car.localPosition.y)
	...
	arg_93_0.speedX = math.abs(arg_93_0.speedX + arg_93_0.baseASpeedX) > math.abs(arg_93_0.baseSpeedX) and arg_93_0.baseSpeedX or arg_93_0.speedX + arg_93_0.baseASpeedX
	arg_93_0.speedY = math.abs(arg_93_0.speedY + arg_93_0.baseASpeedY) > math.abs(arg_93_0.baseSpeedY) and arg_93_0.baseSpeedY or arg_93_0.speedY + arg_93_0.baseASpeedY

	local var_93_2 = arg_93_0.car.localPosition

	arg_93_0.car.localPosition = Vector3(var_93_2.x + arg_93_0.speedX, var_93_2.y + arg_93_0.speedY, 0)
end

function var_0_0.CheckPathTurn(arg_94_0, arg_94_1)
	local var_94_0 = arg_94_1 + 1 > #arg_94_0.mapCells and 1 or arg_94_1 + 1
	local var_94_1 = arg_94_1 - 1 < 1 and #arg_94_0.mapCells or arg_94_1 - 1
...
function var_0_0.CheckPickCharacter(arg_95_0, arg_95_1)
	if arg_95_0.selectedShipId == 0 or #arg_95_0.pickCharList == 0 then
		local function var_95_0(arg_96_0)
			...
			arg_95_0:emit(MonopolyCar2024Mediator.ON_PICK, arg_95_0.actId, var_96_0, function(arg_97_0)
		...
		local var_95_1 = _.map(arg_95_0.pickCharList, function(arg_100_0)
			return table.indexof(arg_95_0.pickableShipId, arg_100_0)
		end)

		arg_95_0.pickPage:ExecuteAction("Show", arg_95_0.actId, var_95_1, arg_95_0.autoFlag, arg_95_0.turnCnt, var_95_0)
	else
		arg_95_1()
	end
end
...
function var_0_0.InitMap(arg_101_0)
	...
	for iter_101_0 = 1, #var_0_4 do
		...
		for iter_101_1 = 1, #var_101_2 do
			...
			if var_101_4 > 0 then
				local var_101_5 = cloneTplTo(arg_101_0.tplMapCell, arg_101_0.mapContainer, tostring(var_101_4))
				local var_101_6 = Vector2(var_0_1 * var_101_3 + var_101_1.x, -var_0_2 * var_101_3 + var_101_1.y)

				var_101_5.localPosition = var_101_6

				local var_101_7 = pg.activity_event_monopoly_map[var_101_4].icon
				local var_101_8 = GetSpriteFromAtlas("ui/MonopolyCar2024_atlas", var_101_7)

				var_101_5:GetComponent(typeof(Image)).sprite = var_101_8

				var_101_5:GetComponent(typeof(Image)):SetNativeSize()
				...
				table.insert(arg_101_0.mapCells, var_101_9)
			end
		end
	end
...
function var_0_0.UpdateCarPos(arg_105_0, arg_105_1, arg_105_2)
	if arg_105_0.model then
		...
		arg_105_0.anim:SetAction(var_105_3, 0)
...
function var_0_0.GetCarMoveType(arg_106_0, arg_106_1, arg_106_2, arg_106_3)
	...
	for iter_106_0 = 1, #var_0_4 do
		...
		for iter_106_1 = 1, #var_106_2 do
			local var_106_3 = var_106_2[iter_106_1]

			if var_106_3 == arg_106_1 then
				var_106_0 = {
					x = iter_106_1,
					y = iter_106_0
				}
	...
	if var_106_1.y > var_106_0.y then
		var_106_4 = arg_106_3 and var_0_11 or var_0_9
		var_106_5 = Vector3(var_0_5, var_0_5, var_0_5)
	elseif var_106_1.y < var_106_0.y then
		var_106_4 = arg_106_3 and var_0_10 or var_0_8
		var_106_5 = Vector3(var_0_5, var_0_5, var_0_5)
...
function var_0_0.Dispose(arg_109_0)
	for iter_109_0, iter_109_1 in pairs(arg_109_0.cheerLeaders or {}) do
