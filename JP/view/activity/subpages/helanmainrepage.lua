...
function var_0_0.updateUI(arg_7_0)
	local var_7_0 = false
	local var_7_1, var_7_2 = arg_7_0.timeMgr:inTime(ShopConst.GetShopConfig(var_0_1).time)
	local var_7_3
	...
	arg_7_0.btnFuncList = {
		...
		fight = function(arg_12_0)
			onButton(arg_7_0, arg_12_0, function()
				local var_13_0 = pg.activity_template[arg_7_0.activity.id].config_client.fightLinkActID

				if var_13_0 then
					arg_7_0:emit(ActivityMediator.SKIP_ACTIVITY_MAP, var_13_0)
				else
