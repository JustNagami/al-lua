...
function var_0_0.OnFirstFlush(arg_4_0)
	...
	onScroll(arg_4_0, arg_4_0.scrollTF, function(arg_8_0)
		setActive(arg_4_0.pageSignDownTF, arg_8_0.y > 0.01)
		setActive(arg_4_0.pageSignUpTF, arg_8_0.y < 0.99)
	end)
end

function var_0_0.OnUpdateFlush(arg_9_0)
	for iter_9_0 = 1, #arg_9_0.config.front_drops do
		local var_9_0 = arg_9_0.config.front_drops[iter_9_0]
		local var_9_1 = arg_9_0.content:Find("award" .. tostring(iter_9_0))
		local var_9_2 = var_9_1:Find("btnAchieve")
		local var_9_3 = var_9_1:Find("achieve_sign")
		local var_9_4 = _.include(arg_9_0.activity.data1_list, var_9_0[1])

		if var_9_4 then
			var_9_1.transform:SetAsLastSibling()
		end

		setGray(var_9_1:Find("limit_label"), var_9_4)
		setGray(var_9_1:Find("items"), var_9_4)
		setActive(var_9_3, var_9_4)
		setActive(var_9_2, arg_9_0.shareData.player.level >= var_9_0[1] and not var_9_4)
	end
end
