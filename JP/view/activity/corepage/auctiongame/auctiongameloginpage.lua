...
function var_0_0.OnInit(arg_1_0)
	...
	for iter_1_0 = 1, arg_1_0.sign.childCount do
		local var_1_0 = arg_1_0:getItem(iter_1_0)
...
function var_0_0.OnFirstFlush(arg_3_0)
	onButton(arg_3_0, arg_3_0.btnGet, function()
		...
		local var_4_2 = pg.gameset.urpt_chapter_max.description[1]
		local var_4_3 = LOCK_UR_SHIP and 0 or getProxy(BagProxy):GetLimitCntById(var_4_2)
		local var_4_4, var_4_5 = arg_3_0:checkCanGetList()

		if table.isEmpty(var_4_5) then
			return
		end

		local var_4_6, var_4_7 = Task.StaticJudgeOverflow(var_4_1.gold, var_4_1.oil, var_4_3, true, true, var_4_4)
		...
		seriesAsync(var_4_0, function()
			arg_3_0:emit(ActivityMediator.ON_TASK_SUBMIT_ONESTEP, var_4_5)
		end)
	end)
end
...
function var_0_0.checkCanGetList(arg_7_0)
	...
	for iter_7_0, iter_7_1 in ipairs(arg_7_0.taskGroup[1]) do
		local var_7_3 = arg_7_0.taskProxy:getTaskById(iter_7_1)

		if var_7_3 and var_7_3:getTaskStatus() == 1 then
			local var_7_4 = pg.task_data_template[iter_7_1]

			for iter_7_2, iter_7_3 in ipairs(var_7_4.award_display) do
				var_7_2(iter_7_3)
			end
...
function var_0_0.OnUpdateFlush(arg_9_0)
	...
	for iter_9_0, iter_9_1 in ipairs(arg_9_0.items) do
		local var_9_1 = arg_9_0.taskGroup[1][iter_9_0]
		local var_9_2 = pg.task_data_template[var_9_1]
		local var_9_3 = Drop.Create(var_9_2.award_display[1])

		updateDrop(iter_9_1.item, var_9_3)
		onButton(arg_9_0, iter_9_1.frame, function()
			arg_9_0:emit(BaseUI.ON_DROP, var_9_3)
		end, SFX_PANEL)

		local var_9_4 = arg_9_0.taskProxy:getTaskById(var_9_1) or arg_9_0.taskProxy:getFinishTaskById(var_9_1)
		local var_9_5 = not not var_9_4
		local var_9_6 = var_9_4 and var_9_4:getTaskStatus() == 1
		local var_9_7 = var_9_4 and var_9_4:getTaskStatus() == 2

		var_9_0 = var_9_0 or var_9_6

		setActive(iter_9_1.lock, not var_9_5)
		setActive(iter_9_1.get, var_9_6 and not var_9_7)
		setActive(iter_9_1.got, var_9_7)
		onButton(arg_9_0, iter_9_1.get, function()
			local var_11_0 = {}
			local var_11_1 = var_9_2.award_display
			local var_11_2 = getProxy(PlayerProxy):getRawData()
			local var_11_3 = pg.gameset.urpt_chapter_max.description[1]
			local var_11_4 = LOCK_UR_SHIP and 0 or getProxy(BagProxy):GetLimitCntById(var_11_3)
			local var_11_5, var_11_6 = Task.StaticJudgeOverflow(var_11_2.gold, var_11_2.oil, var_11_4, true, true, var_11_1)
			...
			seriesAsync(var_11_0, function()
				arg_9_0:emit(ActivityMediator.ON_TASK_SUBMIT, var_9_4)
			end)
		end, SFX_PANEL)
	end
...
function var_0_0.setPlayerInfo(arg_15_0)
	...
	local var_15_1 = var_15_0:GetShipPhantomMarks()[1]
	local var_15_2 = getProxy(BayProxy):GetShipPhantom(var_15_1)

	GetImageSpriteFromAtlasAsync("SquareIcon/" .. var_15_2:getPainting(), "", arg_15_0.playerIcon)
	setText(arg_15_0.playerName, var_15_0.name)
