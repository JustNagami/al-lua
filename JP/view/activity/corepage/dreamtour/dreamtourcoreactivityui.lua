			...
			elseif not arg_2_0.pageDic[var_3_0.id] then
				...
				if arg_2_0.pageDic[var_3_0.id] ~= nil then
					...
					onToggle(arg_2_0, arg_3_2, function(arg_5_0)
						local var_5_0 = arg_3_2:Find("off")
...
function var_0_0.verifyTabs(arg_8_0, arg_8_1)
	local var_8_0 = arg_8_0.activities[arg_8_0:getActivityIndex(arg_8_1) or arg_8_0:getActivityIndex(arg_8_0:GetActiveActivity()) or 1]

	if var_8_0 == nil then
		return
	end

	local var_8_1 = var_8_0:getConfig("is_show")
	local var_8_2 = arg_8_0.tabs:Find(tostring(var_8_1))
