...
function var_0_0.didEnter(arg_3_0, arg_3_1)
	...
	local var_3_4 = var_3_0:GetRoundEventAndBidInfoList()

	for iter_3_0 = 1, var_3_0:GetRound() - 1 do
		local var_3_5 = var_3_4[iter_3_0][var_3_1.id]
		...
		arg_3_0.itemViewList[iter_3_0]:didEnter(var_3_5)
	end
end
...
function var_0_0.willExit(arg_6_0)
	if not IsNil(arg_6_0.uiFrameGo) then
		...
		if var_6_0.childCount > 0 then
			...
			local var_6_2 = var_6_1.gameObject.name

			PoolMgr.GetInstance():ReturnPrefab("IconFrame/" .. var_6_2, var_6_2, var_6_1.gameObject)
		end
	end
