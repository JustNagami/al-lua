...
function var_0_0.didEnter(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	if var_3_2.information_bar == 1 then
		setText(arg_3_0.uiResultText, string.format("<color=%s>%s</color>", var_3_3, var_3_2.describe))
	else
		local var_3_4 = arg_3_1.eventData.value

		if var_3_2.type == AuctionGameConst.EVENT_TYPE.MAX_RARITY then
			var_3_4 = i18n("auction_game_rarity_" .. var_3_4)
		elseif var_3_2.type == AuctionGameConst.EVENT_TYPE.RARITY_ITEMS_CELL_COUNT then
			var_3_4 = var_3_4 / 100
		else
			var_3_4 = StringHelper.ForamtNumber(var_3_4)
		end
