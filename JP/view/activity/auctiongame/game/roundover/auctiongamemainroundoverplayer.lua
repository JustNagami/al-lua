...
function var_0_0.didEnter(arg_3_0, arg_3_1)
	...
	if var_3_1.icon == AuctionGameConst.TB_NPC_ID then
		var_3_2 = pg.ship_skin_template[var_3_1.icon].prefab
	else
		var_3_2 = Ship.New({
	...
	local var_3_4 = var_3_0:GetRound()
	local var_3_5 = var_3_1.id
	local var_3_6 = var_3_0:GetRoundEventAndBidInfo(var_3_4, var_3_5) or {}

	setText(arg_3_0.uiBidText, StringHelper.ForamtNumber(var_3_6.bidValue))
	...
	elseif AuctionGameTools.IsBidSuccess() then
		...
		setActive(arg_3_0.uiSuccessStateGo, var_3_6.state == 1)
	else
		setActive(arg_3_0.uiFailStateGo, false)
		setActive(arg_3_0.uiSuccessStateGo, false)
	end
	...
	local var_3_7 = var_3_0:GetRound()
	local var_3_8 = var_3_6.eventID or 501
	local var_3_9 = pg.auction_event[var_3_8]

	LoadSpriteAsync(var_3_9.icon, function(arg_7_0)
...
function var_0_0.willExit(arg_8_0)
	if not IsNil(arg_8_0.uiFrameGo) then
		...
		if var_8_0.childCount > 0 then
			...
			local var_8_2 = var_8_1.gameObject.name

			PoolMgr.GetInstance():ReturnPrefab("IconFrame/" .. var_8_2, var_8_2, var_8_1.gameObject)
		end
	end
