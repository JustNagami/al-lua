...
function var_0_0.MakeItemInList(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = tf(instantiate(var_9_0))

	if arg_9_2 == CrossRoadGameConst.BING_MIAN then
		local var_9_2 = var_9_1:GetComponent(typeof(RectTransform))
		local var_9_3 = var_9_2.sizeDelta

		var_9_3.x = CrossRoadGameConst.BINGMIAN_DISTANCE
		var_9_2.sizeDelta = var_9_3
	end

	setParent(var_9_1, arg_9_0.sceneContent, false)
