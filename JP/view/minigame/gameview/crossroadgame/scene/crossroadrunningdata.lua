...
function var_0_0.InitAllRoads(arg_3_0)
	local function var_3_0(arg_4_0, arg_4_1, arg_4_2)
		...
		local var_4_1 = var_4_0:Find("startPoint")
		local var_4_2 = var_4_0:Find("midPoint")
		local var_4_3 = var_4_0:Find("endPoint")
...
function var_0_0.OutRoleUnion(arg_42_0, arg_42_1, arg_42_2)
	...
	if var_42_0 == var_42_1 then
		...
		for iter_42_0 = var_42_2 + 1, #arg_42_0._roleList do
			...
			if var_42_4:GetRunState() == CrossRoadGameConst.SHIP_STATE.crash then
				-- block empty
			elseif arg_42_0:FindRoleFa(var_42_4) == var_42_0 then
				var_42_4:SetFatherID(var_42_2)
			else
				break
			end
		end
...
function var_0_0.InRoleUnion(arg_43_0, arg_43_1, arg_43_2)
	...
	local var_43_1 = arg_43_0:FindRoleFa(arg_43_1)
	local var_43_2 = arg_43_0:FindRoleFa(arg_43_2)

	if var_43_1 == var_43_2 then
		return
	end

	arg_43_1:SetFatherID(var_43_2)
end
...
function var_0_0.CheckCarCarshRole(arg_45_0, arg_45_1, arg_45_2)
	...
	return CrossRoadGameHelper:IsRectCross(var_45_0, var_45_4, var_45_2, var_45_5, var_45_6, var_45_7, var_45_8, var_45_9)
end
...
function var_0_0.CheckCarCarshPlayer(arg_46_0, arg_46_1)
	...
	return CrossRoadGameHelper:IsRectCross(var_46_0, var_46_4, var_46_2, var_46_5, var_46_7, var_46_8, var_46_9, var_46_10)
end
