...
function var_0_0.UpdateGood(arg_9_0, arg_9_1, arg_9_2)
	...
	arg_9_2.name = var_9_0.id

	IslandShopPage.StaticUpdateCommodityTpl(arg_9_2, var_9_0)
...
function var_0_0.Flush(arg_11_0)
	...
	local var_11_0 = arg_11_0.shopIds[arg_11_0.showPhase or 1]

	arg_11_0.displayShop = arg_11_0.shops[var_11_0]
	...
	local var_11_2 = arg_11_0.displayShop:GetExistTime()
	local var_11_3 = var_11_1:inTime(var_11_2)

	setActive(arg_11_0.lockTF, not var_11_3)

	if not var_11_3 then
		local var_11_4 = var_11_1:DescDateFromConfig(var_11_2[1]) .. "~" .. var_11_1:DescDateFromConfig(var_11_2[2])

		setText(arg_11_0.lockTF:Find("layout/Text"), var_11_4)
	end
