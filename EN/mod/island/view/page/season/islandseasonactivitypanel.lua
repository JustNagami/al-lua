...
function var_0_0.verifyTabs(arg_9_0, arg_9_1)
	if #arg_9_0.activities > 0 then
		...
		local var_9_1 = arg_9_0.rtTabsContent:GetChild(var_9_0 - 1)

		triggerToggle(var_9_1, true)
	end
end
...
function var_0_0.updateActivity(arg_16_0, arg_16_1)
	local var_16_0 = ActivityConst.IslandPageIdLinks[arg_16_1.id]

	if var_16_0 then
		for iter_16_0, iter_16_1 in ipairs(var_16_0) do
			arg_16_0:_updateActivity(getProxy(ActivityProxy):getActivityById(iter_16_1))
		end
	else
...
function var_0_0.selectActivity(arg_24_0, arg_24_1)
	...
	if not arg_24_0.activity or arg_24_0.activity.id ~= arg_24_1.id then
		local var_24_1 = arg_24_0.pageDic[arg_24_1.id]

		assert(var_24_1, "找不到id:" .. arg_24_1.id .. "的活动页，请检查")
	...
	parallelAsync(var_24_0, function()
		...
		var_29_0:ActionInvoke("ShowOrHide", true)
		var_29_0:ActionInvoke("Flush", arg_24_0.activity)
	end)
end
