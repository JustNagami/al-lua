...
function var_0_0.OnInit(arg_3_0)
	...
	arg_3_0.toggleList:make(function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == UIItemList.EventUpdate then
			...
			setText(arg_5_2:Find("name/Text"), var_5_3:getName())
...
function var_0_0.UpdateActivity(arg_9_0, arg_9_1)
	...
	local var_9_0 = arg_9_0.activity:GetDrawCount()
	local var_9_1 = arg_9_0.activity:GetNextCountAwardTimes() or 0

	setText(arg_9_0.rtCountWord, i18n("island_draw_choice") .. string.format("%d/%d", var_9_0, var_9_1))
