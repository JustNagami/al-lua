...
function var_0_0.Ctor(arg_1_0, arg_1_1)
	...
	arg_1_0.forceDormLine = defaultValue(arg_1_1.forceDormLine, false)
...
local function var_0_3(arg_15_0)
	...
	if arg_15_0.charScale then
		var_15_0 = Vector2(arg_15_0.charScale[1], arg_15_0.charScale[2])
	else
		var_15_0 = Vector2(1, 1)
	end
...
function var_0_0.GenStyleData(arg_16_0, arg_16_1)
	...
	return {
		mode = arg_16_1.mode,
		text = HXSet.hxLan(arg_16_1.text or ""),
		counsellor = var_16_0,
		scale = arg_16_1.dir == 1 and Vector3(1, 1, 1) or Vector3(-1, 1, 1),
		position = Vector2(arg_16_1.posX or 0, arg_16_1.posY or 0),
		handPosition = arg_16_1.handPos and Vector3(arg_16_1.handPos.x, arg_16_1.handPos.y, 0) or Vector3(-267, -96, 0),
		handAngle = arg_16_1.handPos and Vector3(0, 0, arg_16_1.handPos.w or 0) or Vector3(0, 0, 0)
	}
end

function var_0_0.GetHighlightName(arg_17_0)
	if arg_17_0:GetDialogueType() == var_0_0.DIALOGUE_DORM or arg_17_0.forceDormLine then
		return "wShowArea4"
