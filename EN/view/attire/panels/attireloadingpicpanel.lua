...
function var_0_0.addListener(arg_7_0)
	onButton(arg_7_0, arg_7_0.openShowBtn, function()
		...
		pg.m02:sendNotification(GAME.UPDATE_LOADING_PIC, var_8_2)
	end, SFX_PANEL)
	onButton(arg_7_0, arg_7_0.closeShowBtn, function()
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			...
			onYes = function()
				...
				pg.m02:sendNotification(GAME.UPDATE_LOADING_PIC, var_11_2)
			end
		})
		...
		pg.m02:sendNotification(GAME.UPDATE_LOADING_PIC, var_10_0)
	end, SFX_PANEL)
	...
	function arg_7_0.lScrollRectSC.onUpdateItem(arg_15_0, arg_15_1)
		...
		local var_15_0 = arg_7_0:getCurPicInfoForShowByIndex(arg_15_0)

		arg_7_0:updatePicTpl(arg_15_1, var_15_0)
		onButton(arg_7_0, arg_15_1, function()
			if arg_7_0.isEditMode then
				if arg_7_0:isPicInfoSelected(var_15_0) then
					arg_7_0:removePicInfoFromEditList(var_15_0)
				else
					arg_7_0:addPicInfoToEditList(var_15_0)
				end

				arg_7_0:updatePicTpl(arg_15_1, var_15_0)
				arg_7_0:updateCountText()
			else
				arg_7_0:openPicViewLayer(var_15_0)
			end
		end, SFX_PANEL)
	end
	...
	onButton(arg_7_0, arg_7_0.confirmBtn, function()
		...
		pg.m02:sendNotification(GAME.UPDATE_LOADING_PIC, var_29_4)
	end, SFX_PANEL)
...
function var_0_0.updateCountText(arg_35_0)
	...
	setText(arg_35_0.countNumText, string.format("%d/%d", var_35_1, AppreciatePicConst.MAX_COUNT))
end
...
function var_0_0.setImage(arg_42_0, arg_42_1, arg_42_2)
	...
	local var_42_1 = GetFileName(var_42_0)
	local var_42_2 = GetComponent(arg_42_1, typeof(Image)).sprite

	if not IsNil(var_42_2) then
		local var_42_3 = var_42_2.name

		if string.lower(var_42_3) ~= string.lower(var_42_1) then
			arg_42_0.resLoader:LoadSprite(var_42_0, var_42_1, arg_42_1, false)
		end
	else
		arg_42_0.resLoader:LoadSprite(var_42_0, var_42_1, arg_42_1, false)
	end
...
function var_0_0.updateCurPicTplList(arg_46_0)
	for iter_46_0 = 1, arg_46_0.listTF.childCount do
		...
		if var_46_1 ~= "-1" then
			...
			arg_46_0:updatePicTpl(var_46_0, var_46_3)
		end
	end
end
...
function var_0_0.updateFilterBtn(arg_48_0)
	local var_48_0 = findTF(arg_48_0.openFilterBtn, "ALL")
	local var_48_1 = findTF(arg_48_0.openFilterBtn, "Default")
	local var_48_2 = findTF(arg_48_0.openFilterBtn, "Gallery")
	local var_48_3 = findTF(arg_48_0.openFilterBtn, "Manga")
	local var_48_4 = findTF(arg_48_0.openFilterBtn, "Selected")

	setActive(var_48_0, arg_48_0.curFilterMode == var_0_0.FilterMode.All)
	setActive(var_48_1, arg_48_0.curFilterMode == var_0_0.FilterMode.Default)
	setActive(var_48_2, arg_48_0.curFilterMode == var_0_0.FilterMode.Gallery)
	setActive(var_48_3, arg_48_0.curFilterMode == var_0_0.FilterMode.Manga)
	setActive(var_48_4, arg_48_0.curFilterMode == var_0_0.FilterMode.Selected)
end
...
function var_0_0.initPicInfoList(arg_49_0)
	...
	for iter_49_0, iter_49_1 in ipairs(pg.gallery_config.all) do
		local var_49_1 = GalleryConst.GetGalleryPicPathByID(iter_49_1)

		if checkABExist(var_49_1) then
			local var_49_2 = AppreciatePicConst.createPicInfo(AppreciatePicConst.TYPE_GALLERY, iter_49_1)
	...
	for iter_49_2, iter_49_3 in ipairs(pg.cartoon.all) do
		local var_49_3 = MangaConst.GetMangaPicPathByID(iter_49_3)

		if checkABExist(var_49_3) then
			local var_49_4 = AppreciatePicConst.createPicInfo(AppreciatePicConst.TYPE_MANGA, iter_49_3)
...
function var_0_0.isDefaultPicInfo(arg_53_0, arg_53_1)
	...
	local var_53_1 = table.contains(AppreciatePicConst.getDefaultGalleryPicIDList(), arg_53_1.id)

	return var_53_0 and var_53_1
end
...
function var_0_0.getDefaultPicInfoList(arg_61_0)
	local var_61_0 = AppreciatePicConst.getDefaultGalleryPicIDList()
	local var_61_1 = {}

	for iter_61_0, iter_61_1 in ipairs(var_61_0) do
		local var_61_2 = GalleryConst.GetGalleryPicPathByID(iter_61_1)

		if checkABExist(var_61_2) then
			local var_61_3 = AppreciatePicConst.createPicInfo(AppreciatePicConst.TYPE_GALLERY, iter_61_1)

			table.insert(var_61_1, var_61_3)
		end
	end
