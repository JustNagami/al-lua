...
function var_0_0.didEnter(arg_4_0, arg_4_1)
	...
	setText(arg_4_0.uiBidText, StringHelper.ForamtNumber(arg_4_1.bidValue or 0))

	local var_4_0 = arg_4_1.eventID

	if var_4_0 ~= nil then
		local var_4_1 = pg.auction_event[var_4_0]

		LoadSpriteAsync(var_4_1.icon, function(arg_5_0)
