...
function var_0_0.didEnter(arg_4_0, arg_4_1)
	...
	PoolMgr.GetInstance():GetPrefab("emoji/" .. var_4_0.pic, var_4_0.pic, true, function(arg_5_0)
...
function var_0_0.ReturnEmoji(arg_6_0)
	...
	if not IsNil(arg_6_0.emojiTf) then
		local var_6_0 = pg.emoji_template[arg_6_0.id]

		PoolMgr.GetInstance():ReturnPrefab("emoji/" .. var_6_0.pic, var_6_0.pic, arg_6_0.emojiTf)
