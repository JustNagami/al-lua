...
function var_0_0.RefreshEstimate(arg_5_0)
	...
	for iter_5_0, iter_5_1 in pairs(var_5_0:GetStoreItemDataList()) do
	...
	setText(arg_5_0.uiEstimateText, i18n("auction_store_estimate", StringHelper.ForamtNumber(var_5_1), StringHelper.ForamtNumber(var_5_2)))
end
