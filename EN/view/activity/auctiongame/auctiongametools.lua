...
function var_0_0.GetLastLocationSelectedID()
	local var_3_0 = getProxy(PlayerProxy):getPlayerId()
	local var_3_1 = pg.auction_session.all[1]
	local var_3_2 = PlayerPrefs.GetInt(string.format("AUCTION_GAME_SELECTED_LOCATION_%s", var_3_0), var_3_1)

	if pg.auction_session[var_3_2] == nil then
		var_3_2 = pg.auction_session.all[1]
	end

	local var_3_3 = var_0_0.GetCurrencyCnt()

	for iter_3_0 = table.keyof(pg.auction_session.all, var_3_2), 1, -1 do
		local var_3_4 = pg.auction_session.all[iter_3_0]

		if var_3_3 >= pg.auction_session[var_3_4].threshold then
			return var_3_4
		end
	end
...
function var_0_0.SetLastLocationSelectedID(arg_4_0)
	local var_4_0 = getProxy(PlayerProxy):getPlayerId()

	PlayerPrefs.SetInt(string.format("AUCTION_GAME_SELECTED_LOCATION_%s", var_4_0), arg_4_0)
end
...
function var_0_0.GetPlayerNoSortList(arg_7_0)
	...
	for iter_7_0, iter_7_1 in ipairs(var_7_0:GetPlayerList()) do
		local var_7_4 = iter_7_1.id
		local var_7_5 = (var_7_1[var_7_4] or {}).bidValue or 0

		var_7_3[var_7_4] = {
			num = 0,
			playerID = var_7_4,
			bidValue = var_7_5,
			bidOrder = table.keyof(var_7_2, var_7_4) or #var_7_2 + 1,
			index = iter_7_0
		}
	end
	...
	for iter_7_4, iter_7_5 in ipairs(var_7_6) do
		if var_7_7 and iter_7_5.data.bidValue == var_7_7.bidValue and iter_7_5.data.bidOrder == var_7_7.bidOrder then
			iter_7_5.data.num = var_7_8
		else
			iter_7_5.data.num = iter_7_4
			var_7_8 = iter_7_4
		end

		var_7_7 = iter_7_5.data
	end
...
function var_0_0.GetRevealItemEffectName(arg_12_0)
	local var_12_0 = pg.auction_collection[arg_12_0]
	local var_12_1 = var_12_0.rarity
	local var_12_2 = var_12_0.contour
	local var_12_3 = {
		"hui",
		"lan",
		"zi",
	...
	return string.format("effect/vx_auctiongame_icon%sx%s_%s", var_12_2[1], var_12_2[2], var_12_3[var_12_1])
end

function var_0_0.RefreshItemDataByEvent(arg_13_0)
	local var_13_0 = arg_13_0.event_id
	local var_13_1 = pg.auction_event[var_13_0]

	if var_13_1 == nil then
		return
	end

	print("触发事件:", var_13_0, var_13_1.describe)

	local var_13_2 = getProxy(AuctionGameProxy)
	local var_13_3 = var_13_2:GetStoreItemDataList()
	local var_13_4 = var_13_1.group == AuctionGameConst.EVENT_TYPE_GROUP.COMMON

	switch(var_13_1.type, {
		[AuctionGameConst.EVENT_TYPE.ITEM_CONTOUR_BY_SIZE] = function()
			for iter_14_0, iter_14_1 in ipairs(arg_13_0.item_list) do
				...
				if var_13_3[var_14_0] == nil then
					var_13_3[var_14_0] = AuctionGameStoreItemData.New(iter_14_1)
				else
					var_13_3[var_14_0]:UpdateContour(iter_14_1.pos)
				end

				local var_14_1 = var_13_1.config_data

				var_13_3[var_14_0]:InitContour(var_14_1[1], var_14_1[2])
				var_13_3[var_14_0]:SetShowContour()
				var_13_3[var_14_0]:SetRevealFlag(true)
			end
		end,
		[AuctionGameConst.EVENT_TYPE.ITEM_POSITION] = function()
			for iter_15_0, iter_15_1 in ipairs(arg_13_0.item_list) do
				...
				if var_13_3[var_15_0] == nil then
					var_13_3[var_15_0] = AuctionGameStoreItemData.New(iter_15_1)
				else
					var_13_3[var_15_0].position = iter_15_1.pos[1]
				end

				var_13_3[var_15_0]:SetShowPos()
				var_13_3[var_15_0]:SetRevealFlag(true)
			end
		end,
		...
		[AuctionGameConst.EVENT_TYPE.RANDOM_ITEM_RARITY] = function()
			for iter_17_0, iter_17_1 in ipairs(arg_13_0.item_list) do
				...
				if var_13_3[var_17_0] == nil then
					var_13_3[var_17_0] = AuctionGameStoreItemData.New(iter_17_1)
				else
					var_13_3[var_17_0]:UpdateRarity(iter_17_1.rarity)
				end

				var_13_3[var_17_0]:SetShowRarity()
				var_13_3[var_17_0]:SetRevealFlag(true)
			end
		end,
		[AuctionGameConst.EVENT_TYPE.REVEAL_ITEM] = function()
			for iter_18_0, iter_18_1 in ipairs(arg_13_0.item_list) do
				...
				var_13_3[var_18_0] = AuctionGameStoreItemData.New(iter_18_1)

				var_13_3[var_18_0]:SetRevealFlag(true)
			end
		end,
		...
		[AuctionGameConst.EVENT_TYPE.MAX_CELL_ITEM_CONTOUR] = function()
			for iter_20_0, iter_20_1 in ipairs(arg_13_0.item_list) do
				...
				if var_13_3[var_20_0] == nil then
					var_13_3[var_20_0] = AuctionGameStoreItemData.New(iter_20_1)
				else
					var_13_3[var_20_0]:UpdateContour(iter_20_1.pos)
				end

				var_13_3[var_20_0]:SetShowContour()
				var_13_3[var_20_0]:SetRevealFlag(true)
			end
		end,
		[AuctionGameConst.EVENT_TYPE.RARITY_ITEM_CONTOUR] = function()
			for iter_21_0, iter_21_1 in ipairs(arg_13_0.item_list) do
				...
				if var_13_3[var_21_0] == nil then
					var_13_3[var_21_0] = AuctionGameStoreItemData.New(iter_21_1)
				else
					var_13_3[var_21_0]:UpdateContour(iter_21_1.pos)
					var_13_3[var_21_0]:UpdateRarity(iter_21_1.rarity)
				end

				local var_21_1 = var_13_1.config_data[1]

				var_13_3[var_21_0]:UpdateRarity(var_21_1)
				var_13_3[var_21_0]:SetShowContour()
				var_13_3[var_21_0]:SetShowRarity()
				var_13_3[var_21_0]:SetRevealFlag(true)
			end
		end,
		...
		[AuctionGameConst.EVENT_TYPE.ALL_ITEM_CONTOUR] = function()
			for iter_28_0, iter_28_1 in ipairs(arg_13_0.item_list) do
				...
				if var_13_3[var_28_0] == nil then
					var_13_3[var_28_0] = AuctionGameStoreItemData.New(iter_28_1)
				else
					var_13_3[var_28_0]:UpdateContour(iter_28_1.pos)
				end

				var_13_3[var_28_0]:SetShowContour()
				var_13_3[var_28_0]:SetRevealFlag(true)
			end
		end,
		[AuctionGameConst.EVENT_TYPE.RARITY_ITEMS_POSITION] = function()
			for iter_29_0, iter_29_1 in ipairs(arg_13_0.item_list) do
				...
				if var_13_3[var_29_0] == nil then
					var_13_3[var_29_0] = AuctionGameStoreItemData.New(iter_29_1)
				else
					var_13_3[var_29_0]:UpdateRarity(iter_29_1.rarity)
					var_13_3[var_29_0]:UpdatePos(iter_29_1.pos[1])
				end

				local var_29_1 = var_13_1.config_data[1]

				var_13_3[var_29_0]:UpdateRarity(var_29_1)
				var_13_3[var_29_0]:SetShowRarity()
				var_13_3[var_29_0]:SetShowPos()
				var_13_3[var_29_0]:SetRevealFlag(true)
			end
		end,
		...
		print("事件类型未支持:" .. var_13_1.type)
	end)
	var_13_2:AddEventSummary(var_13_2:GetRound(), var_13_4, {
		eventID = var_13_0,
...
function var_0_0.GuideSelectedEventOver()
	...
	local var_40_1 = getProxy(AuctionGameProxy)

	var_40_1:UpdateGroundEventList(var_40_0.player_events)

	if var_40_0.event_effect then
		var_40_1:UpdateEventEffect(var_40_0.event_effect)
	end

	var_40_1:ResetPlayerOptState()

	var_40_1.phaseTimestamp = var_40_0.timestamp

	pg.m02:sendNotification(GAME.AUCTION_GAME_BID_PHASE)
end

function var_0_0.GuideBided(arg_41_0)
	local var_41_0 = getProxy(PlayerProxy):getPlayerId()
	local var_41_1 = {
...
function var_0_0.GuideSkipToRound2()
	...
	var_43_2:UpdateRoundData(var_43_1)
...
function var_0_0.GuideBided2(arg_44_0)
	local var_44_0 = getProxy(PlayerProxy):getPlayerId()
	local var_44_1 = {
		timestamp = pg.TimeMgr.GetInstance():GetServerTime() + pg.gameset.auction_publicity_time.key_value,
		bid_list = {
			{
