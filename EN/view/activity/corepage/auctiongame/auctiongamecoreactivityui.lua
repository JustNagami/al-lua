			...
			elseif not arg_4_0.pageDic[var_7_0.id] then
				...
				if arg_4_0.pageDic[var_7_0.id] ~= nil then
					...
					onToggle(arg_4_0, arg_7_2, function(arg_9_0)
						local var_9_0 = arg_7_2:Find("off")
...
function var_0_0.verifyTabs(arg_13_0, arg_13_1)
	local var_13_0 = arg_13_0.activities[arg_13_0:getActivityIndex(arg_13_1) or arg_13_0:getActivityIndex(arg_13_0:GetActiveActivity()) or 1]

	if var_13_0 == nil then
		return
	end

	local var_13_1 = var_13_0:getConfig("is_show")
	local var_13_2 = arg_13_0.tabs:Find(tostring(var_13_1))
