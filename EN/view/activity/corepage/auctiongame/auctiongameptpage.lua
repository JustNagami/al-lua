...
function var_0_0.setPlayerInfo(arg_4_0)
	...
	local var_4_1 = var_4_0:GetShipPhantomMarks()[1]
	local var_4_2 = getProxy(BayProxy):GetShipPhantom(var_4_1)

	GetImageSpriteFromAtlasAsync("SquareIcon/" .. var_4_2:getPainting(), "", arg_4_0.playerIcon)
	setText(arg_4_0.playerName, var_4_0.name)
