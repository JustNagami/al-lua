...
function var_0_0.OnFirstFlush(arg_2_0)
	...
	if arg_2_0.mgHubData.highScores[var_0_1] and arg_2_0.mgHubData.highScores[var_0_1][1] then
		var_2_4 = arg_2_0.mgHubData.highScores[var_0_1][1]
	end

	setText(arg_2_0.highestScore, var_2_4)

	local var_2_5 = arg_2_0.totalTimes - 7 < 0 and 0 or arg_2_0.totalTimes - 7

	scrollTo(arg_2_0.awardsRect, 1 - var_2_5 / (arg_2_0.totalTimes - 7), 0)
end
