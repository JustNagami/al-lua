...
function var_0_0.updateCard(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_2 = var_16_1:Find("Progress")

	setActive(var_16_1, false)
	setActive(var_16_2, false)

	local var_16_3 = arg_16_2:Find("Image")
	local var_16_4 = arg_16_2:Find("NumText")
	local var_16_5 = arg_16_2:Find("NewTag")

	arg_16_0:updateCardImg(var_16_0, var_16_3)
	setActive(var_16_4, true)
	setText(var_16_4, string.format("%d", arg_16_1))
	setActive(var_16_5, arg_16_0:isPicNew(var_16_0))
...
function var_0_0.updateCardImg(arg_18_0, arg_18_1, arg_18_2)
	...
	if not IsNil(var_18_2) then
		local var_18_3 = var_18_2.name

		if string.lower(var_18_3) ~= string.lower(var_18_1) then
