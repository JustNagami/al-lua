...
function var_0_0.BindEvent(arg_14_0)
	...
	arg_14_0:bind(var_0_0.ON_POV_STICK_VIEW, function(arg_24_0, arg_24_1)
		...
		elseif isActive(arg_14_0.cameras[var_0_0.CAMERA.PHOTO_FREE]) then
			local var_24_3 = arg_14_0.cameras[var_0_0.CAMERA.PHOTO_FREE]:Find("PhotoFree Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera)):GetCinemachineComponent(Cinemachine.CinemachineCore.Stage.Aim)

			var_24_2(var_24_3, "m_HorizontalAxis", var_24_0)
			var_24_2(var_24_3, "m_VerticalAxis", var_24_1)
		end
	end)
	...
	arg_14_0:bind(var_0_0.PHOTO_CALL, function(arg_26_0, arg_26_1, ...)
		if var_14_2[arg_26_1] then
			local var_26_0 = arg_14_0:GetCurrentLadyEnv()

			arg_14_0[arg_26_1](arg_14_0, var_26_0, ...)
		else
...
function var_0_0.initScene(arg_29_0)
	...
	local var_29_2 = SceneManager.GetSceneByName(var_29_0 .. "_base")
	...
	local var_29_3 = GameObject.Find("CM Cameras").transform

	eachChild(var_29_3, function(arg_31_0)
		setActive(arg_31_0, false)
	end)

	arg_29_0.camBrain.enabled = false
	arg_29_0.camBrain.enabled = true
	arg_29_0.cameraAim = var_29_3:Find("Aim Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera))
	arg_29_0.cameraAim2 = var_29_3:Find("Aim2 Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera))
	arg_29_0.cameraFree = nil
	arg_29_0.cameraFurnitureWatch = nil
	arg_29_0.cameraRole = var_29_3:Find("Role Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera))
	arg_29_0.cameraRole2 = var_29_3:Find("Role2 Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera))

	local var_29_4 = var_29_3:Find("Talk Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera))

	arg_29_0.cameraGift = var_29_3:Find("Gift Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera))
	arg_29_0.cameras = {
		arg_29_0.cameraAim,
		arg_29_0.cameraAim2,
		arg_29_0.cameraRole,
		[var_0_0.CAMERA.TALK] = var_29_4,
		[var_0_0.CAMERA.GIFT] = arg_29_0.cameraGift,
		[var_0_0.CAMERA.ROLE2] = arg_29_0.cameraRole2,
		[var_0_0.CAMERA.PHOTO] = var_29_3:Find("Photo Camera"):GetComponent(typeof(Cinemachine.CinemachineFreeLook)),
		[var_0_0.CAMERA.PHOTO_FREE] = var_29_3:Find("PhotoFree Controller"),
		[var_0_0.CAMERA.POV] = var_29_3:Find("FP Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera)),
		[var_0_0.CAMERA.SKIN] = arg_29_0.room:isPersonalRoom() and var_29_3:Find("Skin Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera)) or nil
	}
	...
	if arg_29_0.isMultiFloor then
		...
		for iter_29_0 = 0, math.floor(arg_29_0.restrictedBox.childCount / 2) - 1 do
			local var_29_8 = iter_29_0 == 0 and var_29_6 or var_29_6 .. "_" .. iter_29_0
			local var_29_9 = iter_29_0 == 0 and var_29_7 or var_29_7 .. "_" .. iter_29_0

			table.insert(arg_29_0.restrictedHeightRange, {
				arg_29_0.restrictedBox:Find(var_29_8).position.y + var_29_5,
				arg_29_0.restrictedBox:Find(var_29_9).position.y - var_29_5
			})
		end
	else
		arg_29_0.restrictedHeightRange = {
...
function var_0_0.InitLightSettings(arg_33_0)
	...
	local var_33_0 = GameObject.Find("[Lighting]").transform

	table.IpairsCArray(var_33_0:GetComponentsInChildren(typeof(Light), true), function(arg_34_0, arg_34_1)
...
function var_0_0.InitSlots(arg_38_0)
	local var_38_0 = arg_38_0.room:GetSlots()
	local var_38_1 = arg_38_0.modelRoot:GetComponentsInChildren(typeof(Transform), true):ToTable()

	arg_38_0.slotDict = {}

	_.each(var_38_0, function(arg_39_0)
		...
		for iter_39_0, iter_39_1 in ipairs(var_38_1) do
...
function var_0_0.SetContactStateDic(arg_41_0, arg_41_1)
	...
	for iter_41_0, iter_41_1 in pairs(arg_41_0.contactStateDic) do
		...
		local var_41_0 = pg.dorm3d_collection_template[iter_41_0].vfx_prefab
		...
		table.insertto(arg_41_0.transRangeDic.list, underscore.map(var_41_0, function(arg_42_0)
...
function var_0_0.ActiveContact(arg_44_0)
	for iter_44_0, iter_44_1 in pairs(arg_44_0.contactInRangeDic) do
		arg_44_0:UpdateContactDisplay(iter_44_0, arg_44_0.contactInRangeDic[iter_44_0] and not arg_44_0.hideConcatFlag and arg_44_0.contactStateDic[iter_44_0] or arg_44_0.hideContactStateDic[iter_44_0])
	end
end

function var_0_0.UpdateContactDisplay(arg_45_0, arg_45_1, arg_45_2)
	local var_45_0 = pg.dorm3d_collection_template[arg_45_1]

	for iter_45_0, iter_45_1 in ipairs(var_45_0.vfx_prefab) do
		local var_45_1 = arg_45_0.modelRoot:Find(iter_45_1)
		...
		elseif not arg_45_0.modelRoot:Find(iter_45_1) then
			...
			setActive(var_45_1, arg_45_2 == ApartmentRoom.ITEM_FIRST)
		end
	end

	for iter_45_2, iter_45_3 in ipairs(var_45_0.model) do
		...
		elseif not arg_45_0.modelRoot:Find(iter_45_3) then
			...
			local var_45_2 = arg_45_0.modelRoot:Find(iter_45_3)

			if arg_45_0:CheckSceneItemActive(var_45_2) then
				local var_45_3 = GetComponent(var_45_2, typeof(EventTriggerListener))

				if arg_45_2 == ApartmentRoom.ITEM_FIRST then
					var_45_3 = var_45_3 or GetOrAddComponent(var_45_2, typeof(EventTriggerListener))

					var_45_3:AddPointClickFunc(function(arg_46_0, arg_46_1)
						arg_45_0:emit(var_0_0.CLICK_CONTACT, arg_45_1)
					end)

					var_45_3.enabled = true
				elseif var_45_3 then
					var_45_3.enabled = false
				end

				setActive(var_45_2, arg_45_2 > ApartmentRoom.ITEM_LOCK)
			end
		end
	end
end
...
function var_0_0.UpdateFloatPosition(arg_48_0)
	...
	local var_48_1 = arg_48_0:GetScreenPosition(var_48_0.ladyHeadCenter.position + Vector3(0, 0.2, 0))
	local var_48_2 = arg_48_0:GetLocalPosition(var_48_1, arg_48_0.rtFloatPage)

	setLocalPosition(arg_48_0.rtFloatPage:Find("lady"), var_48_2)
end
...
function var_0_0.LoadSingleCharacter(arg_54_0, arg_54_1, arg_54_2)
	local var_54_0 = {}
	local var_54_1 = LadyEnv.New(arg_54_0)

	arg_54_0.ladyDict[arg_54_1] = var_54_1

	local var_54_2 = getProxy(ApartmentProxy):getApartment(arg_54_1)
	...
	for iter_54_0, iter_54_1 in ipairs({
		...
		local var_54_6 = string.format("dorm3d/character/%s/res/%s", var_54_3, iter_54_1)

		if checkABExist(var_54_6) then
			table.insert(var_54_0, function(arg_55_0)
				arg_54_0.loader:LoadBundle(var_54_6, function(arg_56_0)
	...
	var_54_1.skinId = var_54_4
	var_54_1.skinIdList = {
		var_54_4
	}

	table.insert(var_54_0, function(arg_57_0)
		local var_57_0 = string.format("dorm3d/character/%s/prefabs/%s", var_54_3, var_54_5)

		arg_54_0.loader:GetPrefab(var_57_0, "", function(arg_58_0)
		...
		for iter_54_2, iter_54_3 in ipairs(var_54_2:GetAllModelIds()) do
			if not table.contains(var_54_1.skinIdList, iter_54_3) then
				...
				if var_54_7:IsShow() or iter_54_3 == 199033 then
					...
					if checkABExist(var_54_9) then
						table.insert(var_54_1.skinIdList, iter_54_3)
						table.insert(var_54_0, function(arg_59_0)
							arg_54_0.loader:GetPrefab(var_54_9, "", function(arg_60_0)
	...
	if arg_54_0.contextData.pendingDic[arg_54_1] then
		local var_54_10 = pg.dorm3d_welcome[arg_54_0.contextData.pendingDic[arg_54_1]]

		if var_54_10.item_prefab ~= "" then
			table.insert(var_54_0, function(arg_61_0)
				local var_61_0 = string.lower("dorm3d/furniture/item/" .. var_54_10.item_prefab)

				arg_54_0.loader:GetPrefab(var_61_0, "", function(arg_62_0)
...
function var_0_0.HXCharacter(arg_63_0, arg_63_1)
	...
	local var_63_0 = arg_63_1:GetComponentsInChildren(typeof(SkinnedMeshRenderer), true)

	table.IpairsCArray(var_63_0, function(arg_64_0, arg_64_1)
		local var_64_0 = arg_64_1.sharedMaterials
		local var_64_1 = false

		table.IpairsCArray(var_64_0, function(arg_65_0, arg_65_1)
			...
			local var_65_3 = var_65_1:LoadAssetSync(var_65_2, typeof(Material), false, false)

			var_64_0[arg_65_0] = var_65_3
...
function var_0_0.InitHolyLight(arg_66_0)
	...
	Dorm3dHxHelper.ShowHolyLight(var_66_0, arg_66_0.holyLightRoot, true)
end
...
function var_0_0.didEnter(arg_78_0)
	...
	arg_78_0.joystickTimer = FrameTimer.New(function()
		local var_79_0 = arg_78_0.joystickDelta * var_78_0
		local var_79_1 = var_79_0.x
		local var_79_2 = var_79_0.y

		local function var_79_3(arg_80_0, arg_80_1, arg_80_2)
		...
		if arg_78_0.surroudCamera and not arg_78_0.pinchMode then
			var_79_3(arg_78_0.surroudCamera, "m_XAxis", var_79_1)
			var_79_3(arg_78_0.surroudCamera, "m_YAxis", var_79_2)
		elseif arg_78_0.furniturePOV and arg_78_0.cameras[var_0_0.CAMERA.FURNITURE_WATCH] and isActive(arg_78_0.cameras[var_0_0.CAMERA.FURNITURE_WATCH]) then
			var_79_3(arg_78_0.furniturePOV, "m_HorizontalAxis", var_79_1)
			var_79_3(arg_78_0.furniturePOV, "m_VerticalAxis", var_79_2)
		end
	...
	arg_78_0.moveStickTimer = FrameTimer.New(function()
		...
		local var_81_1 = 200
		local var_81_2 = (var_81_0 - arg_78_0.moveStickOrigin):ClampMagnitude(var_81_1)
		local var_81_3 = var_81_2 / var_81_1

		arg_78_0.moveStickPosition = arg_78_0.moveStickOrigin + var_81_2

		local var_81_4 = Vector3.New(var_81_3.x, 0, var_81_3.y)
		local var_81_5 = arg_78_0.mainCameraTF:TransformDirection(var_81_4)

		var_81_5.y = 0

		local var_81_6 = var_81_5:Normalize()

		var_81_6:Mul(var_78_1)

		if isActive(arg_78_0.cameras[var_0_0.CAMERA.POV]) then
			arg_78_0.playerController:SimpleMove(var_81_6)

			arg_78_0.tweenFOV = true
		elseif isActive(arg_78_0.cameras[var_0_0.CAMERA.PHOTO_FREE]) then
			arg_78_0.cameras[var_0_0.CAMERA.PHOTO_FREE]:GetComponent(typeof(UnityEngine.CharacterController)):Move(var_81_6 * Time.deltaTime)
			arg_78_0:emit(Dorm3dPhotoMediator.CAMERA_STICK_MOVE, var_81_3:Normalize())
			onNextTick(function()
				local var_82_0 = arg_78_0.cameras[var_0_0.CAMERA.PHOTO_FREE]
				local var_82_1 = arg_78_0:GetRestritedHeightRange()
				local var_82_2 = math.InverseLerp(var_82_1[1], var_82_1[2], var_82_0.position.y)

				arg_78_0:emit(Dorm3dPhotoMediator.CAMERA_LIFT_CHANGED, var_82_2)
			end)
		end
	end, 1, -1)
	...
	GlobalClickEventMgr.Inst:AddPinchFunc(function(arg_84_0, arg_84_1)
		...
		local var_84_1 = arg_78_0.pinchSize - var_84_0
		local var_84_2 = arg_78_0.pinchNodeOrder * (arg_84_1.x < arg_84_0.x and -1 or 1)
		local var_84_3 = var_84_1 * var_78_3 * var_84_2

		if isActive(arg_78_0.cameras[var_0_0.CAMERA.POV]) then
			local var_84_4 = 0.5
			local var_84_5 = 1

			arg_78_0.pinchValue = math.clamp(arg_78_0.pinchValue + var_84_3, var_84_4, var_84_5)
		...
		if isActive(arg_78_0.surroudCamera) and arg_78_0.surroudCamera == arg_78_0.cameras[var_0_0.CAMERA.PHOTO] then
			...
			arg_78_0:SetPinchValue(math.clamp(arg_78_0.pinchValue + var_84_3, var_84_6, var_84_7))
	...
	function arg_78_0.camBrainEvenetHandler.OnBlendStarted(arg_86_0)
		...
		local var_86_0 = arg_78_0.camBrain.ActiveVirtualCamera

		arg_78_0.activeCMCamera = var_86_0
	end
...
function var_0_0.Update(arg_95_0)
	...
	if arg_95_0.tweenFOV then
		local var_95_0 = Damp(1, 1, Time.deltaTime)

		arg_95_0.pinchValue = Mathf.Lerp(arg_95_0.pinchValue, 1, var_95_0)
	...
	if arg_95_0.contactInRangeDic then
		local var_95_1 = arg_95_0.transformFilter:Execute():ToTable()

		for iter_95_0, iter_95_1 in pairs(arg_95_0.contactInRangeDic) do
			local var_95_2 = pg.dorm3d_collection_template[iter_95_0]
			local var_95_3 = arg_95_0.transRangeDic[iter_95_0]
			local var_95_4 = underscore(var_95_1):chain():slice(unpack(var_95_3)):any(function(arg_96_0)
				return arg_96_0
			end):value()

			if tobool(iter_95_1) ~= var_95_4 then
				arg_95_0.contactInRangeDic[iter_95_0] = var_95_4

				arg_95_0:UpdateContactDisplay(iter_95_0, var_95_4 and not arg_95_0.hideConcatFlag and arg_95_0.contactStateDic[iter_95_0] or arg_95_0.hideContactStateDic[iter_95_0])
			end
		end
	end
...
function var_0_0.CheckInSector(arg_97_0)
	...
	for iter_97_0, iter_97_1 in pairs(arg_97_0.ladyDict) do
		if iter_97_1.lady then
			...
			if var_97_1 ~= tobool(var_0_0.IsPointInSector(var_97_2, var_97_0)) then
...
function var_0_0.TriggerLadyDistance(arg_98_0)
	for iter_98_0, iter_98_1 in pairs(arg_98_0.ladyDict) do
		if iter_98_1.lady then
			...
			if (arg_98_0:GetBlackboardValue(iter_98_1, "inPending") and var_0_0.POV_PENDING_CLOSE_DISTANCE or var_0_0.POV_CLOSE_DISTANCE) > iter_98_1.dis ~= arg_98_0:GetBlackboardValue(iter_98_1, "inDistance") then
...
function var_0_0.GetPOVFOV(arg_101_0)
	local var_101_0 = arg_101_0.cameras[var_0_0.CAMERA.POV].m_Lens

	return ReflectionHelp.RefGetField(typeof("Cinemachine.LensSettings"), "FieldOfView", var_101_0)
end

function var_0_0.SetPOVFOV(arg_102_0, arg_102_1)
	local var_102_0 = arg_102_0.cameras[var_0_0.CAMERA.POV].m_Lens

	ReflectionHelp.RefSetField(typeof("Cinemachine.LensSettings"), "FieldOfView", var_102_0, arg_102_1)

	arg_102_0.cameras[var_0_0.CAMERA.POV].m_Lens = var_102_0
end
...
function var_0_0.RefreshSlots(arg_103_0, arg_103_1, arg_103_2)
	...
	table.ParallelIpairsAsync(var_103_0, function(arg_104_0, arg_104_1, arg_104_2)
		...
		local function var_104_4(arg_106_0)
			table.Foreach(arg_103_0.slotDict[var_104_0].sceneHides or {}, function(arg_107_0, arg_107_1)
			...
			if arg_106_0 then
				local var_106_0 = arg_106_0:getConfig("scene_hides")

				if #var_106_0 > 0 then
					table.Ipairs(var_106_0, function(arg_108_0, arg_108_1)
						...
						local var_108_1 = isActive(var_108_0)
...
function var_0_0.ChangePlayerPosition(arg_120_0, arg_120_1)
	...
	local var_120_0 = arg_120_0.furnitures:Find(arg_120_1):Find("PlayerPoint").position
...
function var_0_0.ShiftZone(arg_132_0, arg_132_1, arg_132_2)
	local var_132_0 = arg_132_0:GetFurnitureByName(arg_132_1)
	...
	seriesAsync({
		...
		function(arg_134_0)
			if arg_132_0.shiftLady or arg_132_0.room:isPersonalRoom() then
				...
				arg_132_0.contextData.ladyZone[var_134_0] = var_132_0.name

				local var_134_1 = arg_132_0.ladyDict[var_134_0]

				var_134_1:SetZone(arg_132_0.contextData.ladyZone[var_134_0])

				if arg_132_0:GetBlackboardValue(var_134_1, "inPending") then
					arg_132_0:SetOutPending(var_134_1)
					arg_132_0:SwitchAnim(var_134_1, var_0_0.ANIM.IDLE)
					onNextTick(function()
		...
		function(arg_136_0)
			arg_132_0.contextData.inFurnitureName = var_132_0.name

			if SlideExtraSystem.IsOpen(arg_132_0.room) and arg_132_0.contextData.inFurnitureName == SlideConst.SLIDE_ZONE then
				arg_132_0:SyncInterestTransformByTf(var_132_0.transform:Find("StayPoint"))
...
function var_0_0.ActiveCamera(arg_139_0, arg_139_1)
	local var_139_0 = isActive(arg_139_1)
...
function var_0_0.RegisterOrbits(arg_145_0, arg_145_1)
	...
	arg_145_0.orbits.current = _.range(3):map(function(arg_146_0)
		...
		return Cinemachine.CinemachineFreeLook.Orbit.New(var_146_0.m_Height, var_146_0.m_Radius)
	end)
...
function var_0_0.SetCameraObrits(arg_147_0)
	...
	local var_147_0 = arg_147_0.surroudCamera

	if not var_147_0 then
		return
	end

	local var_147_1 = arg_147_0.orbits.original[1]

	for iter_147_0 = 0, #arg_147_0.orbits.current - 1 do
		local var_147_2 = arg_147_0.orbits.current[iter_147_0 + 1]
		local var_147_3 = arg_147_0.orbits.original[iter_147_0]

		var_147_2.m_Height = math.lerp(var_147_1.m_Height, var_147_3.m_Height, arg_147_0.pinchValue)
		var_147_2.m_Radius = var_147_3.m_Radius * arg_147_0.pinchValue
	end

	var_147_0.m_Orbits = arg_147_0.orbits.current
end

function var_0_0.RevertCameraOrbit(arg_148_0)
	arg_148_0 = arg_148_0.scene

	local var_148_0 = arg_148_0.surroudCamera
	...
	for iter_148_0 = 0, #arg_148_0.orbits.current - 1 do
		local var_148_1 = arg_148_0.orbits.current[iter_148_0 + 1]
		local var_148_2 = arg_148_0.orbits.original[iter_148_0]

		var_148_1.m_Height = var_148_2.m_Height
		var_148_1.m_Radius = var_148_2.m_Radius
	end

	var_148_0.m_Orbits = arg_148_0.orbits.current
...
function var_0_0.SetExtraAnimSpeed(arg_161_0, arg_161_1, arg_161_2, arg_161_3)
	table.Ipairs(arg_161_2 or {}, function(arg_162_0, arg_162_1)
		...
		if arg_161_1.extraItems[var_162_0] then
			arg_161_1.extraItems[var_162_0].trans:GetComponent(typeof(Animator)).speed = arg_161_3
		end
	end)
end
...
function var_0_0.PlayEnterExtraItem(arg_165_0, arg_165_1, arg_165_2, arg_165_3)
	...
	if arg_165_2 and #arg_165_2 > 0 then
		table.Ipairs(arg_165_2, function(arg_166_0, arg_166_1)
			...
			local var_166_2 = #arg_166_1 > 4 and arg_166_1[5] or nil
...
function var_0_0.HideSceneItem(arg_167_0, arg_167_1, arg_167_2)
	if arg_167_2 and #arg_167_2 > 0 then
		...
		table.Ipairs(arg_167_2, function(arg_168_0, arg_168_1)
			local var_168_0 = arg_167_0:GetSceneItem(arg_168_1)
...
function var_0_0.ResetTempHideSceneItems(arg_169_0, arg_169_1, arg_169_2)
	...
	if arg_169_1.tempHideSceneItems and #arg_169_1.tempHideSceneItems > 0 then
		table.Ipairs(arg_169_1.tempHideSceneItems, function(arg_170_0, arg_170_1)
			...
			local var_170_0 = arg_169_0:GetSceneItem(arg_170_1)

			setActive(var_170_0, true)
		end)
...
function var_0_0.HideCharacterBylayer(arg_180_0, arg_180_1)
	...
	local var_180_1 = arg_180_1.lady:Find("all")

	for iter_180_0 = 0, var_180_1.childCount - 1 do
...
function var_0_0.RevertCharacterBylayer(arg_181_0, arg_181_1)
	...
	for iter_181_0 = 0, var_181_1.childCount - 1 do
		...
		if var_181_2.name ~= var_181_0 then
			pg.ViewUtils.SetLayer(var_181_2, Layer.Character3D)
		end
	end
...
function var_0_0.HideFurnitureSlots(arg_190_0)
	if arg_190_0.displaySlots then
		...
		table.Foreach(arg_190_0.displaySlots, function(arg_191_0, arg_191_1)
			...
			if IsNil(var_191_0:Find("Selector")) then
				return
			end

			setActive(var_191_0:Find("Selector"), false)
		end)
...
function var_0_0.DisplayFurnitureSlots(arg_192_0, arg_192_1)
	...
	_.each(arg_192_1, function(arg_193_0)
		...
		if var_193_0:Find("Selector") then
...
function var_0_0.UpdateDisplaySlots(arg_194_0, arg_194_1)
	table.Foreach(arg_194_0.displaySlots, function(arg_195_0, arg_195_1)
		...
		if not IsNil(var_195_0:Find("Selector")) then
			setActive(var_195_0:Find("Selector/Normal"), arg_194_1[arg_195_0] == 0)
			setActive(var_195_0:Find("Selector/Active"), arg_194_1[arg_195_0] == 1)
			setActive(var_195_0:Find("Selector/Ban"), arg_194_1[arg_195_0] == 2)
		end

		local var_195_1 = arg_194_0.slotDict[arg_195_0].model
		local var_195_2 = arg_194_0.slotDict[arg_195_0].displayModelName

		if var_195_2 and var_195_2 ~= "" then
			var_195_1 = var_195_0:GetChild(var_195_0.childCount - 1)
		end

		local function var_195_3(arg_196_0, arg_196_1)
			local var_196_0 = arg_196_0:GetComponentsInChildren(typeof(Renderer), true)

			table.IpairsCArray(var_196_0, function(arg_197_0, arg_197_1)
				local var_197_0 = arg_197_1.material

				if var_197_0 and var_197_0:HasProperty("_FinalTint") then
					var_197_0:SetColor("_FinalTint", arg_196_1)
				end
			end)
		end
		...
		if var_195_1 then
			if arg_194_1[arg_195_0] == 1 then
				var_195_3(var_195_1, Color.NewHex("3F83AE73"))
			else
				var_195_3(var_195_1, Color.New(0, 0, 0, 0))
			end
		end
	end)
end
...
function var_0_0.EnterPhotoMode(arg_198_0, arg_198_1, arg_198_2)
	...
	seriesAsync({
		...
		function(arg_201_0)
			...
			local var_201_1 = arg_198_0.ladyDict[var_201_0]

			arg_198_0:SwitchAnim(var_201_1, arg_198_2)
			var_201_1.ladyAnimator:Update(0)
			arg_198_0:ResetCharPoint(var_201_1, arg_198_1:GetWatchCameraName())
			arg_198_0:SyncInterestTransform(var_201_1)
			setActive(var_201_1.ladySafeCollider, true)
			arg_198_0:HideCharacter(var_201_0)

			local var_201_2 = arg_198_0.cameras[var_0_0.CAMERA.PHOTO]
			local var_201_3 = var_201_2.m_XAxis

			var_201_3.Value = 180
			var_201_2.m_XAxis = var_201_3

			local var_201_4 = var_201_2.m_YAxis

			var_201_4.Value = 0.7
			var_201_2.m_YAxis = var_201_4
			...
			arg_198_0:RegisterCameraBlendFinished(var_201_2, arg_201_0)
			arg_198_0:ActiveCamera(var_201_2)
		end,
		function(arg_202_0)
...
function var_0_0.ExitPhotoMode(arg_204_0)
	...
	seriesAsync({
		...
		function(arg_206_0)
			...
			local var_206_1 = arg_204_0.cameras[var_0_0.CAMERA.POV]

			arg_204_0:RegisterCameraBlendFinished(var_206_1, arg_206_0)
			arg_204_0:ActiveCamera(var_206_1)
		end,
		function(arg_208_0)
...
function var_0_0.SwitchCameraZone(arg_210_0, arg_210_1, arg_210_2, arg_210_3)
	...
	seriesAsync({
		...
		function(arg_212_0)
			local var_212_0 = arg_210_0:GetCurrentLadyEnv()

			arg_210_0:SwitchAnim(var_212_0, arg_210_2)
			onNextTick(function()
				arg_210_0:ResetCharPoint(var_212_0, arg_210_1:GetWatchCameraName())
				arg_210_0:SyncInterestTransform(var_212_0)
...
function var_0_0.SwitchPhotoCamera(arg_217_0)
	if not arg_217_0.contextData.photoFreeMode then
		...
		local var_217_0 = arg_217_0.cameras[var_0_0.CAMERA.PHOTO_FREE]
		local var_217_1 = arg_217_0.cameras[var_0_0.CAMERA.PHOTO_FREE]:Find("PhotoFree Camera"):GetComponent(typeof(Cinemachine.CinemachineVirtualCamera)):GetCinemachineComponent(Cinemachine.CinemachineCore.Stage.Aim)
		local var_217_2 = arg_217_0.mainCameraTF.rotation:ToEulerAngles()
		local var_217_3 = var_217_1.m_HorizontalAxis

		var_217_3.Value = var_217_2.y
		var_217_1.m_HorizontalAxis = var_217_3

		local var_217_4 = var_217_1.m_VerticalAxis

		var_217_4.Value = arg_217_0:GetNearestAngle(var_217_2.x, var_217_4.m_MinValue, var_217_4.m_MaxValue)
		var_217_1.m_VerticalAxis = var_217_4

		local var_217_5 = arg_217_0.mainCameraTF.position
		local var_217_6 = arg_217_0:GetRestritedHeightRange()
		local var_217_7 = math.InverseLerp(var_217_6[1], var_217_6[2], var_217_5.y)

		var_217_5.y = math.clamp(var_217_5.y, var_217_6[1], var_217_6[2])
		var_217_0.transform.position = var_217_5

		arg_217_0:emit(Dorm3dPhotoMediator.CAMERA_LIFT_CHANGED, var_217_7)
...
function var_0_0.SetPhotoCameraHeight(arg_218_0, arg_218_1)
	local var_218_0 = arg_218_0.cameras[var_0_0.CAMERA.PHOTO_FREE]
	local var_218_1 = arg_218_0:GetRestritedHeightRange()
	local var_218_2 = math.lerp(var_218_1[1], var_218_1[2], arg_218_1)

	var_218_0:GetComponent(typeof(UnityEngine.CharacterController)):Move(Vector3.New(0, var_218_2 - var_218_0.position.y, 0))
	onNextTick(function()
		local var_219_0 = arg_218_0:GetRestritedHeightRange()
		local var_219_1 = math.InverseLerp(var_219_0[1], var_219_0[2], var_218_0.position.y)

		arg_218_0:emit(Dorm3dPhotoMediator.CAMERA_LIFT_CHANGED, var_219_1)
	end)
end

function var_0_0.ResetPhotoCameraPosition(arg_220_0)
	local var_220_0 = arg_220_0.cameras[var_0_0.CAMERA.PHOTO]
	local var_220_1 = var_220_0.m_XAxis

	var_220_1.Value = 180
	var_220_0.m_XAxis = var_220_1

	local var_220_2 = var_220_0.m_YAxis

	var_220_2.Value = 0.7
	var_220_0.m_YAxis = var_220_2
end
...
function var_0_0.GetNearestAngle(arg_223_0, arg_223_1, arg_223_2, arg_223_3)
	...
	arg_223_1 = var_223_0 - Mathf.DeltaAngle(arg_223_1, var_223_0)
...
function var_0_0.PlayTimeline(arg_224_0, arg_224_1, arg_224_2)
	...
	table.insert(var_224_0, function(arg_228_0)
		...
		local var_228_2 = var_228_1:GetComponentsInChildren(typeof(Animator), true)

		table.IpairsCArray(var_228_2, function(arg_229_0, arg_229_1)
		...
		assert(var_228_3, "Missing MainCamera")

		local var_228_4 = GameObject.Find("[sequence]").transform

		arg_224_0.nowTimelinePlayer = TimelinePlayer.New(var_228_4)
			...
			switch(arg_231_1.stringParameter, {
				...
				TimelineSelectStart = function()
					...
					if arg_224_1.options then
						...
						arg_224_0:DoTimelineOption(var_235_0, function(arg_236_0)
				...
				TimelineAccompanyJump = function()
					if arg_224_0.canTriggerAccompanyPerformance then
						...
						local var_241_1 = var_241_0[math.random(#var_241_0)]

						arg_231_0:SetTime(var_241_1)
					end
				end,
				TimelineIKStart = function()
					...
					local var_242_1 = arg_224_0:GetCurrentLadyEnv()

					if var_242_1:CheckIkTimelineStatus(var_242_0) then
						arg_224_0:emit(RoomIKSystem.SET_IK_TIMELINE_STATUS, var_242_1, var_228_0.gameObject, var_242_0, var_228_3)
					end
				end,
				...
				TimelineAimIKStart = function()
					...
					arg_224_0:emit(AimIKSystem.ENTER_TIMELINE_AIMIK_STATUS, var_244_0)
				end
			}, function()
	...
	table.insert(var_224_0, function(arg_250_0)
		arg_224_0:RevertArtScene(var_224_1, arg_250_0)
	end)
	seriesAsync(var_224_0, function()
		...
		local var_251_0 = arg_224_0.timelineMark

		arg_224_0.timelineMark = nil

		existCall(arg_224_2, var_251_0, function(arg_252_0)
...
function var_0_0.SetCharacterAnimSpeed(arg_260_0, arg_260_1)
	...
	if arg_260_1 > 0 then
		var_260_0.ladyHeadIKComp.DampTime = var_260_0.ladyHeadIKData.DampTime / arg_260_1
	else
		var_260_0.ladyHeadIKComp.DampTime = var_260_0.ladyHeadIKData.DampTime * math.huge
	end
end
...
function var_0_0.OnAnimationEvent(arg_261_0, arg_261_1)
	...
	local var_261_1 = table.removebykey(arg_261_0.animEventCallbacks, var_261_0)
...
function var_0_0.PlaySceneItemAnim(arg_263_0, arg_263_1, arg_263_2, arg_263_3)
	...
	if not arg_263_0.sceneAnimatorDict[arg_263_1] then
		local var_263_0 = pg.dorm3d_scene_animator[arg_263_1]
		local var_263_1 = arg_263_0:GetSceneItem(var_263_0.item_name)

		assert(var_263_1, "Missing Scene Animator in pg.dorm3d_scene_animator: " .. arg_263_1 .. " " .. var_263_0.item_name)

		if not var_263_1 then
			return
		end

		local var_263_2 = var_263_1:GetComponent(typeof(Animator))
	...
	if not arg_263_3 and arg_263_0.sceneAnimatorDict[arg_263_1].animator:GetCurrentAnimatorStateInfo(0):IsName(arg_263_2) then
		return
	end
...
function var_0_0.OnCameraBlendFinished(arg_274_0, arg_274_1)
	...
	local var_274_0 = table.removebykey(arg_274_0.cameraBlendCallbacks, arg_274_1)
...
function var_0_0.PlayHeartFX(arg_275_0, arg_275_1)
	...
	setActive(var_275_0.effectHeart, false)
	setActive(var_275_0.effectHeart, true)
...
function var_0_0.PlayExpression(arg_276_0, arg_276_1)
	...
	if var_276_1 then
		...
		var_276_3:Reset(nil, var_276_2)
		var_276_3:Start()

		if var_276_1.instance then
			setActive(var_276_1.instance, false)
			setActive(var_276_1.instance, true)
		end
	...
	arg_276_0.loader:GetPrefab("dorm3D/effect/prefab/expression/" .. var_276_0, var_276_0, function(arg_278_0)
		var_276_4.instance = arg_278_0

		onNextTick(function()
			local var_279_0 = arg_276_0:GetCurrentLadyEnv()

			setParent(arg_278_0, var_279_0.ladyHeadCenter)
		end)
...
function var_0_0.RemoveExpression(arg_280_0, arg_280_1)
	local var_280_0 = arg_280_0.expressionDict[arg_280_1]

	if not var_280_0 then
		return
	end

	arg_280_0.loader:ClearRequest(var_280_0)

	if var_280_0.instance then
		arg_280_0.loader:ReturnPrefab(var_280_0.instance)
	end
...
function var_0_0.RegisterGlobalVolume(arg_282_0)
	...
	local var_282_1 = GraphicsInterface.Instance.GetOrAddVolumeComponent(var_282_0, typeof(BLHX.Rendering.CustomDepthOfField))
	local var_282_2 = GraphicsInterface.Instance.GetOrAddVolumeComponent(var_282_0, typeof(UnityEngine.Rendering.Universal.ColorAdjustments))

	arg_282_0.originalCameraSettings = {
		depthOfField = {
			enabled = var_282_1.enabled.value,
			focusDistance = {
				length = 2,
				min = var_282_1.gaussianStart.min,
				value = var_282_1.gaussianStart.value
			},
			blurRadius = {
				min = var_282_1.blurRadius.min,
				max = var_282_1.blurRadius.max,
				value = var_282_1.blurRadius.value
			}
		},
		postExposure = {
			value = var_282_2.postExposure.value
		},
		contrast = {
			min = var_282_2.contrast.min,
			max = var_282_2.contrast.max,
			value = var_282_2.contrast.value
		},
		saturate = {
			min = var_282_2.saturation.min,
			max = var_282_2.saturation.max,
			value = var_282_2.saturation.value
		}
	}
	arg_282_0.originalCameraSettings.depthOfField.enabled = true

	local var_282_3 = var_282_0:GetComponent(typeof(UnityEngine.Rendering.Volume))

	arg_282_0.originalVolume = {
		profile = var_282_3.sharedProfile,
		weight = var_282_3.weight
	}
end
...
function var_0_0.SettingCamera(arg_283_0, arg_283_1)
	...
	local var_283_1 = GraphicsInterface.Instance.GetOrAddVolumeComponent(var_283_0, typeof(BLHX.Rendering.CustomDepthOfField))
	local var_283_2 = GraphicsInterface.Instance.GetOrAddVolumeComponent(var_283_0, typeof(UnityEngine.Rendering.Universal.ColorAdjustments))

	var_283_1.enabled:Override(arg_283_1.depthOfField.enabled)
	var_283_1.gaussianStart:Override(arg_283_1.depthOfField.focusDistance.value)
	var_283_1.gaussianEnd:Override(arg_283_1.depthOfField.focusDistance.value + arg_283_1.depthOfField.focusDistance.length)
	var_283_1.blurRadius:Override(arg_283_1.depthOfField.blurRadius.value)
	var_283_2.postExposure:Override(arg_283_1.postExposure.value)
	var_283_2.contrast:Override(arg_283_1.contrast.value)
	var_283_2.saturation:Override(arg_283_1.saturate.value)
end
...
function var_0_0.SetCharacterLight(arg_290_0, arg_290_1, arg_290_2, arg_290_3)
	...
	local var_290_1 = Color.Lerp(arg_290_0.originalCharacterColor.color, arg_290_1, arg_290_3)
	local var_290_2 = math.lerp(arg_290_0.originalCharacterColor.intensity, arg_290_2, arg_290_3)
	local var_290_3 = arg_290_0.characterLight:GetComponent(typeof("BLHX.Rendering.CharacterLight"))

	ReflectionHelp.RefSetProperty(typeof("BLHX.Rendering.CharacterLight"), "characterLightColor", var_290_3, var_290_1)
	ReflectionHelp.RefSetProperty(typeof("BLHX.Rendering.CharacterLight"), "characterLightIntensity", var_290_3, var_290_2)
end
...
function var_0_0.ChangeSubScene(arg_305_0, arg_305_1, arg_305_2)
	...
	table.insert(var_305_0, function(arg_307_0)
		if Dorm3dSceneMgr.IsSameSceneInfo(arg_305_1, arg_305_0.dormSceneMgr.sceneInfo) then
			...
			var_305_1.ladyActiveZone = var_305_1.walkBornPoint or "Default"
		end
	...
	if not Dorm3dSceneMgr.IsSameSceneInfo(arg_305_1, arg_305_0.dormSceneMgr.subSceneInfo) then
		table.insert(var_305_0, function(arg_308_0)
			...
			arg_305_0:ResetSceneStructure(SceneManager.GetSceneByName(var_308_2))

			if Dorm3dSceneMgr.IsSameSceneInfo(arg_305_1, arg_305_0.dormSceneMgr.sceneInfo) then
				arg_305_0:RefreshSlots()
			else
				arg_305_0:SwitchAnim(var_305_1, var_0_0.ANIM.IDLE)
			end
	...
	table.insert(var_305_0, function(arg_309_0)
		onNextTick(function()
			arg_305_0:ChangeCharacterPosition(var_305_1)
			arg_305_0:ChangePlayerPosition(var_305_1.ladyActiveZone)
...
function var_0_0.IsPointInSector(arg_311_0, arg_311_1)
	...
	if var_311_0.y > arg_311_0.Radius then
		return false
	end
	...
	local var_311_1 = arg_311_0.Rotation

	return Vector3.Angle(var_311_1 * Vector3.forward, var_311_0) <= arg_311_0.Angle / 2
end
