local var_0_0 = class("Dorm3dStockingMgr", import("view.dorm3d.Core.BaseSystem"))
...
function var_0_0.OnInit(arg_1_0)
	...
	if var_1_0 then
		for iter_1_0, iter_1_1 in pairs(var_1_0.skinIdList) do
			local var_1_1 = arg_1_0:GetSkinDict()[iter_1_1].ladyGameObject
...
function var_0_0.OnHandleNotification(arg_10_0, arg_10_1, arg_10_2)
	if arg_10_1 == GAME.APARTMENT_REPLACE_FURNITURE_DONE then
		...
		for iter_10_0, iter_10_1 in pairs(var_10_0.skinIdList) do
			local var_10_1 = arg_10_0:GetSkinDict()[iter_10_1].ladyGameObject
...
function var_0_0.OnBeginDrag(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = CameraMgr.instance:Raycast(arg_12_0:GetSceneRaycaster(), var_12_0):ToTable()

	if #var_12_1 > 0 then
		local var_12_2 = var_12_1[1].gameObject.transform
		local var_12_3, var_12_4 = table.Find(var_0_0.L_COLLIDERS, function(arg_13_0, arg_13_1)
			return var_12_2.name == arg_13_1
		end)
		local var_12_5, var_12_6 = table.Find(var_0_0.R_COLLIDERS, function(arg_14_0, arg_14_1)
			return var_12_2.name == arg_14_1
		end)
		local var_12_7 = var_12_4 and 1 or var_12_6 and 2 or nil

		warning(var_12_2, var_12_7)

		if not var_12_7 or var_0_1.enable_drag[var_12_7] == 0 or not arg_12_0.isShow[var_12_7] then
			return
		end

		arg_12_0.inDragStocking = var_12_7
...
function var_0_0.OnDrag(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_1 = arg_15_2.delta

	arg_15_0:Emit(Dorm3dRoomTemplateScene.ON_STICK_MOVE, var_15_1)
end
...
function var_0_0.TriggerEvent(arg_18_0, arg_18_1, arg_18_2, arg_18_3)
	...
	switch(arg_18_1, {
		function()
			arg_18_0:Emit(Dorm3dRoomScene.EXTRA_DO_TALK, arg_18_2[1], var_18_0)
		end
	})
end
...
function var_0_0.InitStatus(arg_22_0, arg_22_1)
	...
	arg_22_0.mainCamera = arg_22_0:GetMainCameraTF():GetComponent(typeof(Camera))
...
function var_0_0.ResetLady(arg_27_0)
	local var_27_0 = arg_27_0:GetIKPointByName(var_0_1.character_position)
...
function var_0_0.SetStockingStatus(arg_28_0, arg_28_1)
	...
	seriesAsync({
		function(arg_29_0)
			arg_28_0:Emit(RoomIKSystem.ENTER_STOCKING_IK_MODE, arg_29_0)
		end,
		function(arg_30_0)
			arg_28_0:Emit(Dorm3dRoomScene.EXTRA_SET_UI, arg_30_0, "stocking")
		end,
		function(arg_31_0)
			arg_28_0:ResetLady()
			arg_28_0:Emit(Dorm3dRoomTemplateScene.EXTRA_ACTIVE_CAMERA_BY_NAME, var_0_1.camera)

			local var_31_0 = arg_28_0:GetCameraRoot():Find(var_0_1.camera):GetComponent(typeof(Cinemachine.CinemachineFreeLook))

			if var_31_0 then
				arg_28_0:Emit(Dorm3dRoomTemplateScene.EXTRA_REGISTER_ORBITS, var_31_0)
			end

			arg_28_0:Emit(Dorm3dRoomTemplateScene.EXTRA_PLAY_ENTER_SCENE_ANIM, var_0_1.enter_scene_anim)
			arg_28_0:Emit(Dorm3dRoomTemplateScene.EXTRA_PLAY_ENTER_EXTRA_ITEM, arg_28_0.ladyEnv, var_0_1.enter_extra_item)
			arg_28_0:Emit(Dorm3dRoomTemplateScene.EXTRA_HIDE_SCENE_ITEM, var_0_1.hide_scene_item)
...
function var_0_0.ExitStockingStatus(arg_33_0)
	seriesAsync({
		function(arg_34_0)
			arg_33_0:Emit(Dorm3dRoomScene.EXTRA_SET_UI, arg_34_0, "back")
		end,
		function(arg_35_0)
			...
			arg_33_0:Emit(Dorm3dRoomTemplateScene.EXTRA_RESET_SCENE_ITEM_ANIMATORS)
			arg_33_0:Emit(Dorm3dRoomTemplateScene.EXTRA_RESET_TEMP_HIDE_SCENE_ITEMS)
			arg_33_0:Emit(Dorm3dRoomTemplateScene.EXTRA_REVERT_CAMERA_ORBIT)
			arg_33_0:Emit(RoomIKSystem.EXIT_STOCKING_IK_MODE)
			arg_35_0()
		end
	})
end
...
function var_0_0.GetTipShowInfo(arg_38_0, arg_38_1)
	...
	for iter_38_0, iter_38_1 in ipairs(var_0_1.enable_drag) do
		if iter_38_1 == 1 then
			...
			arg_38_0:Emit(Dorm3dRoomTemplateScene.EXTRA_GET_SCREEN_POSITION, var_38_1, arg_38_0.tipDirections[iter_38_0][1].position, arg_38_0.mainCamera)

			local var_38_2 = {}

			arg_38_0:Emit(Dorm3dRoomTemplateScene.EXTRA_GET_SCREEN_POSITION, var_38_2, arg_38_0.tipDirections[iter_38_0][2].position, arg_38_0.mainCamera)

			local var_38_3 = {}

			arg_38_0:Emit(Dorm3dRoomTemplateScene.EXTRA_GET_SCREEN_POSITION, var_38_3, arg_38_0.tiptransforms[iter_38_0].position, arg_38_0.mainCamera)
			table.insert(var_38_0, {
				pos = var_38_3.value,
				dir = var_38_2.value - var_38_1.value
			})
		end
	end
	...
	if arg_38_0.useHideMode then
		for iter_38_2, iter_38_3 in ipairs(arg_38_0.sceneStockingTFs) do
			if not arg_38_0.isShow[iter_38_2] then
				...
				arg_38_0:Emit(Dorm3dRoomTemplateScene.EXTRA_GET_SCREEN_POSITION, var_38_5, iter_38_3.position, arg_38_0.mainCamera)
	...
	if arg_38_1 then
		...
		table.insert(arg_38_1, var_38_4)
	end
...
function var_0_0.GetStockingGeo(arg_39_0, arg_39_1)
	local var_39_0 = pg.dorm3d_resource[arg_39_1].stocking_geo_path

	if var_39_0 == "" then
		return nil, nil
	end

	local var_39_1 = arg_39_0:Find(var_39_0[1])
	local var_39_2 = arg_39_0:Find(var_39_0[2])
...
function var_0_0.IsUnlockStocking(arg_41_0, arg_41_1)
	...
	return true, arg_41_0:GetRoom():IsFurnitureSetIn(var_0_0.UNLOCK_CONFIG[arg_41_1])
end
