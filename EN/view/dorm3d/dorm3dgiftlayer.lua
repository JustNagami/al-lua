...
function var_0_0.UpdateFilterGiftIds(arg_15_0)
	arg_15_0.filterGiftIds = underscore.filter(arg_15_0.giftIds, function(arg_16_0)
		...
		if var_16_0.hide_if_not_owned == 1 and arg_15_0.proxy:getGiftCount(arg_16_0) <= 0 then
			return false
		end
...
function var_0_0.UpdateGift(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	local var_20_4 = pg.dorm3d_favor_trigger[var_20_1.cfg.favor_trigger_id].num

	setText(var_20_3:Find("favor/number"), "+" .. var_20_4)
	...
	local var_20_5 = Dorm3dGift.New({
		configId = arg_20_2
	})
	local var_20_6 = Dorm3dGift.IsSingleGiveGift(arg_20_2) and arg_20_0.proxy:isGiveGiftDone(arg_20_2)
	local var_20_7 = var_20_5:GetShopID()

	setActive(var_20_0:Find("info/lack"), var_20_7 ~= 0)

	if var_20_7 ~= 0 then
		local var_20_8 = CommonCommodity.New({
			id = var_20_7
		}, Goods.TYPE_SHOPSTREET)
		local var_20_9, var_20_10, var_20_11 = var_20_8:GetPrice()
		local var_20_12 = Drop.New({
			type = DROP_TYPE_RESOURCE,
			id = var_20_8:GetResType(),
			count = var_20_9
		})

		setActive(var_20_0:Find("info/lack/tip"), var_20_2 and not var_20_6 and Dorm3dGift.GetViewedFlag(arg_20_2) == 0)
		...
		if var_20_14 > 0 then
			var_20_13 = {
				getProxy(ApartmentProxy):GetGiftShopCount(var_20_5:GetConfigID()),
				var_20_14
			}
		end
		...
		onButton(arg_20_0, var_20_0:Find("info/lack"), function()
			...
			if not var_20_5:CheckBuyLimit() then
			...
			arg_20_0:emit(Dorm3dGiftMediator.SHOW_SHOPPING_CONFIRM_WINDOW, {
				content = {
					icon = "<icon name=" .. var_20_8:GetResIcon() .. " w=1.1 h=1.1/>",
					off = var_20_10,
					cost = var_20_12.count,
					old = var_20_11,
	...
	setActive(arg_20_1:Find("mask"), var_20_6)
	...
	;(function()
		...
		pressPersistTrigger(arg_20_1:Find("base/PageUtil/Minus"), 0.5, function()
			...
			var_27_0 = var_27_0 <= 0 and arg_20_0.selectGiftCount or var_27_0
		...
		pressPersistTrigger(arg_20_1:Find("base/PageUtil/Add"), 0.5, function()
			...
			var_28_0 = var_28_0 > var_26_0 and var_26_0 or var_28_0
	...
	setToggleEnabled(arg_20_1, not var_20_6)
...
function var_0_0.OnGiftListScroll(arg_31_0, arg_31_1)
	...
	local var_31_2 = var_31_0.rect.height
	local var_31_3 = var_31_0:GetChild(0).rect.height + var_31_1.spacing
	local var_31_4 = var_31_0.anchoredPosition.y
	local var_31_5 = var_31_4 + var_31_2
	local var_31_6 = math.floor((var_31_4 - var_31_1.padding.top) / var_31_3)
	local var_31_7 = math.ceil((var_31_5 - var_31_1.padding.top) / var_31_3)

	for iter_31_0 = math.max(1, var_31_6), math.min(#arg_31_0.filterGiftIds, var_31_7) do
		local var_31_8 = arg_31_0.filterGiftIds[iter_31_0]

		if not arg_31_0.showedGiftRecords[var_31_8] then
			arg_31_0.showedGiftRecords[var_31_8] = true

			local var_31_9 = Dorm3dGift.SetViewedFlag(var_31_8)
		end
	end
end
...
function var_0_0.ConfirmGiveGifts(arg_33_0)
	...
	if arg_33_0.apartment:isMaxFavor() then
		...
		local var_33_1 = pg.dorm3d_gift[arg_33_0.selectGiftId].favor_trigger_id
		local var_33_2 = pg.dorm3d_favor_trigger[var_33_1]
		local var_33_3 = arg_33_0.apartment.favor + var_33_2.num * arg_33_0.selectGiftCount - arg_33_0.apartment:getMaxFavor()

		if var_33_3 > 0 then
			table.insert(var_33_0, function(arg_35_0)
				pg.NewStyleMsgboxMgr.GetInstance():Show(pg.NewStyleMsgboxMgr.TYPE_MSGBOX, {
					contentText = i18n("dorm3d_gift_favor_exceed", var_33_3),
					onConfirm = arg_35_0
				})
			end)
		end
...
function var_0_0.AfterGiveGift(arg_37_0, arg_37_1)
	...
	local var_37_1 = table.indexof(arg_37_0.filterGiftIds, var_37_0)

	if var_37_1 then
		local var_37_2 = arg_37_0.giftItemList.container:GetChild(var_37_1 - 1)

		quickPlayAnimation(var_37_2, "anim_dorm3d_giftui_Select")
	end

	local var_37_3 = pg.dorm3d_gift[var_37_0]
	local var_37_4 = {}
	local var_37_5 = Apartment.getGroupConfig(arg_37_0.apartment.configId, var_37_3.reply_dialogue_id)

	if var_37_5 and ApartmentProxy.CheckUnlockConfig(pg.dorm3d_dialogue_group[var_37_5].unlock) then
		table.insert(var_37_4, function(arg_38_0)
			arg_37_0:emit(Dorm3dGiftMediator.DO_TALK, var_37_5, arg_38_0)
		end)
	end

	if var_37_3.unlock_dialogue_id > 0 then
		table.insert(var_37_4, function(arg_39_0)
			pg.TipsMgr.GetInstance():ShowTips(i18n("dorm3d_gift_story_unlock"))
			arg_39_0()
		end)
	end

	seriesAsync(var_37_4, function()
...
function var_0_0.OpenInfoWindow(arg_42_0, arg_42_1)
	...
	local var_42_1 = arg_42_1:getConfig("ship_group_id") ~= 0

	setActive(var_42_0:Find("middle/Dorm3dIconTpl/mark"), var_42_1)
...
function var_0_0.OpenLackWindow(arg_45_0, arg_45_1)
	...
	local var_45_1 = arg_45_1:getConfig("ship_group_id") ~= 0

	setActive(var_45_0:Find("middle/Dorm3dIconTpl/mark"), var_45_1)
	...
	local var_45_2 = ItemTipPanel.GetDropLackConfig(arg_45_1)
	local var_45_3 = var_45_2 and var_45_2.description or {}
	local var_45_4 = var_45_0:Find("bottom/container")

	UIItemList.StaticAlign(var_45_4, var_45_4:Find("tpl"), #var_45_3, function(arg_46_0, arg_46_1, arg_46_2)
		arg_46_1 = arg_46_1 + 1

		if arg_46_0 == UIItemList.EventUpdate then
			local var_46_0 = var_45_3[arg_46_1]
			local var_46_1, var_46_2, var_46_3 = unpack(var_46_0)

			setText(arg_46_2:Find("Text"), var_46_1)
			setText(arg_46_2:Find("btn_go/Text"), i18n("feast_res_window_go_label"))

			local var_46_4, var_46_5, var_46_6 = unpack(var_45_2)
			local var_46_7, var_46_8 = unpack(var_46_5)
			local var_46_9 = #var_46_7 > 0

			if var_46_6 and var_46_6 ~= 0 then
				var_46_9 = var_46_9 and getProxy(ActivityProxy):IsActivityNotEnd(var_46_6)
			end

			setActive(arg_46_2:Find("btn_go"), var_46_9)
			onButton(arg_45_0, arg_46_2:Find("btn_go"), function()
				ItemTipPanel.ConfigGoScene(var_46_7, var_46_8, function()
					arg_45_0:closeView()
				end)
			end, SFX_PANEL)
		end
