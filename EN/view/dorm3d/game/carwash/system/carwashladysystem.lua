...
function var_0_0.InitColliderMap(arg_16_0)
	...
	local var_16_0 = arg_16_0.ladyGO:GetComponentsInChildren(typeof(UnityEngine.Collider), true):ToTable()
...
function var_0_0.OnCommonRaycast(arg_20_0, arg_20_1)
	...
	if var_20_0.collider.gameObject.layer ~= CarWashConst.LADY_LAYER then
		arg_20_0:ResetHiddenReactionState()
	...
	if arg_20_0:TryHandleHiddenReaction(var_20_1, arg_20_1.deltaTime or Time.deltaTime) then
		return
	end

	arg_20_0:OnCharacterHit(var_20_0, arg_20_1.muzzleRay or arg_20_1.ray, var_20_1)
end
...
function var_0_0.OnCharacterHit(arg_25_0, arg_25_1, arg_25_2, arg_25_3)
	...
	if arg_25_3 and arg_25_0:CanTriggerReactionAnim() then
		local var_25_1 = arg_25_0:GetTriggerAnim(arg_25_3)
...
function var_0_0.IsMainCameraOnLeftSide(arg_27_0)
	...
	warning(Vector3.Dot(var_27_1, var_27_0) > 0 and "Camera is on the left side" or "Camera is on the right side")
...
function var_0_0.GetPhase2TipInfos(arg_29_0)
	assert(arg_29_0.posConfig.fury_anim and #arg_29_0.posConfig.fury_anim > 0, "CarWash phase2 fury_anim config is empty: " .. tostring(arg_29_0.posConfig.id))

	local var_29_0 = {}

	for iter_29_0, iter_29_1 in ipairs(arg_29_0.posConfig.fury_anim) do
		local var_29_1 = pg.dorm3d_carwash_animation[iter_29_1]

		assert(var_29_1, "CarWash phase2 animation config not found: " .. tostring(iter_29_1))
		assert(var_29_1.collider and var_29_1.collider[1], "CarWash phase2 animation collider config is empty: " .. tostring(iter_29_1))

		local var_29_2 = var_29_1.collider[1]
		local var_29_3 = arg_29_0.colliderMap[var_29_2]

		assert(var_29_3, "CarWash phase2 collider not found: " .. tostring(var_29_2))

		local var_29_4 = arg_29_0.mainCamera:WorldToScreenPoint(var_29_3.bounds.center)
...
function var_0_0.OnPlayPhase2Reaction(arg_30_0, arg_30_1)
	...
	local var_30_1 = pg.dorm3d_carwash_animation[var_30_0]

	assert(var_30_1, "CarWash phase2 animation config not found: " .. tostring(var_30_0))

	local var_30_2 = arg_30_0:GetTriggerAnim(var_30_1)

	assert(var_30_2 ~= "", "CarWash phase2 reaction animation not found: " .. tostring(var_30_0))
	warning("Play phase2 reaction anim: " .. var_30_2)
	arg_30_0:PlayReactionAnim(var_30_2, function()
...
function var_0_0.PlayAnim(arg_43_0, arg_43_1, arg_43_2)
	...
	local var_43_0 = string.find(arg_43_1, "^Face_")
	local var_43_1 = tobool(var_43_0)

	if not var_43_1 then
		local var_43_2 = string.find(arg_43_1, "^face_")

		var_43_1 = tobool(var_43_2)
	end
