...
function var_0_0.RegisterEvents(arg_1_0)
	...
	arg_1_0:Bind(RoomIKSystem.ON_IK_STATUS_CHANGED, function(arg_11_0, arg_11_1, arg_11_2)
		local var_11_0 = arg_1_0:GetCurrentLadyEnv()

		if not arg_1_0:Func("GetBlackboardValue", var_11_0, "inTouching") then
			return
		end
...
function var_0_0.EnterTouchMode(arg_17_0, arg_17_1)
	...
	table.insert(var_17_1, function(arg_20_0)
		...
		arg_17_0:Emit(RoomIKSystem.SET_IK_CONFIG, var_17_0, var_20_0)
...
function var_0_0.ExitTouchMode(arg_23_0)
	...
	if arg_23_0.inTouchGame then
		...
		table.insert(var_23_1, function(arg_26_0)
			...
			local var_26_0 = arg_23_0.touchConfig.default_favor

			if var_26_0 > 0 then
				arg_23_0:Emit(Dorm3dRoomMediator.TRIGGER_FAVOR, arg_23_0:Get("apartment").configId, var_26_0)
			end
	...
	seriesAsync(var_23_1, function()
		arg_23_0:Func("SetBlackboardValue", var_23_0, "inTouching", false)
		arg_23_0:Emit(Dorm3dRoomTemplateScene.HIDE_BLOCK)

		arg_23_0.touchConfig = nil

		local var_29_0 = arg_23_0.touchExitCall
	...
	return switch(arg_30_3, {
		...
		function()
			return function()
				...
				arg_30_0:Emit(RoomIKSystem.CONSUME_IK_SPECIAL_CALL, var_36_0)
		...
		function(arg_45_0)
			return function(arg_46_0)
				local var_46_0 = pg.dorm3d_ik_touch[arg_30_2]

				if #var_46_0.scene_item == 0 then
					return
				end

				local var_46_1 = arg_30_0:GetSceneItem(var_46_0.scene_item)

				if not var_46_1 then
					warning(string.format("dorm3d_ik_touch:%d without scene_item:%s", arg_30_2, var_46_0.scene_item))

					return
				end

				local var_46_2 = var_46_1:Find(arg_45_0)

				if not IsNil(var_46_2) then
					setActive(var_46_2, false)
					setActive(var_46_2, true)
				end
		...
		function(arg_47_0)
			local var_47_0 = pg.dorm3d_ik_touch_move[arg_47_0]
			local var_47_1 = var_47_0.target_ik
			local var_47_2 = var_47_0.move_time
			local var_47_3 = var_47_0.ik_point
			local var_47_4 = var_47_0.touch_step

			arg_30_1.IKSettings.forceMove = arg_30_1.IKSettings.forceMove or {}

			local var_47_5 = arg_30_1.IKSettings.forceMove

			var_47_5[var_47_1] = var_47_5[var_47_1] or {}
			var_47_5[var_47_1].count = var_47_5[var_47_1].count or 0

			return function(arg_48_0)
				seriesAsync({
					function(arg_49_0)
						if var_47_5[var_47_1].count >= #var_47_4 then
							return arg_49_0()
						end
						...
						local var_49_1 = Vector2.New(unpack(var_47_3))
						local var_49_2 = var_47_5[var_47_1].count

						var_47_5[var_47_1].count = var_49_2 + 1

						pg.IKMgr.GetInstance():ResetIK(var_49_0:GetTriggerBoneName())

						local var_49_3 = arg_30_1.IKSettings.Colliders[var_49_0:GetTriggerBoneName()]
						local var_49_4 = arg_30_0:Get("raycastCamera"):WorldToScreenPoint(var_49_3.position)

						pg.IKMgr.GetInstance():PlayIKMove(var_49_4, var_49_0:GetTriggerBoneName(), var_49_1, var_47_4[var_49_2 + 1], var_47_2, function()
							var_47_5[var_47_1].count = 0
		...
		function(arg_53_0, arg_53_1)
			return function()
				local var_54_0 = arg_30_0:Get("apartment"):GetConfigID()

				arg_30_0:Emit(RoomIKSystem.SET_IK_SWITCH_SKIN_ID, arg_30_0:Get("apartment"):GetCurSkinId())
				arg_30_1:SwitchCharacterSkin(var_54_0, arg_53_0)
...
function var_0_0.GetTouchConfigSourceTarget(arg_59_0, arg_59_1, arg_59_2)
	local var_59_0 = type(arg_59_1.body) == "string" and arg_59_1.body ~= ""
	local var_59_1 = type(arg_59_1.scene_item) == "string" and arg_59_1.scene_item ~= ""

	assert(var_59_0 ~= var_59_1, "Invalid dorm3d_ik_touch source: " .. tostring(arg_59_2 or arg_59_1.id))
...
function var_0_0.AssertTouchConfig(arg_60_0, arg_60_1)
	...
	assert(var_60_0, "Missing dorm3d_ik_touch config: " .. tostring(arg_60_1))
...
function var_0_0.ValidateTouchConfigs(arg_61_0, arg_61_1, arg_61_2)
	...
	_.each(arg_61_1, function(arg_62_0)
		...
		local var_62_1 = arg_61_0:AssertTouchConfig(var_62_0)
		local var_62_2, var_62_3 = arg_61_0:GetTouchConfigSourceTarget(var_62_1, var_62_0)
		local var_62_4 = var_62_2 .. ":" .. var_62_3 .. ":" .. tostring(var_62_1.trigger_type)

		assert(not var_61_0[var_62_4], string.format("Duplicate dorm3d_ik_touch trigger: ids=%s,%s source=%s target=%s trigger_type=%s", tostring(var_61_0[var_62_4]), tostring(var_62_0), var_62_2, var_62_3, tostring(var_62_1.trigger_type)))

		var_61_0[var_62_4] = var_62_0
	end)
end
...
function var_0_0.OnTouchPressDown(arg_65_0, arg_65_1, arg_65_2, arg_65_3)
	...
	var_65_4.timer = Timer.New(function()
...
function var_0_0.OnTouchPressUp(arg_67_0, arg_67_1, arg_67_2)
	...
	local var_67_1 = arg_67_0.touchPressStates and arg_67_0.touchPressStates[var_67_0] or nil
	local var_67_2 = var_67_1 and var_67_1.triggered or arg_67_0.touchPressConsumed and arg_67_0.touchPressConsumed[var_67_0]
...
function var_0_0.CancelTouchPress(arg_70_0, arg_70_1, arg_70_2)
	...
	local var_70_1 = arg_70_0.touchPressStates[var_70_0]

	if var_70_1 and var_70_1.timer then
		var_70_1.timer:Stop()
	end
...
function var_0_0.UpdateHoldProgress(arg_73_0)
	...
	for iter_73_0, iter_73_1 in pairs(arg_73_0.touchPressStates) do
		if not iter_73_1.triggered and iter_73_1.holdTime > var_0_0.HOLD_PROGRESS_SHOW_DELAY then
			local var_73_0 = Time.time - iter_73_1.startTime

			if var_73_0 >= var_0_0.HOLD_PROGRESS_SHOW_DELAY then
				arg_73_0.holdProgressActive = true

				arg_73_0:Emit(Dorm3dIKView.UPDATE_HOLD_PROGRESS, true, iter_73_1.screenPosition, var_73_0 / iter_73_1.holdTime)
...
function var_0_0.TriggerTouchInfo(arg_74_0, arg_74_1)
	...
	local var_74_5 = var_74_4.action_emote

	if #var_74_5 > 0 then
		arg_74_0:Func("PlayFaceAnim", var_74_0, var_74_5)
	end

	local var_74_6 = var_74_4.vibrate

	if type(var_74_6) == "table" and VibrateMgr.Instance:IsSupport() then
		local var_74_7 = {}
		local var_74_8 = {}
		local var_74_9 = {}

		underscore.each(var_74_6, function(arg_75_0)
			...
			table.insert(var_74_7, var_75_0)
			table.insert(var_74_8, arg_75_0[2])
			table.insert(var_74_9, 1)
		end)

		if PLATFORM == PLATFORM_ANDROID then
			VibrateMgr.Instance:VibrateWaveform(var_74_7, var_74_8)
		elseif PLATFORM == PLATFORM_IPHONEPLAYER then
			VibrateMgr.Instance:VibrateWaveform(var_74_7, var_74_8, var_74_9)
		end
	end
...
function var_0_0.UpdateTouchCount(arg_77_0, arg_77_1)
	...
	local var_77_1 = arg_77_0.touchLevel > 1 and 200 or 100

	arg_77_0.touchCount = math.clamp(arg_77_0.touchCount + arg_77_1, var_77_0, var_77_1)
	...
	if var_77_2 and var_77_2 ~= arg_77_0.touchLevel then
		...
		arg_77_0:Emit(RoomIKSystem.GET_IK_BLOCK, var_77_3)

		if var_77_3.blockIK then
		...
		local var_77_4 = arg_77_0.touchConfig.ik_status[var_77_2]
		...
		if var_77_4 then
			...
			local var_77_5 = arg_77_0:GetCurrentLadyEnv()
			...
			seriesAsync({
				...
				function(arg_79_0)
					arg_77_0:Emit(RoomIKSystem.SET_IK_CONFIG, var_77_5, var_77_4)
					arg_77_0:Emit(RoomIKSystem.SET_IK_STATE, true, arg_79_0)

					if var_77_2 > 1 and arg_77_0.touchConfig.heartbeat_enter_anim ~= "" then
						arg_77_0:Func("SwitchAnim", var_77_5, arg_77_0.touchConfig.heartbeat_enter_anim)
					end
				end,
				function(arg_80_0)
