...
function var_0_0.InitWindow(arg_1_0, arg_1_1, arg_1_2)
	...
	if var_1_1 and var_1_2 then
		...
		local var_1_5 = pg.TimeMgr.GetInstance():STimeDescS(var_1_4.stopTime, "%m.%d")
		local var_1_6 = var_1_4:IsMaintenanceFinish() and "eventshop_time_hint" or "eventshop_time_hint2"

		setText(arg_1_0.timeLimitTF:Find("Text"), i18n(var_1_6, var_1_5))
	end
	...
	local var_1_8 = math.max(math.floor(var_1_7 / arg_1_1:getConfig("resource_num")), 1)

	if arg_1_1:getConfig("goods_purchase_limit") ~= 0 then
		local var_1_9 = arg_1_1:GetPurchasableCnt()

		var_1_8 = math.min(var_1_8, math.max(0, var_1_9))
	end

	local function var_1_10(arg_2_0)
		arg_2_0 = math.max(arg_2_0, 1)
		arg_2_0 = math.min(arg_2_0, var_1_8)
