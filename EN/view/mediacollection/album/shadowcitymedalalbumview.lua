local var_0_0 = class("ShadowCityMedalAlbumView", import(".MedalAlbumTemplateView"))

var_0_0.GROUP_ID = 51143
...
function var_0_0.FindUI(arg_2_0)
	...
	arg_2_0.medalDetailView = ShadowCityMedalDetailPanel.New(arg_2_0._tf:Find("DetailView"), arg_2_0)
