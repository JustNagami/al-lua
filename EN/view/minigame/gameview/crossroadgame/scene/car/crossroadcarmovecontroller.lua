...
function var_0_0.SetSpCarState(arg_4_0, arg_4_1)
	...
	if var_4_0 == arg_4_0.spCarState.start then
		if arg_4_1:GetId() == CrossRoadGameConst.XINZEXI then
			local var_4_1 = arg_4_1:GetSpTrackId()
			local var_4_2 = arg_4_0:GetNearTrackId(var_4_1)
			local var_4_3 = arg_4_0:GetDownerthirdPosByTrackId(var_4_2)

			arg_4_1:SetSpTrackId(var_4_2)
			arg_4_1:SetTarget(var_4_3)
			arg_4_1:SetState(arg_4_0.spCarState.mid)
		else
			arg_4_0:SetSpCarInMoveEnd(arg_4_1)
		end
	elseif var_4_0 == arg_4_0.spCarState.mid then
		local var_4_4 = arg_4_1:GetSpTrackId()
		local var_4_5 = arg_4_0:GetNearTrackId(var_4_4)

		arg_4_1:SetSpTrackId(var_4_5)
		arg_4_0:SetSpCarInMoveEnd(arg_4_1)
...
function var_0_0.SetCarInSceneTrack(arg_6_0, arg_6_1)
	...
	local var_6_1 = arg_6_0.sceneRoadTF:Find(tostring(var_6_0))
	local var_6_2 = arg_6_0.sceneRoadList[var_6_0].startTF.anchoredPosition
	local var_6_3 = arg_6_0.sceneRoadList[var_6_0].midTF.anchoredPosition

	arg_6_1:SetParent(var_6_1)
	arg_6_1:SetPosition(var_6_2)

	if CrossRoadGameHelper:CheckIsSPCar(arg_6_1:GetId()) then
		arg_6_1:SetSpTrackId(arg_6_0:GetNearTrackId(var_6_0))

		var_6_3 = arg_6_0:GetUperQuarterPosByTrackId(var_6_0)

		arg_6_1:SetTarget(var_6_3)
...
function var_0_0.UpdateCarMove(arg_8_0, arg_8_1, arg_8_2)
	...
	if var_8_5 == CrossRoadGameConst.FRONT_ROAD_NAME then
		arg_8_0:SpCarCheckAndMakeItem(arg_8_1, var_8_10, var_8_0)
...
function var_0_0.SpCarCheckAndMakeItem(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	...
	if CrossRoadGameHelper:isMiddle(arg_9_3.y, arg_9_0.itemLine, arg_9_2.y) and arg_9_0:CanSpCarMakeItem(arg_9_1) then
		...
		if arg_9_1:GetId() == CrossRoadGameConst.XINZEXI then
			...
			arg_9_0._event(CrossRoadGameConst.MAKE_XUAN_WO, var_9_0)
		end
	end
end
...
function var_0_0.CanSpCarMakeItem(arg_12_0, arg_12_1)
	...
	if arg_12_1:GetId() == CrossRoadGameConst.XINZEXI then
		var_12_1 = CrossRoadGameConst.BINGMIAN_MAKE_PROBABILITY
	else
		var_12_1 = CrossRoadGameConst.XUANWO_MAKE_PROBABILITY
	end
...
function var_0_0.GetNorCarDirct(arg_15_0, arg_15_1, arg_15_2)
	...
	local var_15_1 = CrossRoadGameHelper:GetPosDis(arg_15_1, var_15_0)
...
function var_0_0.GetEndCarDirct(arg_16_0, arg_16_1, arg_16_2)
	...
	local var_16_1 = CrossRoadGameHelper:GetPosDis(arg_16_1, var_16_0)
...
function var_0_0.GetUperQuarterPosByTrackId(arg_18_0, arg_18_1)
	...
	local var_18_2 = CrossRoadGameHelper:GetHalfPos(var_18_0, var_18_1)

	return (CrossRoadGameHelper:GetHalfPos(var_18_0, var_18_2))
end
...
function var_0_0.GetDownerthirdPosByTrackId(arg_19_0, arg_19_1)
	...
	return (CrossRoadGameHelper:GetThirdPos(var_19_1, var_19_0))
end
