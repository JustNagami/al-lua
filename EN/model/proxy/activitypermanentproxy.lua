...
function var_0_0.IsActivityGroupByType(arg_8_0, arg_8_1, arg_8_2)
	local var_8_0 = var_0_0.ACTIVITY_GROUP_RANGES[arg_8_2]

	return var_8_0 and arg_8_1 >= var_8_0.min and arg_8_1 <= var_8_0.max
end

function var_0_0.GetActivityTypeById(arg_9_0, arg_9_1)
	local var_9_0 = pg.activity_task_permanent[arg_9_1]
	...
	for iter_9_0, iter_9_1 in pairs(var_0_0.ACTIVITY_GROUP_RANGES) do
		if arg_9_0:IsActivityGroupByType(var_9_0.activity_group, iter_9_0) then
			return iter_9_0
		end
	end
...
function var_0_0.getDoingActivityId(arg_14_0, arg_14_1, arg_14_2)
	...
	for iter_14_0, iter_14_1 in ipairs(arg_14_0.doingActivities or {}) do
...
function var_0_0.getDoingActivityById(arg_15_0, arg_15_1, arg_15_2)
	...
	return var_15_0 and getProxy(ActivityProxy):getActivityById(var_15_0) or nil
end
