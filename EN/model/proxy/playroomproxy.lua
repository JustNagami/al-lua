...
function var_0_0.GetPlayer(arg_2_0, arg_2_1)
	return arg_2_0.playerDataList and arg_2_0.playerDataList[arg_2_1] or nil
end
...
function var_0_2.UpdatePlayerList(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_2) do
		...
		table.insert(arg_5_0.playerList, var_5_0)

		arg_5_0.playerDataList[var_5_0] = var_0_1.New(iter_5_1)
	end
...
function var_0_2.GetPlayer(arg_6_0, arg_6_1)
	return arg_6_0.playerDataList and arg_6_0.playerDataList[arg_6_1] or nil
end
...
function var_0_3.UpdatePlayerList(arg_8_0, arg_8_1, arg_8_2, arg_8_3)
	...
	for iter_8_0, iter_8_1 in ipairs(arg_8_1) do
		...
		table.insert(arg_8_0.playerList, var_8_0)

		arg_8_0.playerDataList[var_8_0] = var_0_1.New(iter_8_1)
	end
...
function var_0_3.GetPlayer(arg_9_0, arg_9_1)
	return arg_9_0.playerDataList and arg_9_0.playerDataList[arg_9_1] or nil
end
...
function var_0_4.UpdatePlayerList(arg_11_0, arg_11_1, arg_11_2, arg_11_3)
	...
	for iter_11_0, iter_11_1 in ipairs(arg_11_1) do
		...
		table.insert(arg_11_0.playerList, var_11_0)

		arg_11_0.playerDataList[var_11_0] = var_0_1.New(iter_11_1)
	end
	...
	arg_13_0:on(23096, function(arg_15_0)
		...
		if arg_13_0.roomData and arg_13_0.roomData.roomType == PlayRoomConst.PLAY_ROOM_TYPE.MATCH then
			if arg_13_0.matchReadyRoom == nil then
				...
				local var_15_0 = arg_13_0.matchReadyRoom.readyList
				local var_15_1 = getProxy(PlayerProxy):getPlayerId()
				local var_15_2 = table.keyof(var_15_0, var_15_1)
				local var_15_3 = arg_13_0.matchReadyRoom.endTimestamp

				arg_13_0:ExitMatchReadyRoom()

				if arg_13_0.matchStartTime then
					local var_15_4 = pg.TimeMgr.GetInstance():GetServerTime() - arg_13_0.matchStartTime

					pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildPlayRoomMatch("bar", 2, 1, var_15_4, 2))
...
function var_0_6.ExitRoom(arg_24_0)
	...
	if arg_24_0.matchStartTime then
		local var_24_0 = pg.TimeMgr.GetInstance():GetServerTime() - arg_24_0.matchStartTime

		pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildPlayRoomMatch("bar", 2, 1, var_24_0, 1))
...
function var_0_6.AddInviteList(arg_27_0, arg_27_1)
	...
	table.insert(arg_27_0.inviteList, {
...
function var_0_6.GetInviteRecordList(arg_33_0)
	local var_33_0 = pg.gameset.match_refuseCD.key_value
	local var_33_1 = pg.TimeMgr.GetInstance():GetServerTime()

	for iter_33_0 = #arg_33_0.inviteRecordList, 1, -1 do
		if var_33_1 >= arg_33_0.inviteRecordList[iter_33_0].timestamp + var_33_0 then
...
function var_0_6.UpdateMatchRoomData(arg_36_0, arg_36_1)
	...
	if arg_36_0.matchReadyRoom == nil then
		...
		if arg_36_0.matchStartTime then
			local var_36_1 = pg.TimeMgr.GetInstance():GetServerTime() - arg_36_0.matchStartTime

			pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildPlayRoomMatch("bar", 2, 1, var_36_1, 3))
...
function var_0_6.GetMatchFlag(arg_41_0)
	return arg_41_0.matchReadyRoom == nil and arg_41_0:GetMatchTime() >= pg.TimeMgr.GetInstance():GetServerTime()
end
...
function var_0_6.AddChatMsg(arg_50_0, arg_50_1)
	local var_50_0 = ChatProxy.InjectPublicMsg(arg_50_1.content, Player.New(arg_50_1.player))
	local var_50_1 = ChatMsg.New(ChatConst.ChannelPlayRoom, var_50_0)

	var_50_1.typePlayRoom = arg_50_1.type

	table.insert(arg_50_0.chatMsgs, var_50_1)
...
function var_0_6.GetSelfRankData(arg_55_0, arg_55_1)
	...
	arg_55_0.selfRankData[arg_55_1]:UpdateData({
		score = PlayRoomTools.GetPtScrore(arg_55_1),
		player = {
			id = var_55_0.id,
			level = var_55_0.level,
			name = var_55_0.name,
			guild_name = var_55_1 and var_55_1.name or "",
			display = var_55_0.displayInfo
		}
	}, 0)
