...
function var_0_0.GetEstimateValue(arg_11_0)
	if arg_11_0.id ~= nil and arg_11_0.id ~= 0 then
		local var_11_0 = pg.auction_collection[arg_11_0.id].value
	...
	if arg_11_0.showRarity ~= true and arg_11_0.showContour ~= true then
		var_11_1 = Clone(pg.auction_collection.all)
	else
		local var_11_2 = {}

		if arg_11_0.showRarity then
			var_11_2 = Clone(pg.auction_collection.get_id_list_by_rarity[arg_11_0.rarity])
		else
			var_11_2 = Clone(pg.auction_collection.all)
		end

		if arg_11_0.showContour then
			for iter_11_0, iter_11_1 in ipairs(var_11_2) do
				local var_11_3 = pg.auction_collection[iter_11_1].contour

				if arg_11_0.contour[1] == var_11_3[1] and arg_11_0.contour[2] == var_11_3[2] then
	...
	for iter_11_2, iter_11_3 in ipairs(var_11_1) do
		local var_11_6 = pg.auction_collection[iter_11_3]

		if var_11_4 == 0 or var_11_4 > var_11_6.value then
			var_11_4 = var_11_6.value
		end

		if var_11_5 == 0 or var_11_5 < var_11_6.value then
			var_11_5 = var_11_6.value
		end
	end
