return {
	...
	scripts = {
		{
			say = "Hmm. Signal normal... Angle normal... Alright.",
			wait = 1,
		...
		{
			say = "Oh, Commander... Has the call already started?",
			wait = 1,
		...
		{
			say = "I'm not interrupting your work at this hour, am I?",
			wait = 1,
			voice = "event:/dorm/dorm3d_nakhimov_telephone3/dorm3d_nakhimov_telephone3",
			options = {
				{
					content = "Don't worry. I wanted to hear your voice.",
					flag = 1
				}
			},
			dispatcher = {
		...
		{
			say = "I'm glad... I was just adjusting my video call settings.",
			wait = 1,
		...
		{
			say = "The plan was to call you later, when I wouldn't disturb your work.",
			wait = 1,
		...
		{
			say = "But my cable tapped the call button...",
			wait = 1,
		...
		{
			say = "Umm... Actually, I was thinking of where to position my device for this call.",
			wait = 1,
		...
		{
			say = "The angle I would look prettiest from... What we'd talk about during the call...",
			wait = 1,
			voice = "event:/dorm/dorm3d_nakhimov_telephone8/dorm3d_nakhimov_telephone8"
		},
		{
			say = "I was thinking of discussing that piece of equipment you had me inspect a while back.",
			wait = 2,
		...
		{
			say = "It's fixed, though, so there isn't much more to talk about.",
			wait = 2,
		...
		{
			say = "It made me wonder. If I pretended to still have questions, would it mean I'd get to talk to you longer...?",
			wait = 1,
		...
		{
			say = "I also thought of how I should stand, and what kind of face I should make...",
			wait = 1,
		...
		{
			say = "But when I accidentally placed the call, all of it slipped my mind.",
			wait = 1,
		...
		{
			say = "Urk... This is harder than I thought. I'm oddly nervous.",
			wait = 1,
		...
		{
			say = "Even though we're talking through a screen, it makes my heart race more than when we're face-to-face...",
			wait = 2,
			voice = "event:/dorm/dorm3d_nakhimov_telephone15/dorm3d_nakhimov_telephone15",
			options = {
				{
					content = "You're plenty cute as you are, nervous and all.",
					flag = 1
				}
			},
			dispatcher = {
		...
		{
			say = "R-really? Okay... I won't prepare next time.",
			wait = 0.5,
		...
		{
			say = "Commander, you may call me anytime, anywhere.",
			wait = 0.5,
		...
		{
			say = "I'll always be waiting for you.",
			wait = 0.5,
