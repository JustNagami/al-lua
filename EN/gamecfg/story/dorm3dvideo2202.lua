return {
	...
	scripts = {
		...
		{
			say = "I've been wondering and wondering what you were doing, Commander.",
			wait = 1,
		...
		{
			say = "I was so distracted by the thought, I couldn't fully engage in the task in front of me. So I decided to give you a ring...",
			wait = 1,
		...
		{
			say = "Heehee. I'm always honest when it comes to my desires.",
			wait = 1,
		...
		{
			say = "When feelings smoulder in silence, isn't it better to put them into words?",
			wait = 1,
		...
		{
			say = "I want to brew tea for you, look at your face as you drink it, and hear you tell me how good it is.",
			wait = 1,
		...
		{
			say = "These urges arise one after another with no indication they will stop.",
			wait = 2,
		...
		{
			say = "Does it trouble you that I am like this, Commander?",
			wait = 2,
		...
		{
			say = "You always indulge me like that.",
			wait = 1,
		...
		{
			say = "I might end up all the more dependent on you at this rate.",
			wait = 1,
		...
		{
			say = "Even though I am supposed to be the one offering you guidance and company...",
			wait = 1,
		...
		{
			say = "At some point, I started thinking of nothing but being by your side... longing for that warmth.",
			wait = 1,
		...
		{
			say = "Perhaps I should abstain a little after all...",
			wait = 2,
			voice = "event:/dorm/dorm3d_implacable_telephone31/dorm3d_implacable_telephone31",
			options = {
				{
					content = "Depend on me as much as you want.",
					flag = 1
				}
			},
			dispatcher = {
		...
		{
			say = "But you won't be satisfied if the dependence is so one-sided, will you?",
			wait = 1,
		...
		{
			say = "I wonder what I must do for you to bare everything to me too...",
			wait = 1,
		...
		{
			say = "Heehee, this will take some serious thought.",
			wait = 1,
		...
		{
			say = "I won't stop until you entrust me with it all. Your delight and your lament.",
			wait = 1,
		...
		{
			say = "Hmm, the heat of my passion cannot be transmitted through mere words on a screen.",
			wait = 1,
		...
		{
			say = "I must express my feelings face-to-face and as they are.",
			wait = 1,
		...
		{
			say = "So I shall leave the rest for when we meet.",
			wait = 1,
		...
		{
			say = "I'll be waiting here for you always.",
			wait = 1,
