	...
	scripts = {
		{
			nameColor = "#FFFFFF",
			actorName = 20707,
			say = "Commander, I'm writing them in every last line... my eternal feelings for you.",
		...
		},
		{
			nameColor = "#FFFFFF",
			actorName = 20707,
			say = "I shall do all that is required for my confession... because of my love for you.",
