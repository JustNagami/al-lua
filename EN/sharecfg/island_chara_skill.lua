...
;(function()
	...
	pg.base.island_chara_skill[1023] = {
		...
		icon = "chara_all_skill_8",
		desc = "Stamina recovery is decreased by $1%, but working speed is increased by $2%.",
		desc_add = {
			{
				{
					"10"
	...
	pg.base.island_chara_skill[1024] = {
		id = 1024,
		name = "Harvesting Expertise",
		icon = "chara_all_skill_9",
		desc = "When working in Newsprout Nursery, there is a $1% chance of getting additional output with each harvest.",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1025] = {
		id = 1025,
		name = "Explosives Expertise",
		icon = "chara_all_skill_1",
		desc = "When working in Rockheap Mine, there is a $1% chance of getting additional output with each time work is done.",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1026] = {
		id = 1026,
		name = "Grilling Expertise",
		icon = "chara_all_skill_13",
		desc = "When working at the Fin-'n'-Feather Grill, +1 menu item slots and revenue from food increases by $1%.",
		desc_add = {
			{
				{
					"4"
	...
	pg.base.island_chara_skill[1027] = {
		id = 1027,
		name = "Logging Expertise",
		icon = "chara_all_skill_16",
		desc = "When assigned to process lumber at the Base Factory, increases working speed by $1%.",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1028] = {
		...
		icon = "chara_all_skill_14",
		desc = "When assigned to the manual workbench at the Base Factory, there is a $1% chance of getting additional output each time work is done.",
		desc_add = {
			{
				{
					"6"
	...
	pg.base.island_chara_skill[1029] = {
		...
		name = "Full of Energy",
		icon = "chara_all_skill_8",
		desc = "When working in the Verdant Woods, lumber production time is shortened by $1%. When Mogador's stamina is below 70, greeting her recovers $2 of her stamina (once per day).",
		desc_add = {
			{
				{
					"1"
	...
	pg.base.island_chara_skill[1030] = {
		...
		icon = "chara_all_skill_12",
		desc = "When assigned as staff to any store, stamina consumption is reduced by $1%. Additionally, that store's menu item slots +1.",
		desc_add = {
			{
				{
					"3"
	...
	pg.base.island_chara_skill[1031] = {
		...
		desc = "Once per day, greet Royal Fortune to obtain a random reward ($1).",
		desc_add = {
			{
				{
					"Lv1"
	...
	pg.base.island_chara_skill[1032] = {
		...
		icon = "chara_all_skill_4",
		desc = "When working at Café Manjuu, there is a $1% chance of getting additional output each time work is done. Increases sales from food by $2%.",
		desc_add = {
			{
				{
					"1"
