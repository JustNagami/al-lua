...
;(function()
	pg.base.dorm3d_ins_chat_language[1] = {
		param = "Master, are you satisfied with the furnishings in the room?",
		ship_group = 20220,
		flag = 0,
		type = 1,
		id = 1,
		option = {
			{
				1,
				"Was it you who picked them?"
			}
		}
	}
	pg.base.dorm3d_ins_chat_language[2] = {
		param = "Was it you who picked them?",
		ship_group = 0,
		type = 1,
		option = "",
		id = 2,
	...
	pg.base.dorm3d_ins_chat_language[4] = {
		param = "A properly decorated room can calm the mind and bring comfort, particularly when all is arranged harmoniously.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 4,
	...
	pg.base.dorm3d_ins_chat_language[5] = {
		param = "As your humble maid, ensuring this is my natural duty.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 5,
	...
	pg.base.dorm3d_ins_chat_language[6] = {
		param = "Therefore, I made some arrangements to provide you with a more relaxing experience.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 6,
	...
	pg.base.dorm3d_ins_chat_language[7] = {
		param = "If I may ask, are the results to your liking?",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 7,
	...
	pg.base.dorm3d_ins_chat_language[9] = {
		param = "I can tell you worked hard on this. I appreciate the sentiment.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 9,
	...
	pg.base.dorm3d_ins_chat_language[10] = {
		param = "That being said, I want you to prioritize your own comfort a little more.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 10,
	...
	pg.base.dorm3d_ins_chat_language[12] = {
		param = "The reason for that being...",
		ship_group = 0,
		type = 1,
		option = "",
		id = 12,
	...
	pg.base.dorm3d_ins_chat_language[13] = {
		param = "Whenever you're here with me, I feel so at ease.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 13,
	...
	pg.base.dorm3d_ins_chat_language[14] = {
		param = "I want you by my side forever, and I want you to feel relaxed when you are there.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 14,
	...
	pg.base.dorm3d_ins_chat_language[17] = {
		param = "Likewise, I also feel at ease when you're by my side, my honourable Master!",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 17,
	...
	pg.base.dorm3d_ins_chat_language[18] = {
		param = "My honourable Master, are you perhaps interested in my collection?",
		ship_group = 20220,
		flag = 0,
		type = 1,
		id = 18,
	...
	pg.base.dorm3d_ins_chat_language[20] = {
		param = "Some of them make me feel a little... concerned.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 20,
	...
	pg.base.dorm3d_ins_chat_language[22] = {
		param = "Forgive me, Master, for letting you see this unseemly side of me...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 22,
	...
	pg.base.dorm3d_ins_chat_language[23] = {
		param = "A maid in your service should never commit such a careless faux pas...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 23,
	...
	pg.base.dorm3d_ins_chat_language[24] = {
		param = "Please punish me for this shameful digression, my honourable Master!",
		ship_group = 20220,
		flag = 1,
		type = 1,
		id = 24,
	...
	pg.base.dorm3d_ins_chat_language[26] = {
		param = "In fact, I like this side of you.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 26,
	...
	pg.base.dorm3d_ins_chat_language[29] = {
		param = "Despite my evident indecency, you still wish to be with me and engage in...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 29,
	...
	pg.base.dorm3d_ins_chat_language[31] = {
		param = "Umm, it just occurred to me...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 31,
	...
	pg.base.dorm3d_ins_chat_language[32] = {
		param = "I once again jumped to conclusions, didn't I? I'm terribly sorry...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 32,
	...
	pg.base.dorm3d_ins_chat_language[33] = {
		param = "You seem to express a great deal of care for me, my honourable Master.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 33,
	...
	pg.base.dorm3d_ins_chat_language[34] = {
		param = "Is there anything you would like to discuss with me?",
		ship_group = 20220,
		flag = 0,
		type = 1,
		id = 34,
	...
	pg.base.dorm3d_ins_chat_language[35] = {
		param = "No, nothing in particular.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 35,
	...
	pg.base.dorm3d_ins_chat_language[36] = {
		param = "Though I will say that every time I look at you, it feels like all my stress goes away.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 36,
	...
	pg.base.dorm3d_ins_chat_language[38] = {
		param = "Easing your mind is but one of my duties as your humble maid.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 38,
	...
	pg.base.dorm3d_ins_chat_language[39] = {
		param = "Should you request it, I am always ready to be by your side.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 39,
	...
	pg.base.dorm3d_ins_chat_language[40] = {
		param = "Judging by your phrasing, am I correct in assuming that some stress still lingers within you?",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 40,
	...
	pg.base.dorm3d_ins_chat_language[41] = {
		param = "If that is the case, please allow me to take care of it.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 41,
	...
	pg.base.dorm3d_ins_chat_language[42] = {
		param = "I pledge to help you completely regain your spirits so that you may resume work at full capacity!",
		ship_group = 20220,
		flag = 1,
		type = 1,
		id = 42,
	...
	pg.base.dorm3d_ins_chat_language[44] = {
		param = "I have work I need to do right after this, so I'm short on time...",
		ship_group = 0,
		type = 1,
		option = "",
		id = 44,
	...
	pg.base.dorm3d_ins_chat_language[45] = {
		param = "That's not a problem! All I ask for is that you allow me to run a bath for you!",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 45,
	...
	pg.base.dorm3d_ins_chat_language[46] = {
		param = "The only thing you need to do is lie back, relax, and allow me to give you my service.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 46,
	...
	pg.base.dorm3d_ins_chat_language[47] = {
		param = "Furthermore, if you should ever ask for it...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 47,
	...
	pg.base.dorm3d_ins_chat_language[48] = {
		param = "I'm fully prepared to offer myself to you!",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 48,
	...
	pg.base.dorm3d_ins_chat_language[49] = {
		param = "Master... are you fond of my appearance?",
		ship_group = 20220,
		flag = 0,
		type = 1,
		id = 49,
	...
	pg.base.dorm3d_ins_chat_language[50] = {
		param = "Yeah. You're just so cute.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 50,
	...
	pg.base.dorm3d_ins_chat_language[51] = {
		param = "I couldn't help but snap a photo.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 51,
	...
	pg.base.dorm3d_ins_chat_language[53] = {
		param = "You flatter me with your compliments, Master.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 53,
	...
	pg.base.dorm3d_ins_chat_language[54] = {
		param = "While I don't believe I deserve to be called cute, if cuteness is what you want, I shall strive to be more like that!",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 54,
	...
	pg.base.dorm3d_ins_chat_language[55] = {
		param = "It is, after all, a maid's duty to do everything in power to live up to her Master's hopes and desires.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 55,
	...
	pg.base.dorm3d_ins_chat_language[56] = {
		param = "On the subject of photographs...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 56,
	...
	pg.base.dorm3d_ins_chat_language[57] = {
		param = "Would it be alright if I took a picture of you next time?",
		ship_group = 20220,
		flag = 1,
		type = 1,
		id = 57,
	...
	pg.base.dorm3d_ins_chat_language[59] = {
		param = "What do you want that for?",
		ship_group = 0,
		type = 1,
		option = "",
		id = 59,
	...
	pg.base.dorm3d_ins_chat_language[60] = {
		param = "You always maintain an air of nobility, and I would like something to remember that by.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 60,
	...
	pg.base.dorm3d_ins_chat_language[61] = {
		param = "Just as your photo preserved my look in an instant, I want to preserve yours to cherish it.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 61,
	...
	pg.base.dorm3d_ins_chat_language[62] = {
		param = "Master, is this a gift for me?",
		ship_group = 20220,
		flag = 0,
		type = 1,
		id = 62,
	...
	pg.base.dorm3d_ins_chat_language[64] = {
		param = "The moment I saw this, I knew it was perfect for you. So I got it for you as a gift.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 64,
	...
	pg.base.dorm3d_ins_chat_language[66] = {
		param = "I am but your humble maid, and still you go out of your way for me like this...",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 66,
	...
	pg.base.dorm3d_ins_chat_language[68] = {
		param = "Will you permit me to accept this gift?",
		ship_group = 20220,
		flag = 1,
		type = 1,
		id = 68,
	...
	pg.base.dorm3d_ins_chat_language[69] = {
		param = "Of course. I WANT you to have it.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 69,
	...
	pg.base.dorm3d_ins_chat_language[70] = {
		param = "Any maid worth her salt would do everything she could to grant her master's request, right?",
		ship_group = 0,
		type = 1,
		option = "",
		id = 70,
	...
	pg.base.dorm3d_ins_chat_language[71] = {
		param = "So here's a request: take my gift.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 71,
	...
	pg.base.dorm3d_ins_chat_language[72] = {
		param = "Well... then I shall oblige.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 72,
	...
	pg.base.dorm3d_ins_chat_language[73] = {
		param = "Thank you dearly, my honourable Master.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 73,
	...
	pg.base.dorm3d_ins_chat_language[74] = {
		param = "I shall look after this gift with great care.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 74,
	...
	pg.base.dorm3d_ins_chat_language[75] = {
		param = "At the risk of sounding brazen, please allow me to give you a gift in return at this same time tomorrow.",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 75,
	...
	pg.base.dorm3d_ins_chat_language[76] = {
		param = "And furthermore, please don't turn it down, okay?",
		ship_group = 20220,
		type = 1,
		option = "",
		id = 76,
	...
	pg.base.dorm3d_ins_chat_language[77] = {
		param = "Ah, you came to visit, Commander.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 77,
	...
	pg.base.dorm3d_ins_chat_language[78] = {
		param = "I have to really thank you for giving me this place to live.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 78,
	...
	pg.base.dorm3d_ins_chat_language[79] = {
		param = "Also, I was wondering... what do you think about the layout?",
		ship_group = 30221,
		flag = 0,
		type = 1,
		id = 79,
	...
	pg.base.dorm3d_ins_chat_language[80] = {
		param = "How do I put it... It has a strong \"you\" aura.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 80,
	...
	pg.base.dorm3d_ins_chat_language[81] = {
		param = "And I like the aura that you have.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 81,
	...
	pg.base.dorm3d_ins_chat_language[82] = {
		param = "So I like your quarters a lot, too.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 82,
	...
	pg.base.dorm3d_ins_chat_language[85] = {
		param = "I'm glad to hear you say that.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 85,
	...
	pg.base.dorm3d_ins_chat_language[86] = {
		param = "I'll do my best to repay your kindness.",
		ship_group = 30221,
		flag = 1,
		type = 1,
		id = 86,
	...
	pg.base.dorm3d_ins_chat_language[87] = {
		param = "If you ever need anything else, don't be afraid to let me know.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 87,
	...
	pg.base.dorm3d_ins_chat_language[88] = {
		param = "You really are too kind... Thank you so much.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 88,
	...
	pg.base.dorm3d_ins_chat_language[89] = {
		param = "In return, I promise to try to make anything you like come true.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 89,
	...
	pg.base.dorm3d_ins_chat_language[90] = {
		param = "Whatever it is, I'll pursue it with all my energy.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 90,
	...
	pg.base.dorm3d_ins_chat_language[91] = {
		param = "Know that I'm always ready for your orders.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 91,
	...
	pg.base.dorm3d_ins_chat_language[92] = {
		param = "Excuse me, could I have your attention?",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 92,
	...
	pg.base.dorm3d_ins_chat_language[93] = {
		param = "Are you looking for something?",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 93,
	...
	pg.base.dorm3d_ins_chat_language[94] = {
		param = "It looked like you were checking out the things in my quarters...",
		ship_group = 30221,
		flag = 0,
		type = 1,
		id = 94,
	...
	pg.base.dorm3d_ins_chat_language[95] = {
		param = "Not exactly. I just hoped to learn something new about you through the things you have.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 95,
	...
	pg.base.dorm3d_ins_chat_language[96] = {
		param = "I feel like I've almost grasped something, but not quite.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 96,
	...
	pg.base.dorm3d_ins_chat_language[98] = {
		param = "I was a bit concerned you might have thought my room looked cluttered.",
		ship_group = 30221,
		flag = 1,
		type = 1,
		id = 98,
	...
	pg.base.dorm3d_ins_chat_language[100] = {
		param = "In fact, it's straight-faced, tidy, and orderly, just like you are.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 100,
...
;(function()
	pg.base.dorm3d_ins_chat_language[101] = {
		param = "\"Straight-faced\" is a strange word to describe someone's home with...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 101,
	...
	pg.base.dorm3d_ins_chat_language[102] = {
		param = "At any rate, if you want to learn more about me, you can just ask directly.",
		ship_group = 30221,
		flag = 2,
		type = 1,
		id = 102,
	...
	pg.base.dorm3d_ins_chat_language[103] = {
		param = "Sure, but won't I be disturbing you during your free time?",
		ship_group = 0,
		type = 1,
		option = "",
		id = 103,
	...
	pg.base.dorm3d_ins_chat_language[104] = {
		param = "Don't worry about that. It's our responsibility to help resolve your problems.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 104,
	...
	pg.base.dorm3d_ins_chat_language[105] = {
		param = "Granted, I may not be as capable as some other people at the port are...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 105,
	...
	pg.base.dorm3d_ins_chat_language[106] = {
		param = "But still, feel free to rely on me a little more.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 106,
	...
	pg.base.dorm3d_ins_chat_language[107] = {
		param = "In the same way... that I rely on you.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 107,
	...
	pg.base.dorm3d_ins_chat_language[108] = {
		param = "Whenever we talk, it somehow feels like there are always more things to chat about.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 108,
	...
	pg.base.dorm3d_ins_chat_language[109] = {
		param = "You make me want to tell you about even little things.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 109,
	...
	pg.base.dorm3d_ins_chat_language[110] = {
		param = "You don't find that... annoying, do you?",
		ship_group = 30221,
		flag = 0,
		type = 1,
		id = 110,
	...
	pg.base.dorm3d_ins_chat_language[111] = {
		param = "Of course I don't. I'm glad I get to chat so much with you.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 111,
	...
	pg.base.dorm3d_ins_chat_language[113] = {
		param = "I'm really glad to hear you say that.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 113,
	...
	pg.base.dorm3d_ins_chat_language[114] = {
		param = "I've never felt this way when talking with anyone else, not even my sisters.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 114,
	...
	pg.base.dorm3d_ins_chat_language[115] = {
		param = "This urge only rises in me when I'm talking with you.",
		ship_group = 30221,
		flag = 1,
		type = 1,
		id = 115,
	...
	pg.base.dorm3d_ins_chat_language[116] = {
		param = "An urge, you say... I actually think I get the same thing.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 116,
	...
	pg.base.dorm3d_ins_chat_language[117] = {
		param = "You always bring such interesting topics to the table and I'm always excited about what the next one will be.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 117,
	...
	pg.base.dorm3d_ins_chat_language[118] = {
		param = "Also, you look so cute when you speak seriously.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 118,
	...
	pg.base.dorm3d_ins_chat_language[120] = {
		param = "Please don't call me cute out of the blue like that.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 120,
	...
	pg.base.dorm3d_ins_chat_language[121] = {
		param = "You really have a penchant for saying unprompted things...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 121,
	...
	pg.base.dorm3d_ins_chat_language[122] = {
		param = "But anyway... I'll be sure to come up with more interesting topics for next time.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 122,
	...
	pg.base.dorm3d_ins_chat_language[123] = {
		param = "I hope you'll pay attention the whole way through.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 123,
	...
	pg.base.dorm3d_ins_chat_language[124] = {
		param = "Don't take this the wrong way, but... it's a little embarrassing with all your attention.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 124,
	...
	pg.base.dorm3d_ins_chat_language[125] = {
		param = "Although, the happiness it makes me feel is much stronger in comparison...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 125,
	...
	pg.base.dorm3d_ins_chat_language[126] = {
		param = "Stronger than I can put into words.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 126,
	...
	pg.base.dorm3d_ins_chat_language[127] = {
		param = "I would've never imagined we'd one day become as close as we are now.",
		ship_group = 30221,
		flag = 0,
		type = 1,
		id = 127,
	...
	pg.base.dorm3d_ins_chat_language[128] = {
		param = "Truth be told, I wanted to build a good relationship with you since the very beginning.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 128,
	...
	pg.base.dorm3d_ins_chat_language[129] = {
		param = "I want to move into the future with you by my side.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 129,
	...
	pg.base.dorm3d_ins_chat_language[131] = {
		param = "It's a mystery what the future has in store for us, but I know one thing for certain:",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 131,
	...
	pg.base.dorm3d_ins_chat_language[132] = {
		param = "You are there with me in my future.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 132,
	...
	pg.base.dorm3d_ins_chat_language[133] = {
		param = "I think we were destined for that ever since the moment we met.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 133,
	...
	pg.base.dorm3d_ins_chat_language[134] = {
		param = "Because you're always with me...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 134,
	...
	pg.base.dorm3d_ins_chat_language[135] = {
		param = "I feel like there's nothing I can't do.",
		ship_group = 30221,
		flag = 1,
		type = 1,
		id = 135,
	...
	pg.base.dorm3d_ins_chat_language[136] = {
		param = "And I'll do all I can not to disappoint you and make sure that future comes true.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 136,
	...
	pg.base.dorm3d_ins_chat_language[138] = {
		param = "My fate, or should I say our fate, is in your hands, Commander.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 138,
	...
	pg.base.dorm3d_ins_chat_language[139] = {
		param = "Don't you think the moon looks beautiful tonight?",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 139,
	...
	pg.base.dorm3d_ins_chat_language[140] = {
		param = "Feeling its soft light on my skin warms my heart...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 140,
	...
	pg.base.dorm3d_ins_chat_language[141] = {
		param = "And when I look up at the night sky, so many memories we've shared come flooding back.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 141,
	...
	pg.base.dorm3d_ins_chat_language[142] = {
		param = "Ever since I came to your side, I've learned more things than I can count.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 142,
	...
	pg.base.dorm3d_ins_chat_language[143] = {
		param = "Each and every one of them is precious and unlike anything I've ever experienced before.",
		ship_group = 30221,
		flag = 0,
		type = 1,
		id = 143,
	...
	pg.base.dorm3d_ins_chat_language[144] = {
		param = "You've taught me so much, too.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 144,
	...
	pg.base.dorm3d_ins_chat_language[147] = {
		param = "Something tells me that perhaps now, my true mission in life begins...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 147,
	...
	pg.base.dorm3d_ins_chat_language[148] = {
		param = "Well, actually, it's more than just a mission.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 148,
	...
	pg.base.dorm3d_ins_chat_language[149] = {
		param = "It's a heartfelt desire to grow as a person and become more mature like my sister.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 149,
	...
	pg.base.dorm3d_ins_chat_language[150] = {
		param = "And to meet the expectations you have for me...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 150,
	...
	pg.base.dorm3d_ins_chat_language[151] = {
		param = "I sincerely hope we'll move forward together, now and forever.",
		ship_group = 30221,
		flag = 1,
		type = 1,
		id = 151,
	...
	pg.base.dorm3d_ins_chat_language[152] = {
		param = "Me, too. I want to be right beside you.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 152,
	...
	pg.base.dorm3d_ins_chat_language[153] = {
		param = "I'm glad. As long as you're with me, no matter where we are...",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 153,
	...
	pg.base.dorm3d_ins_chat_language[154] = {
		param = "Please... just never let go of my hand.",
		ship_group = 30221,
		type = 1,
		option = "",
		id = 154,
...
;(function()
	...
	pg.base.dorm3d_ins_chat_language[844] = {
		param = "Your visit today took me by surprise, Commander.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 844,
	...
	pg.base.dorm3d_ins_chat_language[845] = {
		param = "I hadn't prepared tea or snacks, and my room is a mess...",
		ship_group = 20707,
		flag = 0,
		type = 1,
		id = 845,
	...
	pg.base.dorm3d_ins_chat_language[846] = {
		param = "Don't worry about it. You don't have to prepare for my visits.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 846,
	...
	pg.base.dorm3d_ins_chat_language[847] = {
		param = "I just wanted to see your everyday self.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 847,
	...
	pg.base.dorm3d_ins_chat_language[849] = {
		param = "Most of my time outside of work is spent in prayer.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 849,
	...
	pg.base.dorm3d_ins_chat_language[850] = {
		param = "As for hobbies, I suppose making tea would be the only one worth speaking of.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 850,
	...
	pg.base.dorm3d_ins_chat_language[851] = {
		param = "I must seem awfully dull.",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 851,
		option = {
			{
				2,
				"Can we do it together some time?"
			}
		}
	}
	pg.base.dorm3d_ins_chat_language[852] = {
		param = "Can we do it together some time?",
		ship_group = 0,
		type = 1,
		option = "",
		id = 852,
	...
	pg.base.dorm3d_ins_chat_language[853] = {
		param = "I'd like to see what it's like.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 853,
	...
	pg.base.dorm3d_ins_chat_language[854] = {
		param = "The feeling of prayer is hard to put into words, I suppose.",
		ship_group = 20707,
		flag = 2,
		type = 1,
		id = 854,
	...
	pg.base.dorm3d_ins_chat_language[856] = {
		param = "Yes, I think it's a wonderful experience.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 856,
	...
	pg.base.dorm3d_ins_chat_language[857] = {
		param = "Next time you come over, let's try it together.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 857,
	...
	pg.base.dorm3d_ins_chat_language[858] = {
		param = "Commander, your eye bags look a little darker today.",
		ship_group = 20707,
		flag = 0,
		type = 1,
		id = 858,
	...
	pg.base.dorm3d_ins_chat_language[860] = {
		param = "Your work is important, but those who put their faith in you would be so worried if anything happened to you.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 860,
	...
	pg.base.dorm3d_ins_chat_language[861] = {
		param = "If you really can't cut down on your work hours...",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 861,
	...
	pg.base.dorm3d_ins_chat_language[862] = {
		param = "Allow me to help you make every moment of relaxation count.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 862,
	...
	pg.base.dorm3d_ins_chat_language[863] = {
		param = "Come over and entrust your rest time to me.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 863,
	...
	pg.base.dorm3d_ins_chat_language[864] = {
		param = "I know a special way to put you to sleep. I'm certain I can help you sleep easily and soundly.",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 864,
	...
	pg.base.dorm3d_ins_chat_language[866] = {
		param = "Heehee. It won't be as effective if I tell you now.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 866,
	...
	pg.base.dorm3d_ins_chat_language[867] = {
		param = "You should just... come over, close your eyes, and leave the rest to me.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 867,
	...
	pg.base.dorm3d_ins_chat_language[868] = {
		param = "I'm sure it will be an unforgettable night. Hehehe!",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 868,
	...
	pg.base.dorm3d_ins_chat_language[869] = {
		param = "Commander, can you come shopping with me this weekend?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 869,
	...
	pg.base.dorm3d_ins_chat_language[870] = {
		param = "Your clothes are awfully worn, aren't they? It's about time to get some new ones.",
		ship_group = 20707,
		flag = 0,
		type = 1,
		id = 870,
	...
	pg.base.dorm3d_ins_chat_language[872] = {
		param = "Of course. That's the first topic of conversation at any tea party.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 872,
	...
	pg.base.dorm3d_ins_chat_language[873] = {
		param = "I know a few places where we can get clothing tailor made.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 873,
	...
	pg.base.dorm3d_ins_chat_language[874] = {
		param = "It will take time, of course, but their fabric and designs are first-rate.",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 874,
	...
	pg.base.dorm3d_ins_chat_language[875] = {
		param = "Sounds great. But I usually wear uniforms, so I don't know much about that stuff.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 875,
	...
	pg.base.dorm3d_ins_chat_language[877] = {
		param = "In return, would you please pick out a few for me? Heehee.",
		ship_group = 20707,
		flag = 2,
		type = 1,
		id = 877,
	...
	pg.base.dorm3d_ins_chat_language[878] = {
		param = "You've got a deal. Just don't laugh at my taste.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 878,
	...
	pg.base.dorm3d_ins_chat_language[879] = {
		param = "I'm happy with anything you choose for me. Heehee!",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 879,
	...
	pg.base.dorm3d_ins_chat_language[880] = {
		param = "I had an odd feeling today.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 880,
	...
	pg.base.dorm3d_ins_chat_language[881] = {
		param = "It's as if the distance between us has narrowed a little.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 881,
	...
	pg.base.dorm3d_ins_chat_language[882] = {
		param = "Or maybe... you've just come to learn more about me?",
		ship_group = 20707,
		flag = 0,
		type = 1,
		id = 882,
	...
	pg.base.dorm3d_ins_chat_language[884] = {
		param = "I noticed something in your room that I'd never seen before.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 884,
	...
	pg.base.dorm3d_ins_chat_language[885] = {
		param = "Heehee. Your thirst for knowledge remains unquenchable, I see.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 885,
	...
	pg.base.dorm3d_ins_chat_language[886] = {
		param = "If you're that interested, why not ask me directly?",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 886,
	...
	pg.base.dorm3d_ins_chat_language[887] = {
		param = "I wasn't sure if it was appropriate...",
		ship_group = 0,
		flag = 2,
		type = 1,
		id = 887,
	...
	pg.base.dorm3d_ins_chat_language[888] = {
		param = "You know that I'd never refuse a request of yours.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 888,
	...
	pg.base.dorm3d_ins_chat_language[889] = {
		param = "If you want to know more about me, then just ask.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 889,
	...
	pg.base.dorm3d_ins_chat_language[890] = {
		param = "I'll tell you everything, without exception.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 890,
	...
	pg.base.dorm3d_ins_chat_language[891] = {
		param = "In return... don't hide anything from me, either.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 891,
	...
	pg.base.dorm3d_ins_chat_language[893] = {
		param = "Got it. I'll be honest with you.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 893,
	...
	pg.base.dorm3d_ins_chat_language[894] = {
		param = "Heehee. I have absolute faith in you, Commander.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 894,
	...
	pg.base.dorm3d_ins_chat_language[895] = {
		param = "So... Will you be coming over tomorrow?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 895,
	...
	pg.base.dorm3d_ins_chat_language[896] = {
		param = "If you're not too busy with work, I'd love to see you.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 896,
	...
	pg.base.dorm3d_ins_chat_language[897] = {
		param = "I've been counting down the days. Just three more until the holiday~",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 897,
	...
	pg.base.dorm3d_ins_chat_language[898] = {
		...
		option = {
			{
				1,
				"Not in particular, yet."
			}
		}
	}
	pg.base.dorm3d_ins_chat_language[899] = {
		param = "Not in particular, yet.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 899,
	...
	pg.base.dorm3d_ins_chat_language[900] = {
		param = "Is there anywhere you want to go?",
		ship_group = 0,
		type = 1,
		option = "",
		id = 900,
...
;(function()
	pg.base.dorm3d_ins_chat_language[901] = {
		param = "Hmm, is there? I suppose not~",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 901,
	...
	pg.base.dorm3d_ins_chat_language[902] = {
		param = "But I do have a few things prepared... Tea and aromatherapy, for example.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 902,
	...
	pg.base.dorm3d_ins_chat_language[903] = {
		param = "I also have a few relaxation techniques in mind.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 903,
	...
	pg.base.dorm3d_ins_chat_language[904] = {
		param = "How about a simple holiday alone in my room? Just the two of us.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 904,
	...
	pg.base.dorm3d_ins_chat_language[907] = {
		param = "Then it's a date. Leave your impending holiday to me~",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 907,
	...
	pg.base.dorm3d_ins_chat_language[908] = {
		param = "I'll make it one you'll never want to end♡",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 908,
	...
	pg.base.dorm3d_ins_chat_language[909] = {
		param = "I really enjoyed the gift you brought today.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 909,
	...
	pg.base.dorm3d_ins_chat_language[910] = {
		param = "But it does bother me that I'm only taking your gifts without giving you anything in return.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 910,
	...
	pg.base.dorm3d_ins_chat_language[911] = {
		param = "Is there anything you would like?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 911,
	...
	pg.base.dorm3d_ins_chat_language[912] = {
		param = "Or... would you prefer a surprise?",
		ship_group = 20707,
		flag = 0,
		type = 1,
		id = 912,
	...
	pg.base.dorm3d_ins_chat_language[914] = {
		param = "You let me come over all the time. A present or two is no big deal.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 914,
	...
	pg.base.dorm3d_ins_chat_language[915] = {
		param = "Heehee. I thought you might say that.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 915,
	...
	pg.base.dorm3d_ins_chat_language[916] = {
		param = "Don't worry. My gift won't cost a penny.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 916,
	...
	pg.base.dorm3d_ins_chat_language[917] = {
		param = "In fact... it's one-of-a-kind that money can't buy.",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 917,
	...
	pg.base.dorm3d_ins_chat_language[918] = {
		param = "Now I'm curious. What is it?",
		ship_group = 0,
		type = 1,
		option = "",
		id = 918,
	...
	pg.base.dorm3d_ins_chat_language[919] = {
		param = "Telling you now would spoil the fun~",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 919,
	...
	pg.base.dorm3d_ins_chat_language[920] = {
		param = "Come over for it right now.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 920,
	...
	pg.base.dorm3d_ins_chat_language[921] = {
		param = "I'll be waiting for you... Heheh.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 921,
	...
	pg.base.dorm3d_ins_chat_language[922] = {
		param = "Lately, when I pray for you, time seems to stretch on forever.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 922,
	...
	pg.base.dorm3d_ins_chat_language[923] = {
		param = "Maybe... my mind is too cluttered with distractions.",
		ship_group = 20707,
		flag = 0,
		type = 1,
		id = 923,
	...
	pg.base.dorm3d_ins_chat_language[925] = {
		param = "Do you want me to say it directly?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 925,
	...
	pg.base.dorm3d_ins_chat_language[926] = {
		param = "Because I'm thinking about you. Heehee!",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 926,
	...
	pg.base.dorm3d_ins_chat_language[928] = {
		param = "I want to pray for you alone, to keep you by my side forever...",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 928,
	...
	pg.base.dorm3d_ins_chat_language[929] = {
		param = "Basking in your warmth for so long has made me a little selfish, I suppose.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 929,
	...
	pg.base.dorm3d_ins_chat_language[930] = {
		param = "But you'll take responsibility for that, won't you♡",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 930,
	...
	pg.base.dorm3d_ins_chat_language[931] = {
		param = "Are you still up, Commander?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 931,
	...
	pg.base.dorm3d_ins_chat_language[932] = {
		param = "I trust you aren't staying up too late...",
		ship_group = 20707,
		flag = 0,
		type = 1,
		id = 932,
	...
	pg.base.dorm3d_ins_chat_language[934] = {
		param = "Which means you aren't asleep.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 934,
	...
	pg.base.dorm3d_ins_chat_language[937] = {
		param = "I just warmed up some milk. I'll bring it over for you.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 937,
	...
	pg.base.dorm3d_ins_chat_language[938] = {
		param = "After you drink it, you'd best go to your room and sleep.",
		ship_group = 20707,
		flag = 2,
		type = 1,
		id = 938,
	...
	pg.base.dorm3d_ins_chat_language[940] = {
		param = "Don't stay up all alone every night, okay?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 940,
	...
	pg.base.dorm3d_ins_chat_language[942] = {
		param = "I'm sure it'll be a much better time with me around. Heehee♡",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 942,
	...
	pg.base.dorm3d_ins_chat_language[943] = {
		param = "Commander, what if we tried milk tea for our next afternoon tea? It's all the rage lately.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 943,
	...
	pg.base.dorm3d_ins_chat_language[946] = {
		param = "But there's something I don't understand... Milk tea is simply a way of blending something else with the tea.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 946,
	...
	pg.base.dorm3d_ins_chat_language[947] = {
		param = "So why don't people like my special blend?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 947,
	...
	pg.base.dorm3d_ins_chat_language[948] = {
		param = "I've been thinking about it. Do you have any ideas?",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 948,
	...
	pg.base.dorm3d_ins_chat_language[949] = {
		param = "You know, the thing about a popular blend is...",
		ship_group = 0,
		type = 1,
		option = "",
		id = 949,
	...
	pg.base.dorm3d_ins_chat_language[950] = {
		param = "Every popular recipe is the result of countless failed experiments.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 950,
	...
	pg.base.dorm3d_ins_chat_language[951] = {
		param = "I see. Without ample trial and error, success is ultimately a game of luck.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 951,
	...
	pg.base.dorm3d_ins_chat_language[952] = {
		param = "Which means... I just need to keep trying?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 952,
	...
	pg.base.dorm3d_ins_chat_language[953] = {
		param = "Understood. I'll prepare a few new recipes with milk tea.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 953,
	...
	pg.base.dorm3d_ins_chat_language[954] = {
		param = "Heehee. Just you wait, Commander.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 954,
	...
	pg.base.dorm3d_ins_chat_language[955] = {
		param = "Commander, what photos did you take today?",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 955,
	...
	pg.base.dorm3d_ins_chat_language[957] = {
		param = "Just some casual shots. Flowers by the window, a bookshelf, stuff like that.",
		ship_group = 0,
		type = 1,
		option = "",
		id = 957,
	...
	pg.base.dorm3d_ins_chat_language[958] = {
		param = "Heehee. Very ordinary things, indeed.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 958,
	...
	pg.base.dorm3d_ins_chat_language[959] = {
		param = "But when you photograph them...",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 959,
	...
	pg.base.dorm3d_ins_chat_language[960] = {
		param = "Those scenes take on new meaning.",
		ship_group = 20707,
		flag = 1,
		type = 1,
		id = 960,
	...
	pg.base.dorm3d_ins_chat_language[962] = {
		param = "They're no longer just parts of a room, but scenes you once looked at.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 962,
	...
	pg.base.dorm3d_ins_chat_language[963] = {
		param = "When I look at them again in the distant future, I'll be reminded of how you looked when you took the photos.",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 963,
	...
	pg.base.dorm3d_ins_chat_language[964] = {
		param = "Let me take a picture of you next time, too!",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 964,
	...
	pg.base.dorm3d_ins_chat_language[965] = {
		param = "Because I want to capture moments worth looking back on over and over again. Heehee♡",
		ship_group = 20707,
		type = 1,
		option = "",
		id = 965,
