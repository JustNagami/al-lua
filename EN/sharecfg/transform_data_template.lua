...
;(function()
	...
	pg.base.transform_data_template[6105] = {
		...
		use_ship = 0,
		level_limit = 35,
		descrip = "Anti-Air Gun efficiency +5%",
		icon = "aaup_1",
		skill_id = 0,
		condition_id = {
			6103
	...
	pg.base.transform_data_template[6211] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Retrofit complete. The following changes have been applied:\n\nAA +20, RLD +25.\nThis ship's Big Seven skill has been upgraded to Big Seven - West Virginia.",
		icon = "mt_yellow",
		skill_id = 0,
		condition_id = {
			6206,
...
;(function()
	...
	pg.base.transform_data_template[9412] = {
		...
		use_ship = 0,
		level_limit = 90,
		descrip = "Learn Glowworm Assault",
		icon = "skill_red",
		skill_id = 151190,
		condition_id = {
			9411
...
;(function()
	...
	pg.base.transform_data_template[16311] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Retrofitting complete. The following have been applied:\nTRP +30, AA +15\n<color=#92fc63>Anti-Air Gun base +1</color>, <color=#92fc63>Anti-Air Gun efficiency +40%</color>",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			16308,
...
;(function()
	...
	pg.base.transform_data_template[24209] = {
		...
		use_ship = 0,
		level_limit = 70,
		descrip = "Torpedo efficiency +5%/Torpedo efficiency +5%",
		icon = "tpup_2",
		skill_id = 0,
		condition_id = {
			24207
	...
	pg.base.transform_data_template[24211] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Retrofit complete. The following changes have been applied:\nFP +30, ACC +15, Main Gun Base +1, Main Gun efficiency becomes 120%.",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			24209,
...
;(function()
	...
	pg.base.transform_data_template[25411] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Completing the retrofit will have the following effects:\n\nTRP +30, EVA +15, Main Gun base +1, the ship's \"All Out Assault\" skill and \"Rezkiy Assault\" skill will be upgraded, she will learn the \"Zhuque's Flamebinds\" skill, her Torpedo gear slot will change into a Missile gear slot, and her weapon efficiencies will change into 100%/150%/105%",
		icon = "mt_blue",
		skill_id = 0,
		condition_id = {
			25409
	...
	pg.base.transform_data_template[25611] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Retrofit complete. The following changes have been applied:\n\nTRP +30, EVA +15, Main Gun Mount +1.\nThis ship's \"All Out Assault\" skill and \"United As One\" skill have been improved.\nThis ship has gained the skill \"Xuanwu's Tenacity\".\nThis ship's Torpedo gear slot has changed into a Missile gear slot.\nThis ship's weapon efficiencies have changed to 100%/150%/105%.",
		icon = "mt_blue",
		skill_id = 0,
		condition_id = {
			25609
...
;(function()
	...
	pg.base.transform_data_template[49311] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Retrofit complete. The following changes have been applied: FP +25, EVA +20",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			49309,
	...
	pg.base.transform_data_template[49312] = {
		...
		use_ship = 0,
		level_limit = 90,
		descrip = "Learn Serpentine Brushstrokes",
		icon = "skill_red",
		skill_id = 152130,
		condition_id = {
			49308,
	...
	pg.base.transform_data_template[49412] = {
		...
		use_ship = 0,
		level_limit = 90,
		descrip = "Learn Dazzling Fan Dance",
		icon = "skill_red",
		skill_id = 152120,
		condition_id = {
			49408,
	...
	pg.base.transform_data_template[53411] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Retrofit complete. The following changes have been applied:\n\nAA +35, AVI +25.\n<color=#92fc63>This ship's 1st weapon slot can now equip Fighters and gains +2 aircraft.</color>\n<color=#92fc63>This ship's 2nd weapon slot can equip any type of aircraft and gains +1 aircraft/mount.</color>",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			53409,
	...
	pg.base.transform_data_template[57911] = {
		...
		use_ship = 1,
		level_limit = 85,
		descrip = "Retrofit complete. The following changes have been applied:\n\nAA +35, AVI +25. \nThis ship's <color=#92fc63>1st gear slot can now equip Fighters</color> and her <color=#92fc63>2nd gear slot can now equip any aircraft type</color>.",
		icon = "mt_red",
		skill_id = 0,
		condition_id = {
			57909,
