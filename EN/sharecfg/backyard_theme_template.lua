...
;(function()
	...
	pg.base.backyard_theme_template[138] = {
		...
		comfortable = 0,
		Cfg_2 = 8,
		desc = "Enjoy a tour of the opulent, glamorous streets of Luxury Bay!",
		discount_time = "",
		discount = 0,
		new = 1,
		icon = "shhthemeicon",
	...
	pg.base.backyard_theme_template[139] = {
		Cfg_1 = 5,
		name = "Surprising Circus",
		hot = 1,
		is_view = 1,
		id = 139,
		comfortable = 0,
		Cfg_2 = 8,
		desc = "Come one, come all! Laughs and thrills alike await you at the Surprising Circus!",
		discount_time = "",
		discount = 0,
		new = 1,
		icon = "mxtthemeicon",
	...
	pg.base.backyard_theme_template[142] = {
		Cfg_1 = 5,
		name = "Seaside Endurance Race",
		hot = 1,
		is_view = 1,
		id = 142,
		comfortable = 0,
		Cfg_2 = 8,
		desc = "Feel the roar of the engines, the cheers, and the dazzling spotlights! Go all out and leave it all on this magical racetrack!",
		discount_time = "",
		discount = 0,
		new = 1,
		icon = "car3themeicon",
