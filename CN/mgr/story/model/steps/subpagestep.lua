...
function var_0_0.ShouldShowSubPage(arg_4_0)
	if arg_4_0.page == var_0_1 then
		...
		local var_4_2 = var_4_1:getConfig("config_client").link_act
		local var_4_3 = var_4_0:RawGetActivityById(var_4_2)
		local var_4_4 = pg.NewStoryMgr.GetInstance():IsReView()

		return var_4_3 and not var_4_3:isEnd() and not var_4_4
	else
		return true
	end
end
