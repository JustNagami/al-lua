...
function var_0_0.OnSceneEnter(arg_22_0)
	if arg_22_0.waitSceneData and pg.NewGuideMgr.GetInstance():ExistScene(arg_22_0.waitSceneData.sceneName) then
...
function var_0_0.ShowDialogueWindow(arg_27_0, arg_27_1, arg_27_2)
	...
	if not arg_27_0.dialogueWindows[var_27_1] then
		table.insert(var_27_0, function(arg_28_0)
			arg_27_0:LoadDialogueWindow(var_27_1, arg_28_0)
		end)
	end
	...
	table.insert(var_27_0, function(arg_29_0)
		...
		arg_27_0:UpdateDialogue(arg_27_1, var_29_0, arg_29_0)
	end)
...
function var_0_0.UpdateDialogue(arg_30_0, arg_30_1, arg_30_2, arg_30_3)
	...
	if var_30_2 then
		seriesAsync({
			function(arg_31_0)
				arg_30_0:LoadCounsellor(var_30_2.name, arg_31_0)
			end,
			function(arg_32_0)
				local var_32_0 = arg_30_0.counsellors[var_30_2.name]

				setActive(var_32_0, true)

				var_32_0.localPosition = arg_30_2.localPosition + Vector3(var_30_2.position.x, var_30_2.position.y, 0)
				var_32_0.localScale = Vector3(var_30_2.scale.x, var_30_2.scale.y, 1)
...
function var_0_0.LoadCounsellor(arg_33_0, arg_33_1, arg_33_2)
	if not arg_33_0.counsellors[arg_33_1] then
		LoadAnyAsync("guideitem/" .. arg_33_1, "", nil, function(arg_34_0)
			...
			local var_34_0 = Object.Instantiate(arg_34_0, arg_33_0.charContainer)
...
function var_0_0.LoadDialogueWindow(arg_35_0, arg_35_1, arg_35_2)
	LoadAnyAsync("guideitem/window_" .. arg_35_1, "", nil, function(arg_36_0)
		...
		local var_36_0 = Object.Instantiate(arg_36_0, arg_35_0.windowContainer)
...
local function var_0_2(arg_39_0, arg_39_1, arg_39_2, arg_39_3)
	...
	elseif arg_39_3.type == GuideStep.HIGH_TYPE_LINE then
		local var_39_0 = arg_39_2.rect
		local var_39_1 = arg_39_0._tf:InverseTransformPoint(arg_39_2.position)

		arg_39_0.uiLoader:LoadHighLightArea({
			position = Vector3(var_39_1.x, var_39_1.y, 0) + Vector3(var_39_0.x, var_39_0.y, 0),
			size = Vector2(var_39_0.width, var_39_0.height),
