...
function var_0_0.ForamtNumberK(arg_1_0)
	...
	local var_1_2 = math.floor(var_1_1 / 1000)
	local var_1_3 = tostring(var_1_2):reverse():gsub("(%d%d%d)", "%1,"):reverse():gsub("^,", "")

	return var_1_0 .. var_1_3 .. "K"
end
...
function var_0_0.ForamtNumber(arg_2_0)
	...
	local var_2_2 = tostring(var_2_1):reverse():gsub("(%d%d%d)", "%1,"):reverse():gsub("^,", "")
