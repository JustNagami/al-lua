...
function var_0_0.OnInit(arg_3_0)
	...
	arg_3_0.toggleList:make(function(arg_5_0, arg_5_1, arg_5_2)
		...
		if arg_5_0 == UIItemList.EventUpdate then
			...
			local var_5_2 = pg.island_draw_reward[var_5_0]
			local var_5_3 = Drop.New({
				type = var_5_2.drop_type,
				id = var_5_2.drop_id
			})

			IslandShopDrawAwardPage.ShowDropInfo(var_5_3, arg_5_2:Find("mask/Image"))
			setScrollText(arg_5_2:Find("name/Text"), var_5_3:getName())
	...
	var_11_0:AddDragEndFunc(function(arg_14_0, arg_14_1)
		...
		table.insert(var_14_1, function(arg_15_0)
			if var_14_0 then
				...
				parallelAsync({
					function(arg_16_0)
						local var_16_0 = math.min(math.abs(arg_11_1.localPosition.x - var_11_2[arg_11_0.after]) / 200, 1) * 0.3

						LeanTween.moveLocalX(arg_11_1.gameObject, var_11_2[arg_11_0.after], var_16_0):setEase(LeanTweenType.easeOutCubic):setOnComplete(System.Action(arg_16_0))
					end,
					function(arg_17_0)
...
function var_0_0.change2ScrPos(arg_20_0, arg_20_1, arg_20_2)
	local var_20_0 = pg.UIMgr.GetInstance().overlayCameraComp

	return (LuaHelper.ScreenToLocal(arg_20_1, arg_20_2, var_20_0))
end
