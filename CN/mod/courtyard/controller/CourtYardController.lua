...
function var_0_0.SetUp(arg_4_0)
	...
	for iter_4_2, iter_4_3 in ipairs(var_4_0.ships) do
		table.insert(var_4_3, function(arg_6_0)
			...
			arg_4_0:AddShip(iter_4_3, var_6_0[1] or 0, var_6_0[2] or 0)
			onNextTick(arg_6_0)
		end)
	end
...
function var_0_0.SaveFurnitures(arg_45_0)
	if arg_45_0.storey.recoder:HasChange() then
		local var_45_0 = arg_45_0.storey:ToTable()
...
function var_0_0.RestoreFurnitures(arg_47_0)
	...
	local var_47_0 = arg_47_0.storey.recoder:GetHeadSample()
...
function var_0_0.DataToFurnitureVO(arg_63_0, arg_63_1)
	local var_63_0 = pg.furniture_data_template[arg_63_1.configId]

	if var_63_0.type == Furniture.TYPE_WALLPAPER or var_63_0.type == Furniture.TYPE_FLOORPAPER then
		return CourtYardPaper.New(arg_63_0, arg_63_1)
	elseif var_63_0.type == Furniture.TYPE_FOLLOWER then
		return CourtYardFollowerFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.type == Furniture.TYPE_RANDOM_CONTROLLER then
		return CourtYardRandomControllerFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.type == Furniture.TYPE_MAT then
		return CourtYardMatFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.type == Furniture.TYPE_TRANSPORT then
		return CourtYardTransportFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.type == Furniture.TYPE_WALL_MAT then
		return CourtYardWallMatFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.type == Furniture.TYPE_STAGE or var_63_0.type == Furniture.TYPE_ARCH then
		return CourtYardStageFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.type == Furniture.TYPE_MOVEABLE then
		return CourtYardMoveableFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.belong == 1 and var_63_0.canputon == 1 then
		return CourtYardCanPutFurniture.New(arg_63_0, arg_63_1)
	elseif var_63_0.belong > 1 then
...
function var_0_0.DataToShip(arg_64_0, arg_64_1, arg_64_2, arg_64_3)
	...
	elseif arg_64_0.system == CourtYardConst.SYSTEM_REVERSE_PACMAN then
		return CourtYardReversePacmanShip.New(arg_64_0, arg_64_1)
	else
