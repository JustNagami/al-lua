...
local function var_0_16(arg_10_0)
	...
	if var_10_2 == 2 and underscore.any(getGameset("profile_cvchange_button_block")[2], function(arg_11_0)
...
local function var_0_18(arg_14_0, arg_14_1)
	...
	local function var_14_1(arg_15_0)
		return arg_14_0 == 2 and arg_15_0.voice_key_2 >= 0 and arg_15_0.voice_key_2 or arg_15_0.voice_key
	end

	local var_14_2 = var_14_1(var_14_0)

	if var_14_2 == 0 or var_14_2 == -2 then
		local var_14_3 = var_0_11(arg_14_1)
		local var_14_4 = var_0_2[var_14_3]

		var_14_2 = var_14_1(var_14_4)
	end
...
local function var_0_19(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4)
	if arg_16_0 then
		...
		local var_16_3 = var_16_2 == 2 and arg_16_0.voice_key_2 or arg_16_0.voice_key
		local var_16_4 = arg_16_2 == var_0_0.WORD_TYPE_MAIN
		local var_16_5 = var_16_4 and arg_16_2 .. arg_16_3[1] or arg_16_2
		local var_16_6 = var_0_4[var_16_5]
		local var_16_7 = var_16_6 and var_16_6.resource_key

		if not var_16_7 and var_16_4 then
		...
		if var_16_3 ~= var_0_0.CV_KEY_BAN and var_16_7 then
			...
			if arg_16_4 and var_16_3 == var_0_0.CV_KEY_REPALCE then
				local var_16_9 = var_0_1[arg_16_1].group_index
...
local function var_0_21(arg_18_0, arg_18_1)
	...
	if not var_18_0 or not var_18_0.main_extra or var_18_0.main_extra == "" or type(var_18_0.main_extra) == "table" and #var_18_0.main_extra == 0 then
		return nil
	end
	...
	for iter_18_0, iter_18_1 in ipairs(var_18_0.main_extra) do
		...
		if var_18_3 <= arg_18_1 then
			var_18_1 = var_18_1 and var_18_1 .. "|" .. var_18_4 or var_18_4

			local var_18_5 = string.split(var_18_4, "|")
...
function var_0_0.GetMainSceneWordCnt(arg_23_0, arg_23_1)
	...
	if not var_23_0 or not var_23_0[var_0_0.WORD_TYPE_MAIN] or var_23_0[var_0_0.WORD_TYPE_MAIN] == "" then
		local var_23_1 = var_0_11(arg_23_0)

		var_23_0 = var_0_2[var_23_1]
	end

	local var_23_2 = 0

	if var_23_0 and var_23_0[var_0_0.WORD_TYPE_MAIN] and var_23_0[var_0_0.WORD_TYPE_MAIN] ~= "" then
		var_23_2 = #string.split(var_23_0[var_0_0.WORD_TYPE_MAIN], "|")
	end

	local var_23_3, var_23_4 = var_0_21(arg_23_0, arg_23_1)

	if var_23_3 then
		var_23_2 = var_23_2 + table.getCount(var_23_4)
	end
...
function var_0_0.GetL2dCvCalibrate(arg_24_0, arg_24_1, arg_24_2)
	...
	if type(var_24_0.l2d_voice_calibrate) == "table" and var_24_0.l2d_voice_calibrate.use_event then
		return -1
	end
	...
	return var_24_0.l2d_voice_calibrate[arg_24_1]
end
...
function var_0_0.GetL2dSoundEffect(arg_25_0, arg_25_1, arg_25_2)
	...
	return var_25_0.l2d_se[arg_25_1]
end

function var_0_0.ExistVoiceKey(arg_26_0)
	local var_26_0 = var_0_2[arg_26_0]

	return var_26_0 and var_26_0.voice_key ~= var_0_0.CV_KEY_BAN
end

function var_0_0.GetCVAuthor(arg_27_0)
	local var_27_0 = var_0_1[arg_27_0]
	local var_27_1 = var_0_16(arg_27_0) == 2 and var_27_0.voice_actor_2 or var_27_0.voice_actor
	local var_27_2 = ""
...
function var_0_0.GetCVList()
	...
	for iter_28_0, iter_28_1 in ipairs(pg.character_voice.all) do
		local var_28_1 = pg.character_voice[iter_28_1]

		if not pg.AssistantInfo.isDisableSpecialClick(var_28_1.key) and var_28_1.unlock_condition[1] >= 0 then
			var_28_0[#var_28_0 + 1] = setmetatable({}, {
				__index = var_28_1
			})
		end
	end
...
function var_0_0.ExistDifferentWord(arg_29_0, arg_29_1, arg_29_2)
	...
	if string.find(arg_29_1, "main") then
		...
		var_29_1 = string.split(var_29_2, "|")[arg_29_2]
	else
