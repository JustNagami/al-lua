...
function var_0_0.init(arg_11_0)
	...
	setText(var_11_4, i18n("shop_gift_title"))
	setText(var_11_5, i18n("shop_item_title"))
	setText(var_11_6, i18n("shop_item_title"))
	setText(var_11_7, i18n("shop_akashi_pick_title"))
	...
	if Live2dConst.GetLive2DArm32MatchAble() then
		local var_11_9 = Ship.New({
			configId = 312011
		}):getPainting()

		LoadPaintingPrefabAsync(arg_11_0.painting, var_11_9, var_11_9, "mainNormal", function()
	...
	arg_11_0.live2dTimer = Timer.New(function()
		local var_13_0 = pg.ChargeShipTalkInfo.Actions
		local var_13_1 = var_13_0[math.random(#var_13_0)]

		if arg_11_0:checkBuyDone(var_13_1.action) then
			arg_11_0:displayShipWord(nil, false, var_13_1.dialog_index)
		end
	end, 20, -1)
...
function var_0_0.switchSubView(arg_23_0, arg_23_1)
	...
	local var_23_0 = arg_23_0.subViewList[arg_23_0.curSubViewNum]
...
function var_0_0.updateCurSubView(arg_25_0)
	...
	var_25_0:setGoodData(arg_25_0.firstChargeIds, arg_25_0.chargedList, arg_25_0.normalList, arg_25_0.normalGroupList)
	var_25_0:reUpdateAll()
end
...
function var_0_0.updateNoRes(arg_26_0, arg_26_1)
	...
	for iter_26_0, iter_26_1 in ipairs(arg_26_1) do
		if iter_26_1[2] > 0 then
			if iter_26_1[1] == 59001 then
				...
				arg_26_1[iter_26_0][2] = iter_26_1[3] - (var_26_0[iter_26_1[1]] and var_26_0[iter_26_1[1]].count or 0)
			end
		end
	...
	for iter_26_2, iter_26_3 in ipairs(arg_26_0.contextData.noRes) do
		local var_26_2 = Item.getConfigData(iter_26_3[1]).name

		var_26_1 = var_26_1 .. i18n(iter_26_3[1] == 59001 and "text_noRes_info_tip" or "text_noRes_info_tip2", var_26_2, iter_26_3[2])
...
function var_0_0.displayShipWord(arg_27_0, arg_27_1, arg_27_2, arg_27_3)
	if not arg_27_0.chatFlag then
		...
		local var_27_0 = arg_27_0.player:getChargeLevel()
		local var_27_1 = arg_27_3 or math.random(1, var_27_0)
		local var_27_2

		if arg_27_3 then
			var_27_2 = pg.pay_level_award[var_27_1].dialog
		else
			var_27_2 = arg_27_1 or pg.pay_level_award[var_27_1].dialog
		end

		if not arg_27_1 then
			arg_27_0:playCV(var_27_1)
		end

		setText(arg_27_0.chatText, var_27_2)

		local var_27_3 = arg_27_0.chatText:GetComponent(typeof(Text))

		if #var_27_3.text > CHAT_POP_STR_LEN_SHORT then
			var_27_3.alignment = TextAnchor.MiddleLeft
		else
			var_27_3.alignment = TextAnchor.MiddleCenter
		end
		...
		;(function()
			...
			LeanTween.scale(rtf(arg_27_0.chat.gameObject), Vector3.New(1, 1, 1), var_28_1):setFrom(Vector3.New(0, 0, 0)):setEase(LeanTweenType.easeOutBack):setOnComplete(System.Action(function()
				if not arg_27_2 then
					LeanTween.scale(rtf(arg_27_0.chat.gameObject), Vector3.New(0, 0, 1), var_28_1):setEase(LeanTweenType.easeInBack):setDelay(var_28_1 + var_28_0):setOnComplete(System.Action(function()
...
function var_0_0.InitChatPosition(arg_31_0)
	local var_31_0 = arg_31_0.painting.localPosition + Vector3(-21, -176, 0)
	local var_31_1 = arg_31_0.painting.parent:TransformPoint(var_31_0)
	local var_31_2 = arg_31_0.chat.parent:InverseTransformPoint(var_31_1)

	arg_31_0.chat.localPosition = Vector3(var_31_2.x, var_31_2.y, 0)
end
...
function var_0_0.playHeartEffect(arg_32_0)
	...
	local var_32_0 = arg_32_0.painting:Find("heartsfly")
...
function var_0_0.createLive2D(arg_34_0)
	local var_34_0 = Live2DPainting.GenerateData({
		ship = Ship.New({
			configId = 312011
		}),
		offset = {
	...
	arg_34_0.live2dChar = Live2DPainting.New(var_34_0, function(arg_35_0)
...
function var_0_0.playCV(arg_37_0, arg_37_1)
	local var_37_0 = pg.pay_level_award[arg_37_1]
	local var_37_1
	...
	if var_37_1 then
		...
		pg.CriMgr.GetInstance():PlaySoundEffect_V3(var_37_1)
	end
end
...
function var_0_0.jpUIEnter(arg_42_0)
	...
	onButton(arg_42_0, arg_42_0.userAgreeBtn3, function()
		local var_43_0 = require("ShareCfg.UserAgreement3")

		arg_42_0:emit(ChargeMediator.OPEN_USER_AGREE, var_43_0 or "")
	end, SFX_PANEL)
	onButton(arg_42_0, arg_42_0.userAgreeBtn4, function()
		local var_44_0 = require("ShareCfg.UserAgreement4")

		arg_42_0:emit(ChargeMediator.OPEN_USER_AGREE, var_44_0 or "")
	end, SFX_PANEL)
end
