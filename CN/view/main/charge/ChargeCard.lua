...
function var_0_0.updateCharge(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	if var_4_1 and (not arg_4_1:isFree() or var_4_3) and var_4_2 and var_4_2 > 0 then
		...
		if var_4_9 <= var_4_2 then
			var_4_10 = var_4_2 % var_4_9
		elseif var_4_8 <= var_4_2 then
			var_4_10 = var_4_2 % var_4_8
		elseif var_4_7 <= var_4_2 then
			var_4_10 = var_4_2 % var_4_7
		end
	...
	if var_4_11 == 2 then
		setText(arg_4_0.limitText, i18n("charge_limit_all", var_4_13 - var_4_12, var_4_13))
	elseif var_4_11 == 4 then
		setText(arg_4_0.limitText, i18n("charge_limit_daily", var_4_13 - var_4_12, var_4_13))
	else
...
function var_0_0.UpdateShipIcon(arg_7_0, arg_7_1)
	...
	local var_7_3 = pg.ship_skin_template[var_7_2]

	LoadSpriteAsync("qicon/" .. var_7_3.prefab, function(arg_8_0)
...
function var_0_0.updateGemItem(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_2 = arg_9_1:getConfig("group_limit")

	if var_9_2 > 0 then
		local var_9_3 = arg_9_1:getConfig("group_type") or 0

		if var_9_3 == 1 then
			setText(arg_9_0.limitText, i18n("charge_limit_daily", var_9_2 - arg_9_1.groupCount, var_9_2))
		elseif var_9_3 == 2 then
			setText(arg_9_0.limitText, i18n("charge_limit_weekly", var_9_2 - arg_9_1.groupCount, var_9_2))
		elseif var_9_3 == 3 then
			setText(arg_9_0.limitText, i18n("charge_limit_monthly", var_9_2 - arg_9_1.groupCount, var_9_2))
		end
	end
	...
	local var_9_4 = arg_9_1:getConfig("tag")

	setActive(arg_9_0.tag, var_9_4 > 0)

	if var_9_4 > 0 then
		for iter_9_0, iter_9_1 in ipairs(arg_9_0.tags) do
			setActive(iter_9_1, iter_9_0 == var_9_4)
		end
	end

	setActive(arg_9_0.numLeftText, false)

	local var_9_5, var_9_6 = arg_9_1:inTime()
	local var_9_7 = arg_9_1:getConfig("id") == ActivityConst.FREE_PACKAGE_SHOW_TIME_ID

	if var_9_5 and (not arg_9_1:isFree() or var_9_7) and var_9_6 and var_9_6 > 0 then
		setActive(arg_9_0.numLeftText, true)

		local var_9_8, var_9_9, var_9_10 = pg.TimeMgr.GetInstance():parseTimeFrom(var_9_6)

		if var_9_8 > 0 then
			setText(arg_9_0.numLeftText, i18n("shop_goods_left_day", var_9_8))
		elseif var_9_9 > 0 then
			setText(arg_9_0.numLeftText, i18n("shop_goods_left_hour", var_9_9))
		elseif var_9_10 then
			setText(arg_9_0.numLeftText, i18n("shop_goods_left_minute", var_9_10 > 0 and var_9_10 or 1))
		end

		local var_9_11 = 60
		local var_9_12 = 3600
		local var_9_13 = 86400
		local var_9_14

		if var_9_13 <= var_9_6 then
			var_9_14 = var_9_6 % var_9_13
		elseif var_9_12 <= var_9_6 then
			var_9_14 = var_9_6 % var_9_12
		elseif var_9_11 <= var_9_6 then
			var_9_14 = var_9_6 % var_9_11
		end

		if var_9_14 and var_9_14 > 0 then
	...
	local var_9_15 = arg_9_1:getConfig("effect_args")

	if #var_9_15 > 0 then
		local var_9_16 = Item.getConfigData(var_9_15[1])

		if var_9_16 then
			setScrollText(arg_9_0.name, var_9_16.name)
			arg_9_0:updateImport(arg_9_0:GetShopDisplayItemData(arg_9_1))

			local var_9_17 = arg_9_0:CheckSkinDiscounItem(var_9_16.display_icon)

			if var_9_17 then
				arg_9_0:UpdateShipIcon(var_9_17)
			end
		end

		arg_9_0.iconTF.sprite = GetSpriteFromAtlas("chargeicon/1", "")

		LoadSpriteAsync(var_9_16.icon, function(arg_11_0)
...
function var_0_0.updateImport(arg_14_0, arg_14_1)
	...
	setActive(arg_14_0.itemPanel1, var_14_0)
	...
	if var_14_0 then
		...
		for iter_14_2 = 1, arg_14_0.grid1.childCount do
			local var_14_2 = arg_14_0.grid:GetChild(iter_14_2 - 1)
		...
		for iter_14_5 = 1, arg_14_0.grid1.childCount do
			local var_14_4 = arg_14_0.grid1:GetChild(iter_14_5 - 1)
		...
		setActive(arg_14_0.itemPanel2, not var_14_6)
		setActive(arg_14_0.itemPanel3, var_14_6)
		...
		if var_14_6 then
			...
			for iter_14_8 = 1, arg_14_0.grid3.childCount do
				local var_14_8 = arg_14_0.grid3:GetChild(iter_14_8 - 1)
			...
			setScrollText(arg_14_0.firstTipText2, var_14_5)
			...
			for iter_14_11 = 1, arg_14_0.grid2.childCount do
				local var_14_10 = arg_14_0.grid2:GetChild(iter_14_11 - 1)
...
function var_0_0.GetShopDisplayItemData(arg_16_0, arg_16_1)
	...
	local var_16_3 = arg_16_1:getConfig("effect_args")
	local var_16_4 = Item.getConfigData(var_16_3[1])

	table.insert(var_16_0, {
		text = var_16_2,
		list = var_16_4.display_icon
	})
