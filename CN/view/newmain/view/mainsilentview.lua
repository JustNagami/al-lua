...
function var_0_0.FlushTips(arg_25_0)
	...
	arg_25_0.tips:make(function(arg_26_0, arg_26_1, arg_26_2)
		if UIItemList.EventUpdate == arg_26_0 then
			...
			local var_26_1 = GetSpriteFromAtlas("ui/MainUI_atlas", var_0_8[var_26_0.type])
...
function var_0_0.CollectTips(arg_36_0, arg_36_1)
	...
	arg_36_0:CollectChapterAutoTips(arg_36_1)
end
...
function var_0_0.CollectChapterAutoTips(arg_42_0, arg_42_1)
...
function var_0_0.FlushBattery(arg_43_0)
	local var_43_0 = SystemInfo.batteryLevel

	if var_43_0 < 0 then
		var_43_0 = 1
	end

	local var_43_1 = math.floor(var_43_0 * 100)

	arg_43_0.batteryTxt.text = var_43_1 .. "%"

	local var_43_2 = 1 / #arg_43_0.electric

	for iter_43_0, iter_43_1 in ipairs(arg_43_0.electric) do
		local var_43_3 = var_43_1 < (iter_43_0 - 1) * var_43_2

		setActive(iter_43_1, not var_43_3)
	end
end

function var_0_0.FlushTime(arg_44_0)
	arg_44_0.systemTimeUtil:SetUp(function(arg_45_0, arg_45_1, arg_45_2)
		if SettingsMainScenePanel.IsEnable24HourSystem() then
			arg_44_0.timeEnTxt.color = Color.New(1, 1, 1, 0)
		else
			arg_44_0.timeEnTxt.color = Color.New(1, 1, 1, 1)
		...
		arg_44_0.timeTxt.text = arg_45_0 .. ":" .. arg_45_1
		arg_44_0.timeEnTxt.text = arg_45_2
	end)
end
...
function var_0_0.FlushDate(arg_46_0)
	local var_46_0 = os.date("%Y/%m/%d")
	local var_46_1 = string.split(var_46_0, "/")
	local var_46_2 = var_46_1[1]
	local var_46_3 = tonumber(var_46_1[2])
	local var_46_4 = var_46_1[3]
	local var_46_5 = pg.TimeMgr.GetInstance():GetServerWeek()
	local var_46_6 = {
		var_0_11[var_46_5],
		var_0_12[var_46_3],
		var_46_4,
	...
	arg_46_0.dateTxt.text = table.concat(var_46_6, " / ")
end

function var_0_0.FlushMusicPlayer(arg_47_0)
	local var_47_0 = pg.BgmMgr.GetInstance():GetNow() == "MainMusicPlayer"

	if tobool(arg_47_0.musicPlayerView:isShowing()) ~= var_47_0 then
		if var_47_0 then
			arg_47_0.musicPlayerView:ExecuteAction("Show", true)
		else
			arg_47_0.musicPlayerView:ExecuteAction("Hide")
		end
	end
end
...
function var_0_0.OnDestroy(arg_48_0)
	...
	arg_48_0.dftAniEvent:SetEndEvent(nil)
	arg_48_0:RemoveTimer()
	arg_48_0.changeSkinBtn:Dispose()

	arg_48_0.changeSkinBtn = nil

	arg_48_0.systemTimeUtil:Dispose()

	arg_48_0.systemTimeUtil = nil

	arg_48_0.musicPlayerView:Destroy()

	arg_48_0.musicPlayerView = nil
end
