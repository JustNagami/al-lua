...
function var_0_0.InitDragEvent(arg_13_0)
	...
	var_13_2:AddPointDownFunc(function(arg_14_0, arg_14_1)
		...
		local var_14_1 = arg_13_0:GetTouchTarget(var_14_0, arg_14_1.position)

		if not var_14_1 then
			return
		end

		arg_13_0.touchPressTarget = var_14_1

		arg_13_0:EmitTouchPress(true, var_14_1, arg_14_1.position)
	end)
	var_13_2:AddPointUpFunc(function(arg_15_0, arg_15_1)
		...
		arg_13_0:EmitTouchPress(false, var_15_0, arg_15_1.position)
	end)
	var_13_2:AddBeginDragFunc(function(arg_16_0, arg_16_1)
		...
		local var_16_2 = CameraMgr.instance:Raycast(var_16_0.IKSettings.CameraRaycaster, var_16_1):ToTable()

		if #var_16_2 <= 0 then
			return
		end

		local var_16_3 = var_16_2[1].gameObject.transform
		local var_16_4 = table.keyof(var_16_0.IKSettings.Colliders, var_16_3)

		warning(var_16_3, var_16_4)

		if not var_16_4 then
			return
		end

		arg_13_0:emit(RoomIKSystem.ON_BEGIN_DRAG_CHARACTER_BODY, var_16_0, var_16_4, var_16_1)
...
function var_0_0.GetTouchTarget(arg_19_0, arg_19_1, arg_19_2)
	...
	local var_19_0 = CameraMgr.instance:Raycast(arg_19_1.IKSettings.CameraRaycaster, arg_19_2):ToTable()

	for iter_19_0, iter_19_1 in ipairs(var_19_0) do
		local var_19_1 = iter_19_1.gameObject.transform
		local var_19_2 = table.keyof(arg_19_1.IKSettings.Colliders, var_19_1)
		...
		local var_19_3 = arg_19_0:GetTouchSceneItem(arg_19_1, var_19_1)
...
function var_0_0.GetTouchSceneItem(arg_20_0, arg_20_1, arg_20_2)
	...
	for iter_20_0, iter_20_1 in ipairs(arg_20_1.iKTouchDatas) do
		local var_20_0 = pg.dorm3d_ik_touch[iter_20_1[1]]

		if #var_20_0.scene_item > 0 then
			local var_20_1 = arg_20_0.contextData.GetSceneItem(var_20_0.scene_item)

			if var_20_1 and var_0_0.IsTransformInHierarchy(arg_20_2, var_20_1) then
				return var_20_0.scene_item
			end
		end
	end
end
...
function var_0_0.EmitTouchPress(arg_22_0, arg_22_1, arg_22_2, arg_22_3)
	if arg_22_2.source == "body" then
		arg_22_0:emit(arg_22_1 and RoomTouchSystem.ON_TOUCH_CHARACTER_DOWN or RoomTouchSystem.ON_TOUCH_CHARACTER_UP, arg_22_2.target, arg_22_3)
	elseif arg_22_2.source == "scene_item" then
		arg_22_0:emit(arg_22_1 and RoomTouchSystem.ON_TOUCH_SCENE_ITEM_DOWN or RoomTouchSystem.ON_TOUCH_SCENE_ITEM_UP, arg_22_2.target, arg_22_3)
	end
end
...
function var_0_0.UpdateTouchTips(arg_42_0, arg_42_1, arg_42_2)
	UIItemList.StaticAlign(arg_42_0.ikTouchTipsRoot, arg_42_0.ikTouchTipTpl, #arg_42_2, function(arg_43_0, arg_43_1, arg_43_2)
		...
		local var_43_3 = pg.dorm3d_ik_touch[var_43_2]

		arg_42_0:SetTouchTipType(arg_43_2, var_43_3.trigger_type)

		if var_43_3.tip_offset and var_43_3.tip_offset ~= "" then
			var_43_1 = Vector2.New(unpack(var_43_3.tip_offset))
		end
		...
		if var_43_0 then
			local var_43_4 = var_43_0.position
			local var_43_5 = var_43_0:GetComponent(typeof(UnityEngine.Collider))

			if var_43_5 then
				var_43_4 = var_43_5.bounds.center
			end

			setLocalPosition(arg_43_2, arg_42_0.contextData.GetLocalPosition(arg_42_0.contextData.GetScreenPosition(var_43_4, arg_42_1.IKSettings.CameraRaycaster.eventCamera), arg_42_0.ikTouchTipsRoot) + var_43_1)
		end
...
function var_0_0.UpdateTips(arg_52_0, arg_52_1, arg_52_2)
	if arg_52_1 and arg_52_2 then
		local var_52_0 = _.filter(arg_52_2.readyIKLayers or {}, function(arg_53_0)
			return not arg_53_0.ignoreDrag
		end)

		UIItemList.StaticAlign(arg_52_0.ikTipsRoot, arg_52_0.ikTipsRoot:GetChild(0), #var_52_0, function(arg_54_0, arg_54_1, arg_54_2)
			...
			local var_54_0
			local var_54_1 = Vector2.zero
			local var_54_2 = var_52_0[arg_54_1]
			local var_54_3 = var_54_2:GetTriggerBoneName()
			local var_54_4 = var_54_3 and arg_52_2.IKSettings.Colliders[var_54_3] or nil
			local var_54_5 = var_54_2:GetIKTipOffset()
			...
			if var_54_4 then
				...
				if var_54_10.x == 0.5 then
					if var_54_8.x < 0 then
						var_54_11.x = var_54_9.xMax
					else
						var_54_11.x = var_54_9.xMin
					end
				end

				if var_54_10.y == 0.5 then
					if var_54_8.y < 0 then
						var_54_11.y = var_54_9.yMax
					else
						var_54_11.y = var_54_9.yMin
					end
				end

				local var_54_12 = var_54_11 - var_54_9.center

				setLocalRotation(arg_54_2, Quaternion.LookRotation(Vector3.forward, Vector3.New(var_54_12.x, var_54_12.y, 0)))
			end

			setActive(arg_54_2, var_54_4)
		end)
		arg_52_0:UpdateTouchTips(arg_52_2, arg_52_2.iKTouchDatas or {})
	end
