...
function var_0_0.ShowBlackScreen(arg_27_0, arg_27_1, arg_27_2)
	...
	setImageColor(arg_27_0.blackLayer, Color.NewHex(var_27_0.color))
	...
	arg_27_0:managedTween(LeanTween.alphaCanvas, function()
		...
		existCall(arg_27_2)
	end, GetComponent(arg_27_0.blackLayer, typeof(CanvasGroup)), arg_27_1 and 1 or 0, var_27_0.time):setDelay(var_27_0.delay)
end
