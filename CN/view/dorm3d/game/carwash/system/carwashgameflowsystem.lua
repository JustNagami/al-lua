...
function var_0_0.EmitCountdown(arg_31_0)
	local var_31_0 = math.max(math.ceil(arg_31_0.remainingTime or 0), 0)

	if arg_31_0.lastCountdownSeconds == var_31_0 then
		return
	end

	arg_31_0.lastCountdownSeconds = var_31_0

	arg_31_0:Emit(var_0_0.UPDATE_COUNTDOWN, {
		remainingSeconds = var_31_0
	})
end
...
function var_0_0.UpdateGameStatus(arg_40_0, arg_40_1, arg_40_2)
	...
	local var_40_1 = arg_40_0.contextData.gameStatus[arg_40_1]
...
function var_0_0.SetGameState(arg_41_0, arg_41_1)
	...
	if arg_41_1 == CarWashConst.GAME_STATE.PHASE_2 and var_41_0 ~= CarWashConst.GAME_STATE.PHASE_2 then
...
function var_0_0.ModifyHeartBeatValue(arg_44_0, arg_44_1)
	...
	local var_44_1 = math.max(math.min(var_44_0 + arg_44_1, 100), 0)

	arg_44_0:SetHeartBeatValue(var_44_1)
end
...
function var_0_0.TryEnterPhase2ByHeartBeat(arg_46_0, arg_46_1)
	local var_46_0 = pg.dorm3d_carwash_pos[arg_46_0.contextData.gameConfig.pos_phase2]

	if not var_46_0 then
		return
	end

	if arg_46_1 < var_46_0.mood_value then
		return
	end
...
function var_0_0.DecreaseStainsCount(arg_53_0, arg_53_1)
	...
	arg_53_0:SetStainsCount(math.max(var_53_0 - arg_53_1, 0))
end
...
function var_0_0.CheckAllPhase2TipsClicked(arg_57_0)
	local var_57_0 = pg.dorm3d_carwash_pos[arg_57_0.contextData.gameConfig.pos_phase2]

	assert(var_57_0, "CarWash phase2 pos config not found: " .. tostring(arg_57_0.contextData.gameConfig.pos_phase2))

	for iter_57_0, iter_57_1 in ipairs(var_57_0.fury_anim) do
