...
function var_0_0.UpdateMuzzleEffect(arg_12_0, arg_12_1)
	...
	if var_12_0 then
		local var_12_2 = arg_12_0:UpdateAimTarget(var_12_1.point, arg_12_1)

		setActive(arg_12_0.hitVFX, not arg_12_0.isAimTargetEntering)

		arg_12_0.hitVFX.position = var_12_2
...
function var_0_0.LookAtTarget(arg_13_0, arg_13_1)
	...
	if var_13_0:SqrMagnitude() <= 1e-06 then
		return
	end

	arg_13_0:StartGunRotation(Quaternion.LookRotation(var_13_0.normalized, Vector3.up), var_0_0.GUN_LOOK_LERP_TIME, false, var_0_0.GUN_ROTATION_STATE_LOOK)
end
...
function var_0_0.StartGunRotation(arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
	...
	local var_15_0 = arg_15_3 and arg_15_0.gunTF.localRotation or arg_15_0.gunTF.rotation
