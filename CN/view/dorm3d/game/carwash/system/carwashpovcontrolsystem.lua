...
function var_0_0.UpdatePlayerMove(arg_26_0)
	...
	local var_26_1 = var_26_0 / var_0_0.MOVE_STICK_RANGE

	arg_26_0.moveStickPosition = arg_26_0.moveStickOrigin + var_26_0

	local var_26_2 = Vector3.New(var_26_1.x, 0, var_26_1.y)

	if var_26_2:SqrMagnitude() <= 0 then
		return
	end

	local var_26_3 = arg_26_0.mainCameraTF:TransformDirection(var_26_2)

	var_26_3.y = 0

	local var_26_4 = var_26_3:Normalize()

	var_26_4:Mul(var_0_0.MOVE_SPEED)
	arg_26_0.characterController:SimpleMove(var_26_4)
end
