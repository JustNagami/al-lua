...
function var_0_0.InitSceneRefs(arg_10_0)
	...
	for iter_10_0, iter_10_1 in ipairs(var_0_0.GLASS_CONFIG) do
		...
		local var_10_1 = var_10_0.transform
		local var_10_2 = var_10_0:GetComponent(typeof(MaterialSwitcher))

		assert(var_10_2, "MaterialSwitcher component not found on " .. tostring(iter_10_1.path))

		local var_10_3 = GameObject.Find(iter_10_1.region)

		assert(var_10_3, "CarWash glass decal region not found: " .. tostring(iter_10_1.region))

		local var_10_4 = var_10_1:Find(iter_10_1.vfx)

		assert(var_10_4, "CarWash glass vfx not found: " .. tostring(iter_10_1.vfx))
		setActive(var_10_4, false)
		table.insert(arg_10_0.glassInfos, {
			switcher = var_10_2,
			regionTF = var_10_3.transform,
			vfxTF = var_10_4
		})
	end
...
function var_0_0.SetGlassTransparent(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	...
	local var_13_0 = arg_13_2 and var_0_0.TRANSPARENT_INDEX or var_0_0.OPAQUE_INDEX
