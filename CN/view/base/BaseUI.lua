...
function var_0_0.loadUISync(arg_15_0, arg_15_1)
	...
	local var_15_1 = pg.UIMgr.GetInstance().UIMain

	var_15_0.transform:SetParent(var_15_1.transform, false)
...
function var_0_0.SetUIParent(arg_22_0, arg_22_1)
	local var_22_0 = pg.UIMgr.GetInstance().UIMain

	arg_22_1.transform:SetParent(var_22_0.transform, false)
end
...
function var_0_0.enter(arg_45_0)
	...
	if tobool(arg_45_0:loadingQueue()) and arg_45_0.contextData.resumeCallback then
		local var_45_0 = arg_45_0.contextData.resumeCallback
...
function var_0_0.PlayUIAnimation(arg_51_0, arg_51_1, arg_51_2, arg_51_3)
	local var_51_0 = arg_51_1:GetComponent(typeof(Animation))
	local var_51_1 = arg_51_1:GetComponent(typeof(UIEventTrigger))

	var_51_1.didExit:RemoveAllListeners()
	var_51_1.didExit:AddListener(function()
		var_51_1.didExit:RemoveAllListeners()
		arg_51_3()
	end)
	var_51_0:Play(arg_51_2)
end
...
function var_0_0.detach(arg_55_0, arg_55_1)
	...
	local var_55_0 = PoolMgr.GetInstance()
	local var_55_1 = arg_55_0:getUIName()

	if arg_55_0._go ~= nil and var_55_1 then
		var_55_0:ReturnUI(var_55_1, arg_55_0._go)
