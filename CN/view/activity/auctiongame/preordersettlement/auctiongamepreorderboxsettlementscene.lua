...
function var_0_0.didEnter(arg_6_0)
	...
	local var_6_2 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_AUCTION_GAME):getConfig("config_client").itemID
...
function var_0_0.OnRefreshOver(arg_10_0)
	...
	getProxy(AuctionGameBaseProxy):AddGold(var_10_0)
	pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildPreorder(1, var_10_0))
