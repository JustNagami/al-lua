...
function var_0_0.initNotificationHandleDic(arg_5_0)
	arg_5_0.handleDic = {
		[GAME.SUBMIT_TASK_DONE] = function(arg_6_0, arg_6_1)
			if not (getProxy(ContextProxy):GetPrevContext(0).mediator == ActivityMediator) and #arg_6_1:getBody().awards > 0 then
		...
		[GAME.SUBMIT_ACTIVITY_TASK_DONE] = function(arg_7_0, arg_7_1)
			if not (getProxy(ContextProxy):GetPrevContext(0).mediator == CoreActivityMainMediator) and #arg_7_1:getBody().awards > 0 then
