...
function var_0_0.init(arg_2_0)
	...
	onButton(arg_2_0, arg_2_0.uiOkBtn, function()
		...
		local var_4_1 = pg.gameset.auction_event_choose_time.key_value - (var_4_0:GetTimestamp() - pg.TimeMgr.GetInstance():GetServerTime())

		pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildAuctionChooseEvent(var_4_0:GetAuctionID(), var_4_0:GetRound(), var_4_1, arg_2_0.selectedID))
...
function var_0_0.didEnter(arg_5_0)
	...
	local var_5_1 = var_5_0:GetPersonalEventList()
