...
function var_0_0.init(arg_2_0)
	...
	for iter_2_2, iter_2_3 in pairs(arg_2_0.contourList) do
		local var_2_0 = iter_2_3[1]
		local var_2_1 = iter_2_3[2]
		...
		arg_2_0.contourItemList[#arg_2_0.contourItemList]:didEnter(var_2_1, var_2_0)
	end
end
...
function var_0_0.didEnter(arg_5_0)
	...
	local var_5_0 = getProxy(AuctionGameBaseProxy)

	setText(arg_5_0.uiCollectText, string.format("%s/%s", var_5_0.unlockCollectionCnt, #pg.auction_collection.all))
end
...
function var_0_0.GetCollectionList(arg_8_0, arg_8_1, arg_8_2)
	...
	for iter_8_0, iter_8_1 in ipairs(pg.auction_collection.all) do
		local var_8_1 = pg.auction_collection[iter_8_1]

		if (arg_8_1 == 0 or var_8_1.rarity == arg_8_1) and (arg_8_2[1] == 0 or arg_8_2[1] == var_8_1.contour[1] and arg_8_2[2] == var_8_1.contour[2]) then
...
function var_0_0.GetPriceArea(arg_10_0)
	...
	for iter_10_0, iter_10_1 in ipairs(arg_10_0.idList) do
		local var_10_2 = pg.auction_collection[iter_10_1]

		if iter_10_0 == 1 then
			var_10_0 = var_10_2.value
			var_10_1 = var_10_2.value
		else
			var_10_0 = var_10_0 > var_10_2.value and var_10_2.value or var_10_0
			var_10_1 = var_10_1 < var_10_2.value and var_10_2.value or var_10_1
		end
	end
...
function var_0_0.GetFilterData(arg_11_0)
	...
	for iter_11_0, iter_11_1 in ipairs(pg.auction_collection.all) do
		local var_11_2 = pg.auction_collection[iter_11_1]

		if not table.keyof(var_11_0, var_11_2.rarity) then
			table.insert(var_11_0, var_11_2.rarity)
		end

		var_11_1[var_11_2.contour[1]] = var_11_1[var_11_2.contour[1]] or {}

		if not table.keyof(var_11_1[var_11_2.contour[1]], var_11_2.contour[2]) then
			table.insert(var_11_1[var_11_2.contour[1]], var_11_2.contour[2])
		end
	end
	...
	for iter_11_2, iter_11_3 in pairs(var_11_1) do
		...
		table.insert(var_11_3, iter_11_2)
	end

	table.sort(var_11_3, function(arg_14_0, arg_14_1)
	...
	for iter_11_4, iter_11_5 in ipairs(var_11_3) do
