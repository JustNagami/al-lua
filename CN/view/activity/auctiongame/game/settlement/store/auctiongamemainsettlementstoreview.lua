...
function var_0_0.Init(arg_2_0)
	...
	local var_2_0 = getProxy(AuctionGameProxy):GetMaxLineCnt() * AuctionGameConst.CELL_COL_CNT
...
function var_0_0.ShowAllContour(arg_5_0)
	for iter_5_0, iter_5_1 in ipairs(arg_5_0.itemDataList) do
		local var_5_0 = arg_5_0.itemViewList[uid] or AuctionGameStoreItem.New(tf(Instantiate(arg_5_0.uiItemTf, arg_5_0.uiCellParentTf)), arg_5_0._parentClass)
		local var_5_1 = AuctionGameConst.CELL_COL_CNT * (iter_5_1.position.y - 1) + iter_5_1.position.x
		local var_5_2 = arg_5_0.cellItemViewList[var_5_1]:GetPosition()

		var_5_0:SetPosition(var_5_2)
...
function var_0_0.RevealItem(arg_6_0, arg_6_1)
	local var_6_0 = arg_6_0.itemDataList[arg_6_1]
	local var_6_1 = var_6_0.id
	local var_6_2 = var_6_0.uid
	local var_6_3 = arg_6_0.itemViewList[var_6_2] or AuctionGameStoreItem.New(tf(Instantiate(arg_6_0.uiItemTf, arg_6_0.uiCellParentTf)), arg_6_0._parentClass)

	var_6_3:didEnter(var_6_0)

	arg_6_0.itemViewList[var_6_2] = var_6_3
	arg_6_0.showIndex = arg_6_0.showIndex + 1

	arg_6_0:emit(AuctionGameMainSettlementScene.REVEAL_ITEM, var_6_0)
end
