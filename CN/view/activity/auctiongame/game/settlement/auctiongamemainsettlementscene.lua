...
function var_0_0.didEnter(arg_6_0)
	...
	local var_6_2 = var_6_1.bidUserID
	local var_6_3
	...
	setPaintingPrefabAsync(arg_6_0.uiPaintingTf, var_6_4:getPainting(), "chuanwu", nil, {
	...
	setScrollText(arg_6_0.uiNameText, var_6_3.name)

	local var_6_5 = var_6_0:GetAuctionID()

	setScrollText(arg_6_0.uiSessionText, pg.auction_session[var_6_5].name)
	...
	local var_6_6 = getProxy(ActivityProxy):getActivityByType(ActivityConst.ACTIVITY_TYPE_AUCTION_GAME):getConfig("config_client").itemID
...
function var_0_0.OnRefreshText(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = arg_9_0.addValue - arg_9_0.settlementVO.bidValue

	setText(arg_9_0.uiProceedsText, string.format("<color=%s>%s</color>", var_9_1 > 0 and "#03825F" or "#B13535", StringHelper.ForamtNumber(var_9_1)))
end
...
function var_0_0.OnRefreshOver(arg_10_0)
	...
	local var_10_4 = pg.auction_session[var_10_0:GetAuctionID()].name
	local var_10_5 = var_10_1.bidUserID == getProxy(PlayerProxy):getPlayerId() and 1 or 0

	pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildAuctionSettlement(var_10_4, var_10_5, var_10_1.bidValue, arg_10_0.addValue, var_10_2.gold, var_10_2.gold + var_10_3))
