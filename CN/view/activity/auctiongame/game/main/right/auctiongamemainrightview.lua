...
function var_0_0.Init(arg_2_0)
		...
		arg_2_0:emit(BaseUI.ON_ADD_SUBLAYER, Context.New({
			...
			data = {
				...
				comformCallback = function()
					...
					if var_8_0:GetAuctionState() == AuctionGameConst.AUCTION_PHASE.BID then
						var_8_1 = pg.gameset.auction_bid_time.key_value + var_8_1
					else
						var_8_1 = pg.gameset.auction_event_choose_time.key_value + var_8_1
					end
	...
	local var_2_1 = getProxy(AuctionGameProxy):GetPlayerList()
...
function var_0_0.OnShowEmoji(arg_24_0, arg_24_1, arg_24_2)
	...
	local var_24_1 = getProxy(AuctionGameProxy):GetPlayerList()

	for iter_24_0, iter_24_1 in ipairs(var_24_1) do
		arg_24_0.playerViewList[iter_24_0]:ShowEmoji(var_24_0, arg_24_2.emojiID)
	end
end

function var_0_0.OnSwitchEmoji(arg_25_0)
	local var_25_0 = getProxy(AuctionGameProxy):GetPlayerList()
