...
function var_0_0.initNotificationHandleDic(arg_3_0)
	arg_3_0.handleDic = {
		[GAME.AUCTION_GAME_ROUND_OVER] = function(arg_4_0, arg_4_1)
			...
			local var_4_1 = pg.gameset.auction_bid_time.key_value

			pg.GameTrackerMgr.GetInstance():Record(GameTrackerBuilder.BuildAuctionBid(var_4_0:GetAuctionID(), var_4_0:GetRound(), var_4_1, 0, 1))
