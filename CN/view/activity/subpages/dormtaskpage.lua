...
function var_0_0.OnUpdateFlush(arg_6_0)
	...
	arg_6_0.taskVO = arg_6_0.taskProxy:getTaskById(var_6_0) or arg_6_0.taskProxy:getFinishTaskById(var_6_0)

	local var_6_1 = arg_6_0.taskVO:getConfig("award_display")[1]
	local var_6_2 = {
		type = var_6_1[1],
		id = var_6_1[2],
		count = var_6_1[3]
	...
	updateDrop(arg_6_0.awardTF, var_6_2)
	onButton(arg_6_0, arg_6_0.awardTF, function()
		arg_6_0:emit(BaseUI.ON_DROP, var_6_2)
	end, SFX_PANEL)
	...
	local var_6_3 = arg_6_0.taskVO:getProgress()
	local var_6_4 = arg_6_0.taskVO:getConfig("target_num")

	setText(arg_6_0.desc, arg_6_0.taskVO:getConfig("desc"))
	setText(arg_6_0.progress, var_6_3 .. "/" .. var_6_4)
	setSlider(arg_6_0.slider, 0, var_6_4, var_6_3)

	local var_6_5 = arg_6_0.taskVO:getTaskStatus()

	setActive(arg_6_0.battleBtn, var_6_5 == 0)
	setActive(arg_6_0.getBtn, var_6_5 == 1)
	setActive(arg_6_0.gotBtn, var_6_5 == 2)
	setActive(arg_6_0.awardGot, var_6_5 == 2)
end

function var_0_0.getTaskIdx(arg_8_0, arg_8_1)
	local var_8_0 = 1
	local var_8_1 = arg_8_1:getNDay()
	local var_8_2 = #arg_8_0.taskGroup
	local var_8_3 = math.min(var_8_1, var_8_2)
	local var_8_4 = true
	...
	return math.min(var_8_0, var_8_2)
end
