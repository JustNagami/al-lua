local var_0_0 = class("ShiningMagicInvitationPage", import("view.activity.CorePage.CoreActivityPage"))
...
function var_0_0.OnFirstFlush(arg_3_0)
	onButton(arg_3_0, arg_3_0.goBtn, function()
		local var_4_0 = arg_3_0.coreActivityUI:GetActivityIdByPageClass("ShiningMagicPacmanPage")
...
function var_0_0.OnUpdateFlush(arg_6_0)
	updateActivityTaskStatus(arg_6_0.activity)
...
function var_0_0.RefreshProgress(arg_9_0)
	...
	local var_9_1 = math.min(arg_9_0.finishCount, var_9_0)

	for iter_9_0 = 1, var_9_0 do
		local var_9_2 = arg_9_0.rtMarks:GetChild(iter_9_0 - 1)

		setActive(var_9_2:Find("mark"), iter_9_0 <= var_9_1)
	end
end
...
function var_0_0.RefreshButtons(arg_10_0)
	...
	local var_10_3, var_10_4 = getActivityTask(arg_10_0.activity)
	...
	setActive(arg_10_0.red, var_10_1 or var_10_5)
