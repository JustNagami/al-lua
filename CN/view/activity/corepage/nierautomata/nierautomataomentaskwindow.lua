...
function var_0_0.UpdateListItem(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = findTF(var_9_0, "day/dayText")
	local var_9_2 = findTF(var_9_0, "tasks")
	local var_9_3 = findTF(arg_9_2, "lock")
	local var_9_4 = findTF(var_9_3, "desc_bg/desc")
...
function var_0_0.UpdateTaskItem(arg_12_0, arg_12_1, arg_12_2, arg_12_3)
	...
	local var_12_8 = var_12_3 and var_12_3:getTaskStatus() == 2
	local var_12_9 = var_12_4.desc

	if utf8.len(var_12_9) >= 17 then
		setScrollText(arg_12_3:Find("mask/description"), var_12_9)
	else
		setText(arg_12_3:Find("mask/description"), var_12_9)
	end

	setSlider(arg_12_3:Find("progress"), 0, var_12_7, var_12_6)
	setText(arg_12_3:Find("progressText"), var_12_6 .. "<color=#52514a>/" .. var_12_7 .. "</color>")
	setActive(arg_12_3:Find("progressText"), not var_12_8)
	setActive(arg_12_3:Find("mask_got"), var_12_8)
...
function var_0_0.isTaskLock(arg_15_0, arg_15_1)
	...
	for iter_15_0 = 1, arg_15_1 - 1 do
		local var_15_0 = arg_15_0.taskGroup[iter_15_0]

		for iter_15_1, iter_15_2 in ipairs(var_15_0) do
			local var_15_1 = arg_15_0.taskProxy:getTaskById(iter_15_2) or arg_15_0.taskProxy:getFinishTaskById(iter_15_2)

			if not var_15_1 or var_15_1:getTaskStatus() ~= 2 then
				return 2
			end
		end
	end
