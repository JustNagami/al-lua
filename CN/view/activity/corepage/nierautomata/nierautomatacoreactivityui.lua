...
function var_0_0.OnClickBtn(arg_5_0, arg_5_1, arg_5_2)
	local var_5_0 = getProxy(ActivityProxy):getActivityById(arg_5_2)

	arg_5_0:refreshTime(var_5_0)
end

function var_0_0.refreshTime(arg_6_0, arg_6_1)
	local var_6_0 = arg_6_1.stopTime - pg.TimeMgr.GetInstance():GetServerTime()

	setText(arg_6_0.resTime, i18n("nier_core_countdown", math.floor(var_6_0 / 86400), math.floor(var_6_0 % 86400 / 3600)))
end
