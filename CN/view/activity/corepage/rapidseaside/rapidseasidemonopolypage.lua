...
function var_0_0.UpdateTurnAwards(arg_8_0)
	...
	local var_8_2 = pg.gameset[var_8_1] and pg.gameset[var_8_1].description or {
		3,
		6,
		9
	}
	local var_8_3 = var_8_2[3]
	local var_8_4 = (var_8_0.data1_list[3] or 1) - 1
	local var_8_5 = var_8_0.data1_list[6] or 0

	arg_8_0.turnTxt.text = i18n("RapidSeasideMonopolyPage_turn_cnt_tip")
	arg_8_0.turnCntTxt.text = var_8_4 .. "/" .. var_8_3

	local var_8_6 = (math.max(var_8_0.data2, 1) - 1) / #(var_8_0:getDataConfig("map") or {})

	if var_8_6 == 0 and var_8_4 > 0 then
		var_8_6 = 1
	end

	arg_8_0.progressTxt.text = i18n("RapidSeasideMonopolyPage_progress_tip")
	arg_8_0.progressCntTxt.text = string.format("%.1f", var_8_6 * 100) .. "%"

	local var_8_7 = var_8_0:getDataConfig("sum_lap_reward_show")
	local var_8_8 = false
	local var_8_9 = 0

	for iter_8_0, iter_8_1 in ipairs(arg_8_0.turnAwards) do
		local var_8_10 = var_8_7[iter_8_0]
		local var_8_11 = Drop.New({
			type = var_8_10[1],
			id = var_8_10[2],
			count = var_8_10[3]
		})
		local var_8_12 = var_8_2[iter_8_0]
		local var_8_13 = var_8_12 <= var_8_4 and var_8_5 < var_8_12

		updateDrop(iter_8_1:Find("mask"), var_8_11)
		onButton(arg_8_0, iter_8_1, function()
			arg_8_0:emit(BaseUI.ON_DROP, var_8_11)
		end, SFX_PANEL)
		setActive(iter_8_1:Find("got"), var_8_12 <= var_8_5)
		setActive(iter_8_1:Find("bg_lock"), var_8_12 <= var_8_4)
		setActive(iter_8_1:Find("bg_unlock"), var_8_4 < var_8_12)

		if var_8_9 == 0 and var_8_13 then
			var_8_9 = var_8_12
		end

		setActive(iter_8_1:Find("can_get_mask"), var_8_13)

		var_8_8 = var_8_8 or var_8_13
	end

	setActive(arg_8_0.turnGotBtn, not var_8_8)
	setActive(arg_8_0.turnGetBtn, var_8_8)

	local var_8_14 = pg.TimeMgr.GetInstance():GetServerTime()
	local var_8_15 = var_8_0.data1
	local var_8_16 = math.ceil((var_8_14 - var_8_15) / 86400) * var_8_0:getDataConfig("daily_time") + (var_8_0.data1_list[1] or 0) - (var_8_0.data1_list[2] or 0)

	arg_8_0.leftCountTxt.text = i18n("MonopolyCar2024Game_total_num_tip", var_8_16)
...
function var_0_0.UpdateTask(arg_11_0)
	local var_11_0 = pg.activity_template[arg_11_0.activity.id].config_data[1]
	local var_11_1 = pg.activity_template[var_11_0].config_data[1]
	local var_11_2 = getProxy(TaskProxy)
	local var_11_3 = var_11_2:getTaskById(var_11_1) or var_11_2:getFinishTaskById(var_11_1) or Task.New({
		id = var_11_1
	})
	local var_11_4 = var_11_2:getTaskById(var_11_1)
	local var_11_5 = var_11_3:getConfig("award_display")[1]
	...
	updateDrop(arg_11_0.taskAward:Find("mask"), var_11_6)
	onButton(arg_11_0, arg_11_0.taskAward, function()
		arg_11_0:emit(BaseUI.ON_DROP, var_11_6)
	end, SFX_PANEL)

	local var_11_7 = var_11_3:getConfig("target_num")

	if var_11_4 ~= nil then
		local var_11_8 = math.min(var_11_3:getProgress(), var_11_7)

		setSlider(arg_11_0.taskProgress, 0, var_11_7, var_11_8)

		local var_11_9 = var_11_3:getConfig("desc")

		for iter_11_0, iter_11_1 in ipairs({
			var_11_8
		}) do
			var_11_9 = string.gsub(var_11_9, "$" .. iter_11_0, iter_11_1)
		end

		arg_11_0.taskDesc.text = var_11_9

		local var_11_10 = var_11_3:isFinish()
		local var_11_11 = var_11_3:isReceive()

		setActive(arg_11_0.taskGoBtn, not var_11_10 and not var_11_11)
		setActive(arg_11_0.taskGetBtn, var_11_10 and not var_11_11)
		setActive(arg_11_0.taskGotBtn, var_11_11)
	else
		local var_11_12 = var_11_7

		setSlider(arg_11_0.taskProgress, 0, var_11_7, var_11_12)

		local var_11_13 = var_11_3:getConfig("desc")

		for iter_11_2, iter_11_3 in ipairs({
			var_11_12
		}) do
			var_11_13 = string.gsub(var_11_13, "$" .. iter_11_2, iter_11_3)
		end

		arg_11_0.taskDesc.text = var_11_13
	...
	onButton(arg_11_0, arg_11_0.taskGetBtn, function()
		arg_11_0:emit(ActivityMediator.ON_TASK_SUBMIT, var_11_3, function(arg_14_0)
			if arg_14_0 then
...
function var_0_0.UpdateRed(arg_16_0)
	local var_16_0 = pg.activity_template[arg_16_0.activity.id].config_client

	if var_16_0.is_showMedal then
		local var_16_1 = var_16_0.medal_group_id

		setActive(arg_16_0.redMalPoint, ActivityMedalGroup.showTip(var_16_1))
	end
end
