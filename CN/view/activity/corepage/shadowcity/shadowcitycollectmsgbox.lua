local var_0_0 = class("ShadowCityCollectMsgBox", import("view.activity.CorePage.DOA.DOACoreActivityMsgBox"))
...
function var_0_0.OnInit(arg_2_0)
	...
	setText(arg_2_0.window:Find("top/title"), i18n("island_get_way"))
end
...
function var_0_0.Show(arg_3_0, arg_3_1)
	...
	arg_3_0:setWindowSize(var_3_2 - 1)
...
function var_0_0.setWindowSize(arg_6_0, arg_6_1)
	setSizeDelta(arg_6_0.window:Find("bg"), Vector2(769, 440 + 50 * arg_6_1))
end
