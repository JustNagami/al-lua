...
function var_0_0.updateUI(arg_4_0)
	...
	if var_4_1 then
		local var_4_3 = arg_4_0.timeMgr:Table2ServerTime(var_4_1)

		var_4_2 = var_0_0:skinCommdityTimeStamps(var_4_3)
	end

	setActive(arg_4_0.shop_bgtime, var_4_2 and var_4_2 ~= 0)
	setText(arg_4_0.shop_time, var_4_2)

	local var_4_4, var_4_5 = arg_4_0.timeMgr:inTime(pg.activity_template[arg_4_0.activity.id].time)
	local var_4_6

	if var_4_5 then
		local var_4_7 = arg_4_0.timeMgr:Table2ServerTime(var_4_5)

		var_4_6 = var_0_0:skinCommdityTimeStamps(var_4_7)
	end

	setActive(arg_4_0.build_bgtime, var_4_6 and var_4_6 ~= 0)
