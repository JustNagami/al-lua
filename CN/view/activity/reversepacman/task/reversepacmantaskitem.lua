local var_0_0 = class("ReversePacmanTaskItem", import("view.base.BasePanel"))
...
function var_0_0.Init(arg_2_0)
	onButton(arg_2_0, arg_2_0.uiGoBtn, function()
		arg_2_0:emit(ReversePacmanTaskMediator.ON_TASK_GO, arg_2_0.taskVO)
	end, SFX_PANEL)
	onButton(arg_2_0, arg_2_0.uiGetBtn, function()
		arg_2_0:emit(ReversePacmanTaskMediator.ON_TASK_SUBMIT, arg_2_0.taskVO)
	end, SFX_PANEL)
