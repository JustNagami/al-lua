...
local var_0_1 = "anim_BRVZ_change"
	...
	arg_21_0:addbubbleMsgBoxList({
		...
		function(arg_24_0)
			if underscore.all(underscore.values(arg_21_0.storyNodesDict), function(arg_25_0)
				...
				arg_21_0:PlayStory(var_24_0, arg_24_0)
			else
				arg_24_0()
			end
		end
...
function var_0_0.UpdateBattle(arg_26_0)
	...
	for iter_26_0, iter_26_1 in ipairs(var_26_1) do
		local var_26_2 = arg_26_0.seriesNodes[tostring(iter_26_1)]
		local var_26_3 = BossRushSeriesData.New({
			id = iter_26_1,
			actId = var_26_0.id
		})
		local var_26_4 = var_26_3:IsUnlock(var_26_0)

		setActive(var_26_2, var_26_4)

		local var_26_5 = var_26_3:GetType()

		setActive(var_26_2:Find("blue"), var_26_5 == BossRushSeriesData.TYPE.NORMAL)
		setActive(var_26_2:Find("red"), var_26_5 ~= BossRushSeriesData.TYPE.NORMAL)

		local var_26_6

		if var_26_5 == BossRushSeriesData.TYPE.NORMAL then
			var_26_6 = var_26_2:Find("blue")
		else
			var_26_6 = var_26_2:Find("red")
		end

		setText(var_26_6:Find("Text"), var_26_3:GetName())
		setText(var_26_6:Find("diff/Text"), switch(iter_26_1, {
			[6001] = function()
		...
		local var_26_7 = var_26_5 == BossRushSeriesData.TYPE.SP

		setActive(var_26_2:Find("times"), var_26_7)

		local var_26_8 = true

		if var_26_7 then
			local var_26_9 = var_26_0:GetUsedBonus()[iter_26_0] or 0
			local var_26_10 = var_26_3:GetMaxBonusCount()
			local var_26_11 = var_26_10 - var_26_9 > 0

			setText(var_26_2:Find("times/Text"), i18n("series_enemy_SP_count") .. setColorStr(math.max(0, var_26_10 - var_26_9) .. "/" .. var_26_10, var_26_11 and "#6EE868" or "#7f7f7f"))
		end

		onButton(arg_26_0, var_26_2, function()
			if not var_26_4 then
				local var_32_0 = var_26_3:GetPreSeriesId()
				local var_32_1 = BossRushSeriesData.New({
					id = var_32_0
				})

				pg.TipsMgr.GetInstance():ShowTips(i18n("series_enemy_unlock", var_32_1:GetName()))

				return
			end

			arg_26_0:emit(BossRushEscapeManorMediator.ON_FLEET_SELECT, var_26_3)
		end, SFX_PANEL)
	end
end
...
function var_0_0.UpdateStory(arg_33_0)
	...
	for iter_33_0, iter_33_1 in pairs(arg_33_0.storyNodesDict) do
		...
		onButton(arg_33_0, var_33_3, function()
			...
			local var_34_0 = iter_33_1:GetStory()

			arg_33_0:PlayStory(var_34_0, function()
				arg_33_0:UpdateView()
			end)
		end)
	end
	...
	if arg_33_0.storyTask then
		local var_33_6 = arg_33_0.storyTask:getConfig("award_display")
		local var_33_7 = Drop.Create(var_33_6[1])
		local var_33_8 = arg_33_0.storyAward:Find("award_bg")

		updateDrop(var_33_8:Find("IconTpl"), var_33_7)
		onButton(arg_33_0, var_33_8, function()
			arg_33_0:emit(BaseUI.ON_DROP, var_33_7)
		end, SFX_PANEL)

		local var_33_9 = arg_33_0.storyTask:getTaskStatus()
...
function var_0_0.UpdateStoryTask(arg_39_0)
	...
	arg_39_0.storyTask = getProxy(TaskProxy):getTaskVO(var_39_0) or Task.New({
		submit_time = 1,
		id = var_39_0
	})

	setActive(arg_39_0.switchToggle:Find("Story/new"), arg_39_0.storyTask and arg_39_0.storyTask:getTaskStatus() ~= 2)
	...
	if arg_39_0.storyTask then
		local var_39_1 = arg_39_0.storyTask:getConfig("award_display")
		local var_39_2 = Drop.Create(var_39_1[1])
		...
		onButton(arg_39_0, var_39_3:Find("IconTpl"), function()
			arg_39_0:emit(BaseUI.ON_DROP, var_39_2)
		end, SFX_PANEL)
	...
	local var_39_5 = arg_39_0.storyTask:getConfig("award_display")
	local var_39_6 = Drop.Create(var_39_5[1])
	local var_39_7 = arg_39_0.storyAward:Find("award_bg")

	updateDrop(var_39_7:Find("IconTpl"), var_39_6)
	onButton(arg_39_0, var_39_7, function()
		return
	end, SFX_PANEL)

	local var_39_8 = arg_39_0.storyTask:getTaskStatus()

	setActive(var_39_7:Find("get"), var_39_8 == 1)
	setActive(var_39_7:Find("got"), var_39_8 == 2)
