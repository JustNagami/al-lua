...
function var_0_0.displayFleetInfo(arg_54_0)
	...
	local var_54_6 = pg.battle_cost_template[var_54_5].oil_cost == 0 and 0 or var_54_4.oil
	...
	local var_54_7 = arg_54_0.contextData.stageId
	...
	if arg_54_0.contextData.costLimit then
		...
		for iter_54_0, iter_54_1 in ipairs({
			...
			local var_54_13 = iter_54_0 == 1
			local var_54_14 = arg_54_0.contextData.costLimit[var_54_13 and 1 or 2]

			if var_54_14 > 0 then
				var_54_11 = var_54_11 or var_54_14 < var_54_12
				var_54_12 = math.min(var_54_12, var_54_14)
			end

			var_54_9 = var_54_9 + var_54_12
		end

		setTextColor(arg_54_0._costText, var_54_11 and Color(0.9803921568627451, 0.39215686274509803, 0.39215686274509803) or Color.white)
