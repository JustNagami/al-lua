...
function var_0_0.Prepare(arg_2_0)
	...
	for iter_2_0 = 1, #var_2_0 do
		...
		local var_2_2 = CrossRoadRole.New(var_2_1, iter_2_0, arg_2_0._tpl, arg_2_0._runningData)

		table.insert(arg_2_0.roleList, var_2_2)
	end
	...
	local var_2_3, var_2_4 = arg_2_0.roleList[1]:GetHW()

	arg_2_0.needwalkTime = var_2_3 / arg_2_0.roleList[1]:GetSpeed()
...
function var_0_0.UpdateRoleMove(arg_10_0, arg_10_1, arg_10_2)
	...
	if var_10_3 == CrossRoadGameConst.SCENE_ROAD_NAME then
		for iter_10_0 = 1, 6 do
			local var_10_5 = arg_10_0.itemList[iter_10_0]

			if var_10_5 ~= nil and CrossRoadGameHelper:CheckRoleInItem(arg_10_1, var_10_5) then
				if var_10_5.id == CrossRoadGameConst.BING_MIAN then
	...
	local var_10_7 = Vector2(var_10_0.x + var_10_6[1], var_10_0.y + var_10_6[2])

	arg_10_1:SetAction(CrossRoadGameConst.SHIP_STATE_ACTION.walk, 0)

	if CrossRoadGameHelper:isMiddle(var_10_7.x, var_10_2.x, var_10_0.x) or var_10_0.x < var_10_2.x then
...
function var_0_0.SetRoleEndTarget(arg_12_0, arg_12_1)
	...
	local var_12_0 = CrossRoadGameConst.SCORE_ONE * arg_12_0.comboCnt + CrossRoadGameConst.SCORE_BASE
...
function var_0_0.SetImageNumber(arg_18_0, arg_18_1, arg_18_2)
	...
	local var_18_1 = (var_18_0 + 1) % 2

	setActive(arg_18_1:Find("wei2/0_" .. var_18_0), true)
	setActive(arg_18_1:Find("wei2/0_" .. var_18_1), false)

	local var_18_2 = arg_18_2 % 10

	for iter_18_0 = 0, 9 do
		setActive(arg_18_1:Find("wei1/0_" .. iter_18_0), false)
	end

	setActive(arg_18_1:Find("wei1/0_" .. var_18_2), true)
end
