...
function var_0_0.MakeRandomCar(arg_3_0, arg_3_1)
	...
	local var_3_4 = arg_3_0.backRoadTF:Find(tostring(var_3_1))
	local var_3_5 = arg_3_0.backRoadList[var_3_1].startTF.anchoredPosition
	local var_3_6 = Vector2.New(var_3_5.x, var_3_5.y - var_3_0.length)
	local var_3_7 = CrossRoadGameConst.START_CAR_SCALE

	var_3_3:SetScale(Vector3(var_3_7, var_3_7, 1))
	var_3_3:SetParent(var_3_4)
	var_3_3:SetPosition(var_3_6)
	var_3_3:SetTarget(var_3_5)
	var_3_3:SetDirect({
		0,
		1
	})
...
function var_0_0.Step(arg_4_0)
	for iter_4_0 = 1, CrossRoadGameConst.GAME_TRACK_COUNT do
		for iter_4_1 = #arg_4_0.carGameObjectList[iter_4_0], 1, -1 do
			local var_4_0 = arg_4_0.carGameObjectList[iter_4_0][iter_4_1]

			if var_4_0:GetNeedDispose() then
...
function var_0_0.Clear(arg_5_0)
	for iter_5_0 = 1, CrossRoadGameConst.GAME_TRACK_COUNT do
		for iter_5_1 = #arg_5_0.carGameObjectList[iter_5_0], 1, -1 do
			local var_5_0 = arg_5_0.carGameObjectList[iter_5_0][iter_5_1]
