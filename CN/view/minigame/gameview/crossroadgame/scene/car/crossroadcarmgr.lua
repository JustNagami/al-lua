...
function var_0_0.Step(arg_4_0, arg_4_1)
	...
	local var_4_0 = arg_4_0._data:GetRoundCnt()
	local var_4_1 = math.max(math.min(var_4_0, #CrossRoadGameConst.MAKE_CAR_TIME), 1)

	arg_4_0.makedelayTime = CrossRoadGameConst.MAKE_CAR_TIME[var_4_1]
