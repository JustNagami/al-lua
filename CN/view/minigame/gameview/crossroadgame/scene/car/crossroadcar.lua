...
function var_0_0.SetCarCrashList(arg_8_0, arg_8_1)
	...
	arg_8_1:SetScale(Vector3(-1 / var_8_0, 1 / var_8_0, 1))

	local var_8_1 = arg_8_1:GetPosition()
	local var_8_2 = arg_8_0._tf.anchoredPosition

	arg_8_1:SetPosition(Vector2(var_8_1.x - var_8_2.x, 0))
...
function var_0_0.GetSpeed(arg_17_0)
	local var_17_0 = arg_17_0._runningData:GetRoundCnt()
	local var_17_1 = math.min(var_17_0, #CrossRoadGameConst.CAR_SPEED_SCALE)
	local var_17_2 = var_17_1 < 1 and 0 or CrossRoadGameConst.CAR_SPEED_SCALE[var_17_1]

	return arg_17_0.speed * (1 + var_17_2)
end
