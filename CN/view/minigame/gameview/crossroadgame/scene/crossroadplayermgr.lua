...
function var_0_0.UpdateAction(arg_5_0)
	...
	if var_5_2 == CrossRoadGameConst.PLAYER_STATE.walk then
		if var_5_3 then
			var_5_1 = var_5_0.stop and CrossRoadGameConst.PLAYER_STATE.stop_walk or CrossRoadGameConst.PLAYER_STATE.sign_walk
		else
			var_5_1 = var_5_2
		end
	else
		var_5_1 = var_5_3 or CrossRoadGameConst.PLAYER_STATE.normal
	end
...
function var_0_0.UpdateMove(arg_6_0, arg_6_1)
	...
	if arg_6_0:GetCrashState() then
		if arg_6_0.carshChangePos then
			local var_6_2 = arg_6_0._runningData:GetPlayerCrashDir()
			local var_6_3 = arg_6_0._runningData:GetPlayerCarshSize()

			arg_6_0:SetPlayerCarshPos(var_6_2, var_6_3)
		end
	...
	if not var_6_0.left == var_6_0.right then
		local var_6_4 = var_6_0.left and {
			-1,
			0
		} or {
			1,
		...
		arg_6_0:SetFaceDir(var_6_4[1])
		arg_6_0:SetPlayerPositionByDir(var_6_4, arg_6_1)
	end
end
...
function var_0_0.SetPlayerPositionByDir(arg_7_0, arg_7_1, arg_7_2)
	...
	local var_7_2 = Vector2(var_7_0.x + var_7_1, var_7_0.y)
	local var_7_3 = arg_7_0._runningData:GetSceneWidth()
	...
	if var_7_2.x > -var_7_3 / 2 and var_7_2.x < var_7_3 / 2 then
...
function var_0_0.SetFaceDir(arg_9_0, arg_9_1)
	...
	var_9_0.x = math.abs(var_9_0.x) * arg_9_1
